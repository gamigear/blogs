        ...
        <div className="row">
          <div className="col-xxl-6 offset-xxl-3 col-xl-6 offset-xl-3 col-lg-8 offset-lg-2">
            <div className="section__title-wrapper mb-60 text-center">
              ...
              <p>
                GameHub là nền tảng tổng hợp các mini game trên mạng xã hội như
                Facebook, TikTok, Zalo... Chúng tôi giúp bạn cập nhật nhanh chóng các mini game mới,
                hướng dẫn tham gia và không bỏ lỡ bất kỳ phần thưởng nào.
              </p>
            </div>
          </div>
        </div>
