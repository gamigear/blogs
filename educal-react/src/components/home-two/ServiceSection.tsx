           ...
           <div className="row">
              <div className="col-xxl-6 offset-xxl-3 col-xl-6 offset-xl-3">
                 <div className="section__title-wrapper section-padding mb-60 text-center">
                    <h2 className="section__title">Tại sao chọn <span className="yellow-bg">GameHub <Image src={YellowBg} style={{width:"auto", height:"auto"}} alt="img not found" /></span> của chúng tôi</h2>
                    <p>Nền tảng tổng hợp mini game trên mạng xã hội hàng đầu Việt Nam.</p>
                 </div>
              </div>
           </div>
           <div className="row">
              <div className="col-xxl-3 col-xl-3 col-lg-3 col-md-6 col-sm-6">
                 <div className="services__item blue-bg-4 mb-30">
                    ...
                    <div className="services__content">
                       <h3 className="services__title"><Link href="/about">500+ <br /> Mini Game</Link></h3>
                       <p>Cập nhật liên tục các mini game mới nhất!</p>
              ...
              <div className="col-xxl-3 col-xl-3 col-lg-3 col-md-6 col-sm-6">
                 <div className="services__item pink-bg mb-30">
                    ...
                    <div className="services__content">
                       <h3 className="services__title"><Link href="/about">Phần thưởng<br /> Hấp dẫn</Link></h3>
                       <p>Nhận quà tặng giá trị từ các sự kiện!</p>
              ...
              <div className="col-xxl-3 col-xl-3 col-lg-3 col-md-6 col-sm-6">
                 <div className="services__item purple-bg mb-30">
                    ...
                    <div className="services__content">
                       <h3 className="services__title"><Link href="/about">Cộng đồng<br /> Sôi động</Link></h3>
                       <p>Kết nối với hàng ngàn game thủ!</p>
              ...
              <div className="col-xxl-3 col-xl-3 col-lg-3 col-md-6 col-sm-6">
                 <div className="services__item green-bg mb-30">
                    ...
                    <div className="services__content">
                       <h3 className="services__title"><Link href="/about">Cập nhật<br /> 24/7</Link></h3>
                       <p>Không bỏ lỡ bất kỳ sự kiện nào!</p>
