  ...
  return (
    ...
    >
      ...
      >
        ...
        <MenuSection label='Quản trị Website'>
          <MenuItem href={`/${locale}/apps/website-dashboard`} icon={<i className='tabler-dashboard' />}>
            Tổng quan
          </MenuItem>
          <SubMenu label='Mini Games' icon={<i className='tabler-device-gamepad-2' />}>
            <MenuItem href={`/${locale}/apps/courses/list`}>Danh sách</MenuItem>
            <MenuItem href={`/${locale}/apps/courses/add`}>Thêm mới</MenuItem>
          </SubMenu>
          <SubMenu label='Bài viết' icon={<i className='tabler-article' />}>
            <MenuItem href={`/${locale}/apps/blogs/list`}>Danh sách</MenuItem>
            <MenuItem href={`/${locale}/apps/blogs/add`}>Thêm mới</MenuItem>
          </SubMenu>
          <SubMenu label='Sự kiện' icon={<i className='tabler-calendar-event' />}>
            <MenuItem href={`/${locale}/apps/events/list`}>Danh sách</MenuItem>
            <MenuItem href={`/${locale}/apps/events/add`}>Thêm mới</MenuItem>
          </SubMenu>
          <MenuItem href={`/${locale}/apps/categories/list`} icon={<i className='tabler-category' />}>
            Danh mục
          </MenuItem>
          <MenuItem href={`/${locale}/apps/banners/list`} icon={<i className='tabler-photo' />}>
            Banner/Slider
          </MenuItem>
          <MenuItem href={`/${locale}/apps/testimonials/list`} icon={<i className='tabler-message-star' />}>
            Đánh giá
          </MenuItem>
          <MenuItem href={`/${locale}/apps/contacts/list`} icon={<i className='tabler-mail' />}>
            Tin nhắn liên hệ
          </MenuItem>
          <MenuItem href={`/${locale}/apps/notifications`} icon={<i className='tabler-bell' />}>
            Thông báo
          </MenuItem>
          <MenuItem href={`/${locale}/apps/website-users`} icon={<i className='tabler-users' />}>
            Người dùng
          </MenuItem>
          <MenuItem href={`/${locale}/apps/media-library`} icon={<i className='tabler-folder' />}>
            Thư viện Media
          </MenuItem>
          <MenuItem href={`/${locale}/apps/menu-management`} icon={<i className='tabler-menu-2' />}>
            Quản lý Menu
          </MenuItem>
          <MenuItem href={`/${locale}/apps/footer-settings`} icon={<i className='tabler-layout-bottombar' />}>
            Cài đặt Footer
          </MenuItem>
          <MenuItem href={`/${locale}/apps/analytics`} icon={<i className='tabler-chart-bar' />}>
            Analytics
          </MenuItem>
          <MenuItem href={`/${locale}/apps/seo-settings`} icon={<i className='tabler-seo' />}>
            Cài đặt SEO
          </MenuItem>
          <MenuItem href={`/${locale}/apps/backup-restore`} icon={<i className='tabler-database' />}>
            Sao lưu & Khôi phục
          </MenuItem>
          <MenuItem href={`/${locale}/apps/website-settings`} icon={<i className='tabler-settings' />}>
            Cài đặt chung
          </MenuItem>
        </MenuSection>
