...
const Home = async () => {
  ...
  // If not enough popular posts, use latest posts
  const displayPopularPosts = popularPosts.length > 0 ? popularPosts : allPosts.slice(0, 6);

  return (
    <LayoutThree>
      <Header hasCategory={headerCategories.enable} categories={categories} />
      <Banner banner={banner} featuredPost={featuredPost || allPosts[0]} topPosts={topPosts.length > 0 ? topPosts : allPosts.slice(1, 5)} />
            ...
            <div className="row gx-5">
              ...
              <div className="md:col-7 lg:col-8 mb-16 lg:mb-0">
                ...
                <div className="row gy-6">
                  {displayPopularPosts.map((post, index) => (
