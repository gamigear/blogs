    ...
    const grid = new Grid({
        columns: [
            ...
            },
            {
                name: 'Customer',
                formatter: (_, row) => html(
                    `<a href="${basePath}dashboards/ecommerces/order-details">
                        <div class="d-flex align-items-center gap-3 position-relative">
                            <div class="lh-1">
                                <span class="avatar avatar-md avatar-rounded">
                                    <img src="${row.cells[2].data.src}" alt="User Image">
                                </span>
                            </div>
                            <div>
                ...
                formatter: (_, row) => html(`
                    <div class="dropdown">
                        ...
                        <ul class="dropdown-menu">
                            <li><a class="dropdown-item" href="${basePath}dashboards/ecommerces/order-details"><i class="ri-eye-line me-2"></i>View</a></li>
