...
(async () => {
    if (typeof window !== "undefined") {
        ...
        const raterJsModule = await import("rater-js");
        window.raterJs = raterJsModule.default; // ✅ Make available globally
    }
})();
...
(function () {
  ...
  /* Basic Rater */
  var starRating1 = window.raterJs({
    starSize: 24,
  ...
  var starRating2 = window.raterJs({
  ...
  /* Custom messages */
  var starRating3 = window.raterJs({
    starSize: 24,
    max: 5,
    rating: 4,
  ...
  var starRating4 = window.raterJs({
    max: 10,
    starSize: 24,
    readOnly: true,
    rating: 6,
  ...
  var starRating14 = window.raterJs({
    starSize: 24,
    isBusyText: "Rating in progress. Please wait...",
    element: document.querySelector("#stars-busytext"),
    rateCallback: function rateCallback(rating, done) {
  ...
  /* On hover event */
  var starRating5 = window.raterJs({
    starSize: 24,
    element: document.querySelector("#stars-hover"),
    rateCallback: function rateCallback(rating, done) {
      this.setRating(rating);
  ...
  /* Clear/reset rater */
  var starRating6 = window.raterJs({
    starSize: 24,
