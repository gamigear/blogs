...
import { Navigation, Thumbs, FreeMode, Pagination, EffectCube, EffectFade, EffectFlip, EffectCoverflow, Mousewheel, Keyboard,Scrollbar,Autoplay } from 'swiper/modules';
Swiper.use([Navigation, Thumbs, FreeMode, Pagination, EffectCube, EffectFade, EffectFlip, EffectCoverflow, Mousewheel, Keyboard,Scrollbar,Autoplay]);
