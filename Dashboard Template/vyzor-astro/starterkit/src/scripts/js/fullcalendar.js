...
(function () {
  ...
  var calendar = new Calendar(document.getElementById('calendar'), {
    ...
    dateClick: function (info) {
      ...
      var addEventModal = new Modal(document.getElementById('addEvent'));
      addEventModal.show();
    ...
    eventClick: function (info) {
      ...
      document.getElementById('deleteEventButton').onclick = function () {
        ...
        event.remove();
        // Close the modal
        var eventModal = Modal.getInstance(document.getElementById('eventModal'));
        eventModal.hide();
  ...
  document.getElementById('addEventButton').addEventListener('click', function () {
    ...
    // Close the modal
    var addEventModal = Modal.getInstance(document.getElementById('addEvent'));
