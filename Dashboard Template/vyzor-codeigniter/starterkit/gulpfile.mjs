...
// Watch Task
function watchTask() {
  gulp.watch(['public/assets/scss/**/*', '!public/assets/switcher/*.scss'], gulp.series(scssTask));
}

// SCSS Task
function scssTask() {
  const scssFiles = 'public/assets/scss/**/*.scss';
...
function copyLibsTask() {
  const destPath = 'public/assets/libs';
