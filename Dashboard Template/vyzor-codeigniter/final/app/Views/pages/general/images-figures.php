                            ...
                            <div class="card custom-card">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="text-center">
                                        <img src="<?php echo base_url('assets/images/media/media-48.jpg'); ?>" class="img-fluid" alt="...">
                                    </div>
                                </div>
                        ...
                        <div class="col-xl-6">
                            <div class="card custom-card">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="text-center">
                                        <img src="<?php echo base_url('assets/images/media/media-49.jpg'); ?>" class="img-fluid rounded" alt="...">
                                    </div>
                                </div>
                                <div class="card-footer d-none border-top-0">
<!-- Prism Code -->
...
<!-- Prism Code -->
                        ...
                        <div class="col-xl-6">
                            <div class="card custom-card">
                                ...
                                <div class="card-body">
                                    <img class="rounded float-start" src="<?php echo base_url('assets/images/media/media-53.jpg'); ?>" alt="...">
                                </div>
                                <div class="card-footer d-none border-top-0">
<!-- Prism Code -->
<pre class="language-html"><code class="language-html">&lt;img class="rounded float-start" src="<?php echo base_url('assets/images/media/media-53.jpg'); ?>" alt="..."&gt;</code></pre>
<!-- Prism Code -->
                                </div>
                            </div>
                        </div>
                        <div class="col-xl-6">
                            <div class="card custom-card">
                                ...
                                <div class="card-body">
                                    <img class="rounded mx-auto d-block" src="<?php echo base_url('assets/images/media/media-55.jpg'); ?>" alt="...">
                                </div>
                                <div class="card-footer d-none border-top-0">
<!-- Prism Code -->
<pre class="language-html"><code class="language-html">&lt;img class="rounded mx-auto d-block" src="<?php echo base_url('assets/images/media/media-55.jpg'); ?>" alt="..."&gt;</code></pre>
<!-- Prism Code -->
                                </div>
                            </div>
                        </div>
                        <div class="col-xl-6">
                            <div class="card custom-card">
                                ...
                                <div class="card-body">
                                    <img class="rounded float-end" src="<?php echo base_url('assets/images/media/media-54.jpg'); ?>" alt="...">
                                </div>
                                <div class="card-footer d-none border-top-0">
<!-- Prism Code -->
<pre class="language-html"><code class="language-html">&lt;img class="rounded float-end" src="<?php echo base_url('assets/images/media/media-54.jpg'); ?>" alt="..."&gt;</code></pre>
<!-- Prism Code -->
                                </div>
                            </div>
                        </div>
                        <div class="col-xl-6">
                            <div class="card custom-card">
                                ...
                                <div class="card-body d-flex justify-content-between gap-2">
                                    <figure class="figure">
                                        <img class="bd-placeholder-img figure-img img-fluid rounded card-img" src="<?php echo base_url('assets/images/media/media-56.jpg'); ?>" alt="...">
                                        <figcaption class="figure-caption mt-2">A caption for the above image.
                                        </figcaption>
                                    </figure>
                                    <figure class="figure float-end">
                                        <img class="bd-placeholder-img figure-img img-fluid rounded card-img" src="<?php echo base_url('assets/images/media/media-57.jpg'); ?>" alt="...">
                        ...
                        <div class="col-xl-3">
                            <div class="card custom-card">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="text-center">
                                        <img src="<?php echo base_url('assets/images/media/media-51.jpg'); ?>" class="img-thumbnail" alt="...">
                                    </div>
                                </div>
                                <div class="card-footer d-none border-top-0">
<!-- Prism Code -->
                        ...
                        <div class="col-xl-3">
                            <div class="card custom-card">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="text-center">
                                        <img src="<?php echo base_url('assets/images/media/media-52.jpg'); ?>" class="img-thumbnail rounded-pill" alt="...">
                                    </div>
                                </div>
                                <div class="card-footer d-none border-top-0">
<!-- Prism Code -->
