                                ...
                                <div class="card-body">
                                    <div class="d-sm-flex mb-3">
                                        <div class="flex-shrink-0 mb-3 mb-sm-0">
                                            <img class="bd-placeholder-img card-img w-10 h-10" src="<?php echo base_url('assets/images/faces/6.jpg'); ?>" alt="img">
                                        </div>
                                    ...
                                    <div class="d-sm-flex align-items-center">
                                        <div class="flex-shrink-0 mb-3 mb-sm-0">
                                            <img class="bd-placeholder-img card-img avatar-xl" src="<?php echo base_url('assets/images/faces/15.jpg'); ?>" alt="img">
                                        </div>
                                        <div class="flex-grow-1 ms-3">
