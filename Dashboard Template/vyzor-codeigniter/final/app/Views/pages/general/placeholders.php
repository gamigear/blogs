                            ...
                            <div class="row">
                                <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12">
                                    <div class="card custom-card">
                                        <img class="card-img-top" src="<?php echo base_url('assets/images/media/media-60.jpg'); ?>" alt="">
                                        <div class="card-body">
                                ...
                                <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12">
                                    <div class="card" aria-hidden="true">
                                        <img class="card-img-top" src="<?php echo base_url('assets/images/media/media-61.jpg'); ?>" alt="">
                                        <div class="card-body">
