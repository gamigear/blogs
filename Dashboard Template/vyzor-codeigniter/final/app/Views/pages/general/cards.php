                        ...
                        <div class="col-xxl-6 col-xl-6 col-lg-12">
                            ...
                            <div class="row row-cols-12">
                                <div class="col">
                                    <div class="card custom-card">
                                        <div class="card-body">
                                            <img src="<?php echo base_url('assets/images/media/media-25.jpg'); ?>" class="card-img mb-3" alt="...">
                    ...
                    <div class="row">
                        <div class="col-xl-4">
                            <div class="card custom-card overflow-hidden">
                                <div class="row g-0">
                                    <div class="col-md-4">
                                        <img src="<?php echo base_url('assets/images/media/media-37.jpg'); ?>" class="img-fluid h-100 w-100" alt="...">
                                    </div>
                                    <div class="col-md-8">
                                        <div class="card-header">
                        ...
                        <div class="col-xl-4">
                            <div class="card custom-card overflow-hidden">
                                <div class="row g-0">
                                    ...
                                    <div class="col-md-4">
                                        <img src="<?php echo base_url('assets/images/media/media-38.jpg'); ?>" class="img-fluid h-100 w-100" alt="...">
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div class="col-xl-4">
                            <div class="card custom-card overflow-hidden">
                                <div class="row g-0">
                                    ...
                                    <div class="col-md-4">
                                        <img src="<?php echo base_url('assets/images/media/media-39.jpg'); ?>" class="img-fluid h-100 w-100" alt="...">
                                    </div>
                                </div>
                            </div>
                        </div>
