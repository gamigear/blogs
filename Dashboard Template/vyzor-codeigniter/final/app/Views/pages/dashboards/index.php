                                    ...
                                    <div class="card custom-card shadow-none card-bg-primary overflow-hidden dashboard-banner-card">
                                        <div class="card-body">
                                            <div class="dashboard-banner-card-background">
                                                <img src="<?php echo base_url('assets/images/media/backgrounds/8.png'); ?>" alt="">
                                            </div>
                                    ...
                                    <ul class="list-group list-group-flush">
                                        ...
                                        <li class="list-group-item">
                                            <div class="d-flex align-items-center gap-3">
                                                <div class="lh-1">
                                                    <span class="avatar avatar-lg bg-light border border-dashed p-1">
                                                        <img src="<?php echo base_url('assets/images/ecommerce/png/16.png'); ?>" alt="">
                                                    </span>
                                                </div>
                                                <div class="flex-fill">
                                            ...
                                            <tbody>
                                                    ...
                                                    <td>
                                                        <div class="avatar-list-stacked">
                                                            <span class="avatar avatar-rounded avatar-sm bg-light">
                                                                <img src="<?php echo base_url('assets/images/ecommerce/jpg/3.jpg'); ?>" alt="img">
                                                            </span>
                                                            <span class="avatar avatar-rounded avatar-sm bg-light">
                                                                <img src="<?php echo base_url('assets/images/ecommerce/jpg/4.jpg'); ?>" alt="img">
                                                            </span>
                                                            <span class="avatar avatar-rounded avatar-sm bg-light">
                                                                <img src="<?php echo base_url('assets/images/ecommerce/jpg/5.jpg'); ?>" alt="img">
                                                            </span>
                                                        </div>
                                                    </td>
                                                    <td>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <div class="avatar-list-stacked">
                                                            <span class="avatar avatar-rounded avatar-sm bg-light">
                                                                <img src="<?php echo base_url('assets/images/ecommerce/jpg/1.jpg'); ?>" alt="img">
                                                            </span>
                                                            <span class="avatar avatar-rounded avatar-sm bg-light">
                                                                <img src="<?php echo base_url('assets/images/ecommerce/jpg/2.jpg'); ?>" alt="img">
                                                            </span>
                                                        </div>
                                                    </td>
                                                    <td>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <div class="avatar-list-stacked">
                                                            ...
                                                            <span class="avatar avatar-rounded avatar-sm bg-light">
                                                                <img src="<?php echo base_url('assets/images/ecommerce/jpg/6.jpg'); ?>" alt="img">
                                                            </span>
                                                        </div>
                                                    </td>
                                                    <td>
