                                ...
                                <div class="card-body">
                                    <div class="d-flex align-items-center mb-4 flex-wrap">
                                        <div class="d-flex align-items-center">
                                            <div class="me-2">
                                                <span class="avatar avatar-md avatar-rounded bg-light p-2">
                                                    <img src="<?php echo base_url('assets/images/crypto-currencies/regular/Dash.svg'); ?>" alt="">
                                                </span>
                                            </div>
                                            <div class="mb-0 fw-medium">
                                                Dash - DASH
                                        ...
                                        <li class="list-group-item">
                                            <div class="d-flex align-items-center justify-content-between flex-wrap gap-3">
                                                <div class="d-flex align-items-center gap-2">
                                                    <div>
                                                        <span class="avatar avatar-sm p-1 bg-light">
                                                            <img src="<?php echo base_url('assets/images/crypto-currencies/regular/litecoin.svg'); ?>" alt="">
                                                        </span>
                                                    </div>
                                                    <div>
