                        ...
                        <div class="col-xxl-6">
                            <div class="card custom-card">
                                <div class="card-header justify-content-between">
                                    ...
                                    <div class="btn-list">
                                        <a href="<?php echo base_url('projects-create'); ?>" class="btn btn-sm btn-primary btn-wave"><i class="ri-add-line align-middle me-1 fw-medium"></i>Create Project</a>
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="d-flex gap-5 mb-4 flex-wrap">
                                        ...
                                        <div class="d-flex align-items-center gap-2">
                                            <span class="avatar avatar-md avatar-rounded me-1"><img src="<?php echo base_url('assets/images/faces/11.jpg'); ?>" alt=""></span>
                                            <div>
                                            ...
                                            <div>
                                                ...
                                                <p class="project-activity-media mb-0">
                                                    <a href="javascript:void(0);">
                                                        <img src="<?php echo base_url('assets/images/media/file-manager/3.png'); ?>" alt="" class="img-fluid bg-light">
                                                    </a>  
                                ...
                                <div class="card-footer">
                                    <div class="d-sm-flex align-items-center lh-1">
                                        <div class="me-sm-2 mb-2 mb-sm-0 p-1 rounded-circle bg-primary-transparent d-inline-block">
                                            <img src="<?php echo base_url('assets/images/faces/5.jpg'); ?>" alt="" class="avatar avatar-sm avatar-rounded">
                                        </div>
                                        <div class="flex-fill">
...
<?= $this->section('scripts'); ?>
        ...
        <script src="<?php echo base_url('assets/js/project-overview.js'); ?>"></script>
