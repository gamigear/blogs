                                                        ...
                                                        <tr>
                                                            ...
                                                            <td class="border-bottom-0">
                                                                <div class="d-flex align-items-center gap-2">
                                                                    <div class="lh-1">
                                                                        <span class="avatar avatar-xs">
                                                                            <img src="<?php echo base_url('assets/images/flags/russia_flag.jpg'); ?>" alt="">
                                                                        </span>
                                                                    </div>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <div class="d-flex align-items-center gap-2">
                                                                    <div class="lh-1">
                                                                        <span class="avatar avatar-xs avatar-rounded">
                                                                            <img src="<?php echo base_url('assets/images/flags/india_flag.jpg'); ?>" alt="">
                                                                        </span>
                                                                    </div>
                                                                    <div>
                                                                        India
                                            ...
                                            <ul class="list-unstyled browser-insights-list">
                                                    ...
                                                    <div class="d-flex align-items-start gap-3">
                                                        <div class="lh-1">
                                                            <span class="avatar avatar-rounded avatar-sm">
                                                                <img src="<?php echo base_url('assets/images/browsers/chrome.png'); ?>" alt="">
                                                            </span>
                                                        </div>
                                                        <div class="flex-fill">
                                                ...
                                                <li>
                                                    <div class="d-flex align-items-start gap-3">
                                                        <div class="lh-1">
                                                            <span class="avatar avatar-rounded avatar-sm">
                                                                <img src="<?php echo base_url('assets/images/browsers/edge.png'); ?>" alt="">
                                                            </span>
                                                        </div>
                                                        <div class="flex-fill">
                                                ...
                                                <li>
                                                    <div class="d-flex align-items-start gap-3">
                                                        <div class="lh-1">
                                                            <span class="avatar avatar-rounded avatar-sm">
                                                                <img src="<?php echo base_url('assets/images/browsers/firefox.png'); ?>" alt="">
                                                            </span>
                                                        </div>
                                                        <div class="flex-fill">
                                                ...
                                                <li>
                                                    <div class="d-flex align-items-start gap-3">
                                                        <div class="lh-1">
                                                            <span class="avatar avatar-rounded avatar-sm">
                                                                <img src="<?php echo base_url('assets/images/browsers/opera.png'); ?>" alt="">
                                                            </span>
                                                        </div>
                                                        <div class="flex-fill">
                                                ...
                                                <li>
                                                    <div class="d-flex align-items-start gap-3">
                                                        <div class="lh-1">
                                                            <span class="avatar avatar-rounded avatar-sm">
                                                                <img src="<?php echo base_url('assets/images/browsers/safari.png'); ?>" alt="">
                                                            </span>
                                                        </div>
                                                        <div class="flex-fill">
                                                ...
                                                <li>
                                                    <div class="d-flex align-items-start gap-3">
                                                        <div class="lh-1">
                                                            <span class="avatar avatar-rounded avatar-sm">
                                                                <img src="<?php echo base_url('assets/images/browsers/uc.png'); ?>" alt="">
                                                            </span>
                                                        </div>
                                                        <div class="flex-fill">
