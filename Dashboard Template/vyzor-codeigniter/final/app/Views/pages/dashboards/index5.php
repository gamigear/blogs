                                    ...
                                    <div class="card custom-card nft-main-banner-card border-0">
                                        <div class="card-body">
                                            <div class="nft-main-bannr-background">
                                                <img src="<?php echo base_url('assets/images/nft-images/1.png'); ?>" alt="" class="d-md-block d-none">
                                            </div>
                                    ...
                                    <ul class="list-unstyled nft-top-drops-list">
                                        ...
                                        <li>
                                            <div class="d-flex align-items-center gap-2">
                                                <div class="lh-1">
                                                    <span class="avatar avatar-md avatar-rounded">
                                                        <img src="<?php echo base_url('assets/images/nft-images/38.png'); ?>" alt="">
                                                    </span>
                                                </div>
                                                <div class="flex-fill">
                                        ...
                                        <li>
                                            <div class="d-flex align-items-center gap-2">
                                                <div class="lh-1">
                                                    <span class="avatar avatar-md avatar-rounded">
                                                        <img src="<?php echo base_url('assets/images/nft-images/40.png'); ?>" alt="">
                                                    </span>
                                                </div>
                                                <div class="flex-fill">
                                        ...
                                        <li>
                                            <div class="d-flex align-items-center gap-2">
                                                <div class="lh-1">
                                                    <span class="avatar avatar-md avatar-rounded">
                                                        <img src="<?php echo base_url('assets/images/nft-images/41.png'); ?>" alt="">
                                                    </span>
                                                </div>
                                                <div class="flex-fill">
                                        ...
                                        <li>
                                            <div class="d-flex align-items-center gap-2">
                                                <div class="lh-1">
                                                    <span class="avatar avatar-md avatar-rounded">
                                                        <img src="<?php echo base_url('assets/images/nft-images/42.png'); ?>" alt="">
                                                    </span>
                                                </div>
                                                <div class="flex-fill">
                                        ...
                                        <li>
                                            <div class="d-flex align-items-center gap-2">
                                                <div class="lh-1">
                                                    <span class="avatar avatar-md avatar-rounded">
                                                        <img src="<?php echo base_url('assets/images/nft-images/43.png'); ?>" alt="">
                                                    </span>
                                                </div>
                                                <div class="flex-fill">
                                            ...
                                            <div class="swiper-slide">
                                                <div class="card custom-card border-0 shadow-none mb-0">
                                                    <div class="card-body p-0">
                                                        <div class="row g-2">
                                                            <div class="col-12">
                                                                <img src="<?php echo base_url('assets/images/nft-images/38.png'); ?>" alt="" class="nft-featuredcollect-image rounded">
                                                            </div>
                                                            <div class="col-6">
                                                                <img src="<?php echo base_url('assets/images/nft-images/40.png'); ?>" alt="" class="nft-featuredcollect-image rounded">
                                                            </div>
                                                            <div class="col-6">
                                                                <img src="<?php echo base_url('assets/images/nft-images/41.png'); ?>" alt="" class="nft-featuredcollect-image rounded">
                                                            </div>
                                                        </div>
                                                    </div>
                                            ...
                                            <div class="swiper-slide">
                                                <div class="card custom-card border-0 shadow-none mb-0">
                                                    <div class="card-body p-0">
                                                        <div class="row g-2">
                                                            <div class="col-12">
                                                                <img src="<?php echo base_url('assets/images/nft-images/35.png'); ?>" alt="" class="nft-featuredcollect-image rounded">
                                                            </div>
                                                            <div class="col-6">
                                                                <img src="<?php echo base_url('assets/images/nft-images/36.png'); ?>" alt="" class="nft-featuredcollect-image rounded">
                                                            </div>
                                                            <div class="col-6">
                                                                <img src="<?php echo base_url('assets/images/nft-images/37.png'); ?>" alt="" class="nft-featuredcollect-image rounded">
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="card-footer border-top-0 pb-0">
                                            ...
                                            <div class="swiper-slide">
                                                <div class="card custom-card border-0 shadow-none mb-0">
                                                    <div class="card-body p-0">
                                                        <div class="row g-2">
                                                            <div class="col-12">
                                                                <img src="<?php echo base_url('assets/images/nft-images/39.png'); ?>" alt="" class="nft-featuredcollect-image rounded">
                                                            </div>
                                                            <div class="col-6">
                                                                <img src="<?php echo base_url('assets/images/nft-images/42.png'); ?>" alt="" class="nft-featuredcollect-image rounded">
                                                            </div>
                                                            <div class="col-6">
                                                                <img src="<?php echo base_url('assets/images/nft-images/43.png'); ?>" alt="" class="nft-featuredcollect-image rounded">
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="card-footer border-top-0 pb-0">
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <div class="d-flex align-items-center gap-2">
                                                            <div class="lh-1">
                                                                <span class="avatar avatar-md avatar-rounded">
                                                                    <img src="<?php echo base_url('assets/images/nft-images/35.png'); ?>" alt="">
                                                                </span>
                                                            </div>
                                                            <div>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <div class="d-flex align-items-center gap-2">
                                                            <div class="lh-1">
                                                                <span class="avatar avatar-md avatar-rounded">
                                                                    <img src="<?php echo base_url('assets/images/nft-images/37.png'); ?>" alt="">
                                                                </span>
                                                            </div>
                                                            <div>
