                                            ...
                                            <ul class="list-unstyled ecommerce-recent-orders-list">
                                                ...
                                                <li>
                                                    <div class="d-flex align-items-center gap-3">
                                                        <div class="lh-1">
                                                            <span class="avatar avatar-md">
                                                                <img src="<?php echo base_url('assets/images/ecommerce/png/15.png'); ?>" alt="">
                                                            </span>
                                                        </div>
                                                        <div class="flex-fill">
                                            ...
                                            <ul class="list-group list-group-flush">
                                                    ...
                                                    <div class="d-flex align-items-center gap-2 mb-1">
                                                        ...
                                                        <div>
                                                            <span class="avatar avatar-xs">
                                                                <img src="<?php echo base_url('assets/images/faces/emojis/1.png'); ?>" alt="">
                                                            </span>
                                                        </div>
                                                    </div>
                                                ...
                                                <li class="list-group-item">
                                                    <div class="d-flex align-items-center gap-2 mb-1">
                                                        ...
                                                        <div>
                                                            <span class="avatar avatar-xs">
                                                                <img src="<?php echo base_url('assets/images/faces/emojis/2.png'); ?>" alt="">
                                                            </span>
                                                        </div>
                                                    </div>
                                                ...
                                                <li class="list-group-item">
                                                    <div class="d-flex align-items-center gap-2 mb-1">
                                                        ...
                                                        <div>
                                                            <span class="avatar avatar-xs">
                                                                <img src="<?php echo base_url('assets/images/faces/emojis/3.png'); ?>" alt="">
                                                            </span>
                                                        </div>
                                                    </div>
                                                ...
                                                <li class="list-group-item">
                                                    <div class="d-flex align-items-center gap-2 mb-1">
                                                        ...
                                                        <div>
                                                            <span class="avatar avatar-xs">
                                                                <img src="<?php echo base_url('assets/images/faces/emojis/4.png'); ?>" alt="">
                                                            </span>
                                                        </div>
                                                    </div>
                                                ...
                                                <li class="list-group-item">
                                                    <div class="d-flex align-items-center gap-2 mb-1">
                                                        ...
                                                        <div>
                                                            <span class="avatar avatar-xs">
                                                                <img src="<?php echo base_url('assets/images/faces/emojis/5.png'); ?>" alt="">
                                                            </span>
                                                        </div>
                                                    </div>
                                                ...
                                                <li class="list-group-item">
                                                    <div class="d-flex align-items-center gap-2 mb-1">
                                                        ...
                                                        <div>
                                                            <span class="avatar avatar-xs">
                                                                <img src="<?php echo base_url('assets/images/faces/emojis/6.png'); ?>" alt="">
                                                            </span>
                                                        </div>
                                                    </div>
