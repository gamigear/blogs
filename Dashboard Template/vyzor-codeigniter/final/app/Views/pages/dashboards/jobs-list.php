                            ...
                            <div class="card custom-card overflow-hidden">
                                <div class="card-header justify-content-between">
                                    ...
                                    <div class="d-flex flex-wrap gap-2">
                                        <a href="<?php echo base_url('job-post'); ?>" class="btn btn-primary btn-wave">
                                                ...
                                                <tr class="joblist-list">
                                                    ...
                                                    <td>
                                                        <div class="d-flex align-items-center">
                                                            ...
                                                            <div class="ms-2">
                                                                <p class="fw-medium mb-0 d-flex align-items-center"><a href="<?php echo base_url('job-details'); ?>">Software Engineer</a></p>
                                                    ...
                                                    <td>
                                                        <a href="<?php echo base_url('job-details'); ?>" class="btn btn-icon btn-sm btn-primary-light btn-wave waves-effect waves-light">
                                                ...
                                                <tr class="joblist-list">
                                                    ...
                                                    <td>
                                                        <div class="d-flex align-items-center">
                                                            ...
                                                            <div class="ms-2">
                                                                <p class="fw-medium mb-0 d-flex align-items-center"><a href="<?php echo base_url('job-details'); ?>">Data Analyst</a></p>
                                                ...
                                                <tr class="joblist-list">
                                                    ...
                                                    <td>
                                                        <div class="d-flex align-items-center">
                                                            ...
                                                            <div class="ms-2">
                                                                <p class="fw-medium mb-0 d-flex align-items-center"><a href="<?php echo base_url('job-details'); ?>">Product Manager</a></p>
                                                ...
                                                <tr class="joblist-list">
                                                    ...
                                                    <td>
                                                        <div class="d-flex align-items-center">
                                                            ...
                                                            <div class="ms-2">
                                                                <p class="fw-medium mb-0 d-flex align-items-center"><a href="<?php echo base_url('job-details'); ?>">UI/UX Designer</a></p>
                                                ...
                                                <tr class="joblist-list">
                                                    ...
                                                    <td>
                                                        <div class="d-flex align-items-center">
                                                            ...
                                                            <div class="ms-2">
                                                                <p class="fw-medium mb-0 d-flex align-items-center"><a href="<?php echo base_url('job-details'); ?>">Marketing Specialist</a></p>
                                                ...
                                                <tr class="joblist-list">
                                                    ...
                                                    <td>
                                                        <div class="d-flex align-items-center">
                                                            ...
                                                            <div class="ms-2">
                                                                <p class="fw-medium mb-0 d-flex align-items-center"><a href="<?php echo base_url('job-details'); ?>">HR Manager</a></p>
                                                ...
                                                <tr class="joblist-list">
                                                    ...
                                                    <td>
                                                        <div class="d-flex align-items-center">
                                                            ...
                                                            <div class="ms-2">
                                                                <p class="fw-medium mb-0 d-flex align-items-center"><a href="<?php echo base_url('job-details'); ?>">Full Stack Developer</a></p>
                                                ...
                                                <tr class="joblist-list">
                                                    ...
                                                    <td>
                                                        <div class="d-flex align-items-center">
                                                            ...
                                                            <div class="ms-2">
                                                                <p class="fw-medium mb-0 d-flex align-items-center"><a href="<?php echo base_url('job-details'); ?>">Network Administrator</a></p>
                                                ...
                                                <tr class="joblist-list">
                                                    ...
                                                    <td>
                                                        <div class="d-flex align-items-center">
                                                            ...
                                                            <div class="ms-2">
                                                                <p class="fw-medium mb-0 d-flex align-items-center"><a href="<?php echo base_url('job-details'); ?>">Customer Support Lead</a></p>
                                                ...
                                                <tr class="joblist-list">
                                                    ...
                                                    <td>
                                                        <div class="d-flex align-items-center">
                                                            ...
                                                            <div class="ms-2">
                                                                <p class="fw-medium mb-0 d-flex align-items-center"><a href="<?php echo base_url('job-details'); ?>">Sales Manager</a></p>
...
<?= $this->section('scripts'); ?>
    ...
    <!-- job list JS -->
    <script src="<?php echo base_url('assets/js/job-list.js'); ?>"></script>
