                        ...
                        <div class="card custom-card border-0 shadow-none my-4">
                            <div class="card-body p-5">
                                ...
                                <div class="d-grid mt-3">
                                    <a href="<?php echo base_url('index'); ?>" class="btn btn-primary">Reset Password</a>
                                </div>
                                ...
                                <div class="text-center mt-3 fw-medium">
                                    Dont want to reset? <a href="<?php echo base_url('sign-in-basic'); ?>" class="text-primary">login Here</a>
                                </div>
                            </div>
                        </div>
                    </div>
