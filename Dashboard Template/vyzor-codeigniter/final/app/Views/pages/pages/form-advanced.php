...
<?= $this->section('styles'); ?>
        ...
        <!-- intl-tel-input css -->
        <link rel="stylesheet" href="<?php echo base_url('assets/libs/intl-tel-input/build/css/intlTelInput.min.css'); ?>">

        <!-- Tagify CSS -->
        <link rel="stylesheet" href="<?php echo base_url('assets/libs/@yaireo/tagify/tagify.css'); ?>">

        <!-- Dragsort CSS -->
        <link rel="stylesheet" href="<?php echo base_url('assets/libs/@yaireo/dragsort/dragsort.css'); ?>">

        <!-- Dual ListBox CSS -->
        <link rel="stylesheet" href="<?php echo base_url('assets/libs/dual-listbox/dual-listbox.css'); ?>">
...
<?= $this->section('scripts'); ?>
        ...
        <!-- intl-tel-input JS -->
        <script src="<?php echo base_url('assets/libs/intl-tel-input/build/js/intlTelInput.min.js'); ?>"></script>

        <!-- Tagify JS -->
        <script src="<?php echo base_url('assets/libs/@yaireo/tagify/tagify.js'); ?>"></script>

        <!-- Dragsort JS -->
        <script src="<?php echo base_url('assets/libs/@yaireo/dragsort/dragsort.js'); ?>"></script>

        <!-- Dual ListBox JS -->
        <script src="<?php echo base_url('assets/libs/dual-listbox/dual-listbox.js'); ?>"></script>
