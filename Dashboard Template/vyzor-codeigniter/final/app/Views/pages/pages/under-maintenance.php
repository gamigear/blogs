...
<?php $this->setVar('BodyClass', 'coming-soon-main'); ?>
                                ...
                                <div>
                                    <div class="mb-3"> 
                                        <a href="<?php echo base_url('index'); ?>"> 
                                            <img src="<?php echo base_url('assets/images/brand-logos/desktop-logo.png'); ?>" alt="" class="authentication-brand"> 
                                            <img src="<?php echo base_url('assets/images/brand-logos/desktop-dark.png'); ?>" alt="" class="authentication-brand dark"> 
                                        </a> 
                                    </div>
...
<?= $this->section('scripts'); ?>
        ...
        <script src="<?php echo base_url('assets/js/coming-soon.js'); ?>"></script>
