...
<?php $this->setVar('BodyClass', 'bg-white'); ?>
                        ...
                        <div class="card custom-card border-0 shadow-none my-4">
                            <div class="card-body p-5">
                                    ...
                                    <div class="col-xl-12 mb-2">
                                        ...
                                        <div class="mt-2">
                                            <div class="form-check">
                                                ...
                                                <a href="<?php echo base_url('reset-password-basic'); ?>" class="float-end link-danger fw-medium fs-12">Forget password ?</a>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                <div class="d-grid mt-3">
                                    <a href="<?php echo base_url('index'); ?>" class="btn btn-primary">Sign In</a>
                                </div>
                                ...
                                <div class="text-center mt-3 fw-medium">
                                    Dont have an account? <a href="<?php echo base_url('sign-up-basic'); ?>" class="text-primary">Register Here</a>
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <div class="col-xxl-3 col-xl-3 col-lg-12 d-xl-block d-none px-0">
                <div class="authentication-cover overflow-hidden">
                    <div class="authentication-cover-logo">
                        ...
                        <img src="<?php echo base_url('assets/images/brand-logos/toggle-logo.png'); ?>" alt="logo" class="desktop-dark"> 
                        </a>
                    </div>
                    <div class="authentication-cover-background">
                        <img src="<?php echo base_url('assets/images/media/backgrounds/9.png'); ?>" alt="">
                    </div>
                    <div class="authentication-cover-content">
                        ...
                        <div>
                            <img src="<?php echo base_url('assets/images/media/media-72.png'); ?>" alt="" class="img-fluid">
                        </div>
                    </div>
                </div>
            </div>
