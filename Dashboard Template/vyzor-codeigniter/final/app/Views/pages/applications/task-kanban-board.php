                            ...
                            <div class="kanban-tasks" id="new-tasks">
                                <div id="new-tasks-draggable" data-view-btn="new-tasks">
                                    <div class="task-null-background" draggable="false">
                                        <img src="<?php echo base_url('assets/images/media/media-81.svg'); ?>" alt="">
                                    </div>
                                    <div class="card custom-card">
                                            ...
                                            <div class="p-3 kanban-board-head">
                                                ...
                                                <div class="kanban-content mt-2">
                                                    <div class="task-image mt-2">
                                                        <img src="<?php echo base_url('assets/images/media/media-36.jpg'); ?>" class="img-fluid rounded kanban-image" alt="">
                                                    </div>
                                    ...
                                    <div class="card custom-card">
                                        <div class="card-body p-0">
                                            <div class="p-3 kanban-board-head">
                                                ...
                                                <div class="kanban-content mt-2">
                                                    <div class="task-image mt-2">
                                                        <img src="<?php echo base_url('assets/images/media/media-41.jpg'); ?>" class="img-fluid rounded kanban-image" alt="">
                                                    </div>
                                    ...
                                    <div class="card custom-card">
                                        <div class="card-body p-0">
                                            <div class="p-3 kanban-board-head">
                                                ...
                                                <div class="kanban-content mt-2">
                                                    <div class="task-image mt-2">
                                                        <img src="<?php echo base_url('assets/images/media/media-43.jpg'); ?>" class="img-fluid rounded kanban-image" alt="">
                                                    </div>
                                    ...
                                    <div class="card custom-card">
                                        <div class="card-body p-0">
                                            <div class="p-3 kanban-board-head">
                                                ...
                                                <div class="kanban-content mt-2">
                                                    <div class="task-image mt-2">
                                                        <img src="<?php echo base_url('assets/images/media/media-69.jpg'); ?>" class="img-fluid rounded kanban-image bg-light" alt="">
                                                    </div>
