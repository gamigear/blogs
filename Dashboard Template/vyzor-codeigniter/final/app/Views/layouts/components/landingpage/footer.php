        ...
        <section class="section landing-footer text-fixed-white">
            <div class="container">
                ...
                <div class="row justify-content-center gy-3">
                    <div class="col-xl-4">
                        <p class="fw-semibold mb-3 brand-image"><a href="<?php echo base_url('index'); ?>"><img src="<?php echo base_url('assets/images/brand-logos/desktop-dark.png'); ?>" alt=""></a></p>
                    ...
                    <div class="col-sm-3 col-xl-2 col-6">
                        ...
                        <ul class="list-unstyled fw-normal landing-footer-list mb-0">
                            ...
                            <li>
                                <a href="<?php echo base_url('pricing'); ?>" class="text-fixed-white op-6">Pricing</a>
                            </li>
                        </ul>
                    </div>
                    <div class="col-sm-3 col-xl-2 col-6">
                    ...
                    <div class="col-sm-3 col-xl-2 col-6">
                        ...
                        <ul class="list-unstyled fw-normal landing-footer-list mb-0">
                            <li>
                                <a href="<?php echo base_url('blog'); ?>" class="text-fixed-white op-6">Blog</a>
                            </li>
                            <li>
