				...
				<div class="main-sidebar" id="sidebar-scroll">
					...
					<nav class="main-menu-container nav nav-pills flex-column sub-open">
						...
						<ul class="main-menu">
							...
							<li class="slide has-sub">
								...
								<ul class="slide-menu child1">
									...
									<li class="slide <?php echo (current_url() == base_url('index')) ? 'active' : ''; ?>">
										<a href="<?php echo base_url('index'); ?>" class="side-menu__item"> 
									...
									<li class="slide">
										<a href="<?php echo base_url('index1'); ?>" class="side-menu__item">
									...
									<li class="slide has-sub">
										...
										<ul class="slide-menu child2">
											<li class="slide">
												<a href="<?php echo base_url('index2'); ?>" class="side-menu__item">Dashboard</a>
											</li>
											<li class="slide">
											...
											<li class="slide">
												<a href="<?php echo base_url('customers-list'); ?>" class="side-menu__item">Customers</a>
											</li>
											<li class="slide">
												<a href="<?php echo base_url('orders'); ?>" class="side-menu__item">Orders</a>
											</li>
											<li class="slide">
												<a href="<?php echo base_url('orders-details'); ?>" class="side-menu__item">Order Details</a>
											</li>
											<li class="slide">
												<a href="<?php echo base_url('add-product'); ?>" class="side-menu__item">Add Product</a>
											</li>
										</ul>    
									</li>
									<li class="slide has-sub">
										...
										<ul class="slide-menu child2">
											<li class="slide">
												<a href="<?php echo base_url('index4'); ?>" class="side-menu__item">Dashboard</a>
											</li>
											<li class="slide">
												<a href="<?php echo base_url('crypto-transactions'); ?>" class="side-menu__item">Transactions</a>
											</li>
											<li class="slide">
												<a href="<?php echo base_url('crypto-currency-exchange'); ?>" class="side-menu__item">Exchange</a>
											</li>
											<li class="slide">
									...
									<li class="slide has-sub">
										...
										<ul class="slide-menu child2">
											<li class="slide">
												<a href="<?php echo base_url('index3'); ?>" class="side-menu__item">Dashboard</a>
											</li>
											<li class="slide">
									...
									<li class="slide has-sub">
										...
										<ul class="slide-menu child2">
											<li class="slide">
												<a href="<?php echo base_url('index6'); ?>" class="side-menu__item">Dashboard</a>
											</li>
											<li class="slide">
									...
									<li class="slide">
										<a href="<?php echo base_url('index8'); ?>" class="side-menu__item">
									...
									<li class="slide">
										<a href="<?php echo base_url('index9'); ?>" class="side-menu__item">
									...
									<li class="slide">
										<a href="<?php echo base_url('index10'); ?>" class="side-menu__item">
									...
									<li class="slide has-sub">
										...
										<ul class="slide-menu child2">
											<li class="slide">
												<a href="<?php echo base_url('index5'); ?>" class="side-menu__item">Dashboard</a>
											</li>
											<li class="slide">
									...
									<li class="slide has-sub">
										...
										<ul class="slide-menu child2">
											<li class="slide">
												<a href="<?php echo base_url('index7'); ?>" class="side-menu__item">Dashboard</a>
											</li>
											<li class="slide">
									...
									<li class="slide">
										<a href="<?php echo base_url('index13'); ?>" class="side-menu__item">
									...
									<li class="slide">
										<a href="<?php echo base_url('index15'); ?>" class="side-menu__item">
									...
									<li class="slide">
										<a href="<?php echo base_url('index14'); ?>" class="side-menu__item">
									...
									<li class="slide">
										<a href="<?php echo base_url('index11'); ?>" class="side-menu__item">
									...
									<li class="slide">
										<a href="<?php echo base_url('index12'); ?>" class="side-menu__item">
							...
							<li class="slide has-sub">
								...
								<ul class="slide-menu child1">
									...
									<li class="slide">
										<a href="<?php echo base_url('chat'); ?>" class="side-menu__item">
									...
									<li class="slide">
										<a href="<?php echo base_url('file-manager'); ?>" class="side-menu__item">
									...
									<li class="slide">
										<a href="<?php echo base_url('full-calendar'); ?>" class="side-menu__item">
									...
									<li class="slide">
										<a href="<?php echo base_url('sweet-alerts'); ?>" class="side-menu__item">
									...
									<li class="slide">
										<a href="<?php echo base_url('to-do-list'); ?>" class="side-menu__item">
							...
							<li class="slide has-sub">
								...
								<ul class="slide-menu child1 pages-ul">
									...
									<li class="slide">
										<a href="<?php echo base_url('emptypage'); ?>" class="side-menu__item">
									...
									<li class="slide has-sub">
										...
										<ul class="slide-menu child2">
											<li class="slide">
												<a href="<?php echo base_url('form-advanced'); ?>" class="side-menu__item">Form Advanced</a>
											</li>
											<li class="slide has-sub">
											...
											<li class="slide">
												<a href="<?php echo base_url('form-wizards'); ?>" class="side-menu__item">Form Wizards</a>
											</li>
											<li class="slide">
									...
									<li class="slide">
										<a href="<?php echo base_url('faqs'); ?>" class="side-menu__item">
									...
									<li class="slide">
										<a href="<?php echo base_url('landing'); ?>" class="side-menu__item">
									...
									<li class="slide">
										<a href="<?php echo base_url('pricing'); ?>" class="side-menu__item">
									...
									<li class="slide">
										<a href="<?php echo base_url('profile'); ?>" class="side-menu__item">
											<svg xmlns="http://www.w3.org/2000/svg" class="side-menu-doublemenu__icon" viewBox="0 0 256 256"><rect width="256" height="256" fill="none"/><path d="M128,32A96,96,0,0,0,63.8,199.38h0A72,72,0,0,1,128,160a40,40,0,1,1,40-40,40,40,0,0,1-40,40,72,72,0,0,1,64.2,39.37A96,96,0,0,0,128,32Z" opacity="0.2"/><path d="M63.8,199.37a72,72,0,0,1,128.4,0" fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="16"/><circle cx="128" cy="128" r="96" fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="16"/><circle cx="128" cy="120" r="40" fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="16"/></svg>
											Profile</a>
									</li>
									<li class="slide">
										<a href="<?php echo base_url('profile-settings'); ?>" class="side-menu__item">
									...
									<li class="slide">
										<a href="<?php echo base_url('testimonials'); ?>" class="side-menu__item">
									...
									<li class="slide">
										<a href="<?php echo base_url('search-results'); ?>" class="side-menu__item">
									...
									<li class="slide">
										<a href="<?php echo base_url('team'); ?>" class="side-menu__item">
									...
									<li class="slide">
										<a href="<?php echo base_url('terms-conditions'); ?>" class="side-menu__item">
											<svg xmlns="http://www.w3.org/2000/svg" class="side-menu-doublemenu__icon" viewBox="0 0 256 256"><rect width="256" height="256" fill="none"/><polygon points="152 32 152 88 208 88 152 32" opacity="0.2"/><path d="M200,224H56a8,8,0,0,1-8-8V40a8,8,0,0,1,8-8h96l56,56V216A8,8,0,0,1,200,224Z" fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="16"/><polyline points="152 32 152 88 208 88" fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="16"/><line x1="96" y1="136" x2="160" y2="136" fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="16"/><line x1="96" y1="168" x2="160" y2="168" fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="16"/></svg>
											Terms & Conditions</a>
									</li>
									<li class="slide">
										<a href="<?php echo base_url('timeline'); ?>" class="side-menu__item">
								...
								<ul class="slide-menu child1">
									...
									<li class="slide has-sub">
										...
										<ul class="slide-menu child2">
											...
											<li class="slide">
												<a href="<?php echo base_url('links-interactions'); ?>" class="side-menu__item">Links & Interactions</a>
											</li>
											<li class="slide">
									...
									<li class="slide has-sub">
										...
										<ul class="slide-menu child2">
											...
											<li class="slide">
												<a href="<?php echo base_url('css-grid'); ?>" class="side-menu__item">Css Grid</a>
											</li>
											<li class="slide">
									...
									<li class="slide has-sub">
										...
										<ul class="slide-menu child2">
											...
											<li class="slide">
												<a href="<?php echo base_url('media-player'); ?>" class="side-menu__item">Media Player</a>
											</li>
											<li class="slide">
											...
											<li class="slide">
												<a href="<?php echo base_url('ribbons'); ?>" class="side-menu__item">Ribbons</a>
											</li>
											<li class="slide">
												<a href="<?php echo base_url('scrollspy'); ?>" class="side-menu__item">Scrollspy</a>
											</li>
											<li class="slide">
												<a href="<?php echo base_url('sortable-list'); ?>" class="side-menu__item">Sortable JS</a>
											</li>
											<li class="slide">
												<a href="<?php echo base_url('swiperjs'); ?>" class="side-menu__item">Swiper JS</a>
											</li>
											<li class="slide">
												<a href="<?php echo base_url('tour'); ?>" class="side-menu__item">Tour</a>
											</li>
										</ul>
									</li>
								</ul>
							...
							<li class="slide has-sub">
								...
								<ul class="slide-menu child1">
									...
									<li class="slide">
										<a href="<?php echo base_url('vector-maps'); ?>" class="side-menu__item">
									...
									<li class="slide">
										<a href="<?php echo base_url('leaflet-maps'); ?>" class="side-menu__item">
									...
									<li class="slide">
										<a href="<?php echo base_url('google-maps'); ?>" class="side-menu__item">
								...
								<ul class="slide-menu child1">
									...
									<li class="slide has-sub">
										...
										<ul class="slide-menu child2">
											...
											<li class="slide">
												<a href="<?php echo base_url('apex-funnel-charts'); ?>" class="side-menu__item">Funnel Charts</a>
											</li>
											<li class="slide">
									...
									<li class="slide">
										<a href="<?php echo base_url('chartjs-charts'); ?>" class="side-menu__item">
									...
									<li class="slide">
										<a href="<?php echo base_url('echarts'); ?>" class="side-menu__item">
							...
							<li class="slide has-sub">
								...
								<ul class="slide-menu child1"> 
									...
									<li class="slide">
										<a href="<?php echo base_url('tables'); ?>" class="side-menu__item">
									...
									<li class="slide">
										<a href="<?php echo base_url('grid-tables'); ?>" class="side-menu__item">
									...
									<li class="slide">
										<a href="<?php echo base_url('data-tables'); ?>" class="side-menu__item">
							...
							<ul class="slide-menu child1 doublemenu_slide-menu">
								<li class="text-center p-3 text-fixed-white">
									<div class="doublemenu_slide-menu-background">
										<img src="<?php echo base_url('assets/images/media/backgrounds/13.png'); ?>" alt="">
									</div>
									<div class="d-flex flex-column align-items-center justify-content-between h-100">
										<div class="fs-15 fw-medium">Dashboard AI Helper</div>
										<div>
											<span class="avatar avatar-lg p-1">
												<img src="<?php echo base_url('assets/images/media/media-80.png'); ?>" alt="">
						...
						<ul class="doublemenu_bottom-menu main-menu mb-0 border-top">
							...
							<!-- Start::slide -->
							<li class="slide">
								<a href="<?php echo base_url('sign-in-cover'); ?>" class="side-menu__item">
							...
							<!-- Start::slide -->
							<li class="slide">
								<a href="<?php echo base_url('profile'); ?>" class="side-menu__item p-1 rounded-circle mb-0">
