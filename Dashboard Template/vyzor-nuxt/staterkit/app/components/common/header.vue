                    ...
                    <div class="main-header-dropdown dropdown-menu dropdown-menu-end" data-popper-placement="none">
                        ...
                        <div class="p-3 empty-header-item border-top" v-if="notificationNotes.length">
                            <div class="text-center d-grid">
                                <NuxtLink href="#!" class="btn btn-primary btn-wave">
                                    Proceed to
                                    checkout</NuxtLink>
                            </div>
                        </div>
                ...
                <ul class="list-unstyled mb-0">
                    <li>
                        <ul class="list-unstyled mb-0 sub-list">
                            <li>
                                <NuxtLink class="dropdown-item d-flex align-items-center" to="#!"><i
                                        class="ti ti-user-circle me-2 fs-18"></i>View Profile</NuxtLink>
                            </li>
                            <li>
                                <NuxtLink class="dropdown-item d-flex align-items-center" to="#!">
