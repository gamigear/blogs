...
const Sales = () => {
  ...
  const [dateRange, setDateRange] = useState([today, nextWeek]);
      ...
      <div className="d-flex align-items-center justify-content-between mb-3 page-header-breadcrumb flex-wrap gap-2">
        ...
        <div className="d-flex align-items-center gap-2 flex-wrap">
          <div className="form-group">
            <SpkDatepickr className="form-control breadcrumb-input datepicker-input" placeholderText="Select date range" startDate={startDate} endDate={endDate} selectsRange={true} onChange={(update) => setDateRange(update)} />
          </div>
          <div className="btn-list">
            <SpkButton Buttonvariant='primary' Customclass="btn btn-icon btn-wave me-2"><i className="ri-refresh-line"></i></SpkButton>
              ...
              <Card className="custom-card">
                ...
                <Card.Body className="pb-0 pt-5">
                  <div id="sales-overview">
                    <Spkapexcharts height={365} type={'line'} width={'100%'} chartOptions={Overviewoptions} chartSeries={Overviewseries} />
                  </div>
                </Card.Body>
              ...
              <Card className="custom-card shadow-none card-bg-primary overflow-hidden dashboard-banner-card">
                <Card.Body>
                  <div className="dashboard-banner-card-background">
                    <BaseImage src="/build/assets/images/media/backgrounds/8.png" alt="" />
                  </div>
                  <div className="d-flex align-items-center justify-content-between gap-3">
                    <div>
                      ...
                      <BaseLink href="#!" className="btn btn-secondary btn-wave mt-1">Upgrade To Pro <i className="ti ti-arrow-narrow-right"></i></BaseLink>
                    </div>
            ...
            <Col xl={12}>
              <Card className="custom-card">
                <Card.Header className="justify-content-between">
                  ...
                  <BaseLink href="#!" className="fs-12 text-muted text-decoration-underline">View Report <i className="ti ti-arrow-narrow-right"></i></BaseLink>
                </Card.Header>
                <Card.Body className="pb-0 px-0">
                  <div id="visitors-report">
                    <Spkapexcharts height={302} type={'radar'} width={'100%'} chartOptions={Visitorsoptions} chartSeries={Visitorsseries} />
                  </div>
                </Card.Body>
              </Card>
            </Col>
        ...
        <Col xxl={3} md={6}>
          <Card className="custom-card overflow-hidden">
            <Card.Header className="justify-content-between">
              ...
              <BaseLink href="#!" className="text-muted fs-12 text-decoration-underline">View All<i className="ti ti-arrow-narrow-right"></i></BaseLink>
            </Card.Header>
                    ...
                    <div className="d-flex align-items-center gap-3">
                      <div className="lh-1">
                        <span className="avatar avatar-lg bg-light border border-dashed p-1">
                          <BaseImage src={product.image} alt={product.name} />
                        </span>
                      </div>
        ...
        <Col xxl={3} md={6}>
          <Card className="custom-card">
            <Card.Header className="justify-content-between">
              ...
              <Link href="#!" className="text-muted fs-12 text-decoration-underline" onClick={(e) => e.preventDefault()}>View All<i className="ti ti-arrow-narrow-right"></i></Link>
            </Card.Header>
                    ...
                    <div className="d-flex align-items-center gap-3 flex-wrap">
                      <div className="lh-1">
                        <span className="avatar avatar-md bg-light">
                          <BaseImage src={company.logo} alt={company.name} />
                        </span>
                      </div>
                      <div className="flex-fill">
                      ...
                      <td>
                        <div className="avatar-list-stacked text-end">
                          {order.avatars.map((avatar, i) => (
                            <span key={i} className="avatar avatar-rounded avatar-sm bg-light">
                              <BaseImage src={avatar.src} alt={avatar.alt || "img"} />
                            </span>
                          ))}
                          {order.extraAvatars && (
                            <BaseLink className="avatar bg-primary avatar-rounded avatar-sm" href="#!">
                              +{order.extraAvatars}
                            </BaseLink>
                          )}
                        </div>
...
// Assign layout
Sales.layout = (page) => <MainLayout>{page}</MainLayout>;
