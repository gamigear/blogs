...
export const Channels = [
    {
      name: 'CloudComm',
      logo: "/build/assets/images/company-logos/1.png",
    ...
    {
      name: 'BuzzWave',
      logo: '/build/assets/images/company-logos/2.png',
    ...
    {
      name: 'NexusNet',
      logo: '/build/assets/images/company-logos/3.png',
      industry: 'Networking',
      changePercent: '1.95%',
      changeDirection: 'up',
      total: '2,384',
    ...
    {
      name: 'FlashConnect',
      logo: '/build/assets/images/company-logos/4.png',
    ...
    {
      name: 'EchoLink',
      logo: '/build/assets/images/company-logos/5.png',
    ...
    {
      name: 'VibeStream',
      logo: '/build/assets/images/company-logos/6.png',
...
export const Orders = [
    {
      ...
      date: '27,Aug 2024',
      time: '12:45PM',
      products: ['/build/assets/images/ecommerce/jpg/3.jpg', '/build/assets/images/ecommerce/jpg/4.jpg', '/build/assets/images/ecommerce/jpg/5.jpg'],
      amount: '$1,249',
      status: 'Paid',
    ...
    },
    {
      ...
      date: '16,Sep 2024',
      time: '11:15AM',
      products: ['/build/assets/images/ecommerce/jpg/1.jpg', '/build/assets/images/ecommerce/jpg/2.jpg'],
      amount: '$3,299',
      status: 'Pending',
    ...
    },
    {
      ...
      date: '15,Sep 2024',
      time: '04:45PM',
      products: ['/build/assets/images/ecommerce/jpg/5.jpg', '/build/assets/images/ecommerce/jpg/6.jpg'],
      amount: '$4,799',
      status: 'Overdue',
    ...
    },
    {
      ...
      date: '21,Sep 2024',
      time: '02:18PM',
      products: ['/build/assets/images/ecommerce/jpg/3.jpg'],
      amount: '$2,499',
      status: 'Paid',
      statusBg: 'success-transparent',
    },
    {
      ...
      date: '19,Oct 2024',
      time: '03:52PM',
      products: ['/build/assets/images/ecommerce/jpg/4.jpg', '/build/assets/images/ecommerce/jpg/1.jpg'],
      amount: '$3,999',
      status: 'Paid',
      statusBg: 'success-transparent',
    },
 ...
 export const Transactionsdata = [
    {
      ...
      date: "2024-08-27",
      avatars: [
        { src: '/build/assets/images/ecommerce/jpg/1.jpg' },
        { src: '/build/assets/images/ecommerce/jpg/2.jpg' },
      ],
      extraAvatars: 2,
      statusColor:'success',
      icon:'ri-check-line'
    },
    {
      ...
      statusColor:'warning',
      avatars: [
        { src: '/build/assets/images/ecommerce/jpg/3.jpg' },
        { src: '/build/assets/images/ecommerce/jpg/4.jpg' },
        { src: '/build/assets/images/ecommerce/jpg/5.jpg' },
      ],
      icon:'ri-time-line'
    },
    {
      ...
      date: "2024-08-25",
      avatars: [
        { src: '/build/assets/images/ecommerce/jpg/6.jpg' },
        { src: '/build/assets/images/ecommerce/jpg/2.jpg' },
      ],
      statusColor:'success',
      icon:'ri-check-line'
    },
    {
      ...
      amount: "$120.00",
      date: "2024-08-24",
      avatars: [{ src: '/build/assets/images/ecommerce/jpg/5.jpg' }],
      statusColor:'success',
      icon:'ri-check-line'
    },
    {
