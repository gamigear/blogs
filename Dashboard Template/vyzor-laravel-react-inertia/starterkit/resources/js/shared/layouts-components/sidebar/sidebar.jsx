...
const Sidebar = () => {
	...
	function toggleSidemenu(event, targetObject, MenuItems = menuitems, isChild = false) {
		...
		setMenuitems((arr) => [...arr]); // ✅ Triggers re-render
	}
				...
				<SimpleBar className="main-sidebar" id="sidebar-scroll">
					...
					<nav className="main-menu-container nav nav-pills flex-column sub-open">
								...
								<Fragment key={index}>
									<li className={` ${list.menutitle ? "slide__category" : ""} ${list.type === 'link' ? 'slide' : ''} ${list.type === 'sub' ? 'slide has-sub' : ''} ${list.active ? 'open' : ''}  ${list?.selected ? 'active' : ''}  `}>
										...
										{list.type === "link" ?
											...
											: ""}
										{list.type === "empty" ?
											<BaseLink href="#!" className='side-menu__item' onClick={handleClick} >{list.icon}<span className=""> {list.title} {list.badgetxt ? (
								...
								<ul className="slide-menu child1 doublemenu_slide-menu">
									<li className="text-center p-3 text-fixed-white">
										<div className="doublemenu_slide-menu-background">
											<BaseImage src="/build/assets/images/media/backgrounds/13.png" alt="" className="" />
										...
										<div className="d-flex flex-column align-items-center justify-content-between h-100">
											...
											<div>
												<span className="avatar avatar-lg p-1">
													<BaseImage src="/build/assets/images/media/media-80.png" alt="" className="" />
						...
						<ul className="doublemenu_bottom-menu main-menu mb-0 border-top">
							{/* <!-- Start::slide --> */}
							<li className="slide">
								<BaseLink href="#!" className="side-menu__item layout-setting-doublemenu" onClick={toggleTheme}>
							...
							{/* <!-- Start::slide --> */}
							<li className="slide">
								<Link href={`${__APP_BASE_PATH__}/pages/authentication/sign-in/cover`} className="side-menu__item">
							...
							{/* <!-- Start::slide --> */}
							<li className="slide">
								<Link href={`${__APP_BASE_PATH__}/pages/profile-settings`} className="side-menu__item">
							...
							{/* <!-- Start::slide --> */}
							<li className="slide">
								<Link href={`${__APP_BASE_PATH__}/pages/profile`} className="side-menu__item p-1 rounded-circle mb-0">
									<span className="avatar avatar-md avatar-rounded">
										<BaseImage src="/build/assets/images/faces/10.jpg" alt="" className="" />
									</span>
								</Link>
							</li>
							{/* <!-- End::slide --> */}
