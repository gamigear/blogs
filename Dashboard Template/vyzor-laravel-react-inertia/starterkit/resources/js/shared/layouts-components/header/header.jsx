                            ...
                            <DropdownMenu className="main-header-dropdown dropdown-menu-end" data-popper-placement="none">
                                <div className="p-3 bg-primary text-fixed-white">
                                    <div className="d-flex align-items-center justify-content-between">
                                        ...
                                        <BaseLink href="#!" className="text-fixed-white text-decoration-underline fs-12">Continue Shopping <i className="ti ti-arrow-narrow-right"></i></BaseLink>
                                    </div>
                                </div>
                                                    ...
                                                    <div className='d-flex align-items-start justify-content-between mb-3'>
                                                        <div className='fs-14 fw-medium w-75'>
                                                            <div className='text-truncate'>
                                                                <BaseLink href="#!"  >{item.name}</BaseLink>
                                                            </div>
                                ...
                                <div className={`p-3 empty-header-item1 border-top ${note.length === 0 && 'd-none'} `}>
                                    <div className="d-grid">
                                        <BaseLink href="#!" className="btn btn-primary">Proceed to checkout</BaseLink>
                                    </div>
                                </div>
                                {note.length === 0 && (
                                ...
                                <ul className="list-unstyled mb-0">
                                    <li>
                                        <ul className="list-unstyled mb-0 sub-list">
                                            <li>
                                                <BaseLink className="dropdown-item d-flex align-items-center"  href="#!"><i className="ti ti-user-circle me-2 fs-18"></i>View Profile</BaseLink>
                                            </li>
                                            <li>
                                                <BaseLink className="dropdown-item d-flex align-items-center" href="#!"><i className="ti ti-settings-cog me-2 fs-18"></i>Account Settings</BaseLink>
                                            </li>
                                        </ul>
                                    </li>
                                    <li>
