...
export default defineConfig({
    ...
    define: {
        global: 'window',
        __APP_BASE_PATH__: JSON.stringify(basePath), // ✅ Inject basePath into client-side code
    },
    css: {
        url: false, // don't rewrite url()
        preprocessorOptions: {
            scss: {
                additionalData: `$base-url: '${basePath}';`, // inject JS variable as SCSS variable
            },
        },
    },
});
