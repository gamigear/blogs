  ...
  return (
    <Fragment>
      <Card className="custom-card">
          <BaseImage src={member.imgSrc} alt={member.name}  className="card-img-top" style={{ borderTopLeftRadius: "0.5rem", borderTopRightRadius: "0.5rem" }}/>
