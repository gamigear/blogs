...
const SpkKanbanCard = ({ kanban, cardClass }) => {
    return (
        <Fragment>
                ...
                <Card.Body className="p-0">
                    <div className="p-3 kanban-board-head">
                        ...
                        <div className="d-flex align-items-center justify-content-between">
                            ...
                            <SpkDropdown toggleas="a"  Customtoggleclass="btn btn-sm btn-light btn-white no-caret" IconClass="ri-more-2-fill" Icon={true}>
                        ...
                        {kanban.imgSrc &&
                            <div className="kanban-content mt-2">
                                <div className="task-image mt-2">
                                    <BaseImage src={kanban.src} className="img-fluid rounded kanban-image" alt="" />
                                </div>
                    ...
                    <div className="p-3 border-top border-block-start-dashed">
                        <div className="d-flex align-items-center justify-content-between">
                            <div>
                                <BaseLink href="#!" className="me-2 text-primary">
                                ...
                                <BaseLink href="#!" className="text-muted">
                            ...
                            <div className="avatar-list-stacked">
                                {kanban.avatars.map((src, index) => (
                                    <span key={index} className="avatar avatar-sm avatar-rounded">
                                        <BaseImage src={src} alt={`avatar-${index}`} />
                                    </span>
                                ))}
                            </div>
                        </div>
