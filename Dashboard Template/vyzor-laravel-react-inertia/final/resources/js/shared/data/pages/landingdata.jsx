...
export const WorkflowCards = [
    {
        ...
        imgSrc: "/build/assets/images/media/backgrounds/3.png",
    ...
    },
    {
        ...
        imgSrc: "/build/assets/images/media/backgrounds/4.png",
...
const Swiperdata = [
    { imgsrc: "/build/assets/images/company-logos/13.png" },
    { imgsrc: "/build/assets/images/company-logos/14.png" },
    { imgsrc: "/build/assets/images/company-logos/15.png" },
    { imgsrc: "/build/assets/images/company-logos/16.png" },
    { imgsrc: "/build/assets/images/company-logos/17.png" },
    { imgsrc: "/build/assets/images/company-logos/18.png" },
    { imgsrc: "/build/assets/images/company-logos/19.png" },
    { imgsrc: "/build/assets/images/company-logos/20.png"},
    { imgsrc: "/build/assets/images/company-logos/12.png" },
]
export const laningSwiper = Swiperdata.map((idx, index) => (
    <Card key={index} className="custom-card trusted-clients-container mb-0 border border-dashed">
        <Card.Body>
            <BaseImage  src={idx.imgsrc} alt="" className="img-fluid" />
        </Card.Body>
    </Card>
));
