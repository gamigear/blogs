...
import SpkTestimonialcard from "../../@spk-reusable-components/reusable-pages/spk-testimonialcard";
import SpkTeststyleCard from "../../@spk-reusable-components/reusable-pages/spk-teststylecard";
...
const Testimonials3 = [
    ...
    {
        id: 2,
        image: "/build/assets/images/faces/6.jpg",
        name: "Ashley Miller",
        role: "Project Manager",
        rating: 4.5,
        ...
        <div className="card-body text-center p-5">
            ...
            <div className="lh-1 mb-4">
                <span className="avatar avatar-xl avatar-rounded">
                    <BaseImage src={testimonial.image} alt="img" />
                </span>
            </div>
            <div className="mb-2 text-warning fs-15">
                {[...Array(5)].map((_, index) => (
                    <i key={index} className={`me-1 ri-star-fill ${index < Math.floor(testimonial.rating) ? '' : 'ri-star-half-line'}`}></i>
                ))}
            </div>
        ...
        <div className="card-body p-5">
            <div className="lh-1">
                <span className="avatar avatar-xxl avatar-rounded">
                    <BaseImage width={80} height={80} src={testimonial.image} alt={testimonial.name} />
                </span>
            </div>
            <div>
