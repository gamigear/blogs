        ...
        <th scope="row">
            <div className="d-flex align-items-center">
                <span className="avatar avatar-xs me-2 online avatar-rounded">
                    <BaseImage width={20} height={20} src={idx.src} alt="img" />
                </span>{idx.name}
            </div>
        </th>
...
export const Primarytable: Primarytable[] = [
    { id: 1, src: "/build/assets/images/faces/3.jpg", order: "#0007", date: "26-04-2022", name: "Mayor Kelly", },
    { id: 2, src: "/build/assets/images/faces/6.jpg", order: "#0008", date: "	15-02-2022", name: "Wicky Kross", },
    { id: 3, src: "/build/assets/images/faces/1.jpg", order: "#0009", date: "23-05-2022", name: "Julia Cam", }
];`
...
export const Successtable: Primarytable[] = [
    { id: 1, src: "/build/assets/images/faces/10.jpg", order: "#0011", date: "07-01-2022", name: "Helsenky", },
    { id: 2, src: "/build/assets/images/faces/14.jpg", order: "#0012", date: "18-05-2022", name: "Brodus", },
    { id: 3, src: "/build/assets/images/faces/12.jpg", order: "#0013", date: "19-03-2022", name: "Chikka Alen", }
];`
...
export const Warningtable: Primarytable[] = [
    { id: 1, src: "/build/assets/images/faces/13.jpg", order: "#0014", date: "21-02-2022", name: "Sukuro Kim", },
    { id: 2, src: "/build/assets/images/faces/11.jpg", order: "#0018", date: "26-03-2022", name: "Alex Carey", },
    { id: 3, src: "/build/assets/images/faces/2.jpg", order: "#0020", date: "14-03-2022", name: "Pamila Anderson", }
];`
...
export const Hoverable: Hoverable[] = [
    { id: 1, src: "/build/assets/images/faces/15.jpg", name: "Mark Cruise", mail: "markcruise24@gmail.com", date: "Jul 26,2022", text1: "IN-2032", text2: "Paid", color: "success-transparent", class: "", icon: "check-fill" },
    { id: 2, src: "/build/assets/images/faces/12.jpg", name: "Charanjeep", mail: "charanjeep@gmail.in", date: "Mar 14,2022", text1: "IN-2022", text2: "Paid", color: "success-transparent", class: "", icon: "check-fill" },
    { id: 3, src: "/build/assets/images/faces/5.jpg", name: "Samantha Julie", mail: "julie453@gmail.com", date: "Feb 1,2022", text1: "IN-2014", text2: "Cancelled", color: "danger-transparent", class: "", icon: "close-fill" },
    { id: 4, src: "/build/assets/images/faces/11.jpg", name: "Simon Cohen", mail: "simon@gmail.com", date: "Apr 24,2022", text1: "IN-2036", text2: "	Refunded", color: "light", class: "text-default", icon: "reply-line" }
];`
...
<tbody>
    <tr>
        ...
        <td>
            <div className="d-flex align-items-center">
                <span className="avatar avatar-xs me-2 online avatar-rounded">
                    <BaseImage width={20} height={20} src="/build/assets/images/faces/3.jpg" alt="img"/>
                </span>Mayor Kelly
            </div>
        </td>
        ...
        <td>
            <div className="avatar-list-stacked">
                <span className="avatar avatar-sm avatar-rounded">
                    <BaseImage width={28} height={28} src="/build/assets/images/faces/2.jpg" alt="img"/>
                </span>
                <span className="avatar avatar-sm avatar-rounded">
                    <BaseImage width={28} height={28} src="/build/assets/images/faces/8.jpg" alt="img"/>
                </span>
                <span className="avatar avatar-sm avatar-rounded">
                    <BaseImage width={28} height={28} src="/build/assets/images/faces/2.jpg" alt="img"/>
                </span>
