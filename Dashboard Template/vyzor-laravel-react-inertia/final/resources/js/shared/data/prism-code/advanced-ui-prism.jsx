...
<Carousel id="carouselExampleControls"
      ...
      <Carousel.Item>
      <BaseImage fill src="/build/assets/images/media/media-31.jpg"
      className="d-block w-100" alt="..." />
      </Carousel.Item>
      <Carousel.Item>
      <BaseImage fill src="/build/assets/images/media/media-29.jpg"
      className="d-block w-100" alt="..." />
      </Carousel.Item>
      </Carousel>
      `;
...
<Carousel id="carouselExampleIndicators"
      ...
      <Carousel.Item className="active">
      <BaseImage fill src="/build/assets/images/media/media-25.jpg"
      className="d-block w-100" alt="..." />
      </Carousel.Item>
      <Carousel.Item>
      <BaseImage fill src="/build/assets/images/media/media-29.jpg"
      ...
      <Carousel.Item>
      <BaseImage fill src="/build/assets/images/media/media-30.jpg"
      className="d-block w-100" alt="..." />
      </Carousel.Item>
      </Carousel>
      `;
...
<Carousel id="carouselExampleSlidesOnly"
      ...
      <Carousel.Item className="active">
          <BaseImage fill src="/build/assets/images/media/media-26.jpg"
           className="d-block w-100" alt="..." />
      </Carousel.Item>
      <Carousel.Item>
          <BaseImage fill src="/build/assets/images/media/media-27.jpg"
           className="d-block w-100" alt="..." />
      </Carousel.Item>
      <Carousel.Item>
          <BaseImage fill src="/build/assets/images/media/media-33.jpg"
          className="d-block w-100" alt="..." />
      </Carousel.Item>
      </Carousel>
      `;
...
<Carousel id="carouselExampleCaptions"
      className="carousel slide" data-bs-ride="carousel">
      <Carousel.Item className="active">
      <BaseImage fill src="/build/assets/images/media/media-59.jpg"
      className="d-block w-100" alt="..." />
      ...
      <Carousel.Item>
      <BaseImage fill src="/build/assets/images/media/media-60.jpg"
      className="d-block w-100" alt="..." />
      <Carousel.Caption className="d-none d-md-block">
      ...
      <Carousel.Item>
      <BaseImage fill src="/build/assets/images/media/media-61.jpg"
      className="d-block w-100" alt="..." />
      <Carousel.Caption className="d-none d-md-block">
...
Carousel fade id="carouselExampleFade"
      ...
      <Carousel.Item className="active">
         <BaseImage fill src="/build/assets/images/media/media-43.jpg"
         className="d-block w-100" alt="..." />
      </Carousel.Item>
      <Carousel.Item>
         <BaseImage fill src="/build/assets/images/media/media-44.jpg"
         className="d-block w-100" alt="..." />
      </Carousel.Item>
      <Carousel.Item>
         <BaseImage fill src="/build/assets/images/media/media-45.jpg"
         className="d-block w-100" alt="..." />
      </Carousel.Item>
      </Carousel>
      `;
...
<Carousel id="carouselExampleInterval"
      ...
      <Carousel.Item interval={1000} className="active" >
          <BaseImage fill src="/build/assets/images/media/media-40.jpg"
          className="d-block w-100" alt="..." />
      </Carousel.Item>
      <Carousel.Item interval={2000}>
          <BaseImage fill src="/build/assets/images/media/media-41.jpg"
          className="d-block w-100" alt="..." />
      </Carousel.Item>
      <Carousel.Item >
          <BaseImage fill src="/build/assets/images/media/media-42.jpg"
          className="d-block w-100" alt="..." />
      </Carousel.Item>
      </Carousel>
      `;
...
<Carousel touch={false} id="carouselExampleControlsNoTouching"
      ...
      <Carousel.Item className="carousel-item active">
          <BaseImage fill src="/build/assets/images/media/media-63.jpg"
          className="d-block w-100" alt="..." />
      </Carousel.Item>
      <Carousel.Item>
          <BaseImage fill src="/build/assets/images/media/media-64.jpg"
          className="d-block w-100" alt="..." />
      </Carousel.Item>
      <Carousel.Item>
          <BaseImage fill src="/build/assets/images/media/media-62.jpg"
          className="d-block w-100" alt="..." />
      </Carousel.Item>
      </Carousel>
      `;
...
<Carousel id="carouselExampleDark"
      ...
      <BaseImage fill src="/build/assets/images/media/media-13.jpg"
      ...
      <BaseImage fill src="/build/assets/images/media/media-14.jpg"
      className="d-block w-100"
      alt="..." />
      <Carousel.Caption className="d-none d-md-block">
      <h5 className='text-fixed-white'>Second slide label</h5>
      ...
      <Carousel.Item>
      <BaseImage fill src="/build/assets/images/media/media-18.jpg"
      className="d-block w-100"
      alt="..." />
      <Carousel.Caption className="d-none d-md-block">
      <h5 className='text-fixed-white'>Third slide label</h5>
...
export default function BasicModal () {
          ...
          const handleShow1 = () => setShow1(true)
          return(
              <SpkButton variant='primary' type="button" className="btn btn-primary" onClick={handleShow2}>
...
export default function BasicModal () {
          ...
          return(
          <SpkButton variant='primary' type="button" className="" onClick={handleShow3}>
          Launch demo modal</SpkButton>
...
export default function BasicModal () {
          ...
          <Col sm={6} className="col-4 bg-light border">
           ...
           <Modal.Footer>
           <SpkButton variant="secondary" onClick={() => setModalShow2(false)}>
               Close
           </SpkButton>
           <SpkButton variant="primary">
               Save Changes
...
export function Defaultlink() {
          ...
          return (
            <>
              <SpkButton variant="primary" onClick={handleShow1}>
              Enable
              body scrolling
              </SpkButton>
