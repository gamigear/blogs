...
//<!-- Prism Code: This code is only used for showcode purpose -->//
    <BaseImage fill src="/build/assets/images/media/media-58.jpg" className="bd-placeholder-img rounded" alt="..." />
    <BaseImage fill src="/build/assets/images/media/media-58.jpg" className="bd-placeholder-img rounded-top" alt="..." />
    <BaseImage fill src="/build/assets/images/media/media-58.jpg" className="bd-placeholder-img rounded-end" alt="..." />
    <BaseImage fill src="/build/assets/images/media/media-58.jpg" className="bd-placeholder-img rounded-bottom" alt="..." />
    <BaseImage fill src="/build/assets/images/media/media-58.jpg" className="bd-placeholder-img rounded-start" alt="..." />
    <BaseImage fill src="/build/assets/images/media/media-58.jpg" className="bd-placeholder-img rounded-circle" alt="..." />
    <BaseImage fill src="/build/assets/images/media/media-58.jpg" className="bd-placeholder-img  rounded-pill" alt="..." />
// End Prism Code//`;

export const border8 = `
//<!-- Prism Code: This code is only used for showcode purpose -->//
    <BaseImage fill src="/build/assets/images/media/media-58.jpg" className="bd-placeholder-img bd-placeholder-img rounded-0" alt="..." />
    <BaseImage fill src="/build/assets/images/media/media-58.jpg" className="bd-placeholder-img bd-placeholder-img rounded-1" alt="..." />
    <BaseImage fill src="/build/assets/images/media/media-58.jpg" className="bd-placeholder-img bd-placeholder-img rounded-2" alt="..." />
    <BaseImage fill src="/build/assets/images/media/media-58.jpg" className="bd-placeholder-img bd-placeholder-img rounded-3" alt="..." />
    <BaseImage fill src="/build/assets/images/media/media-58.jpg" className="bd-placeholder-img bd-placeholder-img rounded-4" alt="..." />
    <BaseImage fill src="/build/assets/images/media/media-58.jpg" className="bd-placeholder-img bd-placeholder-img rounded-5" alt="..." />
// End Prism Code//`;
...
{Avatardata.map((idx,index) => (
    <span className={'avatar me-2 &#60{idx.class}'} key={index}>
        <BaseImage fill src={idx.src} alt="img" />
    </span>
))}
...
export const Avatardata: AvatarType[] = [
    { id: 1, class: "avatar-radius-0", src: "/build/assets/images/faces/1.jpg" },
    { id: 1, class: "", src: "/build/assets/images/faces/2.jpg" },
    { id: 1, class: "avatar-rounded", src: "/build/assets/images/faces/3.jpg" },
]`
...
export const Avatarsize: AvatarType[] = [
    { id: 1, class: "xs", src: "/build/assets/images/faces/4.jpg" },
    { id: 2, class: "sm", src: "/build/assets/images/faces/5.jpg" },
    { id: 3, class: "md", src: "/build/assets/images/faces/6.jpg" },
    { id: 4, class: "lg", src: "/build/assets/images/faces/7.jpg" },
    { id: 5, class: "xl", src: "/build/assets/images/faces/8.jpg" },
    { id: 6, class: "xxl", src: "/build/assets/images/faces/9.jpg" },
]`
...
export const Avataricon: Icontype[] = [
    { id: 1, class: "xs", src: "/build/assets/images/faces/2.jpg", icon: "camera", class1: "success" },
    { id: 2, class: "sm", src: "/build/assets/images/faces/3.jpg", icon: "edit", class1: "secondary" },
    { id: 3, class: "md", src: "/build/assets/images/faces/14.jpg", icon: "plus", class1: "warning" },
    { id: 4, class: "lg", src: "/build/assets/images/faces/13.jpg", icon: "edit", class1: "info" },
    { id: 5, class: "xl", src: "/build/assets/images/faces/15.jpg", icon: "camera", class1: "success" },
    { id: 6, class: "xxl", src: "/build/assets/images/faces/9.jpg", icon: "plus", class1: "danger" },
]`
...
export const Avataronline: AvatarType[] = [
    { id: 1, class: "xs online", src: "/build/assets/images/faces/8.jpg" },
    { id: 2, class: "sm online", src: "/build/assets/images/faces/10.jpg" },
    { id: 3, class: "md online", src: "/build/assets/images/faces/12.jpg" },
    { id: 4, class: "lg online", src: "/build/assets/images/faces/13.jpg" },
    { id: 5, class: "xl online", src: "/build/assets/images/faces/14.jpg" },
    { id: 6, class: "xxl online", src: "/build/assets/images/faces/15.jpg" },
]`
...
export const Avataroffline: AvatarType[] = [
    { id: 1, class: "xs offline", src: "/build/assets/images/faces/2.jpg" },
    { id: 2, class: "sm offline", src: "/build/assets/images/faces/3.jpg" },
    { id: 3, class: "md offline", src: "/build/assets/images/faces/4.jpg" },
    { id: 4, class: "lg offline", src: "/build/assets/images/faces/5.jpg" },
    { id: 5, class: "xl offline", src: "/build/assets/images/faces/6.jpg" },
    { id: 6, class: "xxl offline", src: "/build/assets/images/faces/7.jpg" },
]`
...
export const Avatarnumber = [
    { id: 1, class: "xs", src: "/build/assets/images/faces/2.jpg", icon: "camera", class1: "primary", data: '2' },
    { id: 2, class: "sm", src: "/build/assets/images/faces/3.jpg", icon: "edit", class1: "secondary", data: '5' },
    { id: 3, class: "md", src: "/build/assets/images/faces/14.jpg", icon: "plus", class1: "warning", data: '1' },
    { id: 4, class: "lg", src: "/build/assets/images/faces/13.jpg", icon: "edit", class1: "info", data: '7' },
    { id: 5, class: "xl", src: "/build/assets/images/faces/15.jpg", icon: "camera", class1: "success", data: '3' },
    { id: 6, class: "xxl", src: "/build/assets/images/faces/9.jpg", icon: "plus", class1: "danger", data: '9' },
]`
...
export const Avatarstack: StackType[] = [
    { id: 1, src: "/build/assets/images/faces/2.jpg" },
    { id: 2, src: "/build/assets/images/faces/8.jpg" },
    { id: 3, src: "/build/assets/images/faces/2.jpg" },
    { id: 4, src: "/build/assets/images/faces/10.jpg" },
    { id: 5, src: "/build/assets/images/faces/4.jpg" },
    { id: 6, src: "/build/assets/images/faces/13.jpg" },
]`
