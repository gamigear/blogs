...
export const NftSwiper = [
    <div className="" id="img-container">
      <BaseImage className="img-fluid" src={"/build/assets/images/nft-images/14.png"} alt="img" />
    </div>,
    <div className=" image-container">
      <BaseImage className="img-fluid" src={"/build/assets/images/nft-images/13.png"} alt="img" />
    </div>,
    <div className=" image-container">
      <BaseImage className="img-fluid" src={"/build/assets/images/nft-images/12.png"} alt="img" />
    </div>,
    <div className=" image-container">
      <BaseImage className="img-fluid" src={"/build/assets/images/nft-images/10.png"} alt="img" />
    </div>
  ]
...
export const NftList = [
    {
      ...
      image: "/build/assets/images/nft-images/5.png",
    },
    {
      id: 2,
      name: 'NinjaBoi',
      ...
      image: "/build/assets/images/nft-images/7.png",
    },
    {
      id: 3,
      name: 'TheRuler',
      ...
      image: "/build/assets/images/nft-images/10.png",
    },
    {
      id: 4,
      name: 'BlockMaster',
      ...
      image: "/build/assets/images/nft-images/12.png",
    },
    {
      id: 5,
      name: 'PixelQueen',
      ...
      image: "/build/assets/images/nft-images/13.png",
    },
    {
      id: 6,
      name: 'CryptoFanatic',
      ...
      image: "/build/assets/images/nft-images/14.png",
    },
];
