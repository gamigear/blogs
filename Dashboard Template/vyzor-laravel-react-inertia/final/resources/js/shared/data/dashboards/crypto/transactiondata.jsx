...
export const TransactionsTable = [
    {
        id: '#1234567890',
        user: { name: 'John Doe', avatar: "/build/assets/images/faces/10.jpg" },
        direction: 'up',
        crypto: { name: 'Bitcoin', icon: "/build/assets/images/crypto-currencies/crypto-icons/bitcoin-btc-logo.svg" },
    ...
    {
        id: '#1234567891',
        user: { name: 'Jane Smith', avatar: "/build/assets/images/faces/5.jpg" },
        direction: 'down',
        crypto: { name: 'Ethereum', icon: "/build/assets/images/crypto-currencies/crypto-icons/ethereum-eth-logo.svg" },
    ...
    {
        id: '#1234567892',
        user: { name: 'Mark Lee', avatar: "/build/assets/images/faces/12.jpg" },
        direction: 'up',
        crypto: { name: 'Solana', icon: "/build/assets/images/crypto-currencies/crypto-icons/solana-sol-logo.svg" },
    ...
    {
        id: '#1234567893',
        user: { name: 'Alex Green', avatar: "/build/assets/images/faces/15.jpg" },
        direction: 'up',
        crypto: { name: 'Bitcoin', icon: "/build/assets/images/crypto-currencies/crypto-icons/bitcoin-btc-logo.svg" },
    ...
    {
        id: '#1234567894',
        user: { name: 'Emma White', avatar: "/build/assets/images/faces/4.jpg" },
        direction: 'up',
        crypto: { name: 'Dogecoin', icon: "/build/assets/images/crypto-currencies/crypto-icons/dogecoin-doge-logo.svg" },
    ...
    {
        id: '#1234567895',
        user: { name: 'Luke Brown', avatar: "/build/assets/images/faces/7.jpg" },
        direction: 'down',
        crypto: { name: 'Bitcoin', icon: "/build/assets/images/crypto-currencies/crypto-icons/bitcoin-btc-logo.svg" },
    ...
    {
        id: '#1234567896',
        user: { name: 'Sophia Black', avatar: "/build/assets/images/faces/6.jpg" },
        direction: 'up',
        crypto: { name: 'Ethereum', icon: "/build/assets/images/crypto-currencies/crypto-icons/ethereum-eth-logo.svg" },
    ...
    {
        id: '#1234567897',
        user: { name: 'Rachel Green', avatar: "/build/assets/images/faces/7.jpg" },
        direction: 'up',
        crypto: { name: 'Tether', icon: "/build/assets/images/crypto-currencies/crypto-icons/tether-usdt-logo.svg" },
    ...
    {
        id: '#1234567898',
        user: { name: 'David Kim', avatar: "/build/assets/images/faces/15.jpg" },
        direction: 'down',
        crypto: { name: 'Bitcoin', icon: "/build/assets/images/crypto-currencies/crypto-icons/bitcoin-btc-logo.svg" },
    ...
    {
        id: '#1234567899',
        user: { name: 'Oliver Stone', avatar: "/build/assets/images/faces/16.jpg" },
        direction: 'up',
        crypto: { name: 'Ethereum', icon: "/build/assets/images/crypto-currencies/crypto-icons/ethereum-eth-logo.svg" },
