...
export const MartketTable = [
    {
        rank: 1,
        name: "Bitcoin",
        imgsrc:"/build/assets/images/crypto-currencies/square-color/Bitcoin.svg",
        symbol: "BTC",
        marketCap: "$850B",
        price: "$44,500",
        priceChange1h: "+0.5%",
    ...
    },
    {
        rank: 2,
        name: "Ethereum",
        imgsrc:"/build/assets/images/crypto-currencies/square-color/Ethereum.svg",
        symbol: "ETH",
        marketCap: "$400B",
        price: "$3,200",
        priceChange1h: "-1.2%",
    ...
    },
    {
        rank: 3,
        name: "Golem",
        imgsrc:"/build/assets/images/crypto-currencies/square-color/Golem.svg",
        symbol: "GLM",
        marketCap: "$1.2B",
        price: "$0.56",
        priceChange1h: "+0.3%",
    ...
    },
    {
        rank: 4,
        name: "Dash",
        imgsrc:"/build/assets/images/crypto-currencies/square-color/Dash.svg",
        symbol: "DASH",
        marketCap: "$12B",
        price: "$200",
        priceChange1h: "-0.5%",
    ...
    },
    {
        rank: 5,
        name: "Litecoin",
        imgsrc:"/build/assets/images/crypto-currencies/square-color/Litecoin.svg",
        symbol: "LTC",
        marketCap: "$13B",
        price: "$185",
        priceChange1h: "+0.7%",
    ...
    },
    {
        rank: 6,
        name: "Ripple",
        imgsrc:"/build/assets/images/crypto-currencies/square-color/Ripple.svg",
        symbol: "XRP",
        marketCap: "$35B",
        price: "$1.00",
        priceChange1h: "+0.1%",
    ...
    },
    {
        rank: 7,
        name: "EOS",
        imgsrc:"/build/assets/images/crypto-currencies/square-color/EOS.svg",
        symbol: "EOS",
        marketCap: "$6.5B",
        price: "$7.00",
        priceChange1h: "-0.3%",
    ...
    },
    {
        rank: 8,
        name: "Bytecoin",
        imgsrc:"/build/assets/images/crypto-currencies/square-color/Bytecoin.svg",
        symbol: "BCN",
        marketCap: "$3.5B",
        price: "$0.03",
        priceChange1h: "+2.1%",
    ...
    },
    {
        rank: 9,
        name: "IOTA",
        imgsrc:"/build/assets/images/crypto-currencies/square-color/IOTA.svg",
        symbol: "IOTA",
        marketCap: "$3.2B",
        price: "$1.15",
        priceChange1h: "+0.2%",
    ...
    },
    {
        rank: 10,
        name: "Monero",
        imgsrc:"/build/assets/images/crypto-currencies/square-color/Monero.svg",
        symbol: "XMR",
        marketCap: "$3.8B",
        price: "$200",
        priceChange1h: "-0.8%",
...
export const MarketData = [
    {
        imgSrc: "/build/assets/images/crypto-currencies/regular/Bitcoin.svg",
        title: "Bitcoin - BTC",
        subtitle: "BTC / USD",
        price: "$35,876.29",
        value: "$0.04",
    ...
    {
        imgSrc: "/build/assets/images/crypto-currencies/regular/Ethereum.svg",
        title: "Ethereum - ETH",
        subtitle: "ETH / USD",
        price: "$31,244.12",
        value: "$2.57",
    ...
    {
        imgSrc: "/build/assets/images/crypto-currencies/regular/Dash.svg",
        title: "Dash - DASH",
        subtitle: "DASH / USD",
        price: "$26,345.00",
        value: "$12.32",
...
export const PortfolioData = [
    ...
    {
        imgSrc: "/build/assets/images/crypto-currencies/regular/litecoin.svg",
        name: "Litecoin",
        quantity: "20 LTC",
        value: "$4,000",
    },
