...
export const ProductDetailsSwiper = [
    <div className="" id="img-container">
      <BaseImage className="img-fluid" src={"/build/assets/images/ecommerce/jpg/4.jpg"} alt="img" />
    </div>,
    <div className=" image-container">
      <BaseImage className="img-fluid" src={"/build/assets/images/ecommerce/jpg/2.jpg"} alt="img" />
    </div>,
    <div className="image-container">
      <BaseImage className="img-fluid" src={"/build/assets/images/ecommerce/jpg/3.jpg"} alt="img" />
    </div>,
    <div className="image-container">
      <BaseImage className="img-fluid" src={"/build/assets/images/ecommerce/jpg/1.jpg"} alt="img" />
    </div>,
    <div className="image-container">
      <BaseImage className="img-fluid" src={"/build/assets/images/ecommerce/jpg/5.jpg"} alt="img" />
    </div>,
    <div className="image-container">
      <BaseImage className="img-fluid" src={"/build/assets/images/ecommerce/jpg/6.jpg"} alt="img" />
    </div>
  ]
