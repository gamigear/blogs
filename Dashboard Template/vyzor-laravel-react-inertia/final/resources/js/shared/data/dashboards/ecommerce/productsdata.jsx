...
const initialCustomerData = [
    ['SPK001', 'Smart TV 50"', "build/assets/images/ecommerce/png/1.png", '$699.99', 'In Stock', 'Published', '120', 'Mar 12, 2025', 'electronics'],
    ['SPK002', 'Running Shoes', "build/assets/images/ecommerce/png/2.png", '$89.99', 'Out of Stock', 'Draft', '0', 'Mar 10, 2025', 'fashion'],
    ['SPK003', 'Wooden Dining Table', "build/assets/images/ecommerce/png/3.png", '$399.99', 'In Stock', 'Published', '45', 'Mar 5, 2025', 'home'],
    ['SPK004', 'Wireless Earbuds', "build/assets/images/ecommerce/png/4.png", '$129.99', 'In Stock', 'Published', '250', 'Mar 2, 2025', 'electronics'],
    ['SPK005', 'Leather Jacket', "build/assets/images/ecommerce/png/5.png", '$199.99', 'In Stock', 'Archived', '75', 'Feb 28, 2025', 'fashion'],
    ['SPK006', 'Office Desk Chair', "build/assets/images/ecommerce/png/7.png", '$149.99', 'Out of Stock', 'Draft', '0', 'Feb 25, 2025', 'home'],
    ['SPK007', 'Portable Speaker', "build/assets/images/ecommerce/png/8.png", '$79.99', 'In Stock', 'Published', '300', 'Feb 20, 2025', 'electronics'],
    ['SPK008', 'Summer Dress', "build/assets/images/ecommerce/png/9.png", '$59.99', 'In Stock', 'Published', '150', 'Feb 18, 2025', 'fashion'],
    ['SPK009', 'Coffee Maker', "build/assets/images/ecommerce/png/10.png", '$59.99', 'In Stock', 'Published', '60', 'Feb 15, 2025', 'home'],
    ['SPK010', 'Electric Kettle', "build/assets/images/ecommerce/png/16.png", '$39.99', 'Out of Stock', 'Archived', '0', 'Feb 10, 2025', 'electronics']
];
        ...
        const grid = new Grid({
            ...
            `)
                },
                {
                    name: 'Product Name',
                    formatter: (_, row) => html(`
              <a href="${__APP_BASE_PATH__}/dashboards/ecommerce/product-details">
            ...
            `)
                ...
                'Date Added',
                {
                    ...
                    formatter: (_, rowIndex) => html(`
                                <span class="d-flex">
                    <a href="${__APP_BASE_PATH__}/dashboards/ecommerce/product-details" class="btn btn-sm me-2 btn-primary-transparent">
