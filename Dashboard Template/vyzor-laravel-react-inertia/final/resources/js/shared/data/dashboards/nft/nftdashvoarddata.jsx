...
export const NftCards = [
    {
        id: 'nft1',
        image: "/build/assets/images/nft-images/2.png",
    ...
    {
        id: '"/build/assets/images/nft-images/2.png"',
        image: "/build/assets/images/nft-images/3.png",
    ...
    {
        id: '"/build/assets/images/nft-images/3.png"',
        image: "/build/assets/images/nft-images/4.png",
...
export const Followers = [
    {
        ...
        name: 'Kairo Tetsuo',
        handle: '@KairoX',
        image: "/build/assets/images/nft-images/6.jpg",
        isFollowing: false,
    },
    {
        id: '2',
        name: 'Aiko Nakamura',
        handle: '@NamiGhost',
        image: "/build/assets/images/nft-images/15.jpg",
        isFollowing: true,
    },
    {
        id: '3',
        name: 'Kairo Tetsuo',
        handle: '@KairoX',
        image: "/build/assets/images/nft-images/16.jpg",
        isFollowing: false,
    },
    {
        id: '4',
        name: 'Ryo Takahashi',
        handle: '@TakaraVision',
        image: "/build/assets/images/nft-images/17.jpg",
        isFollowing: false,
    },
    {
        id: '5',
        name: 'Nova Cypher',
        handle: '@CypherNova',
        image: "/build/assets/images/nft-images/11.jpg",
        isFollowing: false,
    },
    {
        id: '6',
        name: 'Zara Kai',
        handle: '@ZaraKx',
        image: "/build/assets/images/nft-images/9.jpg",
        isFollowing: false,
    },
    {
        id: '7',
        name: 'Maxim Xeno',
        handle: '@XenoMax',
        image: "/build/assets/images/nft-images/8.jpg",
        isFollowing: false,
    },
];
...
export const NftSales = [
    {
        image: "/build/assets/images/nft-images/36.png",
        title: "Blade of the Future",
        author: "Kairo Tetsuo",
        avatar: "/build/assets/images/crypto-currencies/crypto-icons/ethereum-eth-logo.svg",
        price: "10 ETH",
    },
    {
        image: "/build/assets/images/nft-images/38.png",
    ...
    {
        image: "/build/assets/images/nft-images/40.png",
    ...
    {
        image: "/build/assets/images/nft-images/41.png",
    ...
    {
        image: "/build/assets/images/nft-images/42.png",
        title: "Neon Rage",
        author: "Zara Kai",
        avatar: "/build/assets/images/crypto-currencies/crypto-icons/ethereum-eth-logo.svg",
        price: "7 ETH",
    ...
    {
        image: "/build/assets/images/nft-images/43.png",
...
export const NftTableData = [
    ...
    {
        id: 3,
        image: "/build/assets/images/nft-images/35.png",
    ...
    {
        id: 5,
        image: "/build/assets/images/nft-images/37.png",
...
const nftCards = [
    {
        images: [
            "/build/assets/images/nft-images/38.png",
            "/build/assets/images/nft-images/40.png",
            "/build/assets/images/nft-images/41.png",
        ],
        user: {
            name: "Melissa Smith",
            username: "@melissa",
            avatar: "/build/assets/images/faces/5.jpg",
        },
    },
    {
        images: [
            "/build/assets/images/nft-images/35.png",
            "/build/assets/images/nft-images/36.png",
            "/build/assets/images/nft-images/37.png",
        ],
        user: {
            name: "Simon Cowell",
            username: "@simon",
    ...
    {
        images: [
            "/build/assets/images/nft-images/39.png",
            "/build/assets/images/nft-images/42.png",
            "/build/assets/images/nft-images/43.png",
        ],
        user: {
            name: "Json Talor",
            username: "@taylor",
            avatar: "/build/assets/images/faces/10.jpg",
        },
    },
];
        ...
        <Card.Body className="card-body p-0">
            <Row className="g-2">
                <div className="col-12">
                    <BaseImage src={card.images[0]} alt="" className="nft-featuredcollect-image rounded" />
                </div>
                <div className="col-6">
                    <BaseImage src={card.images[1]} alt="" className="nft-featuredcollect-image rounded" />
                </div>
                <div className="col-6">
                    <BaseImage src={card.images[2]} alt="" className="nft-featuredcollect-image rounded" />
                </div>
            </Row>
        </Card.Body>
                ...
                <div className="d-flex align-items-center flex-fill">
                    <div className="me-2 lh-1">
                        <span className="avatar avatar-md avatar-rounded">
                            <BaseImage src={card.user.avatar} alt="" />
                            <BaseLink href="#!" className="badge rounded-pill bg-primary avatar-badge">
                    ...
                    <div>
                        <p className="mb-0 fw-semibold">
                            <BaseLink href="#!">{card.user.name}</BaseLink>
                        </p>
