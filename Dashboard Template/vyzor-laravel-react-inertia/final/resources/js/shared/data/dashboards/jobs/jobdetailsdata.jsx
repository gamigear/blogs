...
export const Responsibilities = [
    "Write clean, scalable, and efficient code for a variety of projects.",
    "Design and develop software solutions, applications, and systems from scratch.",
    "Work closely with designers, product managers, and other developers to build user-friendly, high-performance web applications.",
    ...
    "Collaborate with the DevOps team to ensure the proper deployment and scalability of applications.",
    "Ensure that applications are optimized for maximum speed and scalability.",
    "Stay up-to-date with the latest software development trends, tools, and technologies.",
    "Participate in the full software development lifecycle (SDLC), from planning through deployment."
];

export const Qualifications = [
    "Bachelor’s degree in Computer Science, Information Technology, or related field (or equivalent experience).",
    "Proven experience as a Software Developer or similar role.",
    "Strong knowledge of programming languages such as JavaScript, Python, Ruby, or Java.",
    "Familiarity with frameworks like React, Node.js, Angular, or Vue.js.",
...
export const InfoList = [
    { iconClass: 'ri-time-line fs-15', label: '09:30 AM - 06:00 PM' },
    { iconClass: 'bi bi-mortarboard fs-15', label: 'Graduate and Above' },
    { iconClass: 'bi bi-calendar fs-15', label: '5 Working Days' },
    { iconClass: 'bi bi-person-check fs-15', label: 'Bachelors Preferred' },
];
...
export const JobListings = [
    ...
    },
    {
        ...
        company: "Spruko Technologies LIMITED",
        icon: (
...
//const jobs = [
//    { id: 1, title: 'HTML Developer', company: 'Spotech Technical Solutions', location: 'Hyderabad', salary: '$25,000 - $35,000' },
//    { id: 2, title: 'React Developer', company: 'Infratech PVT LTD', location: 'Hyderabad', salary: '$25,000 - $35,000' },
//    { id: 3, title: 'Vuejs Developer', company: 'G Technical Solutions', location: 'Hyderabad', salary: '$25,000 - $35,000' },
//    { id: 3, title: 'Wordpress Developer', company: 'Hardware Private Solutions', location: 'Hyderabad', salary: '$25,000 - $35,000' },
//  ];
export const jobs = [
    {
        id: 1,
        badges: [
            {
                title: 'HTML Developer', company: 'Spotech Technical Solutions', location: 'Hyderabad', salary: '$25,000 - $35,000'
            },
            {
                title: 'React Developer', company: 'Infratech PVT LTD', location: 'Hyderabad', salary: '$25,000 - $35,000'
            }
        ]
    },
    {
        ...
        badges: [
            ...
            {
                title: 'Wordpress Developer', company: 'Hardware Private Solutions', location: 'Hyderabad', salary: '$25,000 - $35,000'
            }
        ]
    },
]
export const JobsSwiper = jobs.map((job, jobIndex) => (
    <div className="row" key={jobIndex} >
        {job.badges.map((badge, index) => (
            <div className="col-md-6" key={index}>
                <div className="card custom-card featured-jobs">
                    <div className="card-body">
                        <div className="btn-list float-end">
                            <SpkTooltips placement="top" title="Add to wishlist">
                                <Link   onClick={(e) => e.preventDefault()}  href="#!" className="avatar avatar-sm avatar-rounded bg-light text-default"><span><i className="bi bi-heart"></i></span></Link>
                            </SpkTooltips>
                            <SpkTooltips placement="top" title="Featured Jobs">
                                <Link   onClick={(e) => e.preventDefault()}  href="#!" className="avatar avatar-sm avatar-rounded bg-warning-transparent me-0"><span><i className="bi bi-star-fill"></i></span></Link>
                            </SpkTooltips>
                        </div>
                            ...
                            <div>
                                <span className="avatar avatar-lg avatar-rounded bg-primary bg-opacity-10 border">
                                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
                                        <path fill="var(--primary-color)" d="M21.46777,2.3252A1.00007,1.00007,0,0,0,20.73,2H3.27a1.00039,1.00039,0,0,0-.99609,1.08887l1.52,17a.99944.99944,0,0,0,.72851.87451l7.2002,2A.99628.99628,0,0,0,11.99023,23a1.01206,1.01206,0,0,0,.26709-.03613l7.21973-2a1.00055,1.00055,0,0,0,.729-.875l1.52-17A1,1,0,0,0,21.46777,2.3252Zm-3.19238,16.896L11.99072,20.9624,5.72461,19.22168,4.36328,4H19.63672ZM7.81982,13h6.895l-.32714,3.271-2.56788.917L8.65625,16.05811a1.00017,1.00017,0,1,0-.67285,1.88378l3.5,1.25a1.00291,1.00291,0,0,0,.67285,0l3.5-1.25a1.00044,1.00044,0,0,0,.65869-.84228l.5-5A1.00064,1.00064,0,0,0,15.81982,11H8.72461L8.4248,8h7.895a1,1,0,0,0,0-2h-9a1.00064,1.00064,0,0,0-.99511,1.09961l.5,5A1.00012,1.00012,0,0,0,7.81982,13Z"></path>
                                    </svg>
                                </span>
                            </div>
                            <div className="ms-2">
                                <h5 className="fw-medium mb-0 d-flex align-items-center">
                                    <BaseLink href="#!">{badge.title}</BaseLink>
                                </h5>
                                <BaseLink href="#!">
                                    <i className="bi bi-building"></i> {badge.company}
                                </BaseLink>
                            </div>
                        </div>
                        <div className="popular-tags mb-3">
                            <BaseLink href="#!" className="badge rounded-pill bg-light text-default me-1">
                                <i className="bi bi-geo-alt text-muted me-1"></i> {badge.location}
                            </BaseLink>
                            <BaseLink href="#!" className="badge rounded-pill bg-light text-default me-1">
                        ...
                        <div className="d-flex justify-content-between flex-wrap">
                            <h6 className="fw-medium mb-0">{badge.salary}</h6>
