...
export const Drag = [
  { id: 1, name: "1. Draft 300-word blog post" },
  { id: 2, name: "2. Create project plan with milestones" },
  { id: 3, name: "3. Develop sample interview questions" },
  { id: 4, name: "4. Generate customer feedback for product." },
  { id: 5, name: "5. Write email template for newsletter." },
  { id: 6, name: "6. Design logo for fictional company" },
];

export const Drag1 = [
  { id: 1, name: "1. Sketch a website homepage" },
  { id: 2, name: "2. Summarize meeting minutes." },
  { id: 3, name: "3. Code a simple webpage." },
  { id: 4, name: "4. Create survey questions." },
  { id: 5, name: "5. Schedule team meeting." },
  { id: 6, name: "6. Plan team-building activity." },
];

export const Drag2 = [
  { id: 1, name: "1. Brainstorm marketing ideas." },
  { id: 2, name: "2. Write slogan for brand." },
  { id: 3, name: "3. Update contact information." },
  { id: 4, name: "4. Proofread blog post." },
  { id: 5, name: "5. Analyze sales data." },
  { id: 6, name: "6. Edit product description" },
];
