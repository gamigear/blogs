...
export const Solidalerts = [
	...
	{ id: 6, text: "A simple solid success alert—check it out!", class: "solid-success", color: "" },
	{ id: 7, text: "A simple solid info alert—check it out! ", class: "solid-info", color: "" },
	{ id: 8, text: "A simple solid warning alert—check it out!", class: "solid-warning", color: "" },
...
export const Imagealerts = [
	...
	{ id: 3, src1: "/build/assets/images/faces/8.jpg", color: "success", class: "" },
...
export const avatarsizealert = [
	{ id: 1, src1: "/build/assets/images/faces/3.jpg", color: "primary", class: "xs", class1: "", width: 20, height: 20 },
	{ id: 2, src1: "/build/assets/images/faces/5.jpg", color: "secondary", class: "sm", class1: "", width: 28, height: 28 },
	{ id: 3, src1: "/build/assets/images/faces/8.jpg", color: "warning", class: "", class1: "", width: 40, height: 40 },
	{ id: 4, src1: "/build/assets/images/faces/11.jpg", color: "danger", class: "md", class1: "", width: 48, height: 48 },
	{ id: 5, src1: "/build/assets/images/faces/13.jpg", color: "info", class: "lg", class1: "", width: 64, height: 64 },
	{ id: 6, src1: "/build/assets/images/faces/14.jpg", color: "dark", class: "xl", class1: "text-muted", width: 80, height: 80 },
];

const svg1 = <svg className="flex-shrink-0 svg-white" xmlns="http://www.w3.org/2000/svg" height="1.5rem" viewBox="0 0 24 24" width="1.5rem" fill="#000000"><path d="M0 0h24v24H0V0z" fill="none"></path><path d="M11 7h2v2h-2zm0 4h2v6h-2zm1-9C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2zm0 18c-4.41 0-8-3.59-8-8s3.59-8 8-8 8 3.59 8 8-3.59 8-8 8z"></path></svg>

const svg2 = <svg className="flex-shrink-0 svg-white" xmlns="http://www.w3.org/2000/svg" height="1.5rem" viewBox="0 0 24 24" width="1.5rem" fill="#000000"><path d="M0 0h24v24H0V0zm0 0h24v24H0V0z" fill="none"></path><path d="M16.59 7.58L10 14.17l-3.59-3.58L5 12l5 5 8-8zM12 2C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2zm0 18c-4.42 0-8-3.58-8-8s3.58-8 8-8 8 3.58 8 8-3.58 8-8 8z"></path></svg>

const svg3 = <svg className="flex-shrink-0 svg-white" xmlns="http://www.w3.org/2000/svg" enableBackground="new 0 0 24 24" height="1.5rem" viewBox="0 0 24 24" width="1.5rem" fill="#000000"><g><rect fill="none" height="24" width="24"></rect></g><g><g><g><path d="M12,5.99L19.53,19H4.47L12,5.99 M12,2L1,21h22L12,2L12,2z"></path><polygon points="13,16 11,16 11,18 13,18"></polygon><polygon points="13,10 11,10 11,15 13,15"></polygon></g></g></g></svg>

const svg4 = <svg className="flex-shrink-0 svg-white" xmlns="http://www.w3.org/2000/svg" enableBackground="new 0 0 24 24" height="1.5rem" viewBox="0 0 24 24" width="1.5rem" fill="#000000"><g><rect fill="none" height="24" width="24"></rect></g><g><g><g><path d="M15.73,3H8.27L3,8.27v7.46L8.27,21h7.46L21,15.73V8.27L15.73,3z M19,14.9L14.9,19H9.1L5,14.9V9.1L9.1,5h5.8L19,9.1V14.9z"></path><rect height="6" width="2" x="11" y="7"></rect><rect height="2" width="2" x="11" y="15"></rect></g></g></g></svg>
...
export const Svgalert1 = [
	...
	{ id: 2, class1: svg2, text1: "Success Alert", text2: "Success alert to show to success message", color: "secondary", btn1: "", btn2: "close", class: "d-none" },
...
const Asvg = <svg className="flex-shrink-0 svg-primary" xmlns="http://www.w3.org/2000/svg" height="1.5rem" viewBox="0 0 24 24" width="1.5rem" fill="#000000"><path d="M0 0h24v24H0V0z" fill="none"></path><path d="M11 7h2v2h-2zm0 4h2v6h-2zm1-9C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2zm0 18c-4.41 0-8-3.59-8-8s3.59-8 8-8 8 3.59 8 8-3.59 8-8 8z"></path></svg>

const Asvg1 = <svg className="flex-shrink-0 svg-success" xmlns="http://www.w3.org/2000/svg" height="1.5rem" viewBox="0 0 24 24" width="1.5rem" fill="#000000"><path d="M0 0h24v24H0V0zm0 0h24v24H0V0z" fill="none"></path><path d="M16.59 7.58L10 14.17l-3.59-3.58L5 12l5 5 8-8zM12 2C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2zm0 18c-4.42 0-8-3.58-8-8s3.58-8 8-8 8 3.58 8 8-3.58 8-8 8z"></path></svg>

const Asvg2 = <svg className="flex-shrink-0 svg-warning" xmlns="http://www.w3.org/2000/svg" enableBackground="new 0 0 24 24" height="1.5rem" viewBox="0 0 24 24" width="1.5rem" fill="#000000"><g><rect fill="none" height="24" width="24"></rect></g><g><g><g><path d="M12,5.99L19.53,19H4.47L12,5.99 M12,2L1,21h22L12,2L12,2z"></path><polygon points="13,16 11,16 11,18 13,18"></polygon><polygon points="13,10 11,10 11,15 13,15"></polygon></g></g></g></svg>

const Asvg3 = <svg className="flex-shrink-0 svg-danger" xmlns="http://www.w3.org/2000/svg" enableBackground="new 0 0 24 24" height="1.5rem" viewBox="0 0 24 24" width="1.5rem" fill="#000000"><g>
...
export const Svgalert = [
	...
	{ id: 2, class1: Asvg1, text1: "Success Alert", text2: "Success alert to show to success message", color: "secondary", btn1: "cancel", btn2: "open", class: "danger" },
