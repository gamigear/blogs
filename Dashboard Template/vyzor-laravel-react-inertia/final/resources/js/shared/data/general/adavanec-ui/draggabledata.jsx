...
import SpkCard from "../../../@spk-reusable-components/general-reusable/reusable-uielements/reusable-cards/spk-basiccard";
import Spkbgcards from "../../../@spk-reusable-components/general-reusable/reusable-uielements/reusable-cards/spkbgcards";
import SpkCollapsecard from "../../../@spk-reusable-components/general-reusable/reusable-uielements/reusable-cards/spkcollapsecard";
import Spkimageoverlaycard from "../../../@spk-reusable-components/general-reusable/reusable-uielements/reusable-cards/spkimageoverlaycard";
import Spktitlecards from "../../../@spk-reusable-components/general-reusable/reusable-uielements/reusable-cards/spktitlecards";
        ...
        <Fragment>
            ...
            <div className="row">
                ...
                <Col xl={6} ref={rightContainerRef} id="draggable-right">
                    <Spkimageoverlaycard CustomClass="overlay-card" CardHeader={false} Imgsrc="/build/assets/images/media/media-36.jpg" Overlayclass="over-content-bottom top-0"
                        CardFooter={true} Footertext="Last updated 3 mins ago" Customimgclass="card-img" Custombodyclass="text-fixed-white overflow-y-auto" Customfooterclass="text-fixed-white" >
                    ...
                    <Spkbgcards Navigate="#!" color="success" Imgsrc="/build/assets/images/faces/5.jpg" Title="Samantha sid" Value="In leave for 1 month" Textclass="fixed-white" Class=' drag-card' />
                    <Spkimageoverlaycard CustomClass="overlay-card" Title="Image Overlays Are Awesome!" Imgsrc="/build/assets/images/media/media-35.jpg" CardHeader={true}
