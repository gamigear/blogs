...
export const Piechartoptions = {
	...
	labels: ["Comedy", "Action", "Vyzor", "Drama", "Horror"],
	dataLabels: {
		enabled: true,
		style: {
			colors: ["#111"]
...
export const Pieimgoptions = {
	...
	fill: {
		...
		opacity: 0.85,
		image: {
			src: [`${__APP_BASE_PATH__}/build/assets/images/media/media-21.jpg`,
			`${__APP_BASE_PATH__}/build/assets/images/media/media-21.jpg`,
			`${__APP_BASE_PATH__}/build/assets/images/media/media-21.jpg`,
			`${__APP_BASE_PATH__}/build/assets/images/media/media-21.jpg`],
			width: 25
		},
