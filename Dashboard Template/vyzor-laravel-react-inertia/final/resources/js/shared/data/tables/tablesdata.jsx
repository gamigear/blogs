...
const ReadOnlyRow = ({ contact, handleEditClick, handleDeleteClick }) => {
	return (
		<tr>
			...
			<td>
				<SpkButton Buttonvariant="" Customclass="btn btn-primary me-1" Buttontype="button" onClickfunc={(event) => handleEditClick(event, contact)}> Edit
				</SpkButton>
...
export function DataTabless() {
	const [_selectedRows, setSelectedRows] = React.useState([])
	const [toggleCleared, _setToggleCleared] = React.useState(false)
	const [data, _setData] = React.useState(tableDataItems)
...
const Export = ({ onExport }) => (
	<SpkButton onClickfunc={(e) => onExport(e.target.value)} Buttonvariant="primary" Customclass='export-table ti-btn'>Export</SpkButton>
)
