...
import BaseImage from "../../layouts-components/baseimage/baseimage";
...
const Header = () => {
    ...
    const notificationNotes = [
        { id: 1, image: "/build/assets/images/ecommerce/png/13.png", name: "Urban Chic Satchel", description: "Sleek, stylish, and perfect for daily use", oldprice: '$120', newprice: '$90', off: '25%', quantity: "1" },
        { id: 2, image: "/build/assets/images/ecommerce/png/15.png", name: "TrailBlaze Runners", description: "Lightweight and built for comfort", oldprice: '$80', newprice: '$60', off: '25%', quantity: "1" },
        { id: 3, image: "/build/assets/images/ecommerce/png/19.png", name: "VisionTech SLR", description: "High-quality shots with every click", oldprice: '$500', newprice: '$375', off: '25%', quantity: "1" },
        { id: 4, image: "/build/assets/images/ecommerce/png/6.png", name: "FlexiSeat Office Chair", description: "Comfortable support for long hours", oldprice: '$200', newprice: '$150', off: '25%', quantity: "5" },
        { id: 5, image: "/build/assets/images/ecommerce/png/11.png", name: "DecoDial Classic", description: "A bold, colorful timepiece for any room", oldprice: '$50', newprice: '$35', off: '30%', quantity: "2" },
    ]

    const [note, setNote] = useState(notificationNotes);

    const handleNoteRemove = (id, e) => {
        e.stopPropagation();
    ...
    const handleClick = (Environmental) => {
        const searchInput = searchRef.current;
        const container = containerRef.current;

        if (searchInput && container && !searchInput.contains(event.target) && !container.contains(event.target)) {
            container.classList.remove("searchdrop");
        } else if (searchInput && container && (searchInput === event.target || searchInput.contains(event.target))) {
                ...
                <div className="main-header-container container-fluid">
                    ...
                    <div className="header-content-left">
                        ...
                        <div className="header-element">
                            <div className="horizontal-logo">
                                <Link href={`${__APP_BASE_PATH__}/dashboards/sales/`} className="header-logo">
                                    <BaseImage src="/build/assets/images/brand-logos/desktop-logo.png" alt="logo" className="desktop-logo" />
                                    <BaseImage src="/build/assets/images/brand-logos/toggle-dark.png" alt="logo" className="toggle-dark" />
                                    <BaseImage src="/build/assets/images/brand-logos/desktop-dark.png" alt="logo" className="desktop-dark" />
                                    <BaseImage src="/build/assets/images/brand-logos/toggle-logo.png" alt="logo" className="toggle-logo" />
                                </Link>
                        ...
                        <div className="header-element mx-lg-0 mx-2">
                            <BaseLink aria-label="Hide Sidebar" onClick={toggleSidebar} className="sidemenu-toggle header-link animated-arrow hor-toggle horizontal-navtoggle" data-bs-toggle="sidebar" href="#!"><span></span></BaseLink>
                        </div>
                        ...
                        <div ref={containerRef} className="header-element header-search d-md-block d-none my-auto auto-complete-search">
                            ...
                            <BaseLink href="#!" className="header-search-icon border-0">
                    ...
                    <ul className="header-content-right">
                        ...
                        <li className="header-element d-md-none d-block">
                            <BaseLink href="#!" className="header-link" onClick={handleShow1} data-bs-toggle="modal" data-bs-target="#header-responsive-search">
                        ...
                        <Dropdown className="header-element country-selector d-sm-block d-none">
                            ...
                            <DropdownMenu className="main-header-dropdown dropdown-menu" data-popper-placement="none" align="end">
                                {Languages.map((lang, index) => (
                                    <li key={index}>
                                        <BaseLink className="dropdown-item d-flex align-items-center justify-content-between" href="#!">
                                            <div className="d-flex align-items-center">
                                                <span className="avatar avatar-rounded avatar-xs lh-1 me-2">
                                                    <BaseImage src={`/build/assets/images/flags/${lang.flag}`} alt={lang.name} />
                        ...
                        <li className="header-element header-theme-mode">
                            ...
                            <BaseLink href="#!" className="header-link layout-setting" onClick={toggleTheme}>
                            ...
                            <DropdownMenu className="main-header-dropdown dropdown-menu-end" data-popper-placement="none">
                                <div className="p-3 bg-primary text-fixed-white">
                                    <div className="d-flex align-items-center justify-content-between">
                                        ...
                                        <Link href={`${__APP_BASE_PATH__}/dashboards/ecommerce/products/`} className="text-fixed-white text-decoration-underline fs-12">Continue Shopping <i className="ti ti-arrow-narrow-right"></i></Link>
                                    </div>
                                </div>
                                            ...
                                            <div className="d-flex align-items-start cart-dropdown-item gap-3">
                                                <div className="lh-1">
                                                    <span className="avatar avatar-xl bg-gray-300">
                                                        <BaseImage src={`${item.image}`} alt="img" />
                                                    </span>
                                                </div>
                                                    ...
                                                    <div className='d-flex align-items-start justify-content-between mb-3'>
                                                        <div className='fs-14 fw-medium w-75'>
                                                            <div className='text-truncate'>
                                                                <Link href={`${__APP_BASE_PATH__}/dashboards/ecommerce/cart/`}  >{item.name}</Link>
                                                            </div>
                                                        ...
                                                        <div className="text-end">
                                                            <Link href="#!;" onClick={(e) => handleNoteRemove(item.id, e)} className="header-cart-remove dropdown-item-close"><i className="ri-delete-bin-line"></i></Link>
                                                        </div>
                                                    </div>
                                                    <div className="d-flex align-items-center justify-content-between">
                                                        ...
                                                        <div className="d-flex rounded align-items-center flex-nowrap order-qnt gap-2">
                                                            <BaseLink href="#!" onClick={dec} className="badge bg-white p-1 border text-muted fs-13 product-quantity-minus">
                                                                <i className="ri-subtract-line"></i>
                                                            </BaseLink>
                                                            <input type="text" className="form-control form-control-cart border-0 text-center w-100" aria-label="quantity" id="product-qty-1" defaultValue={item.quantity} />
                                                            <BaseLink href="#!" onClick={inc} className="badge bg-white p-1 border text-muted fs-13 product-quantity-plus">
                                ...
                                <div className={`p-3 empty-header-item1 border-top ${note.length === 0 && 'd-none'} `}>
                                    <div className="d-grid">
                                        <Link href={`${__APP_BASE_PATH__}/dashboards/ecommerce/checkout/`} className="btn btn-primary">Proceed to checkout</Link>
                                    </div>
                                </div>
                                {note.length === 0 && (
                            ...
                            <Dropdown.Menu className="main-header-dropdown dropdown-menu dropdown-menu-end" data-popper-placement="none">
                                <div className="p-3 bg-primary text-fixed-white">
                                    <div className="d-flex align-items-center justify-content-between">
                                        ...
                                        <BaseLink href="#!" className="badge bg-light text-default border">Clear All</BaseLink>
                                    </div>
                                </div>
                                <div className="dropdown-divider"></div>
                                <SimpleBar className="list-unstyled mb-0" id="header-notification-scroll">
                                    <li className="dropdown-item position-relative">
                                        <Link href={`${__APP_BASE_PATH__}/applications/chat`} className="stretched-link"></Link>
                                        <div className="d-flex align-items-start gap-3">
                                            <div className="lh-1">
                                                <span className="avatar avatar-sm avatar-rounded bg-primary-transparent">
                                                    <BaseImage src="/build/assets/images/faces/1.jpg" alt="" />
                        ...
                        <li className="header-element header-fullscreen">
                            ...
                            <BaseLink href="#!" className="header-link" onClick={toggleFullscreen}>
                                {isFullscreen ? (
                        ...
                        <Dropdown className="header-element dropdown">
                            ...
                            <Dropdown.Toggle as="a" variant='' className="header-link dropdown-toggle" id="mainHeaderProfile" data-bs-toggle="dropdown" data-bs-auto-close="outside" aria-expanded="false">
                                <div>
                                    <BaseImage src="/build/assets/images/faces/12.jpg" alt="img" className="header-link-icon" />
                                </div>
                            </Dropdown.Toggle>
                            ...
                            <Dropdown.Menu className="main-header-dropdown dropdown-menu pt-0 overflow-hidden header-profile-dropdown dropdown-menu-end" aria-labelledby="mainHeaderProfile">
                                <div className="p-3 bg-primary text-fixed-white">
                                    <div className="d-flex align-items-center justify-content-between">
                                        ...
                                        <Link href="#!" className="text-fixed-white"><i className="ti ti-settings-cog"></i></Link>
                                    </div>
                                </div>
                                <div className="dropdown-divider"></div>
                                <div className="p-3">
                                ...
                                <ul className="list-unstyled mb-0">
                                    <li>
                                        <ul className="list-unstyled mb-0 sub-list">
                                            <li>
                                                <Link className="dropdown-item d-flex align-items-center" href={`${__APP_BASE_PATH__}/pages/profile`}><i className="ti ti-user-circle me-2 fs-18"></i>View Profile</Link>
                                            </li>
                                            <li>
                                                <Link className="dropdown-item d-flex align-items-center" href={`${__APP_BASE_PATH__}/pages/profile-settings`}><i className="ti ti-settings-cog me-2 fs-18"></i>Account Settings</Link>
                                            </li>
                                        </ul>
                                    </li>
                                    <li>
                                        <ul className="list-unstyled mb-0 sub-list">
                                            <li>
                                                <BaseLink className="dropdown-item d-flex align-items-center" href="#!"><i className="ti ti-lifebuoy me-2 fs-18"></i>Support</BaseLink>
                                            </li>
                                            <li>
                                                <BaseLink className="dropdown-item d-flex align-items-center" href="#!"><i className="ti ti-bolt me-2 fs-18"></i>Activity Log</BaseLink>
                                            </li>
                                            <li>
                                                <BaseLink className="dropdown-item d-flex align-items-center" href="#!"><i className="ti ti-calendar me-2 fs-18"></i>Events</BaseLink>
                                            </li>
                                        </ul>
                                    </li>
                                    <li><Link className="dropdown-item d-flex align-items-center" href={`${__APP_BASE_PATH__}/`}><i className="ti ti-logout me-2 fs-18"></i>Log Out</Link></li>
                                </ul>
                            </Dropdown.Menu>
                        </Dropdown>
                        ...
                        <li className="header-element">
                            ...
                            <BaseLink href="#!" className="header-link switcher-icon" data-bs-toggle="offcanvas" data-bs-target="#switcher-canvas" onClick={handleShow} >
