...
const TreemapChart = () => {
    ...
    return (
        ...
        <Fragment>
            ...
            <Pageheader title="Apex Charts" subtitle="Apex Charts" currentpage="Apex Treemap Charts" activepage="Apex Treemap Charts" />
...
// Assign layout
TreemapChart.layout = (page) => <MainLayout>{page}</MainLayout>;
