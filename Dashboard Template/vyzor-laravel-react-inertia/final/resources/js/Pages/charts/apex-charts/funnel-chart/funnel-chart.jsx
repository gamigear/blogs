...
const FunnelChart = () => {
    ...
    return (
        ...
        <Fragment>
            ...
            <Pageheader title="Apex Charts" subtitle="Apex Charts" currentpage="Apex Funnel Charts" activepage="Apex Funnel Charts" />
...
// Assign layout
FunnelChart.layout = (page) => <MainLayout>{page}</MainLayout>;
