...
const RadarChart = () => {
    ...
    return (
        ...
        <Fragment>
            ...
            <Pageheader title="Apex Charts" subtitle="Apex Charts" currentpage="Apex Radar Charts" activepage="Apex Radar Charts" />
            ...
            <Row>
                ...
                <Col xl={6}>
                    <Card className="custom-card custom-chart">
                        <Card.Header>
...
// Assign layout
RadarChart.layout = (page) => <MainLayout>{page}</MainLayout>;
