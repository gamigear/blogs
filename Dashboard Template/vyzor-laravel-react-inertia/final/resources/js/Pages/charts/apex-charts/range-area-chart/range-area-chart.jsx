...
const RangeAreaChart = () => {
    ...
    return (
        ...
        <Fragment>
            ...
            <Pageheader title="Apex Charts" subtitle="Apex Charts" currentpage="Apex Range Area Charts" activepage="Apex Range Area Charts" />
...
// Assign layout
RangeAreaChart.layout = (page) => <MainLayout>{page}</MainLayout>;
