...
const HeatmapChart = () => {
    ...
    return (
        ...
        <Fragment>
            ...
            <Pageheader title="Apex Charts" subtitle="Apex Charts" currentpage="Apex Heatmap Charts" activepage="Apex Heatmap Charts" />
...
// Assign layout
HeatmapChart.layout = (page) => <MainLayout>{page}</MainLayout>;
