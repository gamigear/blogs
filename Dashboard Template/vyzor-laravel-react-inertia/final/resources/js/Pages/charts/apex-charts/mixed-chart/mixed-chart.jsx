...
const MixedChart = () => {
    ...
    return (
        ...
        <Fragment>
            ...
            <Head title={"Apex Mixed Charts"} />

            <Pageheader title="Apex Charts" subtitle="Apex Charts" currentpage="Apex Mixed Charts" activepage="Apex Mixed Charts" />
...
// Assign layout
MixedChart.layout = (page) => <MainLayout>{page}</MainLayout>;
