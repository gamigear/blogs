                            ...
                            <div id="marker-image-map">
                                <Map height={300} defaultCenter={[50.879, 4.6997]} defaultZoom={11}>
                                    <Overlay anchor={[50.879, 4.6997]} offset={[120, 79]}>
                                        <BaseImage src="/build/assets/images/brand-logos/desktop-logo.png" alt='' />
                                    </Overlay>
                                </Map>
                            </div>
                        </Card.Body>
                            ...
                            <div id="lines-map">
                                <Map height={300} defaultCenter={[50.879, 4.6997]} defaultZoom={11}>
                                    <Draggable offset={[60, 87]} anchor={anchor} onDragEnd={setAnchor}>
                                        <BaseImage src="/build/assets/images/brand-logos/desktop-logo.png" alt="Pigeon!" />
                                    </Draggable>
                                </Map>
                            </div>
                        </Card.Body>
...
// Assign layout
Pigeonmaps.layout = (page) => <MainLayout>{page}</MainLayout>;
