...
const Landing = () => {
    ...
    const documentSelectors = (selector) => document.querySelectorAll(selector);
                ...
                <div className="main-header-container container-fluid">
                    ...
                    <div className="header-content-left">
                        ...
                        <div className="header-element">
                            ...
                            <BaseLink href="#!" className="sidemenu-toggle header-link" data-bs-toggle="sidebar" onClick={() => toggleNavigation()}>
                    ...
                    <div className="header-content-right">
                        ...
                        <div className="header-element align-items-center">
                            ...
                            <div className="btn-list d-lg-none d-flex">
                                <Link href={`${__APP_BASE_PATH__}/pages/authentication/sign-up/basic`} className="btn btn-success-light">
                                    Sign Up
                                </Link>
                    ...
                    <div className="main-sidebar shadow-none">
                        ...
                        <nav className="main-menu-container nav nav-pills sub-open">
                            <div className="landing-logo-container">
                                <div className="horizontal-logo">
                                    <Link href={`${__APP_BASE_PATH__}/dashboards/sales`} className="header-logo">
                                        <BaseImage src="/build/assets/images/brand-logos/desktop-logo.png" alt="logo"
                                            className="desktop-logo" />
                                        <BaseImage src="/build/assets/images/brand-logos/desktop-dark.png" alt="logo"
                    ...
                    <!-- Start::slide --> */}
                                ...
                                <li className={`slide has-sub ${expande ? 'open' : ''} `}>
                                    <a href="#!" className={`side-menu__item ${expande ? 'active' : ''} ${isActive ? 'active' : ''}`} onClick={toggleExpand} >
                                        ...
                                        <i className="fe fe-chevron-right side-menu__angle op-8 me-2"></i>
                                    </a>
                    ...
                    <!-- Start::slide --> */}
                            ...
                            <div className="d-lg-flex d-none align-items-center">
                                <div className="btn-list d-xl-flex d-none">
                                    <Link href={`${__APP_BASE_PATH__}/pages/authentication/sign-in/basic`} className="btn btn-wave btn-primary border">
                                        Login / Register
                                    </Link>
                                </div>

                                <BaseLink href="#!" className="btn btn-icon btn-primary-light switcher-icon" onClick={handleShow} data-bs-toggle="offcanvas" data-bs-target="#switcher-canvas">
            ...
            <div className="main-content landing-main px-0" onClick={handleClick1}>
                ...
                <div className="landing-banner">
                    <div className="banner-image-container grid-cards ">
                        <BaseImage src="/build/assets/images/media/backgrounds/5.png" alt="" />
                    </div>
                        ...
                        <Row>
                            <Col xl={6} className="my-auto">
                                ...
                                <div className="btn-list banner-buttons">
                                    <Link href={`${__APP_BASE_PATH__}/dashboards/sales`} className="btn btn-primary btn-lg rounded-pill btn-w-lg">Get Started for free</Link>
                                    <BaseLink className="btn btn-lg btn-light border rounded-pill btn-w-lg" href="#!">View Demo</BaseLink>
                                </div>
                            </Col>
                            <Col xl={6}>
                                <div className="banner-main-img text-end d-xl-block d-none grid-cards">
                                    <BaseImage src="/build/assets/images/media/backgrounds/7.png" alt="" className="img-fluid" />
                                </div>
                            </Col>
                        </Row>
                    </div>
                        ...
                        <Row>
                            ...
                            <Col xl={5} className="my-auto">
                                <div className="services-image-container text-end d-xl-block d-none">
                                    <BaseImage src="/build/assets/images/media/media-67.png" alt="" className="img-fluid" />
                                </div>
                            </Col>
                        </Row>
                    </div>
                ...
                <section className="section section-md section-primary text-fixed-white py-5 buy-now-section overflow-hidden">
                    <div className="testimonials-background-container grid-cards">
                        <BaseImage src="/build/assets/images/media/backgrounds/1.png" alt="" />
                    </div>
                    <div className="container">
                        <div className="d-flex align-items-center gap-2 justify-content-between flex-wrap">
                            ...
                            <div className="btn-list">
                                <Link href={`${__APP_BASE_PATH__}/dashboards/sales/`} className="btn btn-danger btn-lg btn-w-md d-inline-flex align-items-center">View Demo<i className="ti ti-arrow-narrow-right ms-2"></i></Link>
                ...
                <section className="section section-primary testimonials-section">
                    <div className="testimonials-background-container">
                        <BaseImage src="/build/assets/images/media/backgrounds/2.png" alt="" />
                    </div>
                    <div className="container">
                        <div className="heading-section">
                                        ...
                                        <Card.Body className="p-4 text-center">
                                            {card.imgSrc && (
                                                <div className="step-arrow-container d-lg-block d-none">
                                                    <BaseImage src={card.imgSrc} alt={card.title} className="img-fluid" />
                                                </div>
                                            )}
                                            <div className="lh-1 mb-3">
            ...
            <section className="section landing-footer text-fixed-white">
                <div className="container">
                    ...
                    <Row className="justify-content-center gy-3">
                        <Col xl={4}>
                            <p className="fw-semibold mb-3 brand-image"><Link href={`${__APP_BASE_PATH__}/dashboards/sales`}><BaseImage src="/build/assets/images/brand-logos/desktop-dark.png" alt="" /></Link></p>
                        ...
                        <Col sm={3} xl={2} className="col-6">
                            ...
                            <ul className="list-unstyled fw-normal landing-footer-list mb-0">
                                <li>
                                    <BaseLink href="#!" className="text-fixed-white op-6">Services</BaseLink>
                                </li>
                                <li>
                                    <BaseLink href="#!" className="text-fixed-white op-6">Product Tour</BaseLink>
                                </li>
                                <li>
                                    <BaseLink href="#!" className="text-fixed-white op-6">Integrations</BaseLink>
                                </li>
                                <li>
                                    <Link href={`${__APP_BASE_PATH__}/pages/pricing`} className="text-fixed-white op-6">Pricing</Link>
                                </li>
                            </ul>
                        </Col>
                        <Col sm={3} xl={2} className="col-6">
                            ...
                            <ul className="list-unstyled fw-normal landing-footer-list mb-0">
                                <li>
                                    <BaseLink href="#!" className="text-fixed-white op-6">Contact Us</BaseLink>
                                </li>
                                <li>
                                    <BaseLink href="#!" className="text-fixed-white op-6">Technical Support</BaseLink>
                                </li>
                                <li>
                                    <BaseLink href="#!" className="text-fixed-white op-6">Documentation</BaseLink>
                                </li>
                                <li>
                                    <BaseLink href="#!" className="text-fixed-white op-6">Support</BaseLink>
                                </li>
                            </ul>
                        </Col>
                        <Col sm={3} xl={2} className="col-6">
                            ...
                            <ul className="list-unstyled fw-normal landing-footer-list mb-0">
                                <li>
                                    <BaseLink href="#!" className="text-fixed-white op-6">Market Place</BaseLink>
                                </li>
                                <li>
                                    <BaseLink href="#!" className="text-fixed-white op-6">Social Integrations</BaseLink>
                                </li>
                            </ul>
                        </Col>
                        <Col sm={3} xl={2} className="col-6">
                            ...
                            <ul className="list-unstyled fw-normal landing-footer-list mb-0">
                                <li>
                                    <Link href={`${__APP_BASE_PATH__}/pages/blog/blog`} className="text-fixed-white op-6">Blog</Link>
                                </li>
                                <li>
                                    <BaseLink href="#!" className="text-fixed-white op-6">About Us</BaseLink>
                                </li>
                                <li>
                                    <BaseLink href="#!" className="text-fixed-white op-6">Customers</BaseLink>
                                </li>
                                <li>
                                    <BaseLink href="#!" className="text-fixed-white op-6">Jobs</BaseLink>
                                </li>
                            </ul>
                        </Col>
                    </Row>
                ...
                <div className="container">
                    ...
                    <Row>
                        <Col lg={4} className="text-lg-start text-center">
                            <span className="text-fixed-white op-7 fs-14"> © Copyright <span id="year"> 2025 </span> <BaseLink
                                href="#!" className="text-primary fs-15 fw-semibold">Spruko </BaseLink> .All rights reserved
                            </span>
                        </Col>
                        <Col lg={8} className="text-lg-end text-center mt-lg-0 mt-1">
                            <ul className="list-unstyled fw-normal landing-footer-list mb-0">
                                <li>
                                    <BaseLink href="#!" className="text-fixed-white op-8">Terms Of Service</BaseLink>
                                </li>
                                <li>
                                    <BaseLink href="#!" className="text-fixed-white op-8">Privacy Policy</BaseLink>
                                </li>
                                <li>
                                    <BaseLink href="#!" className="text-fixed-white op-8">Legal</BaseLink>
                                </li>
                                <li>
                                    <BaseLink href="#!" className="text-fixed-white op-8">Contact</BaseLink>
                                </li>
                                <li>
                                    <BaseLink href="#!" className="text-fixed-white op-8">Blog</BaseLink>
                                </li>
                                <li>
                                    <BaseLink href="#!" className="text-fixed-white op-8">Licenses</BaseLink>
                                </li>
                            </ul>
                        </Col>
                    </Row>
...
// Assign layout
Landing.layout = (page) => <Landinglayout>{page}</Landinglayout>;
