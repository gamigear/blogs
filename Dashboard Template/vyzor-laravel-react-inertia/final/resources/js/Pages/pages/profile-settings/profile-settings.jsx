                                    ...
                                    <div className="d-flex align-items-start flex-wrap gap-3">
                                        <div>
                                            <span className="avatar avatar-xxl">
                                                <BaseImage src="/build/assets/images/faces/9.jpg" alt="" />
                                            </span>
                                        </div>
                                        <div>
                    ...
                    <Card className="custom-card">
                        ...
                        <Card.Body>
                            <div className="d-sm-flex d-block align-items-top justify-content-between">
                                ...
                                <BaseLink href="#!" className="link-primary text-decoration-underline">Set Up Verification</BaseLink>
                            </div>
...
// Assign layout
ProfileSettings.layout = (page) => <MainLayout>{page}</MainLayout>;
