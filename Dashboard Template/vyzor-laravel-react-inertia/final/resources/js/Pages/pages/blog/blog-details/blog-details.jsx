...
import { Card, Col, Collapse, Dropdown, Form, Image, Row } from "react-bootstrap";
            ...
            <Row>
                <Col xxl={9}>
                    ...
                    <Card className="custom-card">
                        <BaseImage src="/build/assets/images/media/blog/27.jpg" className="card-img-top" alt="..." />
                        <Card.Body>
                            <div className="d-flex align-items-center justify-content-between mb-3 flex-wrap">
                                <div className="d-flex align-items-center gap-2">
                                    <div className="lh-1">
                                        <span className="avatar avatar-xs avatar-rounded">
                                            <BaseImage src="/build/assets/images/faces/13.jpg" alt="" />
                                        </span>
                                    </div>
                                    <div>
                                        John Doe
                                        ...
                                        <div className="mb-3 overflow-visible d-flex align-items-start flex-wrap">
                                            ...
                                            <div className="media-body overflow-visible flex-fill">
                                                <div className="mb-4">
                                                    <nav className="nav float-end">
                                                        <SpkDropdown Togglevariant="" toggleas="a" Icon={true} Customtoggleclass="text-muted fs-16 p-0 ps-4 no-caret" IconClass="fe fe-more-vertical" Menuclass="dropdown-menu-start">
                                                            <Dropdown.Item className="" ><i className="fe fe-edit me-1 d-inline-block"></i> Edit</Dropdown.Item>
                                                            <Dropdown.Item className="" ><i className="fe fe-flag me-1 d-inline-block"></i> Report Abuse</Dropdown.Item>
                                                            <Dropdown.Item className="" ><i className="fe fe-trash-2 me-1 d-inline-block"></i> Delete</Dropdown.Item>
                                                        </SpkDropdown>
                                                    </nav>
                                                    <h6 className="mt-0">JohnDoe23 <span className="text-muted fs-12 mx-1">1 day ago</span></h6>
                                                    ...
                                                    <span className="reply" id="1">
                                                        <BaseLink data-bs-toggle="collapse" onClick={() => toggleReply("1")} href="#collapseExample" role="button" aria-expanded="false" aria-controls="collapseExample"><span className="px-2 py-1 rounded bg-light text-muted fs-12 border d-inline-flex align-items-center">Reply<i className="ti ti-share-3 ms-1"></i></span></BaseLink>
                                                    </span>
                                                ...
                                                <div className="media mb-2 overflow-visible  d-flex flex-wrap">
                                                    <div className="me-3">
                                                        <span className="avatar avatar-rounded avatar-md">
                                                            <BaseImage src="/build/assets/images/faces/3.jpg" alt="img" />
                                                        </span>
                                                    </div>
                                                    <div className="media-body overflow-visible flex-fill">
                                                        <nav className="nav float-end">
                                                        ...
                                                        <h6 className="mt-0 d-flex align-items-center gap-2 flex-wrap">TechEnthusiast99<span className="badge text-muted bg-light border">Reply to JohnDoe23</span><span className="text-muted fs-12 mx-1">2 min ago</span></h6>
                                                        <span><i className="fe fe-thumb-up text-danger"></i></span>
                                                        ...
                                                        <span className="reply" id="2">
                                                            <BaseLink data-bs-toggle="collapse" onClick={() => toggleReply("2")} href="#collapseExample1" role="button" aria-expanded="false" aria-controls="collapseExample1"><span className="px-2 py-1 rounded bg-light text-muted fs-12 border d-inline-flex align-items-center">Reply<i className="ti ti-share-3 ms-1"></i></span></BaseLink>
                                                        </span>
                                        ...
                                        <div className="media mb-0 overflow-visible d-flex align-items-start flex-wrap">
                                            ...
                                            <div className="media-body overflow-visible flex-fill">
                                                <div>
                                                    ...
                                                    <h6 className="mt-0">FutureCoder<span className="text-muted fs-12 mx-1">27 Mar 2025 - 10:45AM</span></h6>
                                                    ...
                                                    <span className="reply" id="3">
                                                        <BaseLink data-bs-toggle="collapse" onClick={() => toggleReply("3")} href="#collapseExample2" role="button" aria-expanded="false" aria-controls="collapseExample2"><span className="px-2 py-1 rounded bg-light text-muted fs-12 border d-inline-flex align-items-center">Reply<i className="ti ti-share-3 ms-1"></i></span></BaseLink>
                                                    </span>
                                ...
                                <Card.Body className="p-5 text-center">
                                    <div className="lh-1 mb-2">
                                        <span className="avatar avatar-rounded blogger-details-avatar">
                                            <BaseImage src="/build/assets/images/faces/14.jpg" alt="" />
                                        </span>
                                    </div>
                        ...
                        <Col xl={12}>
                            <Card className="custom-card overflow-hidden">
                                <Card.Header className="justify-content-between">
                                    ...
                                    <BaseLink href="#!" className="fs-13 text-muted text-decoration-underline">View All<i className="ti ti-arrow-narrow-right"></i></BaseLink>
                                </Card.Header>
                                                ...
                                                <div className="d-flex align-items-center gap-3">
                                                    <div className="lh-1">
                                                        <span className="avatar avatar-xl">
                                                            <BaseImage src={post.image} alt={post.title} />
                                                        </span>
                                                    </div>
                            ...
                            <Card className="custom-card">
                                ...
                                <Card.Body>
                                    <div className="d-flex align-items-center gap-2 flex-wrap">
                                        {Tags.map((idx, index) => (
                                            <BaseLink key={index} href="#!" className="badge bg-primary-transparent">{idx.title}</BaseLink>
                                        ))}
                                    </div>
                                </Card.Body>
                            </Card>
...
// Assign layout
BlogDetails.layout = (page) => <MainLayout>{page}</MainLayout>;
