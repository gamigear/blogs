                            ...
                            <Col xl={12}>
                                <Card className="custom-card profile-card">
                                    <div className="profile-banner-image profile-img">
                                        <BaseImage src="/build/assets/images/media/media-3.jpg" className="card-img-top" alt="..." />
                                    </div>
                                                                    ...
                                                                    <li className="list-group-item">
                                                                        <div className="d-flex align-items-center gap-3 flex-wrap">
                                                                            ...
                                                                            <div>
                                                                                ...
                                                                                <BaseLink href="#!" className="text-muted">https://www.facebook.com/johndoe</BaseLink>
                                                                            </div>
                                                                        </div>
                                                                    </li>
                                                                    <li className="list-group-item">
                                                                        <div className="d-flex align-items-center gap-3 flex-wrap">
                                                                            ...
                                                                            <div>
                                                                                ...
                                                                                <BaseLink href="#!" className="text-muted">https://twitter.com/johndoe</BaseLink>
                                                                            </div>
                                                                        </div>
                                                                    </li>
                                                                    <li className="list-group-item">
                                                                        <div className="d-flex align-items-center gap-3 flex-wrap">
                                                                            ...
                                                                            <div>
                                                                                ...
                                                                                <BaseLink href="#!" className="text-muted">https://www.linkedin.com/in/johndoe</BaseLink>
                                                                            </div>
                                                                        </div>
                                                                    </li>
                                                                    <li className="list-group-item">
                                                                        <div className="d-flex align-items-center gap-3 flex-wrap">
                                                                            ...
                                                                            <div>
                                                                                ...
                                                                                <BaseLink href="#!" className="text-muted">https://www.instagram.com/johndoe</BaseLink>
                                                                            </div>
                                                                        </div>
                                                                    </li>
                                                                </ul>
                                            ...
                                            <Col xxl={8}>
                                                ...
                                                <Card className="custom-card">
                                                    <Card.Body>
                                                        ...
                                                        <div className="profile-img">
                                                            <BaseImage src="/build/assets/images/media/media-23.jpg" className="card-img" alt="..." />
                                                        </div>
                                                    </Card.Body>
                                                    <div className="card-footer">
                                                        <div className="d-flex align-items-center gap-2 flex-wrap">
                                                            <div className="avatar-list-stacked">
                                                                ...
                                                                <span className="avatar avatar-rounded">
                                                                    <BaseImage src="/build/assets/images/faces/10.jpg" alt="img" />
                                                                </span>
                                                            </div>
                                                            <div className="flex-fill">
                                                            ...
                                                            <div className="d-flex align-items-center gap-2 flex-wrap">
                                                                <BaseLink href="#!" className="p-1 px-2 bg-primary-transparent rounded"><i className="ri-message-3-line me-1"></i>Comment</BaseLink>
                                                                <BaseLink href="#!" className="p-1 px-2 bg-info-transparent rounded"><i className="ri-share-forward-line me-1"></i>Share</BaseLink>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div className="card-footer">
                                                                ...
                                                                <div className="d-flex align-items-start gap-3">
                                                                    <div className="lh-1">
                                                                        <span className="avatar avatar-md avatar-rounded">
                                                                            <BaseImage src="/build/assets/images/faces/4.jpg" alt="" />
                                                                        </span>
                                                                    </div>
                                                ...
                                                <Card className="custom-card">
                                                    <Card.Body>
                                                        ...
                                                        <div className="my-3">Success is not final, failure is not fatal: It is the courage to continue that counts. Keep pushing forward! <BaseLink href="#!">&#128170; #MotivationMonday</BaseLink></div>
                                                    </Card.Body>
                                                    <Card.Footer>
                                                        <div className="d-flex align-items-center gap-2 flex-wrap">
                                                            <div className="avatar-list-stacked">
                                                ...
                                                <Card className="custom-card">
                                                    <Card.Body>
                                                        ...
                                                        <div className="my-3">The serene beauty of the evening beach with the soft waves and the sky painted in shades of orange and pink is a perfect way to unwind after a long day. &#x1F305; &#127754; <BaseLink href="#!">#BeachVibes</BaseLink> <BaseLink href="#!">#EveningSunset</BaseLink> <BaseLink href="#!">#Relaxing</BaseLink></div>
                                                        <div className="profile-img">
                                                            <BaseImage src="/build/assets/images/media/media-10.jpg" className="card-img" alt="..." />
                                                        </div>
                                                    </Card.Body>
                                                    <Card.Footer>
                                                        <div className="d-flex align-items-center gap-2 flex-wrap">
                                                            <div className="avatar-list-stacked">
                                                                <span className="avatar avatar-rounded">
                                                                    <BaseImage src="/build/assets/images/faces/13.jpg" alt="img" />
                                                                </span>
                                                                <span className="avatar avatar-rounded">
                                                                    <BaseImage src="/build/assets/images/faces/3.jpg" alt="img" />
                                                                </span>
                                                                ...
                                                                <span className="avatar avatar-rounded">
                                                                    <BaseImage src="/build/assets/images/faces/14.jpg" alt="img" />
                                                                </span>
                                                                <span className="avatar avatar-rounded">
                                                                    <BaseImage src="/build/assets/images/faces/5.jpg" alt="img" />
                                                                </span>
                                                            </div>
                                                            <div className="flex-fill">
                                                        ...
                                                        <ul className="list-unstyled post-comments-list">
                                                            <li>
                                                                <div className="d-flex align-items-start gap-3">
                                                                    <div className="lh-1">
                                                                        <span className="avatar avatar-md avatar-rounded">
                                                                            <BaseImage src="/build/assets/images/faces/6.jpg" alt="" />
                                                                        </span>
                                                                    </div>
                                                                    <div className="flex-fill p-3 rounded bg-light">
                                                                        <div className="d-flex align-items-center justify-content-between flex-wrap">
