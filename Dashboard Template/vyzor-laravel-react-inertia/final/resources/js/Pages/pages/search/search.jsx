...
import { Books, News, VideoData } from "../../../shared/data/pages/searchdata";
import Pageheader from "../../../shared/layouts-components/pageheader/pageheader";
import { Head } from "@inertiajs/react";
import React, { Fragment } from "react";
import { Card, Col, Dropdown, Form, Image, Nav, Pagination, Row, Tab } from "react-bootstrap";
                    ...
                    <Col xl={7}>
                        <div className="input-group p-3">
                            ...
                            <div className="other-search-types">
                                <BaseLink href="#!"><i className="bx bx-microphone"></i></BaseLink>
                                <BaseLink href="#!"><i className="bx bx-image"></i></BaseLink>
                            </div>
                        </div>
                        <div className="d-flex align-items-center justify-content-between flex-wrap gap-3 px-3 pb-0 border-bottom">
                            <Nav className="nav-tabs tab-style-8 scaleX" role="tablist">
                                <Nav.Item className="" role="presentation">
                                    <Nav.Link eventKey={"all"} className="fw-medium text-muted"  aria-selected="true">All</Nav.Link>
                                </Nav.Item>
                                <Nav.Item className="" role="presentation">
                                    <Nav.Link eventKey={"images"} className="fw-medium text-muted"  aria-selected="false" tabIndex={-1}>Images</Nav.Link>
                                </Nav.Item>
                                <Nav.Item className="" role="presentation">
                                    <Nav.Link eventKey={"books"} className="fw-medium text-muted"  aria-selected="false" tabIndex={-1}>Books</Nav.Link>
                                </Nav.Item>
                                <Nav.Item className="" role="presentation">
                                    <Nav.Link eventKey={"news"} className="fw-medium text-muted"  aria-selected="false" tabIndex={-1}>News</Nav.Link>
                                </Nav.Item>
                                <Nav.Item className="" role="presentation">
                                    <Nav.Link eventKey={"videos"} className="fw-medium text-muted"  aria-selected="false" tabIndex={-1}>Videos</Nav.Link>
                                </Nav.Item>
                            </Nav>
                                ...
                                <Row>
                                    <Col xl={7}>
                                        <ul className="list-unstyled search-results-list">
                                            <li>
                                                <div className="d-flex align-items-start justify-content-between flex-wrap flex-sm-nowrap">
                                                    <div>
                                                        <div className="position-relative">
                                                            ...
                                                            <div className="d-flex align-items-center gap-2 mb-2 position-relative">
                                                                ...
                                                                <div>
                                                                    <span className="d-block fw-medium lh-1"><BaseLink href="#!">Developer.com</BaseLink></span>
                                                                    <span className="fs-12 text-muted"> www.developer.com/top-10-web-frameworks</span>
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <div className="mb-2">
                                                            <h6 className="fw-medium mb-1"><BaseLink href="#!" className="searched-item-main-link">Top 10 Web Development Frameworks to Use in 2025</BaseLink></h6>
                                                    ...
                                                    <SpkDropdown Id="dropdownMenuButton1" Icon={true} IconClass="ri-more-2-fill fs-5 text-muted" Customclass="ms-auto" Togglevariant="" Menulabel="dropdownMenuButton1" Toggletext="" Customtoggleclass="no-caret border-0 btn-icon">
                                                    ...
                                                    <div>
                                                        <div className="position-relative">
                                                            ...
                                                            <div className="d-flex align-items-center gap-2 mb-2 position-relative">
                                                                ...
                                                                <div>
                                                                    <span className="d-block fw-medium lh-1"><BaseLink href="#!">WebDevHub</BaseLink></span>
                                                                    <span className="fs-12 text-muted">www.webdevhub.com/react-best-framework</span>
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <div className="mb-2">
                                                            <h6 className="fw-medium mb-1"><BaseLink href="#!" className="searched-item-main-link">Why React is Still the Best Framework for Web Development in 2025</BaseLink></h6>
                                            ...
                                            <li>
                                                <div className="d-flex align-items-start justify-content-between flex-wrap flex-sm-nowrap">
                                                    <div>
                                                        <h6 className=""><BaseLink href="#!" className="fw-medium">Search Related Images :</BaseLink></h6>
                                                        <div className="d-flex align-items-start gap-3 flex-wrap">
                                                            <div>
                                                                <figure className="figure mb-0">
                                                                    <BaseLink className="avatar avatar-search" href="#!">
                                                                        <BaseImage className="img-fluid rounded card-img" src="/build/assets/images/media/media-59.jpg" alt="..." />
                                                                    </BaseLink>
                                                                    <BaseLink href="#!" className="d-block">
                                                                        Natural Serenity
                                                                    </BaseLink>
                                                                </figure>
                                                            </div>
                                                            <div>
                                                                <figure className="figure mb-0">
                                                                    <BaseLink className="avatar avatar-search" href="#!">
                                                                        <BaseImage className="img-fluid rounded card-img" src="/build/assets/images/media/media-60.jpg" alt="..." />
                                                                    </BaseLink>
                                                                    <BaseLink href="#!" className="d-block">
                                                                        Active Living
                                                                    </BaseLink>
                                                            ...
                                                            <div>
                                                                <figure className="figure mb-0">
                                                                    <BaseLink className="avatar avatar-search" href="#!">
                                                                        <BaseImage className="img-fluid rounded card-img" src="/build/assets/images/media/media-61.jpg" alt="..." />
                                                                    </BaseLink>
                                                                    <BaseLink href="#!" className="d-block">
                                                                        Creative Elegance
                                                                    </BaseLink>
                                                            ...
                                                            <div>
                                                                <figure className="figure mb-0">
                                                                    <BaseLink href="#!" className="avatar px-4 avatar-search fw-medium bg-primary-transparent">
                                                    ...
                                                    <div>
                                                        <div className="position-relative">
                                                            ...
                                                            <div className="d-flex align-items-center gap-2 mb-2 position-relative">
                                                                ...
                                                                <div>
                                                                    <span className="d-block fw-medium lh-1"><BaseLink href="#!">CodeAcademy</BaseLink></span>
                                                                    <span className="fs-12 text-muted">www.codeacademy.com/vuejs-2025</span>
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <div className="mb-2">
                                                            <h6 className="fw-medium mb-1"><BaseLink href="#!" className="searched-item-main-link">Vue.js: The Framework You Should Learn in 2025</BaseLink></h6>
                                                    ...
                                                    <div>
                                                        <div className="position-relative">
                                                            ...
                                                            <div className="d-flex align-items-center gap-2 mb-2 position-relative">
                                                                ...
                                                                <div>
                                                                    <span className="d-block fw-medium lh-1"><BaseLink href="#!">DeveloperFuture</BaseLink></span>
                                                                    <span className="fs-12 text-muted">www.developerfuture.com</span>
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <div className="mb-2">
                                                            <h6 className="fw-medium mb-1"><BaseLink href="#!" className="searched-item-main-link">What’s Next for 2025?</BaseLink></h6>
                                                    ...
                                                    <div>
                                                        <div className="position-relative">
                                                            ...
                                                            <div className="d-flex align-items-center gap-2 mb-2 position-relative">
                                                                ...
                                                                <div>
                                                                    <span className="d-block fw-medium lh-1"><BaseLink href="#!">DevStack</BaseLink></span>
                                                                    <span className="fs-12 text-muted">www.devstack.com/fullstack-frameworks-2025</span>
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <div className="mb-2">
                                                            <h6 className="fw-medium mb-1"><BaseLink href="#!" className="searched-item-main-link">Best Full-Stack Development Frameworks for 2025</BaseLink></h6>
                                                    ...
                                                    <div>
                                                        <div className="position-relative">
                                                            ...
                                                            <div className="d-flex align-items-center gap-2 mb-2 position-relative">
                                                                <div className="lh-1">
                                                                    <span className="avatar avatar-md avatar-rounded bg-light border">
                                                                        <BaseImage src="/build/assets/images/company-logos/3.png" alt="" />
                                                                    </span>
                                                                </div>
                                                                <div>
                                                                    <span className="d-block fw-medium lh-1"><BaseLink href="#!">WebDevDebate</BaseLink></span>
                                                                    <span className="fs-12 text-muted">www.webdevdebate.com</span>
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <div className="mb-2">
                                                            <h6 className="fw-medium mb-1"><BaseLink href="#!" className="searched-item-main-link">Which is Better for Web Development in 2025?</BaseLink></h6>
                                                ...
                                                <div className="row gy-3">
                                                    <Col xl={6}>
                                                        <div className="rounded-pill related-search-container">
                                                            <BaseLink href="#!">Top web development frameworks in 2025</BaseLink>
                                                        </div>
                                                    </Col>
                                                    <Col xl={6}>
                                                        <div className="rounded-pill related-search-container">
                                                            <BaseLink href="#!">Best JavaScript frameworks for developers</BaseLink>
                                                        </div>
                                                    </Col>
                                                    <Col xl={6}>
                                                        <div className="rounded-pill related-search-container">
                                                            <BaseLink href="#!">React vs Angular vs Vue comparison 2025</BaseLink>
                                                        </div>
                                                    </Col>
                                                    <Col xl={6}>
                                                        <div className="rounded-pill related-search-container">
                                                            <BaseLink href="#!">Future of web development frameworks</BaseLink>
                                                        </div>
                                                    </Col>
                                                    <Col xl={6}>
                                                        <div className="rounded-pill related-search-container">
                                                            <BaseLink href="#!">How to choose the right framework for your project</BaseLink>
                                                        </div>
                                                    </Col>
                                                    <Col xl={6}>
                                                        <div className="rounded-pill related-search-container">
                                                            <BaseLink href="#!">Svelte vs React performance comparison 2025</BaseLink>
                                                        </div>
                                                    </Col>
                                                </div>
                                            </li>
                                                ...
                                                <ul className="list-group list-group-flush">
                                                    {News.map((post, index) => (
                                                        <li className="list-group-item" key={index}>
                                                            <BaseLink href={post.href} className="stretched-link" />
                                                            <div className="mb-1">
                                    ...
                                    {VideoData.map((video, index) => (
                                        <Col xl={3} lg={6} md={6} sm={6} key={index} className="col-12">
                                            ...
                                            <div className="p-2">
                                                ...
                                                <Link href={video.linkUrl} target="_blank" rel="noreferrer" className="fs-12 link-primary text-decoration-underline">
                                                    {video.linkText}
                                                </Link>
                                            </div>
                                        </Col>
