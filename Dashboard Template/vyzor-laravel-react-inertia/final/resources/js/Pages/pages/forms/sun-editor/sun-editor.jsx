                            ...
                            <div id="editor1">
                                <SpkSunEditor defaulContent={defaultContent1} setoptions={{
                                    buttonList: [
                                        ...
                                        ["preview", "print"],
                                        ["removeFormat"]
                                    ], defaultTag: "div", minHeight: "300px", showPathLabel: false, font: ["Arial", "Comic Sans MS", "Courier New", "Impact"],
...
// Assign layout
QuillEditor.layout = (page) => <MainLayout>{page}</MainLayout>;
