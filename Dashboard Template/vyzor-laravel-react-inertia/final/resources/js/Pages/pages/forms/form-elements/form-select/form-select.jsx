...
const FormSelect = () => {
    ...
    const createOption1 = (email) => ({
        label: email,
        value: email,
    });

    const [inputValue2, setInputValue2] = useState("");
    const [value2, setValue2] = useState([createOption1("abc@hotmail.com")]);
            ...
            <Row>
                <Col xl={6}>
                    <ShowCode title="Multiple Attribute Select" customCardClass="custom-card" customCardBodyClass="" reactCode={formselect9}>
                        <select className="form-select custom-form-select1" multiple aria-label="multiple select example">
                            <option selected>Open this select menu</option>
                            <option value="1">One</option>
                            <option value="2">Two</option>
                            <option value="3">Three</option>
...
// Assign layout
FormSelect.layout = (page) => <MainLayout>{page}</MainLayout>;
