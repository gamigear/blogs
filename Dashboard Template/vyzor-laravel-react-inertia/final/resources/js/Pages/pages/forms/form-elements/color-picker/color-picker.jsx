...
const ColorPickers = () => {
    ...
    return (
        ...
        <Fragment>
            ...
            <Head title="Forms-Color Pickers" />
            ...
            <Row>
                <Col xl={12}>
                    <Card className="custom-card">
                        ...
                        <Card.Body className="d-flex justify-content-between flex-wrap custom-form-color">
...
// Assign layout
ColorPickers.layout = (page) => <MainLayout>{page}</MainLayout>;
