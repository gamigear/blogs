            ...
            <Row>
                ...
                <Col xl={6}>
                    <Card className="custom-card">
                        ...
                        <Card.Body>
                            <SpkMultiselect multi options={Selectoption2} mainClass="default basic-multi-select custom-multi custom-form-close" values={[Selectoption2[0]]} onChange={(valuesA) => setValuesA(valuesA)} />
                        </Card.Body>
                    </Card>
                </Col>
                <Col xl={6}>
                ...
                <Col xl={6}>
                    <Card className="custom-card">
                        ...
                        <Card.Body>
                            <SpkMultiselect multi options={Selectoption4} mainClass="default basic-multi-select custom-multi custom-form-close" onChange={(valuesB) => setValuesB(valuesB)} placeholder="Select a State" />
                        </Card.Body>
                    </Card>
                </Col>
                <Col xl={6}>
...
// Assign layout
Select2.layout = (page) => <MainLayout>{page}</MainLayout>;
