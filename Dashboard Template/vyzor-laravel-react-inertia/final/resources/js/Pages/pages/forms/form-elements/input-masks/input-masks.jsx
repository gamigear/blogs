            ...
            <Row>
                ...
                <Col xl={6}>
                    <Card className="custom-card">
                        ...
                        <Card.Body>
                            <NumericFormat className='form-control' allowLeadingZeros thousandsGroupStyle="lakh" thousandSeparator="," placeholder="Number Here" />
                        </Card.Body>
                    </Card>
                </Col>
                <Col xl={6}>
...
// Assign layout
InputMasks.layout = (page) => <MainLayout>{page}</MainLayout>;
