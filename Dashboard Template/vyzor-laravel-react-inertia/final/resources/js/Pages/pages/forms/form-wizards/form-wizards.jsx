...
import HorizontalNonLinearStepper from "../../../../shared/data/pages/forms/forwizardata";
...
const FormWizards = () => {
    ...
    const handleTabSelect1 = (selectedKey1) => {
        setKey1(selectedKey1);
    };
    const handleNext = () => {
        switch (key) {
            case 'first':
            ...
            <Row>
                <Col xl={6}>
                    <Card className="custom-card">
                        ...
                        <Card.Body>
                            <div id="basicwizard">
                                <Tab.Container id="left-tabs-example" defaultActiveKey="first" activeKey={key1} onSelect={handleTabSelect1}>
                                    <Nav className="nav nav-tabs nav-justified flex-md-row flex-column mb-4 tab-style-6 p-0">
                                        <Nav.Item data-target-form="#!">
                                            <Nav.Link eventKey="first1" className="icon-btn d-flex align-items-center justify-content-md-center gap-1" data-bs-toggle="tab" data-toggle="tab" href="#"><span>Contact Detail</span></Nav.Link>
                                        </Nav.Item>
                                        <Nav.Item data-target-form="#!">
                                            <Nav.Link eventKey="second1" className="icon-btn d-flex align-items-center justify-content-md-center gap-1" data-bs-toggle="tab" data-toggle="tab" href="#"><span>Job Detail</span></Nav.Link>
                                        </Nav.Item>
                                        <Nav.Item data-target-form="#!">
                                            <Nav.Link eventKey="third1" className="icon-btn d-flex align-items-center justify-content-md-center gap-1" data-bs-toggle="tab" data-toggle="tab" href="#"><span>Education Detail</span></Nav.Link>
                                        </Nav.Item>
                                        <Nav.Item>
                                            <Nav.Link eventKey="fourth1" className="icon-btn d-flex align-items-center justify-content-md-center gap-1" data-bs-toggle="tab" data-toggle="tab" href="#"><span>Finish</span></Nav.Link>
                                        </Nav.Item>
                                    </Nav>
                                    <Tab.Content>
                                                    ...
                                                    <div className="text-center p-4">
                                                        ...
                                                        <div className="mb-0">
                                                            <div className="form-check d-inline-block">
                                                                <input className="form-check-input" id="customCheck1" required type="checkbox" /> <label className="form-check-label" htmlFor="customCheck1" >I agree with the <Link className="fw-medium text-decoration-underline" href={`${__APP_BASE_PATH__}/pages/terms-conditions/`}>Terms and Conditions.</Link></label>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                        ...
                                        <div className="d-flex wizard justify-content-between mt-3 flex-wrap gap-2">
                                            <div className="first">
                                                <BaseLink href="#!" className="btn btn-light" onClick={() => setKey1('first1')}>
                                                    First
                                                </BaseLink>
                                            </div>
                                            <div className="d-flex flex-wrap gap-2">
                                                <div className="previous me-2">
                                                    <BaseLink href="#!" className={`btn icon-btn btn-primary ${key1 === 'first1' ? 'disabled' : ''}`} onClick={handlePrevious1}>
                                                        <i className="bx bx-left-arrow-alt me-2"></i>Back To Previous
                                                    </BaseLink>
                                                </div>
                                                <div className="next">
                                                    <BaseLink href="#!" className="btn icon-btn btn-secondary" onClick={handleNext1}>
                                                        Next Step<i className="bx bx-right-arrow-alt ms-2"></i>
                                                    </BaseLink>
                                                </div>
                                            </div>
                                            <div className="last">
                                                <BaseLink href="#!" className={`btn btn-success ${key1 === 'fourth1' ? 'disabled' : ''}`} onClick={() => setKey1('fourth1')}>
                                                    Finish
                                                </BaseLink>
                                            </div>
                                        </div>
                            ...
                            <div id="progresswizard">
                                <Tab.Container id="left-tabs-example" defaultActiveKey="first" activeKey={key} onSelect={handleTabSelect}>
                                    <Nav className="nav nav-tabs nav-justified flex-sm-row flex-column mb-4 tab-style-8 scaleX p-0">
                                        <Nav.Item data-target-form="#!">
                                            <Nav.Link eventKey="first" className="icon-btn d-flex align-items-center justify-content-sm-center gap-1" data-bs-toggle="tab" data-toggle="tab" href="#"><span>Contact Detail</span></Nav.Link>
                                        </Nav.Item>
                                        <Nav.Item data-target-form="#!">
                                            <Nav.Link eventKey="second" className="icon-btn d-flex align-items-center justify-content-sm-center gap-1" data-bs-toggle="tab" data-toggle="tab" href="#"><span>Job Detail</span></Nav.Link>
                                        </Nav.Item>
                                        <Nav.Item data-target-form="#!">
                                            <Nav.Link eventKey="third" className="icon-btn d-flex align-items-center justify-content-sm-center gap-1" data-bs-toggle="tab" data-toggle="tab" href="#"><span>Education Detail</span></Nav.Link>
                                        </Nav.Item>
                                        <Nav.Item>
                                            <Nav.Link eventKey="fourth" className="icon-btn d-flex align-items-center justify-content-sm-center gap-1" data-bs-toggle="tab" data-toggle="tab" href="#"><span>Finish</span></Nav.Link>
                                        </Nav.Item>
                                    </Nav>
                                    <Tab.Content className="">
                                            ...
                                            <div className="row d-flex justify-content-center">
                                                <div className="col-lg-10">
                                                    <div className="text-center p-4">
                                                        ...
                                                        <div className="mb-0">
                                                            <div className="form-check d-inline-block">
                                                                <input className="form-check-input" id="customCheck2" required type="checkbox" /> <label className="form-check-label" htmlFor="customCheck2">I agree with the <Link className="fw-medium text-decoration-underline" href={`${__APP_BASE_PATH__}/pages/terms-conditions/`}>Terms and Conditions.</Link></label>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                        ...
                                        <div className="d-flex wizard justify-content-between mt-3 flex-wrap gap-2">
                                            <div className="first">
                                                <BaseLink href="#!" className="btn btn-light" onClick={() => setKey('first')}>
                                                    First
                                                </BaseLink>
                                            </div>
                                            <div className="d-flex flex-wrap gap-2">
                                                <div className="previous me-2">
                                                    <BaseLink href="#!" className={`btn icon-btn btn-primary ${key === 'first' ? 'disabled' : ''}`} onClick={handlePrevious}>
                                                        <i className="bx bx-left-arrow-alt me-2"></i>Back To Previous
                                                    </BaseLink>
                                                </div>
                                                <div className="next">
                                                    <BaseLink href="#!" className="btn icon-btn btn-secondary" onClick={handleNext}>
                                                        Next Step<i className="bx bx-right-arrow-alt ms-2"></i>
                                                    </BaseLink>
                                                </div>
                                            </div>
                                            <div className="last">
                                                <BaseLink href="#!" className={`btn btn-success ${key === 'fourth' ? 'disabled' : ''}`} onClick={() => setKey('fourth')}>
                                                    Finish
                                                </BaseLink>
                                            </div>
                                        </div>
...
// Assign layout
FormWizards.layout = (page) => <MainLayout>{page}</MainLayout>;
