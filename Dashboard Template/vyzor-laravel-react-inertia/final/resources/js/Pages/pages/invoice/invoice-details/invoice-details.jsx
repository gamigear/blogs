                    ...
                    <Card className="custom-card invoice-card">
                        <Card.Body>
                            <div className="row gy-3">
                                <Col xl={12}>
                                    <BaseImage src="/build/assets/images/brand-logos/desktop-logo.png" alt="" className="img-fluid desktop-logo" />
                                    <BaseImage src="/build/assets/images/brand-logos/desktop-dark.png" alt="" className="img-fluid desktop-dark" />
                                </Col>
                                <Col xl={12}>
                                    <Row>
                                        <Col xl={4} lg={4} md={6} sm={6} className="">
                                            ...
                                            <p className="text-muted">For more information check for <BaseLink href="#!" className="text-primary fw-medium"><u>GSTIN</u></BaseLink> Details.</p>
                                        </Col>
...
// Assign layout
InvoiceDetails.layout = (page) => <MainLayout>{page}</MainLayout>;
