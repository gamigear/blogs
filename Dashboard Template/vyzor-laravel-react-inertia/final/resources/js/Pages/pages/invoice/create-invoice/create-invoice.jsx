                        ...
                        <Card.Body>
                            <div className="row gy-3">
                                ...
                                <Col xl={3} className="custom-picker">
                                    ...
                                    <SpkDatepickr className="form-control" dateFormat="yy/MM/dd" selected={dates["startDate"] ? new Date(dates["startDate"]) : null} onChange={(date) => handleDateChange("startDate", date)} placeholderText='Choose date' />
                                </Col>
                                <Col xl={3} className="custom-picker">
                                    <Form.Label htmlFor="invoice-date-due" className="">Due Date</Form.Label>
                                    <SpkDatepickr className="form-control" dateFormat="yy/MM/dd" selected={dates["dueDate"] ? new Date(dates["dueDate"]) : null} onChange={(date) => handleDateChange("dueDate", date)} placeholderText='Choose date' />
                                </Col>
                                <Col xl={3}>
                                ...
                                <Col xl={12}>
                                    <div className="table-responsive">
                                        <SpkTables tableClass="nowrap text-nowrap table-borderless border mt-3" header={[{ title: 'Product Name' }, { title: 'Description' }, { title: 'Quantity' }, { title: 'Price Per Unit' }, { title: 'Total' }, { title: 'Action' }]} >
                                            ...
                                            <tr>
                                                <td colSpan={6} className="border-bottom-0"><BaseLink className="btn btn-primary-light" href="#!"><i className="bi bi-plus-lg"></i> Add Product</BaseLink></td>
                                            </tr>
                                            <tr>
                                                <td colSpan={4}></td>
                                                <td colSpan={2}>
                                ...
                                <Col xl={4}>
                                    <div className="row gy-3">
                                        ...
                                        <Col xl={12}>
                                            ...
                                            <Form.Label htmlFor="invoice-payment-cardname" className="mb-0"><BaseLink className="text-danger fs-11" href="#!">Enter valid card number*</BaseLink></Form.Label>
                                        </Col>
                                        <Col xl={12}>
...
// Assign layout
CreateInvoice.layout = (page) => <MainLayout>{page}</MainLayout>;
