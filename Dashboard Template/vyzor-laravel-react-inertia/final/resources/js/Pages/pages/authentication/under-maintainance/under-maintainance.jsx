                                    ...
                                    <div className="text-center">
                                        <div className="mb-3">
                                            <Link href={`${__APP_BASE_PATH__}/dashboards/sales`}>
                                                <BaseImage src="/build/assets/images/brand-logos/desktop-logo.png" alt="" className="authentication-brand" />
                                                <BaseImage src="/build/assets/images/brand-logos/desktop-dark.png" alt="" className="authentication-brand dark" />
                                            </Link>
                                        </div>
...
// Assign layout
UnderMaintenance.layout = (page) => <AuthenticationLayout>{page}</AuthenticationLayout>;
