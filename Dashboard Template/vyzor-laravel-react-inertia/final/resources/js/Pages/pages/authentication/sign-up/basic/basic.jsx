                        ...
                        <Card className="custom-card border-0 my-4">
                            <Card.Body className="p-5">
                                ...
                                <div className="sign-up">
                                    ...
                                    <p className="mb-4 text-muted fw-normal text-nowrap">Join us by creating a free account !</p>
                                </div>
                                ...
                                <div className="text-center mt-3 fw-medium">
                                    Already have a account? <Link href={`${__APP_BASE_PATH__}/pages/authentication/sign-in/basic/`} className="text-primary">Sign In</Link>
                                </div>
                            </Card.Body>
                        </Card>
                    </Col>
