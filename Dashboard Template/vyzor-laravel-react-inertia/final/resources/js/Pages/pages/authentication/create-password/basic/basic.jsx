...
const Basic = () => {
    ...
    return (
        ...
        <Fragment>
            ...
            <Head title="Creatpassword-Basic" />
                                    ...
                                    <Row className="gy-3">
                                        <Col xl={12}>
                                            ...
                                            <div className="position-relative custom-auth">
                                                ...
                                                />
                                                <BaseLink href="#!" onClick={() => togglePasswordVisibility('password')} className="show-password-button text-muted"><i className={`align-middle lh-1 ${passwordVisibility.password ? 'ri-eye-line' : 'ri-eye-off-line'}`}></i></BaseLink>
                                            </div>
                                            {formErrors.password && (
                                        ...
                                        <Col xl={12} className="custom-auth">
                                            ...
                                            <div className="position-relative">
                                                <Form.Control
                                                    ...
                                                    onChange={handleChange}
                                                />
                                                <BaseLink onClick={() => togglePasswordVisibility('passwords')} href="#!" className="show-password-button text-muted"><i className={`${passwordVisibility.passwords ? 'ri-eye-line' : 'ri-eye-off-line'} align-middle lh-1`}></i></BaseLink>
                                            </div>
