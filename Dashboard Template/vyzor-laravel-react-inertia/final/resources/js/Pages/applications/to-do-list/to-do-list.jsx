        ...
        <Fragment>
                    ...
                    <Card className="custom-card">
                        <Card.Body className="p-0">
                            ...
                            <div className="p-3 text-center">
                                <BaseImage src={"/build/assets/images/media/media-66.png"} alt="" />
                            </div>
                        </Card.Body>
                    </Card>
                </Col>
                    ...
                    <Card className="custom-card">
                        <Card.Header className="justify-content-between">
                            ...
                            <div className="d-flex flex-wrap gap-2">
                                <SpkDropdown Id="dropdownMenuButton1" Togglevariant="" Menulabel="dropdownMenuButton1" Toggletext="Sort By" Customtoggleclass="btn btn-primary btn-wave waves-effect waves-light no-caret" Arrowicon={true}>
                                        ...
                                        >
                                            {data.map((task, index) => (
                                                <tr className="todo-box" key={index}>
                                                    ...
                                                    <td>
                                                        <BaseLink href="#!" className="fw-medium">{task.title}</BaseLink>
                                                    </td>
                                                    <td>
                                                        <div className="d-flex align-items-center gap-2">
                                                            <div className="lh-1">
                                                                <span className="avatar avatar-xs avatar-rounded">
                                                                    <BaseImage width={20} height={20} src={task.assignee.avatar} alt={task.assignee.name} />
                                                                </span>
                                                            </div>
            ...
            <Modal show={show} onHide={handleClose} centered className="fade" id="create-task" tabIndex={-1}>
                        ...
                        <Col xl={6}>
                            ...
                            <div className="form-group">
                                <div className="input-group custom-input-group flex-nowrap">
                                    ...
                                    <SpkDatepickr className="form-control" selected={dates["assigned"] ? new Date(dates["assigned"]) : null} onChange={(date) => handleDateChange("assigned", date)} Timeinput="Time:" dateFormat="yy/MM/dd h:mm aa" showTimeInput placeholderText='Choose date and time' />
                                </div>
                            </div>
                        </Col>
                        <Col xl={6}>
                            ...
                            <div className="form-group">
                                <div className="input-group custom-input-group flex-nowrap">
                                    <div className="input-group-text text-muted"> <i className="ri-calendar-line"></i> </div>
                                    <SpkDatepickr className="form-control" selected={dates["basicDate"] ? new Date(dates["basicDate"]) : null} onChange={(date) => handleDateChange("basicDate", date)} Timeinput="Time:" dateFormat="yy/MM/dd h:mm aa" showTimeInput placeholderText='Choose date and time' />
                                </div>
                            </div>
                        </Col>
                        <Col xl={6}>
                ...
                <Modal.Footer>
                    ...
                    <SpkButton Buttonvariant="primary" Buttontype="button">Create</SpkButton>
                </Modal.Footer>
            </Modal>
...
// Assign layout
ToDoList.layout = (page) => <MainLayout>{page}</MainLayout>;
