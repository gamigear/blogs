                ...
                <div className="kanban-tasks-type new">
                    <div className="pe-3 mb-3">
                        <div className="d-flex justify-content-between align-items-center">
                            ...
                            <div>
                                <BaseLink  href="#!" onClick={() => handleShow("taskmodal")} className="btn btn-sm bg-white text-default border btn-wave">
                                ...
                                <Col xl={6}>
                                    ...
                                    <div className="form-group">
                                        <div className="input-group">
                                            ...
                                            <SpkDatepickr className="form-control" Timeinput="Time:" dateFormat="yy/MM/dd h:mm aa" selected={dates["TargetDate"] ? new Date(dates["TargetDate"]) : null} onChange={(date) => handleDateChange("TargetDate", date)} placeholderText='Choose date and time' showTimeInput />
                                        </div>
                                    </div>
                                </Col>
                                <Col xl={6}>
...
// Assign layout
KanbanBoard.layout = (page) => <MainLayout>{page}</MainLayout>;
