...
import { Card, Col, Dropdown, Form, Image, ListGroup, Nav, Row, Tab } from "react-bootstrap";
...
const MailSettings = () => {
    ...
    return (
        <Fragment>
            ...
            <Head title="Email-Mail Settings" />
                                                ...
                                                <Row className="gy-2 d-sm-flex align-items-center justify-content-between">
                                                    ...
                                                    <Col xl={5}>
                                                        <div className="float-sm-end">
                                                            <BaseLink href="#!" className="btn btn-success-ghost btn-sm">Learn-more</BaseLink>
                                                        </div>
                                                    </Col>
                                                </Row>
                                            </ListGroup.Item>
...
// Assign layout
MailSettings.layout = (page) => <MainLayout>{page}</MainLayout>;
