...
const Gallery = () => {
    ...
    return (
        <Fragment>
            ...
            <Head title="Applications-Gallery" />
                        ...
                        <div className="card-body">
                            <div className="row gy-3">
                                ...
                                <div className="col-xl-3 col-md-4 col-sm-6">
                                    <a
                                        href={`${__APP_BASE_PATH__}/build/assets/images/media/media-25.jpg`}
                                ...
                                <div className="col-xl-3 col-md-4 col-sm-6">
                                    <a
                                        href={`${__APP_BASE_PATH__}/build/assets/images/media/media-26.jpg`}
                                        className="glightbox2"
                                ...
                                <div className="col-xl-3 col-md-4 col-sm-6">
                                    <a
                                        href={`${__APP_BASE_PATH__}/build/assets/images/media/media-27.jpg`}
                                        className="glightbox2"
                                ...
                                <div className="col-xl-3 col-md-4 col-sm-6">
                                    ...
                                    <a
                                        href={`${__APP_BASE_PATH__}/build/assets/images/media/media-28.jpg`}
                                        className="glightbox2"
                            ...
                            <div className="row gy-3">
                                <div className="col-xl-4 col-md-4 col-sm-6 custom-gallery">
                                    <a href="https://vimeo.com/115041822" className="glightbox3">
                                        <BaseImage src="/build/assets/images/media/media-34.jpg" alt="image" className="img-fluid rounded" />
                                    </a>
                                </div>
                                <div className="col-xl-4 col-md-4 col-sm-6 custom-gallery">
                                    <a href="https://www.youtube-nocookie.com/embed/Ga6RYejo6Hk" className="glightbox3">
                                        <BaseImage src="/build/assets/images/media/media-35.jpg" alt="image" className="img-fluid rounded" />
                                    </a>
                                </div>
                                <div className="col-xl-4 col-md-4 col-sm-6">
                                    <a href={`${__APP_BASE_PATH__}/build/assets/video/1.mp4`} className="glightbox3">
                                        <BaseImage src="/build/assets/images/media/media-36.jpg" alt="image" className="img-fluid rounded" />
                                    </a>
                                </div>
                            </div>
                    ...
                    <div className="card custom-card">
                        ...
                        <div className="card-body">
                            <div className="row gy-3">
                                ...
                                <div className="col-xl-4 col-md-4 col-sm-6">
                                    <a href={`${__APP_BASE_PATH__}/build/assets/video/1.mp4`} className="glightbox1">
...
// Assign layout
Gallery.layout = (page) => <MainLayout>{page}</MainLayout>;
