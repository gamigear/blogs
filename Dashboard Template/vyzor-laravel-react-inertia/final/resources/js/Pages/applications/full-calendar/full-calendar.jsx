...
const Fullcalendar = () => {
        ...
        calendarEvents: [
            {
                ...
                start: new Date("2025-08-04 00:00"),
                id: "1001",
            },
            {
                title: "Atlanta Monster",
            ...
            },
            {
                ...
                start: new Date("2025-08-05 00:00"),
                id: "1002",
            },
        ],
    ...
    return (
        <Fragment>
            ...
            <Head title="Applications-Full Calendar" />
            ...
            <Modal show={show} onHide={handleClose} className="fade" id="addEvent" tabIndex={-1} aria-labelledby="addEventLabel" aria-hidden="true">
                    ...
                    <Row className="gy-3">
                        ...
                        <Col md={6}>
                            <div className="form-group">
                                ...
                                <SpkDatepickr className="form-control" dateFormat="yy/MM/dd" selected={dates["FromDate"] ? new Date(dates["FromDate"]) : null} onChange={(date) => handleDateChange("FromDate", date)} placeholderText='From Date' />
                            </div>
                        </Col>
                        <Col md={6}>
                            <div className="form-group custom-calendar">
                                <Form.Label className="" htmlFor="toDate">To:</Form.Label><br></br>
                                <SpkDatepickr className="form-control" dateFormat="yy/MM/dd" selected={dates["ToDate"] ? new Date(dates["ToDate"]) : null} onChange={(date) => handleDateChange("ToDate", date)} placeholderText='To Date' />
                ...
                <Modal.Footer>
                    <SpkButton Buttonvariant="primary" Buttontype="button" onClickfunc={handleClose} Customclass="btn">Add Event</SpkButton>
                </Modal.Footer>
            </Modal>
...
// Assign layout
Fullcalendar.layout = (page) => <MainLayout>{page}</MainLayout>;
