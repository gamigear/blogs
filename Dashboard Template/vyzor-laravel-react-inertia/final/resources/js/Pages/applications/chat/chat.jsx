...
const Chat = () => {
    ...
    const mainChartWrapperRef = useRef(null);
    ...
    const [_inputValue, setInputValue] = useState(""); // state for input value
                        ...
                        <Tab.Content id="myTabContent">
                            <Tab.Pane eventKey={"users"} className="border-0 chat-users-tab" id="users-tab-pane"
                                ...
                                <SimpleBar className="list-unstyled mb-0 mt-2 chat-users-tab" id="chat-msg-scroll">
                                    ...
                                    {ChatUsers.map((user) => (
                                        <li key={user.id} className={`checkforactive ${activeUser.name === user.name ? 'active chat-msg-unread' : 'chat-inactive'}`} onClick={(e) => {
                                            e.preventDefault(); // only if wrapped in an <a> or similar
                                                ...
                                                <div className="d-flex align-items-top">
                                                    <div className="me-1 lh-1">
                                                        <span className={`avatar avatar-md ${user.status} me-2 avatar-rounded`}>
                                                            <BaseImage src={user.image} alt="img" />
                                                        </span>
                                                    </div>
                                        ...
                                        <li key={group.id} >
                                            <div className="d-flex align-items-center justify-content-between">
                                                ...
                                                <div className="avatar-list-stacked my-auto">
                                                    ...
                                                    <BaseLink className="avatar avatar-sm bg-primary avatar-rounded" href="#!">
                                                        +{group.extraCount}
                                                    </BaseLink>
                                                </div>
                                            </div>
                                                ...
                                                <div className="d-flex align-items-top">
                                                    <div className="me-1 lh-1">
                                                        <span className={`avatar avatar-md ${chat.status} me-2 avatar-rounded`}>
                                                            <BaseImage src={chat.image} alt="img" />
                                                        </span>
                                                    </div>
                                                    <div className="flex-fill" onClick={toggleChat}>
                                                        <p className="mb-0 fw-medium">
                ...
                <div className="main-chat-area border">
                    <div className="d-flex align-items-center border-bottom main-chat-head flex-wrap">
                        <div className="me-2 lh-1">
                            <span className={`avatar avatar-md  chatstatusperson avatar-rounded ${activeUser.status}`}>
                                <BaseImage className="chatimageperson" src={activeUser.image} alt="img" />
                            </span>
                        </div>
                        <div className="flex-fill">
                            <p className="mb-0 fw-medium fs-14 lh-1">
                                <Link
                                    ...
                                    onClick={(e) => {
                                        e.preventDefault(); // prevent Inertia from navigating
                                        handleShow();
                                    }}
                                >
                                    {activeUser.name}
                    ...
                    <SimpleBar className="chat-content" id="main-chat-content">
                        <div className="chat-content-background">
                            <BaseImage src="/build/assets/images/media/backgrounds/12.png" alt="" />
                        </div>
                            ...
                            <SimpleBar>
                                    ...
                                    <div className="chat-list-inner">
                                        <div className="chat-user-profile">
                                            <span className={`avatar avatar-md ${activeUser.status} avatar-rounded chatstatusperson`}>
                                                <BaseImage width={40} height={40} className="chatimageperson" src={activeUser.image} alt="img" />
                                            </span>
                                        </div>
                                        <div className="ms-3">
                                            <span className="chatting-user-info">
                                                <span className="chatnameperson">{activeUser.name}</span> <span className="msg-sent-time"> 10:00 PM</span>
                                            </span>
                                    ...
                                    <div className="chat-list-inner">
                                        ...
                                        <div className="chat-user-profile">
                                            <span className={`avatar avatar-md online avatar-rounded`}>
                                                <BaseImage className="chatimageperson" src="/build/assets/images/faces/15.jpg" alt="img" />
                                            </span>
                                        </div>
                                    </div>
                                </li>
                                ...
                                <li className="chat-item-start">
                                    <div className="chat-list-inner">
                                        ...
                                        <div className="ms-3">
                                            <span className="chatting-user-info">
                                                <span className="chatnameperson">{activeUser.name}</span> <span className="msg-sent-time"> 10:10 PM</span>
                                            </span>
                                            <div className="main-chat-msg">
                                                <div>
                    ...
                    <div className="chat-footer">
                        <BaseLink aria-label="anchor" className="btn btn-icon me-2 btn-light" href="#!">
                        ...
                        <BaseLink aria-label="anchor" className="btn btn-icon ms-2 btn-light emoji-picker" href="#!">
                        ...
                        <BaseLink aria-label="anchor" className="btn btn-primary ms-2 btn-icon btn-send" href="#!">
                    ...
                    <div className="chat-user-details" id="chat-user-details">
                        <div className="text-center mb-5">
                            <span className="avatar avatar-rounded online avatar-xxl me-2 mb-3 chatstatusperson">
                                <BaseImage width={80} height={80} className="chatimageperson" src="/build/assets/images/faces/2.jpg" alt="img" />
                            </span>
                        ...
                        <div className="mb-5">
                            <div className="fw-medium mb-4">Shared Files
                                <span className="float-end fs-11"><BaseLink href="#!" className="fs-13 text-muted"> View All<i className="ti ti-arrow-narrow-right ms-1"></i> </BaseLink></span>
                            </div>
                                        ...
                                        <div className="d-flex align-items-center">
                                            <div className="lh-1">
                                                <span className="avatar avatar-lg">
                                                    <BaseImage width={48} height={48} src={file.fileIcon} alt={file.fileName} />
                                                </span>
                                            </div>
                                            <div className="flex-fill">
...
// Assign layout
Chat.layout = (page) => <MainLayout>{page}</MainLayout>;
export default Chat;
