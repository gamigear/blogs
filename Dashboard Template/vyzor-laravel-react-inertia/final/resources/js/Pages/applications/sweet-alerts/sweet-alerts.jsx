...
const SweetAlerts = () => {
    ...
    function Imagealert() {
        Swal.fire({
            ...
            imageUrl: `${__APP_BASE_PATH__}/build/assets/images/media/media-59.jpg`,
            imageWidth: 400,
            imageHeight: 200,
    ...
    function Backgroundimage() {
        Swal.fire({
            ...
            padding: '3em',
            color: '#716add',
            background: `#fff url(${__APP_BASE_PATH__}/build/assets/images/media/media-19.jpg)`,
    ...
    return (
        <Fragment>
            ...
            <Head title="Applications-Sweet Alerts" />

            <Pageheader title="Applications" currentpage="Sweet Alerts" activepage="Sweet Alerts" />
...
// Assign layout
SweetAlerts.layout = (page) => <MainLayout>{page}</MainLayout>;
