...
const FileManager = () => {
    ...
    return (
        ...
        <Fragment>
            ...
            <Head title="Applications-File Manager" />
                                ...
                                <Card.Body>
                                    <div className="filemanager-upgrade-storage w-100 text-center">
                                        <span className="d-block mb-3 p-4 bg-light rounded file-manager-upgrade-img">
                                            <BaseImage src={"/build/assets/images/media/file-manager/2.png"} alt="" className="img-fluid" />
                                        </span>
                                                        ...
                                                        <tr key={index}>
                                                                    ...
                                                                    <div>
                                                                        <Link
                                                                            ...
                                                                            onClick={(e) => {
                                                                                ...
                                                                                handleShow('offcanvas'); // your custom logic
                                                                                // Bootstrap's data attributes can still work
                                                                            }}
                                                            ...
                                                            <td>
                                                                <div className="hstack gap-2 fs-15">
                                                                    <BaseLink href="#!" className="btn btn-icon btn-sm btn-light">
                        ...
                        <div className="d-flex p-3 align-items-center justify-content-between border-bottom">
                            ...
                            <div className="d-flex align-items-center">
                                <SpkDropdown Togglevariant="" Customclass="dropdown me-1 ms-auto" Customtoggleclass="btn btn-sm btn-icon btn-primary-light btn-wave waves-light waves-effect waves-light no-caret"
                                    ...
                                    <li><Dropdown.Item >Share</Dropdown.Item></li>
                                    <li><Dropdown.Item >Copy</Dropdown.Item></li>
                                    <li><Dropdown.Item >Move</Dropdown.Item></li>
                                    <li><Dropdown.Item >Delete</Dropdown.Item></li>
                                    <li><Dropdown.Item >Raname</Dropdown.Item></li>
                                </SpkDropdown>
                        ...
                        <div className="filemanager-file-details" id="filemanager-file-details">
                            <div className="p-3 text-center border-bottom border-block-end-dashed">
                                <div className="file-details mb-3">
                                    <BaseImage src="/build/assets/images/media/blog/9.jpg" alt="" />
                                </div>
                                <div>
                            ...
                            <div className="p-3">
                                ...
                                {PeopleList.map((person, index) => (
                                    <BaseLink key={index} href="#!">
                                        <div className="d-flex align-items-center p-2 mb-1">
                                            <span className="avatar avatar-sm me-2 avatar-rounded">
                                                <BaseImage src={person.avatar} alt={person.name} />
                                            </span>
...
// Assign layout
FileManager.layout = (page) => <MainLayout>{page}</MainLayout>;
