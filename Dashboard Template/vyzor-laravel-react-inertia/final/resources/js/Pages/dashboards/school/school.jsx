                                        ...
                                        <div className="d-flex align-items-start gap-2">
                                            <div className="lh-1">
                                                <span className="avatar avatar-md avatar-rounded">
                                                    {activity.avatar ? (
                                                        <BaseImage src={activity.avatar} alt={activity.name} />
                                                    ) : (
                            ...
                            <Row className="g-0">
                                <div className="col border-end border-inline-end-dashed">
                                    <div className="text-center">
                                        ...
                                        <h5 className="mb-0 mt-1 fw-semibold d-flex align-items-center justify-content-center gap-1">6,560
                                ...
                                <div className="col">
                                    <div className="text-center">
                                        ...
                                        <h5 className="mb-0 mt-1 fw-semibold d-flex align-items-center justify-content-center gap-1">3,354
                                        ...
                                        <div className="d-flex align-items-center gap-2">
                                            <div className="lh-1">
                                                <span className="avatar avatar-md">
                                                    <BaseImage width={40} height={40} src={student.avatar} alt={student.name} />
                                                </span>
                                            </div>
                                            <div className="flex-fill">
                                            ...
                                            <tr key={index}>
                                                ...
                                                <td>
                                                    <div className="d-flex align-items-center gap-2">
                                                        <div className="lh-1">
                                                            <span className="avatar avatar-md avatar-rounded">
                                                                <BaseImage src={payment.imageUrl} alt="img" />
                                                            </span>
                                                        </div>
                                                        <div>
                                                ...
                                                <div className="d-flex align-items-center gap-2">
                                                    <div className="lh-1">
                                                        <span className="avatar avatar-sm avatar-rounded">
                                                            <BaseImage src={payment.imageUrl} alt={payment.name} />
                                                        </span>
                                                    </div>
                ...
                <Col xxl={3}>
                    <Card className="custom-card">
                        <Card.Header className="justify-content-between">
                            ...
                            <BaseLink href="#!" className="btn btn-primary-light btn-sm">View All</BaseLink>
                        </Card.Header>
                        <Card.Body>
                            <div id="attendance-overview">
                                <Spkapexcharts height={366} type={"bar"} width={"100%"} chartOptions={SchoolAttendanceOptions} chartSeries={SchoolAttendanceSeries} />
                            </div>
                        </Card.Body>
                        <Card.Footer className="p-0">
                            <div className="row mt-0 g-0">
                                <div className="col-6 border-end border-inline-end-dashed text-center p-3">
                                    ...
                                    <h5 className="text-warning fw-semibold mb-0">12.34K</h5>
                                </div>
                                <div className="col-6 text-center p-3">
                                    <p className="mb-1 fw-medium">Girls</p>
                                    <h5 className="text-primary fw-semibold mb-0">10.19K</h5>
                                </div>
                            </div>
                        </Card.Footer>
                    </Card>
...
// Assign layout
School.layout = (page) => <MainLayout>{page}</MainLayout>;
