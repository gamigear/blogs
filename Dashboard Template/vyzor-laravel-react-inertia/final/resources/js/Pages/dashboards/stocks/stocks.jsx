                ...
                <Col xxl={9}>
                    <Card className="custom-card">
                        <Card.Header className="justify-content-between">
                            ...
                            <SpkButtongroup>
                                <BaseLink href="#!" className="btn btn-sm btn-primary-light">1H</BaseLink>
                                <BaseLink href="#!" className="btn btn-sm btn-primary-light">6H</BaseLink>
                                <BaseLink href="#!" className="btn btn-sm btn-primary-light">12H</BaseLink>
                                <BaseLink href="#!" className="btn btn-sm btn-primary">1D</BaseLink>
                            </SpkButtongroup>
                        </Card.Header>
                        <Card.Body>
                            <div className="d-flex align-items-center gap-3 p-3 rounded border border-dashed flex-wrap">
                                <div>
                                    <span className="avatar avatar-lg avatar-rounded">
                                        <BaseImage src="/build/assets/images/media/apps/apple.png" alt="" className="invert-1" />
                                    </span>
                                </div>
                ...
                <Col xxl={3}>
                    <Card className="custom-card">
                        <Card.Header className="justify-content-between">
                            ...
                            <BaseLink href="#!" className="text-muted fs-13">View All</BaseLink>
                        </Card.Header>
                        <Card.Body>
                                        ...
                                        <div className="d-flex align-items-center gap-3">
                                            <div className="lh-1">
                                                <span className="avatar avatar-md p-1">
                                                    <BaseImage src={stock.image} alt={stock.name} className={stock.imgcls} />
                                                </span>
                                            </div>
                                            <div className="flex-fill">
                ...
                <Col xxl={3}>
                    <Card className="custom-card overflow-hidden">
                        <Card.Header className="justify-content-between">
                            ...
                            <BaseLink href="#!" className="fs-12 text-muted py-1 tag-link"> View All<i
                                className="ti ti-arrow-narrow-right ms-1"></i> </BaseLink>
                        </Card.Header>
                        <Card.Body>
                                    ...
                                    <li key={stock.id}>
                                        <div className="d-flex gap-2 flex-wrap align-items-start justify-content-between mb-2">
                                            <div className="d-flex flex-fill align-items-center">
                                                <div className="me-2">
                                                    <span className="avatar avatar-md p-1">
                                                        <BaseImage width={40} height={40} src={stock.logo} alt={stock.name} className="invert-1" />
                                                    </span>
                                                </div>
                                                <div className="lh-1">
                    ...
                    <Card className="custom-card overflow-hidden">
                        <Card.Header className="justify-content-between">
                            ...
                            <div className="d-flex flex-wrap gap-2">
                                ...
                                <SpkDropdown Id="dropdownMenuButton1" Togglevariant="" Menulabel="dropdownMenuButton1" Toggletext="Sort By" Customtoggleclass="btn btn-sm btn-primary  btn-wave waves-effect waves-light no-caret" Arrowicon={true}>
                                                ...
                                                <div className="d-flex align-items-start gap-3">
                                                    <div className="lh-1">
                                                        <span className="avatar avatar-sm">
                                                            <BaseImage width={28} height={28} src={stock.logo} alt={stock.name} className={stock.imgcls} />
                                                        </span>
                                                    </div>
                                                    <div className="flex-fill lh-1">
                                                        <BaseLink href="#!" className="d-block mb-1 fs-14 fw-medium">
                                                            {stock.name}
                                                        </BaseLink>
                                            ...
                                            <td>
                                                <div className="btn-list">
                                                    <SpkTooltips placement="top" title="Edit">
                                                        <Link href="#!"  onClick={(e) => {e.preventDefault();  }} className="btn btn-icon btn-primary-light btn-sm">
                                                            <i className="bi bi-pencil-square"></i>
                                                        </Link>
                                                    </SpkTooltips>
                                                    <SpkTooltips placement="top" title="Delete">
                                                        <Link href="#!"  onClick={(e) => {e.preventDefault();  }} className="btn btn-icon btn-danger-light btn-sm">
...
// Assign layout
Stocks.layout = (page) => <MainLayout>{page}</MainLayout>;
