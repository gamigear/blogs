...
const CreateProject = () => {
    ...
    return (
        <Fragment>
            ...
            <Head title="Projects-Create Project" />
                        ...
                        <Card.Body>
                            <div className="row gy-3">
                                ...
                                <Col xl={6}>
                                    ...
                                    <div className="form-group">
                                        <div className="input-group">
                                            ...
                                            <SpkDatepickr className="form-control flatpickr-input" Timeinput="Time:" dateFormat="yy/MM/dd h:mm aa" placeholderText='Choose date with time' showTimeInput selected={dates["startDate"] ? new Date(dates["startDate"]) : null} onChange={(date) => handleDateChange("startDate", date)} />
                                        </div>
                                    </div>
                                </Col>
                                <Col xl={6}>
                                    ...
                                    <div className="form-group">
                                        <div className="input-group">
                                            <div className="input-group-text text-muted"> <i className="ri-calendar-line"></i> </div>
                                            <SpkDatepickr className="form-control flatpickr-input" Timeinput="Time:" dateFormat="yy/MM/dd h:mm aa" placeholderText='Choose date with time' showTimeInput selected={dates["endDate"] ? new Date(dates["endDate"]) : null} onChange={(date) => handleDateChange("endDate", date)} />
                                        </div>
                                    </div>
                                </Col>
                                <Col xl={6}>
                                ...
                                <Col xl={6}>
                                    ...
                                    <SpkSelect name="colors" option={PrioritySelect} mainClass="default basic-multi-select" id="choices-multiple-default" menuplacement='auto' classNameprefix="Select2" defaultvalue={[PrioritySelect[1]]} />
                                </Col>
                                <Col xl={6}>
...
// Assign layout
CreateProject.layout = (page) => <MainLayout>{page}</MainLayout>;
