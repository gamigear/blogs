...
const ProjectsOverview = () => {
    ...
    const [selectedTasks, setSelectedTasks] = useState(
        TodoItems.map((_, index) => index === 2 || index === 4)
    );
    ...
    return (
        ...
        <Fragment>
            ...
            <Head title="Projects-Projects Overview" />
                    ...
                    <Card className="custom-card">
                        <Card.Header className="justify-content-between">
                            ...
                            <div className="btn-list">
                                <Link href={`${__APP_BASE_PATH__}/dashboards/projects/create-project`} className="btn btn-sm btn-primary btn-wave"><i className="ri-add-line align-middle me-1 fw-medium"></i>Create Project</Link>
                                <BaseLink href="#!" className="btn btn-sm btn-secondary btn-wave"><i className="ri-share-line align-middle fw-medium me-1"></i>Share</BaseLink>
                            </div>
                        </Card.Header>
                        <Card.Body>
                            <div className="d-flex align-items-center mb-4 gap-2 flex-wrap">
                                ...
                                <div className="ms-auto align-self-start">
                                    <SpkDropdown toggleas="a" Customtoggleclass="btn btn-icon btn-sm btn-primary-light no-caret" Toggletext="" Icon={true} IconClass="fe fe-more-vertical">
                            ...
                            <div className="d-flex gap-5 mb-4 flex-wrap">
                                ...
                                <div className="d-flex align-items-center gap-2">
                                    <span className="avatar avatar-md avatar-rounded me-1"><BaseImage width={40} height={40} src="/build/assets/images/faces/11.jpg" alt="" /></span>
                                    <div>
                                ...
                                <div className="row gy-3">
                                    ...
                                    <Col xl={12}>
                                        <div className="d-flex align-items-center justify-content-between mb-2">
                                            ...
                                            <BaseLink href="#!" className="btn btn-primary-light btn-wave btn-sm">See More</BaseLink>
                                        </div>
                                        <ListGroup>
                                            {Tasks.map(task => (
                                        ...
                                        <div className="d-flex align-items-center flex-wrap gap-2">
                                            <div className="lh-1">
                                                <span className={`avatar avatar-md avatar-rounded ${file.avatarClass} bg-light lh-1`}>
                                                    <BaseImage src={file.img} alt={file.name} />
                                                </span>
                                            </div>
                                    ...
                                    <li key={msg.id}>
                                        <div>
                                            <span className="avatar avatar-sm avatar-rounded project-timeline-avatar">
                                                <BaseImage width={28} height={28} src={msg.avatar} alt={msg.name} />
                                            </span>
                                            ...
                                            {msg.attachment && (
                                                <p className="project-activity-media mb-0">
                                                    <BaseLink href="#!">
                                                        <BaseImage width={64} height={64} src={msg.attachment.img} alt="attachment" className="img-fluid bg-light" />
                                                    </BaseLink>
                        ...
                        <Card.Footer>
                            <div className="d-sm-flex align-items-center lh-1">
                                <div className="me-sm-2 mb-2 mb-sm-0 p-1 rounded-circle bg-primary-transparent d-inline-block">
                                    <BaseImage src="/build/assets/images/faces/5.jpg" alt="" className="avatar avatar-sm avatar-rounded" />
                                </div>
                                <div className="flex-fill">
                                                ...
                                                <tr className="todo-box" key={item.id}>
                                                    ...
                                                    <td className={`text-end ${index === TodoItems.length - 1 ? 'border-bottom-0' : ''}`}>
                                                        <div className="d-flex gap-2">
                                                            <BaseLink href="#!" className="btn btn-icon btn-sm btn-info-light btn-wave">
                                                                <i className="ri-edit-line"></i>
                                                            </BaseLink>
                                                            <BaseLink href="#!" className="btn btn-icon btn-sm btn-danger-light btn-wave">
                                                                <i className="ri-delete-bin-line"></i>
                                                            </BaseLink>
                                                        </div>
                                                    </td>
...
// Assign layout
ProjectsOverview.layout = (page) => <MainLayout>{page}</MainLayout>;
