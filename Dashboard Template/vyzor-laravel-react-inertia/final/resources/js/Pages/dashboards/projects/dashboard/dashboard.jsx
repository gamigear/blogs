                                        ...
                                        <tr key={index}>
                                            <td className={index === UrgentTasks.length - 1 ? "border-bottom-0" : ""}>
                                                <div className="d-flex align-items-center gap-2">
                                                    ...
                                                    <BaseLink href="#!" className="urgent-task-title">{task.title}</BaseLink>
                                                </div>
                                            </td>
                                            <td className={index === UrgentTasks.length - 1 ? "border-bottom-0" : ""}>
                                                {task.dueDate}
                                                ...
                                                <div className="avatar-list-stacked mb-0">
                                                    {task.avatars.map((imgSrc, i) => (
                                                        <span key={i} className="avatar avatar-xs avatar-rounded">
                                                            <BaseImage width={20} height={20} src={imgSrc} alt="img" />
                                                        </span>
                                                    ))}
                                                </div>
                                            </td>
                    ...
                    <Card className="custom-card custom-table-tasks">
                        <Card.Header className="justify-content-between">
                            ...
                            <div className="d-flex flex-wrap gap-2">
                                ...
                                <SpkDropdown Id="dropdownMenuButton1" Togglevariant="" Menulabel="dropdownMenuButton1" Toggletext="Sort By" Customtoggleclass="btn-primary btn-sm btn-wave waves-effect waves-light py-1">
                                            ...
                                            <td>
                                                <div className="avatar-list-stacked">
                                                    {project.avatars.map((avatar, i) => (
                                                        <span key={i} className="avatar avatar-xs avatar-rounded">
                                                            <BaseImage className="" src={`${avatar}`} alt="avatar" />
                                                        </span>
                                                    ))}
                                                    {project.moreAvatars && (
                                                        <BaseLink className="avatar avatar-xs bg-primary avatar-rounded text-fixed-white" href="#!">
                                                            +{project.moreAvatars}
                                                        </BaseLink>
                                                    )}
                                                </div>
...
// Assign layout
Projects.layout = (page) => <MainLayout>{page}</MainLayout>;
