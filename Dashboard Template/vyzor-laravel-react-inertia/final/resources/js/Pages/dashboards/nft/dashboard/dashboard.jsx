                            ...
                            <Card className="custom-card nft-main-banner-card border-0">
                                <Card.Body>
                                    <div className="nft-main-bannr-background grid-cards">
                                        <BaseImage src="/build/assets/images/nft-images/1.png" alt="" className="d-md-block d-none" />
                                    </div>
                                                ...
                                                <div className="d-flex align-items-center gap-2 flex-wrap">
                                                    <div className="lh-1">
                                                        <span className="avatar avatar-md avatar-rounded">
                                                            <BaseImage src={follower.image} alt={follower.name} />
                                                        </span>
                                                    </div>
                                                ...
                                                <div className="d-flex align-items-center gap-1">
                                                    <div className="lh-1">
                                                        <span className="avatar avatar-xs">
                                                            <BaseImage width={20} height={20} src={item.avatar} alt="ETH" />
                                                        </span>
                                                    </div>
...
// Assign layout
Nft.layout = (page) => <MainLayout>{page}</MainLayout>;
export default Nft;
