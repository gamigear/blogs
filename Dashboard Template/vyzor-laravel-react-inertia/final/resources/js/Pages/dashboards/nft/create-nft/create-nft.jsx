                ...
                <Col xxl={9} className="">
                    <Card className="custom-card">
                                ...
                                <Col xl={12}>
                                    <div className="row gy-3">
                                        ...
                                        <Col xl={4}>
                                            ...
                                            <SpkSelect option={SelectType} classNameprefix='Select2' menuplacement='auto' mainClass="multi-select custom-nft"
                        ...
                        <div className="card-footer text-end">
                            <BaseLink href="#!" className="btn btn-primary btn-wave waves-effect waves-light">Create NFT</BaseLink>
                        </div>
                    </Card>
                </Col>
                <Col xxl={3} className="">
                    <Card className="custom-card">
                        ...
                        <Card.Body className="pb-0">
                            {CreatNft.map((nft, index) => (
                                <SpkNftCard key={nft.id || index} nft={nft} />
                            ))}
                        </Card.Body>
                    </Card>
                </Col>
...
// Assign layout
CreateNft.layout = (page) => <MainLayout>{page}</MainLayout>;
