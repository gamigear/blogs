...
const AddProduct = () => {
    ...
    return (
        <Fragment>
            ...
            <Head title="Dashboards-Add Products" />
                ...
                <Col xl={3}>
                        ...
                        <Card.Body>
                            <Row className="gy-2">
                                <Col xl={12} className="custom-picker">
                                    ...
                                    <SpkDatepickr className="form-control flatpickr-input" selected={dates["startDate"] ? new Date(dates["startDate"]) : null} onChange={(date) => handleDateChange("startDate", date)} placeholderText='Choose Date' />
                                </Col>
                                <Col xl={12} className="custom-picker">
                                    <Form.Label htmlFor="publish-time" className="">Publish Time</Form.Label>
                                    <SpkDatepickr className="form-control " selected={dates["limitPicker"] ? new Date(dates["limitPicker"]) : null} onChange={(date) => handleDateChange("limitPicker", date)} showTimeSelect showTimeSelectOnly timeIntervals={15} Caption="Time" dateFormat="h:mm aa" placeholderText='Choose Time' />
                                </Col>
                                <Col xl={12}>
                                ...
                                <Col xl={12}>
                                    ...
                                    <SpkSelect multi name="colors" option={Productselect}  mainClass="basic-multi-select" searchable menuplacement='auto' classNameprefix="Select2" placeholder="Select" />
                                </Col>
                                <Col xl={12}>
                    ...
                    <Card className="custom-card">
                        ...
                        <Card.Body>
                            ...
                            <Form.Label className="form-label text-muted mt-1 fs-13 fw-normal mb-0">Upload warranty document (PDF/DOC, max 5MB).</Form.Label>
                        </Card.Body>
                    </Card>
                </Col>
                <Col xl={9}>
...
AddProduct.layout = (page) => <MainLayout>{page}</MainLayout>;
