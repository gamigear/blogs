...
const Dashboard = () => {
    ...
    return (
        ...
        <Fragment>
            ...
            <Head title="Dashboards-Dashboard" />
                                    ...
                                    <Row className="sales-stats mb-3">
                                        <Col xl={4} lg={4} md={4} sm={4} className="">
                                            ...
                                            <div className="d-flex align-items-center gap-1">
                                                ...
                                                <span className="text-success"><i className="ti ti-arrow-narrow-up align-middle me-1"></i>
                                        ...
                                        <Col xl={4} lg={4} md={4} sm={4} className="">
                                            ...
                                            <div className="mb-0">
                                                ...
                                                <span className="text-success d-inline-flex"><i className="ti ti-arrow-narrow-up align-middle me-1"></i>
                                                    <SpkBadge variant="" Customclass="bg-success-transparent"> 0.5%</SpkBadge></span>
                                            </div>
                                        </Col>
                                    </Row>
                                    <div id="sale-stats">
                            ...
                            <Card className="custom-card overflow-hidden">
                                ...
                                <Card.Body className="p-0">
                                    <div className="table-responsive">
                                        <SpkTables tableClass="text-nowrap" header={[{ title: 's.no' }, { title: 'Product Category' }, { title: 'Sale Value', headerClassname: 'text-center' }, { title: 'Total Sales', headerClassname: 'text-center' }, { title: 'Status', headerClassname: '' }]}>
                                                ...
                                                <div className="d-flex align-items-center gap-3">
                                                    <div className="lh-1">
                                                        <span className="avatar avatar-md">
                                                            <BaseImage src={item.image} alt={item.name} />
                                                        </span>
                                                    </div>
                                                ...
                                                <div className="d-flex justify-content-between align-items-center">
                                                    <div className="d-flex align-items-center lh-1 gap-2">
                                                        <span className="avatar avatar-xs avatar-rounded">
                                                            <BaseImage src={country.flag} alt={country.name} />
                                                        </span>
                            ...
                            <Card className="custom-card atm-card border-0 overflow-hidden">
                                <Card.Body>
                                    <div className="atm-card-background-container grid-cards">
                                        <BaseImage src="/build/assets/images/ecommerce/png/21.png" alt="" />
                                    </div>
                                    <div className="d-flex align-items-center gap-2">
                                        <div>
                            ...
                            <Card className="custom-card overflow-hidden">
                                <Card.Header className="justify-content-between">
                                    <div className="card-title">
                                        ...
                                        <BaseLink href="#!" className="d-block fs-12 text-muted fw-normal text-decoration-underline">View report <i className="ti ti-arrow-narrow-right d-inline-block rtl-rotate"></i></BaseLink>
                                    </div>
                                    <div className="text-end">
                                                ...
                                                <div className="d-flex align-items-center gap-2 mb-1">
                                                    ...
                                                    <div>
                                                        <span className="avatar avatar-xs">
                                                            <BaseImage src={item.emojiSrc} alt="" />
                                                        </span>
                                                    </div>
                                                </div>
                        ...
                        <Col xl={12}>
                            <Card className="custom-card overflow-hidden">
                                <Card.Header className="justify-content-between">
                                    ...
                                    <BaseLink href="#!" className="text-muted text-decoration-underline fs-12">View All <i className="ti ti-arrow-narrow-right"></i></BaseLink>
                                </Card.Header>
                                <Card.Body>
                                                ...
                                                <div className="d-flex align-items-center gap-2">
                                                    <div className="lh-1">
                                                        <span className="avatar avatar-md avatar-rounded">
                                                            <BaseImage src={txn.image} alt={txn.name} />
                                                        </span>
                                                    </div>
                                                    <div className="flex-fill">
                            ...
                            <div className="table-responsive">
                                <SpkTables tableClass="text-nowrap" header={[{ title: 'Order ID' }, { title: 'Customer' }, { title: 'Product' }, { title: 'Quantity', headerClassname: 'text-center' }, { title: 'Total Amount' }, { title: 'Payment Method' }, { title: 'Date' }, { title: 'Status' }, { title: 'Action' }]}>
                                    {Orders.map((order, index) => (
                                        <tr key={index}>
                                            <td><BaseLink href="#!">{order.id}</BaseLink></td>
                                            <td><BaseLink href="#!">{order.customer}</BaseLink></td>
                                            <td>
                                                <div className="d-flex align-items-center gap-2">
                                                    <div className="lh-1">
                                                        <span className="avatar avatar-sm avatar-rounded">
                                                            <BaseImage src={order.productImage} alt={order.productName} />
                                                        </span>
                                                    </div>
