...
import { Card, Col, Container, Form, Image, ListGroup, Modal, Nav, Row, Tab } from "react-bootstrap";
...
const Checkout = () => {
    ...
    return (
        <Fragment>
            ...
            <Head title="Dashboards-Checkout" />
                        ...
                        <Card className="custom-card !border-0">
                            <Card.Body>
                                ...
                                <div className="mt-5 mb-3 d-flex align-items-center justify-content-between flex-wrap">
                                    ...
                                    <BaseLink href="#select-address" onClick={handleShow} className="link-primary" data-bs-toggle="modal">Select From Address Book</BaseLink>
                                </div>
                                <Row className="mb-4">
                                    <Col md={6}>
                                ...
                                <div className="mt-5">
                                    ...
                                    <Tab.Container defaultActiveKey={"paypal"}>
                                        <Nav className="nav-tabs custom-nav-tabs-2 gap-3" id="myTab" role="tablist">
                                            <Nav.Item role="presentation" className="me-0" >
                                            ...
                                            <Nav.Item role="presentation" className="me-0" >
                                                <Nav.Link eventKey={"credit"} role="tab" className="me-0">
                                                    <div className="d-flex align-items-center">
                                                        <span className="min-w-fit-content me-3">
                                            ...
                                            <Nav.Item role="presentation" className="me-0" >
                                                <Nav.Link eventKey={"upi"} role="tab" className="me-0">
                                                    <div className="d-flex align-items-center">
                                                        <span className="min-w-fit-content me-3">
                                        ...
                                        <Tab.Content>
                                            <Tab.Pane eventKey={"paypal"} className="tab-pane p-0 border-0" id="paypal-tab" role="tabpanel">
                                                <p className="mb-3 mt-4 text-muted">Order will be placed once the payment is done. Please read all the terms &amp; conditions about <BaseLink href="#!" className="text-primary text-decoration-underline">refund policy</BaseLink>.</p>
                                                <BaseLink href="#!" className="btn btn-primary">Proceed to pay <i className="ti ti-arrow-right fs-18 ms-2 align-middle d-inline-block rtl-transform-icon"></i></BaseLink>
                                            </Tab.Pane>
                                            ...
                                            <Tab.Pane eventKey={"cash"} className="tab-pane p-0 border-0" id="cod-tab" role="tabpanel">
                                                <p className="mb-3 mt-4 text-muted">Proceed to place order. If you have any doubts regarding returning/exchanging products, checkout <BaseLink href="#!" className="text-primary text-decoration-underline">Return & Exchange policy</BaseLink></p>
                                                <BaseLink href="#!" className="btn btn-primary">Proceed to checkout <i className="ti ti-arrow-right align-middle fs-18 ms-2 d-inline-block rtl-transform-icon"></i></BaseLink>
                                            </Tab.Pane>
                                        </Tab.Content>
                                    </Tab.Container>
                                </div>
                                            ...
                                            <div className="d-flex align-items-center gap-3">
                                                <div className="lh-1">
                                                    <span className="avatar avatar-xxl">
                                                        <BaseImage src={product.imageUrl} alt={product.name} />
                                                    </span>
                                                </div>
            ...
            <Modal show={show} size="lg" onHide={handleClose} className="fade modal-style-1 modal-3" centered id="select-address" aria-hidden="true">
                <Modal.Body>
                    ...
                    <div className="d-flex align-items-center gap-2 justify-content-end">
                        <BaseLink href="#!" onClick={handleClose} className="btn btn-light" data-bs-dismiss="modal">Cancel</BaseLink>
                        <BaseLink href="#!" className="btn btn-primary">Select address</BaseLink>
                    </div>
                </Modal.Body>
            </Modal>
...
Checkout.layout = (page) => <MainLayout>{page}</MainLayout>;
