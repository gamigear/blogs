...
import OrdersTable, { DeliveryStatus, OrdersCard, PaymenntStatus } from "../../../../shared/data/dashboards/ecommerce/ordersdata";
...
Orders.layout = (page) => <MainLayout>{page}</MainLayout>;
