                                        ...
                                        <tr key={product.id}>
                                            ...
                                            <td>
                                                <div className="d-inline-flex rounded align-items-center flex-nowrap order-qnt gap-2 p-1 bg-light">
                                                    <BaseLink onClick={dec} href="#!" className="badge bg-white p-2 border text-muted fs-13 product-quantity-minus">
                                                    ...
                                                    <BaseLink onClick={inc} href="#!" className="badge bg-white p-2 border text-muted fs-13 product-quantity-plus">
                                            ...
                                            <td>
                                                <div className="d-flex align-items-center gap-2 lh-1">
                                                    <div><BaseLink href="#!" className="text-muted d-inline-flex align-items-center justify-content-center"><i className="ti ti-trash me-1"></i>Delete</BaseLink></div>
                                                    <div className="vr"></div>
                                                    <div><BaseLink href="#!" className="text-muted d-inline-flex align-items-center justify-content-center"><i className="ti ti-heart me-1"></i>Save For Later</BaseLink></div>
                                                </div>
                                            </td>
                                        </tr>
                                    ))}
                ...
                <Col xl={3}>
                    <Card className="custom-card">
                        ...
                        <Card.Footer className="d-grid">
                            <Link href={`${__APP_BASE_PATH__}/dashboards/ecommerce/checkout`} className="btn btn-primary d-inline-flex align-items-center justify-content-center">Proceed to checkout<i className="ti ti-arrow-narrow-right ms-1"></i></Link>
                        </Card.Footer>
                    </Card>
                </Col>
            </Row>
...
Cart.layout = (page) => <MainLayout>{page}</MainLayout>;
export default Cart;
