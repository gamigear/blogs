...
const ProductDetails = () => {
    ...
    return (
        ...
        <Fragment>
            ...
            <Head title="Dashboards-Product Details" />
                                ...
                                <Row className="g-5">
                                    ...
                                    <Col xl={6}>
                                        <div>
                                            ...
                                            <div className="mb-4">
                                                ...
                                                <div className="mb-0 d-flex flex-wrap gap-1">
                                                    <BaseLink className="color-1 product-colors selected" href="#!">
                                                        <i className="ri-checkbox-blank-circle-fill"></i>
                                                    </BaseLink>
                                                    <BaseLink className="color-2 product-colors" href="#!">
                                                        <i className="ri-checkbox-blank-circle-fill"></i>
                                                    </BaseLink>
                                                    <BaseLink className="color-3 product-colors" href="#!">
                                                        <i className="ri-checkbox-blank-circle-fill"></i>
                                                    </BaseLink>
                                                    <BaseLink className="color-4 product-colors" href="#!">
                                                        <i className="ri-checkbox-blank-circle-fill"></i>
                                                    </BaseLink>
                                                    <BaseLink className="color-5 product-colors" href="#!">
                                                        <i className="ri-checkbox-blank-circle-fill"></i>
                                                    </BaseLink>
                                                </div>
                                            </div>
                                            <div className="mb-4">
                                                ...
                                                <div className="mb-0 d-flex flex-wrap gap-1">
                                                    <BaseLink className="product-sizes selected" href="#!">
                                                        6
                                                    </BaseLink>
                                                    <BaseLink className="product-sizes" href="#!">
                                                        7
                                                    </BaseLink>
                                                    <BaseLink className="product-sizes" href="#!">
                                                        8
                                            ...
                                            <div>
                                                ...
                                                <div className="d-inline-flex rounded align-items-center flex-nowrap order-qnt gap-2 p-1 bg-light">
                                                    <BaseLink href="#!" onClick={dec} className="badge bg-white p-2 border text-muted fs-13 product-quantity-minus">
                                                    ...
                                                    <BaseLink href="#!" onClick={inc} className="badge bg-white p-2 border text-muted fs-13 product-quantity-plus">
                                        ...
                                        <div className="d-flex align-items-center justify-content-center gap-2 mt-5 flex-wrap">
                                            <Link href={`${__APP_BASE_PATH__}/dashboards/ecommerce/cart`} className="btn btn-primary btn-lg btn-w-lg  border"><i className="ti ti-shopping-cart me-1 ms-1"></i>Add To Cart</Link>
                                            <Link href={`${__APP_BASE_PATH__}/dashboards/ecommerce/checkout`} className="btn btn-primary btn-lg btn-w-lg border">Buy Now</Link>
                                        </div>
                                    </Col>
                                                            ...
                                                            <div className="d-flex flex-fill align-items-start gap-3">
                                                                <div>
                                                                    <span className="avatar avatar-md avatar-rounded">
                                                                        <BaseImage src="/build/assets/images/faces/15.jpg" alt="" />
                                                                    </span>
                                                                </div>
                                                            ...
                                                            <Row>
                                                                <Col xl={6}>
                                                                    <div className="products-review-images">
                                                                        <BaseLink href="#!">
                                                                            <BaseImage src="/build/assets/images/ecommerce/jpg/1.jpg" alt="" />
                                                                        </BaseLink>
                                                                        <BaseLink href="#!">
                                                                            <BaseImage src="/build/assets/images/ecommerce/jpg/2.jpg" alt="" />
                                                                        </BaseLink>
                                                                    </div>
                                                                </Col>
...
ProductDetails.layout = (page) => <MainLayout>{page}</MainLayout>;
