...
const OrderDetails = () => {
    ...
    return (
        ...
        <Fragment>
            ...
            <Head title="Dashboards-Order Details" />
                        ...
                        <Col xl={5}>
                            <Card className="custom-card">
                                <Card.Header className="justify-content-between">
                                    ...
                                    <BaseLink href="#!" className="btn btn-primary-light btn-sm  d-inline-flex align-items-center justify-content-center"><i className="ti ti-edit me-1"></i>Edit</BaseLink>
                                </Card.Header>
                                <Card.Body>
...
OrderDetails.layout = (page) => <MainLayout>{page}</MainLayout>;
