...
const Analytics = () => {
    return (
        ...
        <Fragment>
            ...
            {/* <!-- Page Header --> */}
            <Head title="Dashboards-Analytics" />
                            ...
                            <Card className="custom-card overflow-hidden">
                                ...
                                <Card.Body className="p-0">
                                    <div className="table-responsive">
                                        <SpkTables tableClass="text-wrap " header={[{ title: 'S.No' }, { title: 'Country' }, { title: 'Visitors' }]}>
                                                ...
                                                <tr key={index}>
                                                        ...
                                                        <div className="d-flex align-items-center gap-2">
                                                            <div className="lh-1">
                                                                <span className="avatar avatar-xs">
                                                                    <BaseImage src={data.flagUrl} alt={data.country} />
                                                                </span>
                                                            </div>
                                                    ...
                                                    <td className="border-bottom-0 text-end">
                                                        <span className="fs-12 text-muted me-2">
                                                            (
                                                                <i
  className={`align-middle fs-16 ti ${
    data.changeType === 'up' ? 'ti-arrow-up text-success' :
    data.changeType === 'down' ? 'ti-arrow-down text-danger' : ''
  }`}
></i>
                                                    ...
                                                    <td>
                                                        <div className="d-flex align-items-center lh-1">
                                                            <span className="avatar avatar-sm p-1 bg-light me-2">
                                                                <BaseImage src={data.avatarUrl} alt={data.name} />
                                                            </span>
                                                            <div>
                                                    ...
                                                    <td className="text-end">
                                                        <div className="btn-list">
                                                            <SpkTooltips placement="top" title="Edit">
                                                                <Link onClick={(e) => e.preventDefault()} href="#!" className="btn btn-light btn-icon btn-sm">
                                                                    <i className="bi bi-pencil-square"></i>
                                                                </Link>
                                                            </SpkTooltips>
                                                            <SpkTooltips placement="top" title="Delete">
                                                                <Link onClick={(e) => e.preventDefault()} href="#!" className="btn btn-light btn-icon btn-sm me-0">
                                                        ...
                                                        <div className="d-flex align-items-center gap-2">
                                                            <div className="lh-1">
                                                                <span className="avatar avatar-sm avatar-rounded">
                                                                    <BaseImage src={user.avatarUrl} alt={user.name} />
                                                                </span>
                                                            </div>
                                                            <div>{user.name}</div>
                                                        </div>
                                                        ...
                                                        <div className="d-flex align-items-center gap-2">
                                                            <div className="lh-1">
                                                                <span className="avatar avatar-xs avatar-rounded">
                                                                    <BaseImage src={user.countryFlagUrl} alt={user.country} />
                                                                </span>
                                                            </div>
                                                ...
                                                <div className="d-flex align-items-start gap-3">
                                                    <div className="lh-1">
                                                        <span className="avatar avatar-rounded avatar-sm">
                                                            <BaseImage src={browser.imageUrl} alt={browser.name} />
                                                        </span>
                                                    </div>
...
// Assign layout
Analytics.layout = (page) => <MainLayout>{page}</MainLayout>;
