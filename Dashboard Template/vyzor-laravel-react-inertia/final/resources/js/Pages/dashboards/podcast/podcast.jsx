                    ...
                    <Row>
                                    ...
                                    <Card className="custom-card podcast-banner-card border-0 shadow-none">
                                        <Card.Body>
                                            <div className="podcast-banner-card-background grid-cards">
                                                <BaseImage src="/build/assets/images/media/backgrounds/6.png" alt="" />
                                            </div>
                                            <Row>
                                                <Col xl={8}>
                                                ...
                                                <Col xl={4}>
                                                    <BaseImage src="/build/assets/images/media/media-70.png" alt="" className="podcast-banner-img img-fluid d-md-block d-none" />
                                                </Col>
                                            </Row>
                                        </Card.Body>
                                    </Card>
                        ...
                        <Col xxl={4}>
                            <Card className="custom-card">
                                <Card.Header className="justify-content-between">
                                    ...
                                    <BaseLink href="#!" className="text-muted fs-13">View All<i className="ti ti-arrow-narrow-right ms-1 align-middle"></i></BaseLink>
                                </Card.Header>
                                <Card.Body>
                                                ...
                                                <div className="d-flex align-items-center gap-2 flex-wrap">
                                                    <div className="lh-1">
                                                        <span className="avatar avatar-rounded">
                                                            <BaseImage src={user.avatar} alt={user.name} />
                                                        </span>
                                                    </div>
                        ...
                        <Col xl={12}>
                            <Row>
                                ...
                                {MediaCards.map((card) => (
                                    <Col xxl={4} xl={4} lg={6} md={6} sm={12} key={card.id} className="col-12">
                                        <Card className="custom-card">
                                            <Row className="g-0">
                                                <div className="col-3">
                                                    <BaseImage src={card.image} className="img-fluid rounded-start h-100 w-100" alt={card.title} />
                                                </div>
                                                <div className="col-9">
                                    ...
                                    <Row className="row-cols-xxl-5">
                                        {RecentlyMedia.map((card) => (
                                            <div key={card.id} className="col">
                                                <Card className="custom-card">
                                                    <BaseLink href="#!" className="card-anchor"></BaseLink>
                                                    <BaseImage src={card.image} className="card-img-top" alt={card.title} />
                                                    <Card.Body>
                                ...
                                <Card.Body className="p-4">
                                    <div className="text-center mb-4">
                                        <span className="avatar mb-3 podcast-playing-now-avatar shadow">
                                            <BaseImage src="/build/assets/images/media/media-78.jpg" alt="" />
                                        </span>
                                        <BaseLink href="#!"><h6 className="fw-medium mb-1">Echoes of Tomorrow</h6></BaseLink>
                                    ...
                                    <Row className="justify-content-center">
                                        <Col xl={9}>
                                            ...
                                            <div className="d-flex align-items-center justify-content-between flex-wrap gap-3 lh-1 p-3 bg-light rounded">
                                                ...
                                                <BaseLink href="#!" className="btn btn-primary btn-icon rounded-circle">
                                                    <i className="ri-play-fill"></i>
                                                </BaseLink>
                                                <BaseLink href="#!">
                                                ...
                                                <div className="d-flex align-items-center gap-2 flex-wrap">
                                                    ...
                                                    <div className="lh-1">
                                                        <span className="avatar avatar-md avatar-rounded">
                                                            <BaseImage width={40} height={40} src={item.image} alt={item.title} />
                                                        </span>
                                                    </div>
                                                    <div className="flex-fill">
...
// Assign layout
Podcast.layout = (page) => <MainLayout>{page}</MainLayout>;
