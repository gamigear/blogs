...
const PosSystem = () => {
    ...
    return (
        ...
        <Fragment>
            ...
            <Head title="Dashboard-POS System" />
                ...
                <Col xxl={9}>
                    <Row>
                        <Col xl={12}>
                            ...
                            <SpkSwiperJs className="pos-orders-swiper" slides={PosCardsData} navigation={true} slidesPerView={1} spaceBetween={20} autoplay={true} breakpoint={breakpoints} />
                        </Col>
                        <Col xl={12}>
                            ...
                            <div className="d-flex align-items-center gap-2 mb-4 flex-wrap pos-category pos-categories-list" id="filter">
                                <div className={`nft-tag nft-tag-primary ${activeFilter === "*" ? "active" : ""}`}>
                                    <BaseLink href="#" className="stretched-link categories" data-filter="*" key="frst" onClick={() => handleTabClick("*")}>
                                        <span className="nft-tag-icon ">
                                            <BaseImage src="/build/assets/images/pos-system/20.png" alt="" />
                                        </span>
                                        <span className="nft-tag-text podcast-category-text">All</span>
                                    </BaseLink>
                                </div>
                                <div className={`nft-tag nft-tag-secondary ${activeFilter === ".Appetizers" ? "active" : ""}`}>
                                    <BaseLink href="#" className="stretched-link categories" data-filter=".Appetizers" key="sec" onClick={() => handleTabClick(".Appetizers")}>
                                        <span className={`nft-tag-icon `}>
                                            <BaseImage src="/build/assets/images/pos-system/1.png" alt="" />
                                        </span>
                                        <span className="nft-tag-text podcast-category-text">Appetizers</span>
                                    </BaseLink>
                                </div>
                                <div className={`nft-tag nft-tag-info ${activeFilter === ".Main-Course" ? "active" : ""}`}>
                                    <BaseLink href="#" className="stretched-link categories" data-filter=".Main-Course" key="third" onClick={() => handleTabClick(".Main-Course")}>
                                        <span className={`nft-tag-icon `}>
                                            <BaseImage src="/build/assets/images/pos-system/2.png" alt="" />
                                        </span>
                                        <span className="nft-tag-text podcast-category-text">Main Course</span>
                                    </BaseLink>
                                </div>
                                <div className={`nft-tag nft-tag-success ${activeFilter === ".Beverages" ? "active" : ""}`}>
                                    <BaseLink href="#!" className="stretched-link categories" data-filter=".Beverages" key="fou" onClick={() => handleTabClick(".Beverages")}>
                                        <span className={`nft-tag-icon `}>
                                            <BaseImage src="/build/assets/images/pos-system/3.png" alt="" />
                                        </span>
                                        <span className="nft-tag-text podcast-category-text">Beverages</span>
                                    </BaseLink>
                                </div>
                                <div className={`nft-tag nft-tag-danger ${activeFilter === ".Desserts" ? "active" : ""}`}>
                                    <BaseLink href="#!" className="stretched-link categories" data-filter=".Desserts" key="five" onClick={() => handleTabClick(".Desserts")}>
                                        <span className={`nft-tag-icon `}>
                                            <BaseImage src="/build/assets/images/pos-system/4.png" alt="" />
                                        </span>
                                        <span className="nft-tag-text podcast-category-text">Desserts</span>
                                    </BaseLink>
                                </div>
                                <div className={`nft-tag nft-tag-warning ${activeFilter === ".Soups" ? "active" : ""}`}>
                                    <BaseLink href="#!" className="stretched-link categories" data-filter=".Soups" key="six" onClick={() => handleTabClick(".Soups")}>
                                        <span className={`nft-tag-icon `}>
                                            <BaseImage src="/build/assets/images/pos-system/6.png" alt="" />
                                        </span>
                                        <span className="nft-tag-text podcast-category-text">Soups</span>
                                    </BaseLink>
                                </div>
                                <div className={`nft-tag nft-tag-purple ${activeFilter === ".Salads" ? "active" : ""}`}>
                                    <BaseLink href="#!" className="stretched-link categories" data-filter=".Salads" key="seven" onClick={() => handleTabClick(".Salads")}>
                                        <span className={`nft-tag-icon `}>
                                            <BaseImage src="/build/assets/images/pos-system/5.png" alt="" />
                                        </span>
                                ...
                                {Systemcards.map((item) => (
                                    <Col key={item.id} xxl={3} xl={4} lg={4} md={6} sm={6} className={`col-12 card-item ${item.category}`} data-category={item.category}>
                                        <Card className={`custom-card ${item.outOfStock ? 'out-of-stock' : ''}`}>
                                            <BaseImage src={item.image} className="card-img-top bg-light" alt={item.title} />
                                            <Card.Body>
                                                <div className="mb-1">
                                                    <BaseLink href="#!" className="fw-medium fs-16">{item.title}</BaseLink>
                                                </div>
                                                <div className="d-flex align-items-center justify-content-between flex-wrap gap-2">
                                                    ...
                                                    <div>
                                                        <SpkTooltips placement="top" title="Add Item">
                                        ...
                                        <div className="d-flex align-items-start gap-2 flex-wrap">
                                            ...
                                            <div className="flex-grow-1">
                                                ...
                                                <div className="d-flex align-items-center justify-content-between flex-wrap gap-2">
                                                    ...
                                                    <div className="lh-1">
                                                        <BaseLink href="#!" className="text-danger fs-12 text-decoration-underline">
                                                            Remove
                                                        </BaseLink>
                                                    </div>
                                                </div>
                            ...
                            <div className="p-3">
                                ...
                                <div className="btn-group flex-wrap" role="group" aria-label="Basic radio toggle button group">
                                    <input type="radio" className="btn-check" name="btnradio" id="btnradio1"
                                        defaultChecked />
                                    <label className="btn btn-outline-primary btn-w-sm" htmlFor="btnradio1">
                                        <span className="d-block"><i className="ti ti-cash fs-5"></i></span>
                                        <span className="d-block">Cash</span>
                                    </label>

                                    <input type="radio" className="btn-check" name="btnradio" id="btnradio2" />
                                    <label className="btn btn-outline-primary btn-w-sm" htmlFor="btnradio2">
...
// Assign layout
PosSystem.layout = (page) => <MainLayout>{page}</MainLayout>;
