                ...
                <Col xl={3}>
                    <Card className="custom-card overflow-hidden">
                        <Card.Header className="justify-content-between">
                            ...
                            <BaseLink href="#!" className="text-muted">View All <i className="ti ti-arrow-narrow-right ms-1"></i></BaseLink>
                        </Card.Header>
                                        ...
                                        <div className="d-flex align-items-start flex-wrap gap-3">
                                            <div className="lh-1">
                                                <span className="avatar avatar-xl">
                                                    <BaseImage src={course.image} alt="img" />
                                                </span>
                                            </div>
                                            <div className="flex-fill fw-medium">
                                                <BaseLink href="#!" className="text-muted d-block mb-1 fs-10" title="Category">
                                                    <i className="ti ti-tag fs-11 align-middle"></i>&nbsp;{course.category}
                                                </BaseLink>
                                                <BaseLink href="#!" className="d-block mb-2 fs-14">{course.title}</BaseLink>
                                                <div className="d-flex align-items-center flex-wrap gap-3">
                                                    <div className="d-flex align-items-center">
                                                        <BaseLink href="#!" className="me-2 lh-1">
                                                            <span className="avatar avatar-xs avatar-rounded">
                                                                <BaseImage src={course.instructor.avatar} alt="img" />
                                                            </span>
                                                        </BaseLink>
                                                        <BaseLink href="#!" className="flex-fill fs-12">{course.instructor.name}</BaseLink>
                                                    </div>
                                                    <div className="fs-12">
                                        ...
                                        <div className="d-flex align-items-center gap-3 flex-wrap">
                                            <div className="lh-1">
                                                <span className="avatar avatar-md online avatar-rounded">
                                                    <BaseImage src={instructor.image} alt={instructor.name} />
                                                </span>
                                            </div>
                                            <div className="flex-fill">
                                        ...
                                        <div className="d-flex align-items-center justify-content-between gap-1">
                                            <div className="w-50">
                                                ...
                                                <div className="d-flex align-items-center gap-2">
                                                    <div className="lh-1">
                                                        <span className="avatar avatar-xs avatar-rounded">
                                                            <BaseImage width={20} height={20} src={course.image} alt={course.instructor} />
                                                        </span>
                                                    </div>
                ...
                <Col xxl={3} xl={12}>
                    <Card className="custom-card">
                        <Card.Header className="flex-between justify-content-between">
                            ...
                            <SpkDropdown Id="dropdownMenuButton1" Togglevariant="" Menulabel="dropdownMenuButton1" Toggletext="View All" Customtoggleclass=" border-0 p-0 text-muted no-caret" Arrowicon={true}>
                                <Dropdown.Item as="li" >Today</Dropdown.Item>
                                <Dropdown.Item as="li" >This Weak</Dropdown.Item>
                                <Dropdown.Item as="li" >Last Weak</Dropdown.Item>
                            </SpkDropdown>
                    ...
                    <Card className="custom-card">
                        <Card.Header className="justify-content-between">
                            ...
                            <div className="d-flex flex-wrap gap-2">
                                <div>
                                    <Form.Control className="custom-sort-btn" type="text" placeholder="Search Here" aria-label=".form-control-sm example " />
                                </div>
                                <SpkDropdown Id="dropdownMenuButton1" Togglevariant="" Menulabel="dropdownMenuButton1" Toggletext="Sort By" Customtoggleclass=" custom-sort-btn btn btn-primary  btn-wave waves-effect waves-light no-caret" Arrowicon={true}>
                                        ...
                                        <tr key={course.id}>
                                            ...
                                            <td>
                                                <div className="d-flex align-items-center gap-2">
                                                    <div className="lh-1">
                                                        <span className="avatar avatar-xs avatar-rounded">
                                                            <BaseImage width={20} height={20} src={course.avatar} alt="" />
                                                        </span>
                                                    </div>
                                            ...
                                            <td>
                                                <SpkDropdown Id="dropdownMenuButton1" Togglevariant="light" Menulabel="dropdownMenuButton1" Icon={true} IconClass="fe fe-more-vertical" Customtoggleclass="btn btn-icon btn-sm border no-caret">
                                                    <Dropdown.Item as="li"><i className="ri-eye-line me-2"></i>View</Dropdown.Item>
                                                    <Dropdown.Item as="li"><i className="ri-pencil-line me-2"></i>Edit</Dropdown.Item>
                                                    <Dropdown.Item as="li"><i className="ri-delete-bin-line me-2"></i>Delete</Dropdown.Item>
                                                </SpkDropdown>
                                            </td>
                                        </tr>
                                    ))}
