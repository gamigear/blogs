...
import { Card, Col, ListGroup, Pagination, Nav, Row, Tab, Image } from "react-bootstrap";
...
const CRM = () => {
    ...
    return (
        <Fragment>
            ...
            <Head title="Dashboards-CRM" />

            <Pageheader title="Dashboards" subtitle="CRM" currentpage="Dashboard" activepage="CRM" />
                ...
                <Col xxl={4}>
                    <Row>
                                    ...
                                    <Card.Header className="justify-content-between">
                                        ...
                                        <Nav className="nav-tabs justify-content-end nav-tabs-header card-headertabs" role="tablist">
                                            <Nav.Item role="presentation">
                                                <Nav.Link eventKey={"today"} className="" data-bs-toggle="tab" role="tab" aria-current="page"  aria-selected="false" tabIndex={-1}>Today</Nav.Link>
                                            </Nav.Item>
                                            <Nav.Item role="presentation">
                                                <Nav.Link eventKey={"upcoming"} className="" data-bs-toggle="tab" role="tab" aria-current="page"  aria-selected="true">Upcoming</Nav.Link>
                                            </Nav.Item>
                                        </Nav>
                                    </Card.Header>
                                                            ...
                                                            <div className="d-flex align-items-start gap-2 flex-wrap">
                                                                ...
                                                                <div className="flex-fill">
                                                                    <div className="d-flex align-items-center gap-2 mb-1">
                                                                        <BaseLink href="#!" className="crm-task-name">
                                                                            {task.title}
                                                                        </BaseLink>
                                                        ...
                                                        <li key={task.id}>
                                                            <div className="d-flex align-items-start gap-2 flex-wrap">
                                                                ...
                                                                <div className="flex-fill">
                                                                    ...
                                                                    <div className="d-flex align-items-center gap-2 lh-1">
                                                                        <BaseLink href="#!" className="fs-12">{task.code}</BaseLink>
                                                                        <div className="vr"></div>
                                                                        <span className="text-muted mb-0 fs-12">
                        ...
                        <Col xl={12}>
                            <Card className="custom-card">
                                <Card.Body>
                                    <div className="d-flex align-items-center justify-content-between flex-wrap gap-3 gap-sm-0">
                                    ...
                                    <div className="d-flex align-items-center gap-3 justify-content-between flex-wrap">
                                        ...
                                        <div><BaseLink href="#!" className="link-primary text-decoration-underline">Leads Report <i className="ti ti-arrow-narrow-right"></i></BaseLink></div>
                                    </div>
                                </Card.Body>
                            </Card>
                        </Col>
                                                ...
                                                <div className="d-flex align-items-center gap-2">
                                                    <div className="lh-1">
                                                        <span className="avatar avatar-sm avatar-rounded">
                                                            <BaseImage src={lead.avatar} alt={lead.name} />
                                                        </span>
                                                    </div>
                                                    <div>{lead.name}</div>
                                                </div>
                            ...
                            <div className="table-responsive">
                                <SpkTables tableClass="text-nowrap" header={[{ title: 'Deal ID' }, { title: 'Deal Name' }, { title: 'Client Name' }, { title: 'Deal Amount' }, { title: 'Status' }, { title: 'Closing Date' }, { title: 'Sales Rep' }, { title: 'Priority' }, { title: 'Actions' }]}>
                                    {TopdealsTable.map((deal, idx) => (
                                        <tr key={idx}>
                                            <td><BaseLink href="#!">{deal.id}</BaseLink></td>
                                            <td>{deal.title}</td>
                                            <td>
                                                <div className="d-flex align-items-center gap-2 position-relative">
                                                    ...
                                                    <div className="lh-1">
                                                        <span className="avatar avatar-sm avatar-rounded">
                                                            <BaseImage width={28} height={28} src={deal.companyLogo} alt={deal.companyName} />
                                                        </span>
                                                    </div>
...
CRM.layout = (page) => <MainLayout>{page}</MainLayout>;
export default CRM;
