                    ...
                    <Card className="custom-card">
                        ...
                        <Card.Body className="p-0">
                            <div className="row g-0 border-bottom border-block-end-dashed">
                                <Col xl={6} className="border-md-end">
                                        ...
                                        <div className="d-flex align-items-center gap-2 flex-wrap">
                                            <div className="lh-1">
                                                <span className="avatar avatar-md avatar-rounded">
                                                    <BaseImage src={employee.image} alt={employee.name} />
                                                </span>
                                            </div>
                ...
                <Col xxl={4}>
                    <Card className="custom-card overflow-hidden">
                        <Card.Header className="justify-content-between">
                            ...
                            <SpkDropdown toggleas="a"  Customtoggleclass="fs-12 text-muted no-caret" Toggletext="Sort By" Arrowicon={true}>
                                            ...
                                            <td>
                                                <div className="d-flex align-items-center gap-2">
                                                    <span className="avatar avatar-md bg-light p-1 avatar-rounded">
                                                        <BaseImage width={40} height={40} src={attendance.image} alt={attendance.name} />
                                                    </span>
                                                    <div>
                                        ...
                                        <tr key={index}>
                                            ...
                                            <td>
                                                <div className="d-flex align-items-center">
                                                    <span className="avatar avatar-sm me-2 avatar-rounded">
                                                        <BaseImage src={applicant.image} alt="img" />
                                                    </span>
                                                    {applicant.name}
                                                </div>
                                            </td>
                                            ...
                                            <td>
                                                <div className="hstack gap-2 fs-15">
                                                    <BaseLink aria-label="anchor" href="#!" className="btn btn-icon waves-effect waves-light btn-sm btn-success-light rounded-circle">
                                                        <i className="ri-phone-line"></i>
                                                    </BaseLink>
                                                    <BaseLink aria-label="anchor" href="#!" className="btn btn-icon waves-effect waves-light btn-sm btn-primary-light rounded-circle">
                                                        <i className="ri-edit-line"></i>
                                                    </BaseLink>
                                                    <BaseLink aria-label="anchor" href="#!" className="btn btn-icon btn-wave waves-effect waves-light btn-sm btn-danger-light rounded-circle">
...
// Assign layout
Hrm.layout = (page) => <MainLayout>{page}</MainLayout>;
export default Hrm;
