            ...
            <Row>
                <Col xl={9}>
                            ...
                            <div className="d-flex flex-wrap align-items-top justify-content-between gap-2">
                                <div>
                                    <div className="d-flex flex-wrap gap-3">
                                        ...
                                        <div>
                                            <h4 className="fw-medium mb-2 d-flex align-items-center"><BaseLink href="#!">Software Developer</BaseLink></h4>
                                            <BaseLink href="#!"><i className="bi bi-building"></i>Tech Solutions Inc.</BaseLink>
                                            ...
                                            <div className="popular-tags">
                                                <BaseLink href="#!" className="badge rounded-pill bg-info-transparent me-1"><i className="bi bi-clock me-1"></i>Full Time</BaseLink>
                                                <BaseLink href="#!" className="badge rounded-pill bg-danger-transparent"><i className="bi bi-briefcase me-1"></i>13 Openings</BaseLink>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                <div>
                                    <div className="btn-list mb-2">
                                        <BaseLink href="#!" className="btn btn-primary"> Apply Now</BaseLink>
                    ...
                    <div>
                        ...
                        <SpkSwiperJs className="swiper-related-jobs" slides={JobsSwiper} spaceBetween={20} autoplay={true} pagination={false} loop={true} navigation={true} breakpoint={breakpoints} />
                    </div>
                    <Row>
                        <Col xl={6}>
                            <Card className="custom-card border bg-primary-transparent shadow-none">
                                <Card.Body>
                                    <div className="d-flex align-items-center justify-content-between">
                                        ...
                                        <BaseLink href="#!" className="btn btn-success btn-lg" role="button">
                ...
                <Col xl={3}>
                    ...
                    <Card className="custom-card overflow-hidden">
                        <Card.Header className="justify-content-between">
                            ...
                            <BaseLink href="#!" className="text-primary fw-medium fs-13">
                                        ...
                                        <div className="d-sm-flex flex-wrap gap-2">
                                            ...
                                            <div className="flex-grow-1">
                                                <p className="fw-medium fs-13 mb-1">
                                                    <BaseLink href="#!">{job.title}</BaseLink>
                                                </p>
...
// Assign layout
JobDetails.layout = (page) => <MainLayout>{page}</MainLayout>;
