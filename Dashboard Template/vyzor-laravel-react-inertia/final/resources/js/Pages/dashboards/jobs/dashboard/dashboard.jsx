...
const Jobs = () => {
    ...
    return (
        <Fragment>
            ...
            <Head title="Jobs-Dashboards" />

            <Pageheader title="Dashboards" subtitle="Jobs" currentpage="Dashboard" activepage="Jobs" />

            {/* <!-- Page Header Close --> */}

            {/* <!-- Start:: row-1 --> */}

            <Row className="row row-cols-xxl-5 row-cols-lg-3 row-cols-sm-2 row-cols-1">
            ...
            <Row>
                                            ...
                                            <td className={index === JobsTable.length - 1 ? "border-bottom-0" : ""}>
                                                <div className="d-flex align-items-center gap-2">
                                                    <span className="avatar avatar-sm bg-light avatar-rounded">
                                                        <BaseImage src={job.companyLogo} alt={job.companyName} />
                                                    </span>
                                                    <BaseLink href="#!" className="fw-medium">
                                                        {job.companyName}
                                                    </BaseLink>
                                                </div>
                                            </td>
                ...
                <Col xxl={3} xl={12}>
                    <Card className="custom-card overflow-hidden">
                        ...
                        <Card.Body className="p-0">
                            <ListGroup className="list-group-flush overflow-auto" id="recent-jobs">
                                                ...
                                                <div className="d-flex align-items-center gap-2">
                                                    <div className="lh-1">
                                                        <span className="avatar avatar-xs avatar-rounded">
                                                            <BaseImage width={20} height={20} src={job.avatar} alt={job.applicantName} />
                                                        </span>
                                                    </div>
...
// Assign layout
Jobs.layout = (page) => <MainLayout>{page}</MainLayout>;
export default Jobs;
