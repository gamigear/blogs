...
const CandidateDetails = () => {
    ...
    return (
        ...
        <Fragment>
            ...
            <Head title="Jobs-Candidate Details" />
                        ...
                        <Card.Body>
                            <div className="d-flex align-items-center flex-wrap justify-content-between gap-2">
                                <div className="d-flex flex-wrap gap-2 w-sm-75">
                                    <div>
                                        <span className="avatar avatar-xxl">
                                            <BaseImage src="/build/assets/images/faces/13.jpg" className="img-fluid" alt="" />
                                        </span>
                                    </div>
                                    <div className="ms-3 w-sm-75">
                                        <h4 className="fw-medium mb-0 d-flex align-items-center gap-2">
                                            <BaseLink href="#!" className="lh-1">Jhon Doe</BaseLink>
                                            <span className="text-success fs-13 lh-1"><i className="ti ti-star-filled me-1 text-warning"></i>4.5</span>
                                        </h4>
                                        <div className="my-1">
                                            <BaseLink href="#!" className="fw-medium"><i className="bi bi-briefcase me-1 align-middle"></i> Software Engineer</BaseLink>
                                        </div>
                                        <div className="popular-tags">
                                            <BaseLink href="#!" className="badge rounded-pill bg-info-transparent me-1"><i className="bi bi-moon-stars me-1"></i>Full Time</BaseLink>
                                            <BaseLink href="#!" className="badge rounded-pill bg-danger-transparent"><i className="bi bi-clock me-1"></i> Immediate Joinee</BaseLink>
                                        </div>
                                ...
                                <div className="btn-list">
                                    <BaseLink href="#!" className="btn btn-primary"><i className="bi bi-download me-1"></i> Download CV</BaseLink>
                                    <BaseLink href="#!" className="btn btn-icon btn-primary-light btn-wave">
                                                        ...
                                                        <div className="d-flex align-items-start gap-3 mb-4 flex-wrap">
                                                            <div>
                                                                <span className="avatar avatar-lg avatar-rounded bg-light">
                                                                    <BaseImage src={project.logoSrc} alt={project.title} />
                                                                </span>
                                                            </div>
                                                            <div className="flex-fill w-50">
                                                                <BaseLink href="#!" className="fw-semibold fs-14 d-block text-truncate project-list-title">
                                                                    {project.title}
                                                                </BaseLink>
                                                                <span className="d-block text-muted fs-13">{project.description}</span>
                                                            </div>
                                                            <BaseLink href="#!" className="btn btn-primary-light">
                                ...
                                <div className="d-flex align-items-start gap-3">
                                    <div>
                                        <span className="avatar avatar-xl bg-light">
                                            <BaseImage src="/build/assets/images/company-logos/10.png" alt="" />
                                        </span>
                                    </div>
                                    <div>
                        ...
                        <Card.Body>
                            <ul className="list-unstyled candidate-personal-info-list">
                                {PersonalInfoList.map((info, index) => (
                                    <li key={index}>
                                        <div className="d-flex align-items-start gap-2 justify-content-between flex-wrap">
                                            <span className="d-block text-muted d-inline-flex align-items-center personal-info-type">
                                ...
                                <li>
                                    <div className="d-flex align-items-start gap-2 justify-content-between">
                                        <span className="d-block text-muted d-inline-flex align-items-center">
                                            <i className="ti ti-map-pin me-2 align-middle fs-16"></i>Address</span>
                                        <span className="fw-medium d-block text-end">1234 Elm Street, New York, 10001, United States</span>
                                    </div>
                                </li>
                            </ul>
                        </Card.Body>
                            ...
                            <div className="btn-list">
                                {SocialLinks.map((link, index) => (
                                    <SpkTooltips placement="top" key={link.title || index} title={link.title}>
                                        <Link  onClick={(e) => e.preventDefault()}  href={link.href} className={`btn btn-icon rounded-circle ${link.buttonClass}`} data-bs-toggle="tooltip" data-bs-placement="top" data-bs-title={link.title}>
...
// Assign layout
CandidateDetails.layout = (page) => <MainLayout>{page}</MainLayout>;
