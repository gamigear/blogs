...
const PostJob = () => {
    ...
    const [dateRange, setDateRange] = React.useState([today, nextWeek]);
                ...
                <Col xxl={9} xl={8} className="">
                    <Card className="custom-card">
                        ...
                        <Card.Body>
                            <Row className="gy-4 mb-4">
                                ...
                                <Col xl={6} className="job-deadline-column">
                                    ...
                                    <SpkDatepickr className="form-control breadcrumb-input datepicker-input" placeholderText="Choose date" startDate={startDate} endDate={endDate} selectsRange={true} onChange={(update) => setDateRange(update)} />
                        ...
                        <Card.Footer className="text-end">
                            <BaseLink href="#!" className="btn btn-primary btn-wave waves-effect waves-light">
...
// Assign layout
PostJob.layout = (page) => <MainLayout>{page}</MainLayout>;
