...
const SearchCompany = () => {
    ...
    return (
        ...
        <Fragment>
            ...
            <Head title="Jobs-Search Company" />
                        ...
                        <Card.Body className="p-0">
                            <div className="p-4 border-bottom">
                                ...
                                <div className="px-0 py-3 pb-0">
                                    ...
                                    <BaseLink className="ecommerce-more-link badge bg-primary-transparent" aria-expanded={open} onClick={() => setOpen(!open)} data-bs-toggle="collapse" href="#category-more" role="button" aria-controls="category-more">More</BaseLink>
                                </div>
                            </div>
                            <div className="p-4 border-bottom">
                                ...
                                <div className="px-0 py-3 pb-0">
                                    ...
                                    <BaseLink className="ecommerce-more-link badge bg-primary-transparent" data-bs-toggle="collapse" href="#location-more" role="button" aria-expanded={opens} onClick={() => setOpens(!opens)} aria-controls="location-more">More</BaseLink>
                                </div>
                            </div>
                            <div className="p-4 border-bottom">
                                            ...
                                            {CompaniesTable.map((company, index) => (
                                                <tr key={index}>
                                                    ...
                                                    <td className="text-end">
                                                        <BaseLink href="#!" className="btn btn-primary-light d-inline-flex align-items-center">
...
// Assign layout
SearchCompany.layout = (page) => <MainLayout>{page}</MainLayout>;
