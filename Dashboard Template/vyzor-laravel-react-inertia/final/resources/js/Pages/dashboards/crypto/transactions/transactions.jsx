...
const Transactions = () => {
    ...
    return (
        <Fragment>
            ...
            <Head title="Dashboards-Transactions" />
                    ...
                    <Card className="custom-card">
                        <Card.Header className="justify-content-between">
                            ...
                            <div className="d-flex flex-wrap gap-2">
                                ...
                                <SpkDropdown toggleas="a" Customtoggleclass="btn btn-primary btn-wave waves-effect waves-light no-caret" Toggletext="Sort By" Arrowicon={true}>
                        ...
                        <Card.Body className="p-0">
                            <div className="table-responsive">
                                <SpkTables tableClass="text-nowrap transaction-history-table" header={[{ title: '' }, { title: 'Sender' }, { title: 'Transaction Hash' }, { title: 'Coin' }, { title: 'Date' }, { title: 'Amount' }, { title: 'Receiver' }, { title: 'Status' }, { title: 'Actions' }]}>
                                    {allData.map((txn, index) => (
                                        <tr key={index}>
                                            ...
                                            <td>
                                                <div className="d-flex align-items-center gap-2">
                                                    <span className="avatar avatar-xs avatar-rounded">
                                                        <BaseImage src={txn.user.avatar} alt={txn.user.name} />
                                                    </span>
                                            ...
                                            <td>
                                                <div className="d-flex align-items-center gap-2">
                                                    <span className="avatar avatar-xs avatar-rounded">
                                                        <BaseImage src={txn.crypto.icon} alt={txn.crypto.name} />
                                                    </span>
...
Transactions.layout = (page) => <MainLayout>{page}</MainLayout>;
