...
const Marketcap = () => {
    ...
    return (
        ...
        <Fragment>
            ...
            <Head title="Dashboards-Market Cap" />

            <Pageheader title="Dashboards" subtitle="Crypto" currentpage="Marketcap" activepage="Marketcap" />
                ...
                <Col xxl={3} xl={6} lg={12}>
                    <Card className="custom-card overflow-hidden">
                        <Card.Header className="justify-content-between">
                            ...
                            <div>
                                <BaseLink href="#!" className="fw-medium text-success fs-13 text-decoration-underline">View All</BaseLink>
                            </div>
                        </Card.Header>
                                            ...
                                            <div className="d-flex align-items-center gap-2">
                                                <div>
                                                    <span className="avatar avatar-sm p-1 bg-light">
                                                        <BaseImage src={item.imgSrc} alt={item.name} width={28} height={28} />
                                                    </span>
                                                </div>
                                                <div>
                        ...
                        <Card.Header className="justify-content-between">
                            ...
                            <div className="d-flex flex-wrap gap-2 align-items-center">
                                ...
                                <SpkDropdown Customtoggleclass="btn btn-primary btn-sm btn-wave waves-effect waves-light no-caret" Toggletext="Sort By" Arrowicon={true}>
                                    <li><Dropdown.Item >Market Cap</Dropdown.Item></li>
                                    <li><Dropdown.Item >Price</Dropdown.Item></li>
                                    <li><Dropdown.Item >Trading Volume</Dropdown.Item></li>
                                    <li><Dropdown.Item >Price Change (24h)</Dropdown.Item></li>
                                    <li><Dropdown.Item >Rank</Dropdown.Item></li>
                                    <li><Dropdown.Item >A - Z</Dropdown.Item></li>
                                    <li><Dropdown.Item >All-Time High (ATH)</Dropdown.Item></li>
                                </SpkDropdown>
                                <div>
                                        ...
                                        <tr key={crypto.rank}>
                                                ...
                                                <div className="d-flex align-items-center gap-2">
                                                    <div className="lh-1">
                                                        <span className="avatar avatar-xs avatar-rounded">
                                                            <BaseImage src={`${crypto.imgsrc}`} alt={crypto.name} />
                                                        </span>
                                                    </div>
                                                    <div className="fw-medium">
                                                        <BaseLink href="#!">{`${crypto.name} (${crypto.symbol})`}</BaseLink>
                                                    </div>
                                                </div>
                                            </td>
                                            <td>
                                            ...
                                            <td>
                                                <span className="fw-medium">
                                                    <BaseLink href="#!">{crypto.price}</BaseLink>
                                                </span>
                                            </td>
                                            <td>
...
Marketcap.layout = (page) => <MainLayout>{page}</MainLayout>;
