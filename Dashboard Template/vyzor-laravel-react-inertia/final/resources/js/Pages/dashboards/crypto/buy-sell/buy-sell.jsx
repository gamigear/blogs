...
const BuySell = () => {
    ...
    return (
        ...
        <Fragment>
            ...
            <Head title="Dashboards-Buy & Sell" />
            ...
            <div className="row">
                {Buycards.map((idx, index) => (
                    <Col xl={4} key={index}>
                        <SpkListCard cardClass={idx.cardClass} listCard={true} titleClass="d-block text-muted mb-1" list={idx} />
                    </Col>
                ))}
                <Col xl={6}>
...
BuySell.layout = (page) => <MainLayout>{page}</MainLayout>;
