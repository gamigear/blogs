...
import { ActivityItems, Categoriesdataoptions, Categoriesdataseries, Categoriesoptions, Categoriesseries, CategoryData, CategoryItemsData, Countries, Employeesdata, Mapdata, Ordersdata, Productsdata, Recentoptions, Recentseries, Revenuesoptions, Revenuesseries, Salesdata, StatusData, Trafficoptions, Trafficseries, Transactionsdata, Visitorsoptions, Visitorsseries } from "../../shared/data/widgets/widgetsdata";
                ...
                <Col xxl={3} xl={6}>
                    <Card className="custom-card overflow-hidden">
                        <Card.Header className="justify-content-between">
                            ...
                            <BaseLink href="#!" className="fs-12 text-muted"> View All<i className="ti ti-arrow-narrow-right ms-1"></i> </BaseLink>
                        </Card.Header>
                        <Card.Body>
                    ...
                    <Card className="custom-card">
                        ...
                        <Card.Body>
                            <div id="sales-locations">
                                <WorldMap color='var(--primary-color)' tooltipBgColor='#111111' valueSuffix='points' data={Mapdata} size="md" />
                            </div>
                            <div className="mt-4">
                    ...
                    <Card className="custom-card">
                        <Card.Header className="justify-content-between">
                            ...
                            <SpkDropdown Togglevariant="" Customtoggleclass="btn-primary-light btn-sm no-caret" Arrowicon={true} Toggletext="This Week">
                                ...
                                <Dropdown.Item active>This Week</Dropdown.Item>
                            ...
                            <div className="row align-items-center justify-content-center my-2">
                                <div className="col">
                                    <div className="text-center mx-auto">
                                        <div id="top-categories1" className="py-3 text-center mx-auto">
                                            <Spkapexcharts chartOptions={Categoriesdataoptions} chartSeries={Categoriesdataseries} type={"donut"} height={212} />
                                        </div>
                                    </div>
                                </div>
                                <div className="col">
                ...
                <Col xxl={5} xl={6}>
                    <Card className="custom-card overflow-hidden">
                        <Card.Header className="justify-content-between">
                            ...
                            <BaseLink href="#!" className="link-primary fw-semibold">View All Orders<i className="ri-arrow-right-s-line ms-1 align-middle"></i></BaseLink>
                        </Card.Header>
                                        ...
                                        <tr key={index}>
                                            ...
                                            <td>
                                                <SpkButton Buttonvariant="" Customclass="btn btn-sm btn-outline-light btn-wave waves-effect waves-light">
                                                    <i className="fe fe-eye text-muted align-middle me-2 d-inline-block"></i>
                                                    View
                                                </SpkButton>
                                            </td>
                                        </tr>
                    ...
                    <Card className="custom-card">
                        ...
                        <Card.Body className="py-0">
                            <div id="social-visitors">
                                <Spkapexcharts chartOptions={Visitorsoptions} chartSeries={Visitorsseries} height={392} type={"bar"} width={"100%"} />
                            </div>
                        </Card.Body>
                    </Card>
                </Col>
                ...
                <Col xxl={3} xl={6}>
                    <Card className="custom-card">
                        <Card.Header className="justify-content-between">
                            ...
                            <BaseLink href="#!" className="fs-12 text-muted fw-medium"> View All<i className="ti ti-arrow-narrow-right ms-1"></i> </BaseLink>
                        </Card.Header>
                        <Card.Body>
...
// Assign layout
Widgets.layout = (page) => <MainLayout>{page}</MainLayout>;
