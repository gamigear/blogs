	...
	return (
		...
		<Fragment>
			...
			<Row>
				...
				<Col xl={4} lg={6} md={6} sm={12} className="">
					<Card className="custom-card custom-v-swiper custom-swipe">
						<Card.Header>
							<Card.Title>
								Vertical Swiper
							</Card.Title>
				...
				<Col xl={4} lg={6} md={6} sm={12} className="">
					<Card className="custom-card custom-mouse-wheel">
						<Card.Header>
							<Card.Title>
								Mouse Wheel Control
							</Card.Title>
					...
					<Card className="custom-card">
						...
						<Card.Body>
							<Swiper className="mySwiper swiper-h swiper swiper-horizontal1" spaceBetween={50} pagination={{ clickable: true, }} modules={[Pagination]}>
								<SwiperSlide><BaseImage src="/build/assets/images/media/media-30.jpg" alt="" /></SwiperSlide>
								<SwiperSlide>
									<Swiper className="mySwiper2 swiper-v swiper vertical swiper-vertical1" direction={"vertical"} spaceBetween={50} pagination={{ clickable: true, }}
										modules={[Pagination]}>
										<SwiperSlide><BaseImage src="/build/assets/images/media/media-25.jpg" alt="" /></SwiperSlide>
										<SwiperSlide><BaseImage src="/build/assets/images/media/media-31.jpg" alt="" /></SwiperSlide>
										<SwiperSlide><BaseImage src="/build/assets/images/media/media-32.jpg" alt="" /></SwiperSlide>
									</Swiper>
								</SwiperSlide>
								<SwiperSlide><BaseImage src="/build/assets/images/media/media-28.jpg" alt="" /></SwiperSlide>
								<SwiperSlide><BaseImage src="/build/assets/images/media/media-29.jpg" alt="" /></SwiperSlide>
							</Swiper>
						</Card.Body>
					</Card>
				</Col>
...
// Assign layout
SwiperJs.layout = (page) => <MainLayout>{page}</MainLayout>;
