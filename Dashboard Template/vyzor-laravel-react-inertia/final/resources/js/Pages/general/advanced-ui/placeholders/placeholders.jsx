                    ...
                    <Row>
                        <Col xl={6} lg={6} md={6} sm={12} >
                            <Card className="custom-card">
                                <BaseImage className="card-img-top" src="/build/assets/images/media/media-60.jpg" alt="" />
                                <Card.Body>
                        ...
                        <Col xl={6} lg={6} md={6} sm={12} >
                            <Card className="" aria-hidden="true">
                                <BaseImage className="card-img-top" src="/build/assets/images/media/media-61.jpg" alt="" />
                                <div className="card-body">
                                    ...
                                    <BaseLink href="#!" tabIndex={-1} className="btn btn-primary disabled placeholder col-6"></BaseLink>
                                </div>
                            </Card>
                        </Col>
                        <Col xl={12}>
...
// Assign layout
Placeholders.layout = (page) => <MainLayout>{page}</MainLayout>;
