                    ...
                    <Card className="custom-card">
                        ...
                        <Card.Body className="bd-example-row">
                            <p className="mb-4">With the move to flexbox in v4, you can use margin utilities like
                                <span className="text-danger me-1">.me-auto</span>to force sibling columns
                                away
                                from one
                                another.
                            </p>
                    ...
                    <Card className="custom-card">
                        <Card.Body className="">
                            ...
                            <div className="clearfix">
                                <BaseImage src="/build/assets/images/media/media-40.jpg" className="bd-placeholder-img col-md-6 float-md-end mb-3 ms-md-3 rounded img-fluid" alt="..." />
                                <p>
...
// Assign layout
Columns.layout = (page) => <MainLayout>{page}</MainLayout>;
