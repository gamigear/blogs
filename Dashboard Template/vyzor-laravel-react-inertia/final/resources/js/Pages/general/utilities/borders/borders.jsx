            ...
            <Row>
                <Col xl={12}>
                    <ShowCode title="Border Radius" customCardClass="custom-card" customCardBodyClass="" reactCode={border7}>
                        <BaseImage src="/build/assets/images/media/media-58.jpg" className="bd-placeholder-img rounded" alt="..." />
                        <BaseImage src="/build/assets/images/media/media-58.jpg" className="bd-placeholder-img rounded-top" alt="..." />
                        <BaseImage src="/build/assets/images/media/media-58.jpg" className="bd-placeholder-img rounded-end" alt="..." />
                        <BaseImage src="/build/assets/images/media/media-58.jpg" className="bd-placeholder-img rounded-bottom" alt="..." />
                        <BaseImage src="/build/assets/images/media/media-58.jpg" className="bd-placeholder-img rounded-start" alt="..." />
                        <BaseImage src="/build/assets/images/media/media-58.jpg" className="bd-placeholder-img rounded-circle" alt="..." />
                        <BaseImage src="/build/assets/images/media/media-58.jpg" className="bd-placeholder-img  rounded-pill" alt="..." />
                    </ShowCode>
                </Col>
                <Col xl={12}>
                    <ShowCode title="Sizes" customCardClass="custom-card" customCardBodyClass="" reactCode={border8}>
                        <BaseImage src="/build/assets/images/media/media-58.jpg" className="bd-placeholder-img bd-placeholder-img rounded-0" alt="..." />
                        <BaseImage src="/build/assets/images/media/media-58.jpg" className="bd-placeholder-img bd-placeholder-img rounded-1" alt="..." />
                        <BaseImage src="/build/assets/images/media/media-58.jpg" className="bd-placeholder-img bd-placeholder-img rounded-2" alt="..." />
                        <BaseImage src="/build/assets/images/media/media-58.jpg" className="bd-placeholder-img bd-placeholder-img rounded-3" alt="..." />
                        <BaseImage src="/build/assets/images/media/media-58.jpg" className="bd-placeholder-img bd-placeholder-img rounded-4" alt="..." />
                        <BaseImage src="/build/assets/images/media/media-58.jpg" className="bd-placeholder-img bd-placeholder-img rounded-5" alt="..." />
                    </ShowCode>
                </Col>
            </Row>
...
// Assign layout
Borders.layout = (page) => <MainLayout>{page}</MainLayout>;
