                    ...
                    <Row>
                        ...
                        <Col xl={12}>
                            <Card className="custom-card">
                                ...
                                <Card.Body >
                                    <div className="bd-example-cssgrid text-center overflow-x-auto">
                        ...
                        <Col xl={12}>
                            <Card className="custom-card">
                                ...
                                <Card.Body className="bd-example-cssgrid">
                                    ...
                                    <div className="grid mb-3 text-center grid-autocol-responsive overflow-x-auto">
                                        <div className="g-col-6">.g-col-6</div>
                                        <div className="g-col-6">.g-col-6</div>
                                        <div className="g-col-6">.g-col-6</div>
                                        <div className="g-col-6">.g-col-6</div>
                                    ...
                                    <div className="grid text-center grid-col-mixed-responsive overflow-x-auto">
                                        <div className="g-col-6">.g-col-6</div>
                                        <div>1</div>
                                        <div>1</div>
                                        <div>1</div>
                        ...
                        <Col xl={12}>
                            <Card className="custom-card">
                                ...
                                <Card.Body className="bd-example-cssgrid custom-colsGap-grid text-center overflow-x-auto">
                                    <div className="grid mb-3" style={{ "--bs-columns": "4", "--bs-gap": "5rem" }}>
                        ...
                        <Col xl={12}>
                            <Card className="custom-card">
                                ...
                                <Card.Body className="bd-example-cssgrid text-center overflow-x-auto">
                                    ...
                                    <div className="grid mb-3 grid-autocol-responsive gap-1" style={{ "rowGap": "0" }}>
                                        <div className="g-col-6">.g-col-6</div>
                                        <div className="g-col-6">.g-col-6</div>
                                    ...
                                    <p>Because of that, you can have different vertical and horizontal gaps, which
                                        ...
                                        variable.</p>
                                    <div className="grid" style={{ "--bs-gap": ".25rem 1rem" }}>
                                        <div className="g-col-6">.g-col-6</div>
                                        <div className="g-col-6">.g-col-6</div>
                    ...
                    <Row>
                        ...
                        <Col xl={12}>
                            <Card className="custom-card">
                                ...
                                <Card.Body>
                                    <div className="bd-example-cssgrid text-center nesting-grid-reponsive overflow-x-auto">
                                        <div className="grid" style={{ "--bs-columns": "3" }}>
                                            <div>
                                                First auto-column
                                                <div className="grid">
                                                    <div>Auto-column</div>
                                            ...
                                            <div>
                                                Second auto-column
                                                <div className="grid px-1" style={{ "--bs-columns": "12" }}>
                        ...
                        <Col xl={12}>
                            <Card className="custom-card">
                                ...
                                <Card.Body className="bd-example-cssgrid text-center">
                                    <div className="grid" style={{ "--bs-rows": "3", "--bs-columns": "3" }}>
                                        <div>Auto-column</div>
...
// Assign layout
CssGrid.layout = (page) => <MainLayout>{page}</MainLayout>;
