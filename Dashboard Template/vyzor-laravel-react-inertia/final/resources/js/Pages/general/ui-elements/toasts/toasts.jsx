...
const Toasts = () => {
    ...
    return (
        ...
        <Fragment>
            ...
            <Row>
                <Col xl={12}>
                    <ShowCode title="Live example" customCardClass="custom-card" customCardBodyClass="" reactCode={toast2} reusableCode={reusabletoast2}>
                        ...
                        <ToastContainer className="toast-container position-fixed top-0 end-0 p-3">
                            <SpkToast show={toasts['live'] || false} onClose={() => handleToasts('live')} title="Vyzor" message="Hello, world! This is a toast message." timestamp="11 min ago" imgSrc="/build/assets/images/brand-logos/toggle-logo.png" ToastHeader={true} toastClass="custom-toast" headerClass="text-default" imgClass="custom-img-class" autohide={false} />
                        </ToastContainer>
                    </ShowCode>
                ...
                <Col xl={12}>
                    <ShowCode title="Basic example" customCardClass="custom-card" customCardBodyClass="" reactCode={toast1} reusableCode={reusabletoast1}>
                        <SpkToast show={toasts['basic']} onClose={() => handleToasts('basic')} title="Vyzor" message="Hello, world! This is a toast message." timestamp="11 min ago" imgSrc="/build/assets/images/brand-logos/toggle-logo.png" ToastHeader={true} toastClass="custom-toast" headerClass="text-default" imgClass="custom-img-class" autohide={false} />
                    </ShowCode>
                    <ShowCode title="Stacking" customCardClass="custom-card" customCardBodyClass="px-2 px-sm-4" reactCode={toast3} reusableCode={reusabletoast3}>
                        <ToastContainer className="toast-container position-static">

                            <SpkToast show={toasts["stack"]} onClose={() => handleToasts('stack')} ToastHeader={true} toastClass="fade show" headerClass="text-default" imgSrc="/build/assets/images/brand-logos/toggle-logo.png" imgClass="me-2" title="Vyzor" timestamp="just now" message={"See? Just like this."} />
                            <SpkToast show={toasts["stack1"]} onClose={() => handleToasts('stack1')} ToastHeader={true} toastClass="fade show" headerClass="text-default" imgSrc="/build/assets/images/brand-logos/toggle-logo.png" imgClass="me-2" title="Vyzor" timestamp="2 seconds ago" message={" Heads up, toasts will stack automatically"} />
                ...
                <Col xl={12}>
                    <ShowCode title="Translucent" customCardClass="custom-card" customCardBodyClass="" reactCode={toast7} reusableCode={reusabletoast7}>
                        <SpkToast ToastHeader={true} onClose={() => handleToasts('transColor')} show={toasts['transColor']} toastClass="show" headerClass="text-default" imgClass="me-2" imgSrc="/build/assets/images/brand-logos/toggle-logo.png" title="Vyzor" timestamp="11 mins ago" message="Hello, world! This is a toast message." />
                    </ShowCode>
            ...
            <Row>
                <Col xl={12}>
                    <ShowCode title="Color Variants Live" customCardClass="custom-card" customCardBodyClass="" reactCode={toast6} reusableCode={reusabletoast6}>
                        ...
                        <ToastContainer className="toast-container position-fixed top-0 end-0 p-3">
                            <SpkToast ToastHeader={true} bg="primary-transparent" toastClass="colored-toast" onClose={() => handleToasts('PrimaryColor')} show={toasts['PrimaryColor'] || false} delay={3000} autohide={true} headerClass="text-fixed-white bg-primary" imgClass="bd-placeholder-img rounded me-2" imgSrc="/build/assets/images/brand-logos/toggle-dark.png" message="Your,toast message here." title="Vyzor" />
                            <SpkToast ToastHeader={true} bg="secondary-transparent" toastClass="colored-toast" onClose={() => handleToasts('SecondaryColor')} show={toasts['SecondaryColor'] || false} delay={3000} autohide={true} headerClass="text-fixed-white bg-secondary" imgClass="bd-placeholder-img rounded me-2" imgSrc="/build/assets/images/brand-logos/toggle-dark.png" message="Your,toast message here." title="Vyzor" />
                            <SpkToast ToastHeader={true} bg="info-transparent" toastClass="colored-toast" onClose={() => handleToasts('InfoColor')} show={toasts['InfoColor'] || false} delay={3000} autohide={true} headerClass="text-fixed-white bg-info" imgClass="bd-placeholder-img rounded me-2" imgSrc="/build/assets/images/brand-logos/toggle-dark.png" message="Your,toast message here." title="Vyzor" />
                            <SpkToast ToastHeader={true} bg="success-transparent" toastClass="colored-toast" onClose={() => handleToasts('SuccessColor')} show={toasts['SuccessColor'] || false} delay={3000} autohide={true} headerClass="text-fixed-white bg-success" imgClass="bd-placeholder-img rounded me-2" imgSrc="/build/assets/images/brand-logos/toggle-dark.png" message="Your,toast message here." title="Vyzor" />
                            <SpkToast ToastHeader={true} bg="danger-transparent" toastClass="colored-toast" onClose={() => handleToasts('DangerColor')} show={toasts['DangerColor'] || false} delay={3000} autohide={true} headerClass="text-fixed-white bg-danger" imgClass="bd-placeholder-img rounded me-2" imgSrc="/build/assets/images/brand-logos/toggle-dark.png" message="Your,toast message here." title="Vyzor" />
                            <SpkToast ToastHeader={true} bg="warning-transparent" toastClass="colored-toast" onClose={() => handleToasts('WarningColor')} show={toasts['WarningColor'] || false} delay={3000} autohide={true} headerClass="text-fixed-white bg-warning" imgClass="bd-placeholder-img rounded me-2" imgSrc="/build/assets/images/brand-logos/toggle-dark.png" message="Your,toast message here." title="Vyzor" />
                        </ToastContainer>
                    </ShowCode>
                </Col>
                <Col xl={12}>
                    <ShowCode title="Solid Background Toasts" customCardClass="custom-card" customCardBodyClass="" reactCode={toast5} reusableCode={reusabletoast5}>
                        ...
                        <ToastContainer className="toast-container position-fixed top-0 end-0 p-3">
                            <SpkToast ToastHeader={true} toastClass="toast colored-toast bg-primary" bodyClass="text-fixed-white" onClose={() => handleToasts('solidPrimary')} show={toasts['solidPrimary'] || false} delay={3000} autohide={true} headerClass="text-fixed-white bg-primary" imgClass="bd-placeholder-img rounded me-2" imgSrc="/build/assets/images/brand-logos/toggle-dark.png" message="Your,toast message here." title="Vyzor" />
                            <SpkToast ToastHeader={true} toastClass="toast colored-toast bg-secondary" bodyClass="text-fixed-white" onClose={() => handleToasts('solidSecondary')} show={toasts['solidSecondary'] || false} delay={3000} autohide={true} headerClass="text-fixed-white bg-secondary" imgClass="bd-placeholder-img rounded me-2" imgSrc="/build/assets/images/brand-logos/toggle-dark.png" message="Your,toast message here." title="Vyzor" />
                            <SpkToast ToastHeader={true} toastClass="toast colored-toast bg-info" bodyClass="text-fixed-white" onClose={() => handleToasts('solidInfo')} show={toasts['solidInfo'] || false} delay={3000} autohide={true} headerClass="text-fixed-white bg-info" imgClass="bd-placeholder-img rounded me-2" imgSrc="/build/assets/images/brand-logos/toggle-dark.png" message="Your,toast message here." title="Vyzor" />
                            ...
                            <SpkToast ToastHeader={true} toastClass="toast colored-toast bg-danger" bodyClass="text-fixed-white" onClose={() => handleToasts('solidDanger')} show={toasts['solidDanger'] || false} delay={3000} autohide={true} headerClass="text-fixed-white bg-danger" imgClass="bd-placeholder-img rounded me-2" imgSrc="/build/assets/images/brand-logos/toggle-dark.png" message="Your,toast message here." title="Vyzor" />
                            <SpkToast ToastHeader={true} toastClass="toast colored-toast bg-warning" bodyClass="text-fixed-white" onClose={() => handleToasts('solidWarning')} show={toasts['solidWarning'] || false} delay={3000} autohide={true} headerClass="text-fixed-white bg-warning" imgClass="bd-placeholder-img rounded me-2" imgSrc="/build/assets/images/brand-logos/toggle-dark.png" message="Your,toast message here." title="Vyzor" />
                        </ToastContainer>
                    </ShowCode>
                </Col>
            </Row>
                    ...
                    <ShowCode title="Toast Placements" customCardClass="custom-card" customCardBodyClass="" reactCode={toast10} reusableCode={reusabletoast10}>
                        ...
                        <ToastContainer className="toast-container position-fixed top-0 start-0 p-3">
                            <SpkToast ToastHeader={true} toastClass="toast colored-toast bg-primary-transparent text-primary"
                                onClose={() => handleToasts('topLeft')} show={toasts['topLeft'] || false} delay={3000} autohide={true} headerClass="bg-primary text-fixed-white" imgClass="bd-placeholder-img rounded me-2" imgSrc="/build/assets/images/brand-logos/toggle-dark.png" title="Vyzor" message="Your,toast message here." />
                        </ToastContainer>
                        <ToastContainer className="toast-container position-fixed top-0 start-50 translate-middle-x p-3">
                            <SpkToast ToastHeader={true} toastClass="toast colored-toast bg-primary-transparent text-primary"
                                onClose={() => handleToasts('topCenter')} show={toasts['topCenter'] || false} delay={3000} autohide={true} headerClass="bg-primary text-fixed-white" imgClass="bd-placeholder-img rounded me-2" imgSrc="/build/assets/images/brand-logos/toggle-dark.png" title="Vyzor" message="Your,toast message here." />
                        </ToastContainer>
                        <ToastContainer className="toast-container position-fixed top-0 end-0 p-3">
                            <SpkToast ToastHeader={true} toastClass="toast colored-toast bg-primary-transparent text-primary"
                                onClose={() => handleToasts('topRight')} show={toasts['topRight'] || false} delay={3000} autohide={true} headerClass="bg-primary text-fixed-white" imgClass="bd-placeholder-img rounded me-2" imgSrc="/build/assets/images/brand-logos/toggle-dark.png" title="Vyzor" message="Your,toast message here." />
                        </ToastContainer>
                        <ToastContainer className="toast-container position-fixed top-50 start-0 translate-middle-y p-3">
                            <SpkToast ToastHeader={true} toastClass="toast colored-toast bg-primary-transparent text-primary"
                                onClose={() => handleToasts('middleLeft')} show={toasts['middleLeft'] || false} delay={3000} autohide={true} headerClass="bg-primary text-fixed-white" imgClass="bd-placeholder-img rounded me-2" imgSrc="/build/assets/images/brand-logos/toggle-dark.png" title="Vyzor" message="Your,toast message here." />
                        </ToastContainer>
                        <ToastContainer className="toast-container position-fixed top-50 start-50 translate-middle">
                            <SpkToast ToastHeader={true} toastClass="toast colored-toast bg-primary-transparent text-primary"
                                onClose={() => handleToasts('middleCenter')} show={toasts['middleCenter'] || false} delay={3000} autohide={true} headerClass="bg-primary text-fixed-white" imgClass="bd-placeholder-img rounded me-2" imgSrc="/build/assets/images/brand-logos/toggle-dark.png" title="Vyzor" message="Your,toast message here." />
                        </ToastContainer>
                        <ToastContainer className="toast-container position-fixed top-50 end-0 translate-middle-y p-3">
                            <SpkToast ToastHeader={true} toastClass="toast colored-toast bg-primary-transparent text-primary"
                                onClose={() => handleToasts('middleRight')} show={toasts['middleRight'] || false} delay={3000} autohide={true} headerClass="bg-primary text-fixed-white" imgClass="bd-placeholder-img rounded me-2" imgSrc="/build/assets/images/brand-logos/toggle-dark.png" title="Vyzor" message="Your,toast message here." />
                        </ToastContainer>
                        <ToastContainer className="toast-container position-fixed bottom-0 start-0 p-3">
                            <SpkToast ToastHeader={true} toastClass="toast colored-toast bg-primary-transparent text-primary"
                                onClose={() => handleToasts('bottomLeft')} show={toasts['bottomLeft'] || false} delay={3000} autohide={true} headerClass="bg-primary text-fixed-white" imgClass="bd-placeholder-img rounded me-2" imgSrc="/build/assets/images/brand-logos/toggle-dark.png" title="Vyzor" message="Your,toast message here." />
                        </ToastContainer>
                        <ToastContainer className="toast-container position-fixed bottom-0 start-50 translate-middle-x p-3">
                            <SpkToast ToastHeader={true} toastClass="toast colored-toast bg-primary-transparent text-primary"
                                onClose={() => handleToasts('bottomCenter')} show={toasts['bottomCenter'] || false} delay={3000} autohide={true} headerClass="bg-primary text-fixed-white" imgClass="bd-placeholder-img rounded me-2" imgSrc="/build/assets/images/brand-logos/toggle-dark.png" title="Vyzor" message="Your,toast message here." />
                        </ToastContainer>
                        <ToastContainer className="toast-container position-fixed bottom-0 end-0 p-3">
                            <SpkToast ToastHeader={true} toastClass="toast colored-toast bg-primary-transparent text-primary"
                                onClose={() => handleToasts('bottomRight')} show={toasts['bottomRight'] || false} delay={3000} autohide={true} headerClass="bg-primary text-fixed-white" imgClass="bd-placeholder-img rounded me-2" imgSrc="/build/assets/images/brand-logos/toggle-dark.png" title="Vyzor" message="Your,toast message here." />
                        </ToastContainer>
                    </ShowCode>
                </Col>
            </Row>
            ...
            <Row>
                <Col xl={6}>
                    <ShowCode title="Aligning Toast Using Flexbox" customCardClass="custom-card" customCardBodyClass="px-1 px-sm-4" reactCode={toast9} reusableCode={reusabletoast9}>
                        <div className="bd-example bg-light bd-example-toasts d-flex p-0 px-3">
                            <div aria-live="polite" aria-atomic="true"
                                className="d-flex justify-content-center align-items-center w-100">
                                <SpkToast ToastHeader={true} show={toasts['alignColor']} onClose={() => handleToasts('alignColor')} toastClass="fade show shadow-lg" headerClass="text-default" imgClass="bd-placeholder-img rounded me-2" imgSrc="/build/assets/images/brand-logos/toggle-logo.png" title="Vyzor" timestamp="11 mins ago" message="Hello, world! This is a toast message." />
                            </div>
                        </div>
                    </ShowCode>
                </Col>
...
// Assign layout
Toasts.layout = (page) => <MainLayout>{page}</MainLayout>;
