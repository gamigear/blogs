...
const NavsTabs = () => {
    ...
    return (
        ...
        <Fragment>
            ...
            <Head title="Ui Elements-Navs & Tabs" />
            ...
            <Row>
                <Col xl={12}>
                    <Card className="custom-card">
                        ...
                        <Card.Body className="">
                            <Nav className=" nav-tabs border-0 gap-sm-0 gap-1" defaultActiveKey="1">
                                <Nav.Item>
                                    <Nav.Link eventKey="1" className="" >Active</Nav.Link>
                                </Nav.Item>
                                <Nav.Item>
                    ...
                    <Card className="custom-card">
                        ...
                        <Card.Body className="">
                            <Nav className="nav-pills gap-sm-0 gap-1" defaultActiveKey="4">
                                <Nav.Item>
                                    <Nav.Link eventKey="4" className="active" >Active</Nav.Link>
                                </Nav.Item>
                                <Nav.Item>
                                    <Nav.Link className="nav-link" >Link </Nav.Link>
                                </Nav.Item>
                        ...
                        <Tab.Container defaultActiveKey="home">
                            <Card.Body className="">
                                <Nav className="nav-tabs mb-3 border-0" role="tablist">
                                    <Nav.Item>
                                        <Nav.Link eventKey="home" className=""
                                        >Home</Nav.Link>
                                    </Nav.Item>
                                    <Nav.Item>
                                        <Nav.Link eventKey="about" className=""
                                            aria-selected="false">About</Nav.Link>
                                    </Nav.Item>
                                    <Nav.Item>
                                        <Nav.Link eventKey="service" className=""
                                            aria-selected="false">Services</Nav.Link>
                                    </Nav.Item>
                                    <Nav.Item>
                                        <Nav.Link eventKey="license" className=""
                        ...
                        <Tab.Container defaultActiveKey="service1">
                            <Card.Body className="">
                                <Nav className=" nav-tabs mb-3 nav-justified nav-style-1 d-sm-flex d-block" role="tablist">
                                    <Nav.Item>
                                        <Nav.Link eventKey="home1" className=""
                                            aria-selected="false">Home</Nav.Link>
                                    </Nav.Item>
                                    <Nav.Item>
                                        <Nav.Link eventKey="about1" className=""
                                            aria-selected="false">About</Nav.Link>
                                    </Nav.Item>
                                    <Nav.Item className="">
                                        <Nav.Link eventKey="service1" className=""
                                        >Services</Nav.Link>
                                    </Nav.Item>
                                    <Nav.Item>
                                        <Nav.Link eventKey="license1" className=""
                                            aria-selected="false">License</Nav.Link>
                                    </Nav.Item>
                                </Nav>
                                <Tab.Content className="">
                        ...
                        <Tab.Container defaultActiveKey="cart1">
                            <Card.Body className="">
                                <Nav className="nav-style-6 nav-pills mb-3 nav-justified d-sm-flex d-block" role="tablist">
                                    <Nav.Link eventKey="products1" className=""
                                        aria-selected="false">Products</Nav.Link>
                                    <Nav.Link eventKey="cart1" className=""
                                    >Cart <SpkBadge variant="info-transparent"
                                        Customclass="ms-1">Full</SpkBadge></Nav.Link>
                                    <Nav.Link eventKey="orders1" className=""
                                        aria-selected="false">Orders </Nav.Link>
                                    <Nav.Link eventKey="offers1" className=""
                                ...
                                <Row>
                                    <Col xl={3}>
                                        <Nav className=" nav-tabs flex-column nav-style-4" role="tablist">
                                            <Nav.Item>
                                                <Nav.Link eventKey="vertical1" className=""

                                                >Home</Nav.Link>
                                            </Nav.Item>
                                            <Nav.Item>
                                                <Nav.Link eventKey="vertical2" className=""

                                                >About</Nav.Link>
                                            </Nav.Item>
                                            <Nav.Item>
                                                <Nav.Link eventKey="vertical3" className=""

                                                >Services</Nav.Link>
                                            </Nav.Item>
                                            <Nav.Item>
                                                <Nav.Link eventKey="vertical4" className=""
                                ...
                                <Row>
                                    <div className="col-xl-3">
                                        <Nav className="nav-tabs flex-column nav-style-5" role="tablist">
                                            <Nav.Item>
                                                <Nav.Link eventKey="tab1" className=""
                        ...
                        <Tab.Container defaultActiveKey="tabs1">
                            <Card.Body className="">
                                <Nav className=" nav-pills justify-content-center nav-style-2 mb-3" role="tablist">
                                    <Nav.Item>
                                        <Nav.Link eventKey="tabs1" className=""
                                        >Home</Nav.Link>
                                    </Nav.Item>
                                    <Nav.Item>
                                        <Nav.Link eventKey="tabs2" className=""
                                            aria-selected="false">About</Nav.Link>
                                    </Nav.Item>
                                    <Nav.Item>
                                        <Nav.Link eventKey="tabs3" className=""
                                            aria-selected="false">Services</Nav.Link>
                                    </Nav.Item>
                                    <Nav.Item>
                                        <Nav.Link eventKey="tabs4" className=""
                                            aria-selected="false">Contacts</Nav.Link>
                                    </Nav.Item>
                                </Nav>
                                <Tab.Content className="">
                        ...
                        <Tab.Container defaultActiveKey="right1">
                            <Card.Body className="">
                                <Nav className=" nav-pills justify-content-end nav-style-3 mb-3" role="tablist">
                                    <Nav.Item>
                                        <Nav.Link eventKey="right1" className=""
                                        >Home</Nav.Link>
                                    </Nav.Item>
                                    <Nav.Item>
                                        <Nav.Link eventKey="right2" className=""
                                        >About</Nav.Link>
                                    </Nav.Item>
                                    <Nav.Item>
                                        <Nav.Link eventKey="right3" className=""
                                        >Services</Nav.Link>
                                    </Nav.Item>
                                    <Nav.Item>
                                        <Nav.Link eventKey="right4" className=""
                                        >Contacts</Nav.Link>
                                    </Nav.Item>
                                </Nav>
                                <Tab.Content className="">
                            ...
                            <div className="card-header justify-content-between">
                                ...
                                <div>
                                    <Nav className=" nav-tabs justify-content-end nav-tabs-header mb-0" role="tablist">
                                        <Nav.Item>
                                            <Nav.Link eventKey="header1" className=""
                                            >Home</Nav.Link>
                                        </Nav.Item>
                                        <Nav.Item>
                                            <Nav.Link eventKey="header2" className=""
                                            >About</Nav.Link>
                                        </Nav.Item>
                                        <Nav.Item>
                                            <Nav.Link eventKey="header3" className=""
                                            >Services</Nav.Link>
                                        </Nav.Item>
                                    </Nav>
                                </div>
                            ...
                            <div className="card-footer">
                                <Nav className=" nav-tabs justify-content-end nav-tabs-footer mb-0" role="tablist">
                                    <Nav.Item className="m-1">
                                        <Nav.Link eventKey="footer1" className=""
                                        >Home</Nav.Link>
                                    </Nav.Item>
                                    <Nav.Item className="m-1">
                                        <Nav.Link eventKey="footer2" className=""
                                        >About</Nav.Link>
                                    </Nav.Item>
                                    <Nav.Item className="m-1">
                                        <Nav.Link eventKey="footer3" className=""
                                        >Services</Nav.Link>
                                    </Nav.Item>
                                </Nav>
                            </div>
                        ...
                        <Tab.Container defaultActiveKey="orders1">
                            <Card.Body className="">
                                <Nav className=" nav-tabs tab-style-1 d-sm-flex d-block" role="tablist">
                                    <Nav.Item>
                                        <Nav.Link eventKey="orders1" className="" data-bs-target="#orders"
                                        >Orders</Nav.Link>
                                    </Nav.Item>
                                    <Nav.Item>
                                        <Nav.Link eventKey="orders2" className="" data-bs-target="#accepted"
                                        >Accepted</Nav.Link>
                                    </Nav.Item>
                                    <Nav.Item>
                                        <Nav.Link eventKey="orders3" className="" data-bs-target="#declined"
                                        >Declined</Nav.Link>
                                    </Nav.Item>
                                </Nav>
                                <Tab.Content className="">
                            ...
                            <Card.Body className="">
                                <Nav className=" nav-tabs tab-style-2 nav-justified mb-3 d-sm-flex d-block" id="myTab1" role="tablist">
                                    <Nav.Item className="" role="presentation">
                                        <Nav.Link eventKey="ordertab1" className="" id="order-tab"
                                            data-bs-target="#order-tab-pane" type="button"
                                            aria-controls="home-tab-pane" ><i
                                                className="ri-gift-line me-1 align-middle"></i>Ordered</Nav.Link>
                                    </Nav.Item>
                                    <Nav.Item className="" role="presentation">
                                        <Nav.Link eventKey="ordertab2" className="" id="confirmed-tab"
                                            data-bs-target="#confirm-tab-pane" type="button"
                                    ...
                                    <Nav.Item className="" role="presentation">
                                        <Nav.Link eventKey="ordertab3" className="" id="shipped-tab"
                                            data-bs-target="#shipped-tab-pane" type="button"
                                    ...
                                    <Nav.Item className="" role="presentation">
                                        <Nav.Link eventKey="ordertab4" className="" id="delivered-tab"
                                            data-bs-target="#delivered-tab-pane" type="button" aria-selected="false"><i
                            ...
                            <Card.Body className="px-0">
                                <Nav className=" nav-tabs justify-content-center mb-5 tab-style-3" id="myTab2"
                                    ...
                                    <Nav.Item className=" me-0" role="presentation">
                                        <Nav.Link eventKey="hometab" className=" home py-1" id="home-tab"
                                            data-bs-target="#home-tab-pane" type="button"
                                            aria-controls="home-tab-pane" >Home</Nav.Link>
                                    </Nav.Item>
                                    <Nav.Item className=" me-0" role="presentation">
                                        <Nav.Link eventKey="profiletab" className=" about py-1" id="profile-tab"
                                            data-bs-target="#profile-tab-pane" type="button"
                                            aria-controls="profile-tab-pane" aria-selected="false">About</Nav.Link>
                                    </Nav.Item>
                                    <Nav.Item className=" me-0" role="presentation">
                                        <Nav.Link eventKey="contacttab" className=" services py-1" id="contact-tab"
                            ...
                            <Card.Body className=" px-1">
                                <nav>
                                    <Nav className="nav-tabs nav-justified tab-style-4 d-flex" id="nav-tab" role="tablist">
                                        <Nav.Link eventKey="hometab1" className="" id="nav-home-tab"
                                            data-bs-target="#nav-home1" type="button" >Home</Nav.Link>
                                        <Nav.Link eventKey="profiletab1" className="" id="nav-profile-tab"
                                            data-bs-target="#nav-profile1" type="button" aria-selected="false">Profile</Nav.Link>
                                        <Nav.Link eventKey="contacttab1" className="" id="nav-contact-tab"
                                            data-bs-target="#nav-contact1" type="button" aria-selected="false">About</Nav.Link>
                                    </Nav>
                                </nav>
                                ...
                                <Nav className=" nav-pills mb-3 nav-justified tab-style-5 d-sm-flex d-block" id="pills-tab" role="tablist">
                                    <Nav.Item className="" role="presentation">
                                        <Nav.Link eventKey="pillhome" className="" id="pills-home-tab" data-bs-toggle="pill"
                                            ...
                                            aria-controls="pills-home" >Home</Nav.Link>
                                    </Nav.Item>
                                    <Nav.Item className="" role="presentation">
                        ...
                        <Tab.Container defaultActiveKey="a">
                            <Card.Body className="custom-nav-tab">
                                <Nav className=" nav-tabs mb-3 tab-style-6" id="myTab3" role="tablist">
                                    <Nav.Item className="" role="presentation">
                                        <Nav.Link eventKey="a" className="" id="products-tab"
                                            data-bs-target="#products-tab-pane" type="button"
                                            aria-controls="products-tab-pane" ><i
                                                className="ri-gift-line me-1 align-middle d-inline-block"></i>Products</Nav.Link>
                                    </Nav.Item>
                                    <Nav.Item className="" role="presentation">
                                        <Nav.Link eventKey="b" className="" id="sales-tab"
                                            data-bs-target="#sales-tab-pane" type="button"
                                    ...
                                    <Nav.Item className="" role="presentation">
                                        <Nav.Link eventKey="c" className="" id="profit-tab"
                                            data-bs-target="#profit-tab-pane" type="button"
                                    ...
                                    <Nav.Item className="" role="presentation">
                                        <Nav.Link eventKey="d" className="" id="expenses-tab"
                                            data-bs-target="#expenses-tab-pane" type="button"
                                        ...
                                        <div className="table-responsive">
                                            <SpkTables tableClass="mb-0" header={[{ title: 'Product' }, { title: 'Name' }, { title: 'Category' }, { title: 'Price' }]} >
                                                <tr>
                                                    <th scope="row">
                                                        <span className="avatar avatar-sm">
                                                            <BaseImage src="/build/assets/images/ecommerce/jpg/3.jpg" alt="img" />
                                                        </span>
                                                    </th>
                                                    <td>Shoes</td>
                                                    <td>Footwear</td>
                                                ...
                                                <tr>
                                                    <th scope="row">
                                                        <span className="avatar avatar-sm">
                                                            <BaseImage src="/build/assets/images/ecommerce/jpg/4.jpg" alt="img" />
                                                        </span>
                                                    </th>
                                                    <td>Casual Shoes</td>
                                                    <td>Casual Wear</td>
                                                ...
                                                <tr>
                                                    <th scope="row">
                                                        <span className="avatar avatar-sm">
                                                            <BaseImage src="/build/assets/images/ecommerce/jpg/6.jpg" alt="img" />
                                                        </span>
                                                    </th>
                                                    <td>Sport Shoes</td>
                                                    <td>Footwear</td>
                        ...
                        <Tab.Container defaultActiveKey="homestyle">
                            <Card.Body className="">
                                <Nav className=" nav-tabs mb-3 tab-style-8 scaleX" id="myTab4" role="tablist">
                                    <Nav.Item className="" role="presentation">
                                        <Nav.Link eventKey="homestyle" className="" id="home-style8-tab"
                                            data-bs-target="#home-style8-tab-pane" type="button"
                                            aria-controls="home-style8-tab-pane" >Home</Nav.Link>
                                    </Nav.Item>
                                    <Nav.Item className="" role="presentation">
                                        <Nav.Link eventKey="aboutstyle" className="" id="about-style8-tab"
                                            data-bs-target="#about-style8-tab-pane" type="button"
                                            aria-controls="about-style8-tab-pane" aria-selected="false">About</Nav.Link>
                                    </Nav.Item>
                                    <Nav.Item className="" role="presentation">
                                        <Nav.Link eventKey="servicestyle" className="" id="services-style8-tab"
                                            data-bs-target="#services-style8-tab-pane" type="button"
                                        ...
                                        <Nav className="flex-column nav-pills me-3 tab-style-7" id="v-pills-tab"
                                            ...
                                            <Nav.Item>
                                                <Nav.Link eventKey="mainprofile" className=" text-start" id="main-profile-tab" data-bs-toggle="pill"
                                                    data-bs-target="#main-profile" type="button"
                                                    aria-controls="main-profile" ><i
                                            ...
                                            <Nav.Item>
                                                <Nav.Link eventKey="mainpassword" className=" text-start" id="man-password-tab" data-bs-toggle="pill"
                                                    data-bs-target="#man-password" type="button"
                                            ...
                                            <Nav.Item>
                                                <Nav.Link eventKey="mainteam" className=" text-start" id="main-team-tab" data-bs-toggle="pill"
                                                    data-bs-target="#main-team" type="button"
                                            ...
                                            <Nav.Item>
                                                <Nav.Link eventKey="mainbilling" className=" text-start" id="main-billing-tab" data-bs-toggle="pill"
                                                    data-bs-target="#main-billing" type="button"
                                            ...
                                            <Nav.Item>
                                                <Nav.Link eventKey="mainemail" className=" text-start mb-1" id="main-email-tab" data-bs-toggle="pill"
                                                    data-bs-target="#main-email" type="button"
                                                ...
                                                <div className="d-sm-flex">
                                                    <div className="me-3">
                                                        <span className="avatar avatar-xxl">
                                                            <BaseImage src="/build/assets/images/faces/9.jpg" alt="img" />
                                                        </span>
                                                    </div>
                                                    <div>
                                ...
                                <Row>
                                    <div className="col-md-3">
                                        <Nav className=" nav-tabs flex-column vertical-tabs-2" role="tablist">
                                            <Nav.Item>
                                                <Nav.Link eventKey="customhome" className=""
                                            ...
                                            <Nav.Item>
                                                <Nav.Link eventKey="customabout" className=""
                                            ...
                                            <Nav.Item>
                                                <Nav.Link eventKey="customservice" className=" mb-0"
                                ...
                                <Row>
                                    <div className="col-md-4">
                                        <Nav className=" nav-tabs flex-column vertical-tabs-3" role="tablist">
                                            <Nav.Item>
                                                <Nav.Link eventKey="employee" className="text-break"
                                            ...
                                            <Nav.Item>
                                                <Nav.Link eventKey="customers" className=" text-break"
                                            ...
                                            <Nav.Item>
                                                <Nav.Link eventKey="products" className=" text-break mb-2"
                        ...
                        <Tab.Container defaultActiveKey="drophome">
                            <Card.Body className="">
                                <Nav className=" nav-tabs mb-3 border-0 gap-sm-0 gap-1" role="tablist">
                                    <Nav.Item>
                                        <Nav.Link eventKey="drophome" className=""
                                        >Home</Nav.Link>
                                    </Nav.Item>
                                    ...
                                    <Nav.Item>
                                        <Nav.Link eventKey="drophome2" className=""
                                            aria-selected="false">Products</Nav.Link>
                                    </Nav.Item>
                                    <Nav.Item>
                        ...
                        <Tab.Container defaultActiveKey="pillproduct">
                            <Card.Body className="">
                                <Nav className=" nav-pills mb-3" role="tablist">
                                    <Nav.Item>
                                        <Nav.Link eventKey="pillproduct" className=""
                                        >Products</Nav.Link>
                                    </Nav.Item>
                                    <NavDropdown title="Cart" className="">
                                    ...
                                    <Nav.Item>
                                        <Nav.Link eventKey="pillorders" className=""
                                            aria-selected="false">Orders</Nav.Link>
                                    </Nav.Item>
                                    <Nav.Item>
                        ...
                        <Tab.Container defaultActiveKey="fillhome">
                            <Card.Body className="">
                                <Nav className=" nav-pills nav-fill mb-3" role="tablist">
                                    <Nav.Item>
                                        <Nav.Link eventKey="fillhome" className=""
                                        >Home</Nav.Link>
                                    </Nav.Item>
                                    <Nav.Item>
                                        <Nav.Link eventKey="fillabout" className=""
                                            aria-selected="false">Customer-ratings</Nav.Link>
                                    </Nav.Item>
                                    <Nav.Item>
                                        <Nav.Link eventKey="fillservice" className=""
                                            aria-selected="false">Services</Nav.Link>
                                    </Nav.Item>
                                    <Nav.Item>
                        ...
                        <Tab.Container defaultActiveKey="justhome">
                            <Card.Body className="">
                                <Nav className=" nav-pills nav-justified mb-3 d-sm-flex d-block" role="tablist">
                                    <Nav.Item>
                                        <Nav.Link eventKey="justhome" className=""
                                        >Home</Nav.Link>
                                    </Nav.Item>
                                    <Nav.Item>
                                        <Nav.Link eventKey="justdetail" className=""
                                        >Company Details</Nav.Link>
                                    </Nav.Item>
                                    <Nav.Item>
                                        <Nav.Link eventKey="justproduct" className=""
                                        >Products</Nav.Link>
                                    </Nav.Item>
                                    <Nav.Item>
                                        <Nav.Link eventKey="" className=" disabled">Disabled</Nav.Link>
                            ...
                            <Card.Body className="">
                                <Nav className="nav-pills flex-column flex-sm-row mb-3" role="tablist">
                                    <Nav.Item className="flex-fill">
                                        <Nav.Link eventKey="flexhome" className="flex-sm-fill text-sm-center"
                                        >Home</Nav.Link>
                                    </Nav.Item>
                                    <Nav.Item className="flex-fill">
                                        <Nav.Link eventKey="flexbig" className="flex-sm-fill text-sm-center"
                                            aria-selected="false">More Data More The Tab Size</Nav.Link>
                                    </Nav.Item>
                                    <Nav.Item className="flex-fill">
                                        <Nav.Link eventKey="flexabout" className="flex-sm-fill text-sm-center"
                                            aria-selected="false">About</Nav.Link>
                                    </Nav.Item>
...
// Assign layout
NavsTabs.layout = (page) => <MainLayout>{page}</MainLayout>;
