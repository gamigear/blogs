			...
			<Row>
				<Col xl={6}>
					<ShowCode title="Responsive image" customCardClass="custom-card" customCardBodyClass="" reactCode={image5}>
						...
						<div className="text-center">
							<BaseImage src="/build/assets/images/media/media-48.jpg" className="img-fluid" alt="..." />
						</div>
					</ShowCode>
				</Col>
				<Col xl={6}>
					<ShowCode title="Image With Radius" customCardClass="custom-card" customCardBodyClass="" reactCode={image4}>
						...
						<div className="text-center">
							<BaseImage src="/build/assets/images/media/media-49.jpg" className="img-fluid rounded" alt="..." />
						</div>
					</ShowCode>
				</Col>
				<Col xl={6}>
					<ShowCode title="Rounded Image" customCardClass="custom-card" customCardBodyClass="" reactCode={image6}>
						...
						<div className="text-center">
							<BaseImage src="/build/assets/images/media/media-50.jpg" className="img-fluid rounded-pill" alt="..." />
						</div>
					</ShowCode>
				</Col>
				<Col xl={6}>
					<ShowCode title="Image Left Align" customCardClass="custom-card" customCardBodyClass="" reactCode={image3}>
						...
						<BaseImage className="rounded float-start" src="/build/assets/images/media/media-53.jpg" alt="..." />
					</ShowCode>
				</Col>
				<Col xl={6}>
					<ShowCode title="Image Center Align" customCardClass="custom-card" customCardBodyClass="" reactCode={image1}>
						<BaseImage className="rounded mx-auto d-block" src="/build/assets/images/media/media-55.jpg" alt="..." />
					</ShowCode>
				</Col>
				<Col xl={6}>
					<ShowCode title="Image Right Align" customCardClass="custom-card" customCardBodyClass="" reactCode={image2}>
						<BaseImage className="rounded float-end" src="/build/assets/images/media/media-54.jpg" alt="..." />
					</ShowCode>
				</Col>
				<Col xl={6}>
					<ShowCode title="Figures" reactCode={image9} customCardClass="custom-card" customCardBodyClass="d-flex justify-content-between gap-4 card-body flex-wrap pb-4">
						<figure className="figure">
							<BaseImage className="bd-placeholder-img figure-img img-fluid rounded card-img" src="/build/assets/images/media/media-56.jpg" alt="..." />
							<figcaption className="figure-caption mt-2">A caption for the above image.
							</figcaption>
						</figure>
						<figure className="figure float-end">
							<BaseImage className="bd-placeholder-img figure-img img-fluid rounded card-img" src="/build/assets/images/media/media-57.jpg" alt="..." />
				...
				<Col xl={3}>
					<ShowCode title="Image Thumbnail" customCardClass="custom-card" customCardBodyClass="" reactCode={image7}>
						...
						<div className="text-center">
							<BaseImage src="/build/assets/images/media/media-51.jpg" className="img-thumbnail" alt="..." />
						</div>
					</ShowCode>
				</Col>
				<Col xl={3}>
					<ShowCode title="Rounded Thumbnail" customCardClass="custom-card" customCardBodyClass="" reactCode={image8}>
						...
						<div className="text-center">
							<BaseImage src="/build/assets/images/media/media-52.jpg" className="img-thumbnail rounded-pill" alt="..." />
						</div>
					</ShowCode>
				</Col>
			</Row>
...
// Assign layout
ImagesFigures.layout = (page) => <MainLayout>{page}</MainLayout>;
