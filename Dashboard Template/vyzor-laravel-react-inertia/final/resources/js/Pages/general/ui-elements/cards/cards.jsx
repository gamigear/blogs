        ...
        <Fragment>
            ...
            <div className="row">
                <Col xxl={3} xl={6} md={6} sm={12} className="">
                    <SpkCard titleClass="fw-medium px-3 pt-3" bodyClass="p-0" imgClass="card-img-top" imgSrc="/build/assets/images/media/media-24.jpg" title="Card title" bodyText={(
                        <>
                            ...
                            <div className="card-body border-top">
                                <BaseLink href="#!" className="card-link text-primary">Card link</BaseLink>
                                <BaseLink href="#!" className="card-link text-secondary d-inline-block">Another link</BaseLink>
                            </div>
                        </>
                    )} />
                ...
                <Col xxl={3} xl={6} md={6} sm={12} className="">
                    <SpkCard titleClass="fw-medium" imgClass="card-img-top" footer="<span class='card-text'>Last updated 3 mins ago</span>"
                        imgSrc="/build/assets/images/media/media-22.jpg" title="Card title" bodyText={(
                            <>
                                <p className="card-text text-muted">
                                    when an unknown printer took a galley of type and scrambled it to make a type specimen book. It has survived not only five centuries, but also the leap into electronic.
                                </p>
                                <BaseLink href="#!" className="btn btn-primary">Read More</BaseLink>
                            </>
                        )}
                    />
                </Col>
                <Col xxl={3} xl={6} md={6} sm={12} className="">
                    <SpkCard imgClass="card-img-top" imgSrc="/build/assets/images/media/media-23.jpg" bodyText={(
                        <>
                    ...
                    <div className="row row-cols-12">
                        <div className="col grid-cards">
                            <SpkCard
                                bodyText={(
                                    <>
                                        <BaseImage src="/build/assets/images/media/media-25.jpg" className="card-img mb-3" alt="..." />
                                        <h6 className="card-title fw-medium">Product A</h6>
                                        <p className="card-text">With supporting text below as a natural
                                            lead-in to additional content.</p>
                                        <BaseLink href="#!" className="btn btn-primary">Purchase</BaseLink>
                                    </>
                                )}
                            />
                        </div>
                        <div className="col grid-cards">
                            <SpkCard
                                bodyText={(
                                    <>
                                        <BaseImage src="/build/assets/images/media/media-26.jpg" className="card-img mb-3" alt="..." />
                                        <h6 className="card-title fw-medium">Product B</h6>
                                        <p className="card-text">With supporting text below as a natural
                                            lead-in to additional content.</p>
                                        <BaseLink href="#!" className="btn btn-secondary">Purchase</BaseLink>
                                    </>
                                )}
                            />
                        </div>
                        <div className="col grid-cards">
                            <SpkCard
                                bodyText={(
                                    <>
                                        <BaseImage src="/build/assets/images/media/media-27.jpg" className="card-img mb-3" alt="..." />
                                        <h6 className="card-title fw-medium">Product B</h6>
                                        <p className="card-text">With supporting text below as a natural
                                            lead-in to additional content.</p>
                                        <BaseLink href="#!" className="btn btn-light">Purchase</BaseLink>
                                    </>
                                )}
                            />
                        </div>
            ...
            <Row>
                        ...
                        bodyText={(
                            <>
                                <span className="avatar avatar-xl avatar-rounded me-2 mb-2">
                                    <BaseImage src="/build/assets/images/faces/1.jpg" alt="img" />
                                </span>
                                ...
                                <div className="d-flex align-items-center w-100">
                                    <div className="me-2">
                                        <span className="avatar avatar-rounded">
                                            <BaseImage src="/build/assets/images/faces/11.jpg" alt="img" />
                                        </span>
                                    </div>
                                    <div className="">
                                    ...
                                    <SpkDropdown Customclass="ms-auto" toggleas='a'  Customtoggleclass="no-caret btn-icon btn-sm btn-light" Togglevariant="light" Size='sm' Icon={true} IconClass="fe fe-more-vertical" >
                            ...
                            <>
                                <div className="d-flex align-items-center">
                                    <span className="avatar avatar-sm avatar-rounded me-2">
                                        <BaseImage height={28} width={28} src="/build/assets/images/faces/12.jpg" alt="img" />
                                    </span>
                ...
                <Col xl={3}>
                    <SpkCard header="Featured" titleClass="fw-medium mb-2" cardClass="text-center" bodyText={(
                        <>
                            ...
                            <BaseLink href="#!" className="btn btn-primary mt-2 me-1">Read More</BaseLink>
                            <BaseLink href="#!" className="btn btn-outline-secondary mt-2 me-1">Close</BaseLink>
                        </>
                    )}
                        footer={(
                            ...
                            <div className="d-flex w-100">
                                <div className="me-4">
                                    <span className="avatar avatar-lg avatar-rounded">
                                        <BaseImage src="/build/assets/images/faces/12.jpg" alt="img" />
                                    </span>
                                </div>
                ...
                <Col xl={2}>
                    <SpkCard cardClass="mountains-card grid-cards" bodyText={(
                        <>
                            <BaseImage src="/build/assets/images/media/media-4.jpg" className="card-img mb-3" alt="..." />
                ...
                <Col xl={2}>
                    <SpkCard cardClass="mountains-card grid-cards" bodyText={(
                        <>
                            <BaseImage src="/build/assets/images/media/media-9.jpg" className="card-img mb-3" alt="..." />
                ...
                <Col xl={2}>
                    <SpkCard cardClass="mountains-card grid-cards" bodyText={(
                        <>
                            <BaseImage src="/build/assets/images/media/media-15.jpg" className="card-img mb-3" alt="..." />
            ...
            <Row>
                <Col xl={3}>
                    <Row>
                        ...
                        <Col xl={12}>
                            <SpkCard useDivHeader={true} cardHeader="bg-transparent border-bottom border-success p-2" header="Header" bodyClass="text-success" cardFooter="bg-transparent border-top border-success p-2" footer="Footer" cardClass="border border-success mb-3" bodyText={(
                                <>
                                ...
                                <>
                                    <div className="mb-2">
                                        <span className="avatar avatar-md">
                                            <BaseImage width={40} height={40} src="/build/assets/images/faces/15.jpg" alt="img" />
                                        </span>
                                    </div>
                                    ...
                                    <BaseLink href="#!" className="btn btn-primary">Go somewhere</BaseLink>
                                </>
                            )}
                            />
                        </Col>
                        <Col xl={4}>
                            <SpkCard cardClass="text-end" bodyText={(
                                <>
                                    <div className="mb-2">
                                        <span className="avatar avatar-md">
                                            <BaseImage width={40} height={40} src="/build/assets/images/faces/11.jpg" alt="img" />
                                        </span>
                                    </div>
                        ...
                        <Col xl={4}>
                            <SpkCard cardClass="text-center" bodyText={(
                                <>
                                    <div className="mb-2">
                                        <span className="avatar avatar-md">
                                            <BaseImage width={40} height={40} src="/build/assets/images/faces/3.jpg" alt="img" />
                                        </span>
                                    </div>
            ...
            <Row>
                <Col xxl={6} xl={12} className="">
                    ...
                    <Row>
                        <Col xl={6}>
                            <SpkCard header="Using Width 75%" footer={(
                                <>
                                <BaseLink href='#!' className='btn btn-primary d-grid'>Button</BaseLink>
                                </>
                            )}
                             cardClass="w-75"
                                bodyText={(
                        ...
                        <Col xl={6}>
                            <SpkCard header="Using Width 50%" footer={(
                                <>
                                <BaseLink href='#!' className='btn btn-primary d-grid'>Button</BaseLink>
                                </>
                            )} cardClass="w-50"
            ...
            <Row>
                <Col xl={4}>
                    <SpkCard imgSrc="/build/assets/images/media/media-29.jpg" imgClass="card-img-top" bodyText={(
                        <>
                ...
                <Col xl={4}>
                    <SpkCard imgSrcB="/build/assets/images/media/media-28.jpg" imgClassB="card-img-bottom" bodyText={(
                        <>
                            <h6 className="card-title fw-medium">Image caps are widely used in Blog's</h6>
                            <p className="card-text mb-3 text-muted">But I must explain to you how all this mistaken idea of denouncing pleasure and praising pain was born and I will give you a complete account of the system, and expound the actual teachings.</p>
                            <p className="card-text mb-0"><small>Last updated 3 mins ago</small></p>
                ...
                <Col xl={4}>
                    <SpkCard imgSrcB="/build/assets/images/media/media-31.jpg" imgClassB="card-img rounded-0" header="Image caps are widely used in Blog's" footer="<p class='card-text mb-0'><small>Last updated 3 mins ago</small></p>" bodyText={(
                        <>
                ...
                <Col xl={4}>
                    <SpkCard imgSrcA="/build/assets/images/media/media-32.jpg" imgClassA="card-img-top" header="Image caps are widely used in Blog's" footer="<p class='card-text mb-0'><small>Last updated 3 mins ago</small></p>" bodyText={(
                        <>
                            <p className="card-text mb-1 text-muted">This is a wider card with supporting text below
                                as
                                a natural lead-in to additional content. This content is a
                ...
                <Col xl={4}>
                    <SpkCard imgSrcB="/build/assets/images/media/media-30.jpg" imgClassB="card-img rounded-0" footer="<p class='card-text mb-0'><small>Last updated 3 mins ago</small></p>"
                        bodyText={(
                            <>
                ...
                <Col xl={4}>
                    <SpkCard imgSrcC="/build/assets/images/media/media-33.jpg" imgClassC="card-img-bottom"
                        footer={(
            ...
            <Row>
                <Col xl={4}>
                    <Spkimageoverlaycard CustomClass="overlay-card" Imgsrc="/build/assets/images/media/media-35.jpg" Title="Image Overlays Are Awesome!" CustomTitleclass="text-fixed-white" CardHeader={true} CardFooter={false} Custombodyclass="text-fixed-white overflow-y-auto" >
                        <div className="fs-12 mb-2 card-text">There are many variations of passages of Lorem Ipsum available, but the majority have suffered alteration in some form, by injected humour, or randomised words which don't look even.</div>
                        <div className="card-text">Last updated 3 mins ago</div>
                    </Spkimageoverlaycard>
                </Col>
                <Col xl={4}>
                    <Spkimageoverlaycard CustomClass="overlay-card" Custombodyclass="text-fixed-white" Footertext="Last updated 3 mins ago" Imgsrc="/build/assets/images/media/media-36.jpg" Customfooterclass="text-fixed-white" Overlayclass="over-content-bottom" CardHeader={false} CardFooter={true}  >
                ...
                <Col xl={4}>
                    <Spkimageoverlaycard CustomClass="overlay-card" Title=" Image Overlays Are Awesome!" CustomTitleclass="text-fixed-white" Imgsrc="/build/assets/images/media/media-34.jpg" Custombodyclass="text-fixed-white overflow-y-auto p-2 p-sm-4" Customfooterclass="text-fixed-white d-none d-sm-block" CardHeader={true} CardFooter={true} Footertext="Last updated 3 mins ago" >
            ...
            <Row>
                <Col xl={4}>
                    <Spkhorizontalcards CardHeader={true} Imgposition="before" Imagesrc="/build/assets/images/media/media-37.jpg" Imgclass="img-fluid rounded-start h-100 w-100" Title="Horizontal Cards" CardFooter={true} Footertext={"Last updated 3 mins ago"} Navigate={""} >
                ...
                <Col xl={4}>
                    <Spkhorizontalcards CardHeader={true} Imgposition="after" Imagesrc="/build/assets/images/media/media-38.jpg" Title="Horizontal Cards" Navigate={""}  >
                        <h6 className="card-title fw-medium">Horizontal cards are awesome!</h6>
                ...
                <Col xl={4}>
                    <Spkhorizontalcards CardFooter={true} Footertext="Last updated 3 mins ago" Imgposition="after" Imagesrc="/build/assets/images/media/media-39.jpg" Navigate={""} >
            ...
            <Row>
                <Col xl={3}>
                    <Spkbgcards Navigate="#!" color="primary" Imgsrc="/build/assets/images/faces/11.jpg" Title="Adam Smith" Value="Finished by today" Textclass="fixed-white" Class="fixed-white" icon="bi bi-three-dots-vertical" />
                </Col>
                <Col xl={3}>
                    <Spkbgcards Navigate="#!" color="secondary" Imgsrc="/build/assets/images/faces/12.jpg" Title="Elisha Corner" Value="Completed 24 days back" Textclass="fixed-white" Class="fixed-white" icon="bi bi-three-dots-vertical" />
                </Col>
                <Col xl={3}>
                    <Spkbgcards Navigate="#!" color="warning" Imgsrc="/build/assets/images/faces/1.jpg" Title="Sarah Alina" Value="Completed today" Textclass="fixed-white" Class="fixed-white" icon="bi bi-three-dots-vertical" />
                </Col>
                <Col xl={3}>
                    <Spkbgcards Navigate="#!" color="info" Imgsrc="/build/assets/images/faces/8.jpg" Title="Monica Karen" Value="Pending from 4 days" Textclass="fixed-white" Class="fixed-white" icon="bi bi-three-dots-vertical" />
                </Col>
                <Col xl={3}>
                    <Spkbgcards Navigate="#!" color="success" Imgsrc="/build/assets/images/faces/5.jpg" Title="Samantha sid" Value="In leave for 1 month" Textclass="fixed-white" Class="fixed-white" icon="bi bi-three-dots-vertical" />
                </Col>
                <Col xl={3}>
                    <Spkbgcards Navigate="#!" color="danger" Imgsrc="/build/assets/images/faces/14.jpg" Title="Sebastien steyn" Value="Completed by Tomorrow" Textclass="fixed-white" Class="fixed-white" icon="bi bi-three-dots-vertical" />
                </Col>
                <Col xl={3}>
                    <Spkbgcards Navigate="#!" color="light" Imgsrc="/build/assets/images/faces/13.jpg" Title="Jacob Smith" Value="Finished by 24,Nov" Textclass="muted" Class="text-default" icon="bi bi-three-dots-vertical" />
                </Col>
                <Col xl={3}>
                    <Spkbgcards Navigate="#!" color="dark" Imgsrc="/build/assets/images/faces/16.jpg" Title="Pope Adam" Value="Completed on 24,may" Textclass="text-white" Class="white" icon="bi bi-three-dots-vertical" />
                </Col>
            </Row>
            ...
            <Row>
                <Col xl={12}>
                    <div className="card-group">
                        <SpkCard cardClass="overflow-hidden" imgSrcA="/build/assets/images/media/media-40.jpg" imgClassA=" horizontal-custom-card" footer="<small class='text-muted'>Last updated 3 mins ago</small>"
                            bodyText={(
                                <>
                        ...
                        />
                        <SpkCard cardClass="overflow-hidden" imgSrcA="/build/assets/images/media/media-42.jpg" imgClassA=" horizontal-custom-card" footer="<small class='text-muted'>Last updated 3 mins ago</small>"
                            bodyText={(
                                <>
                        ...
                        />
                        <SpkCard cardClass="overflow-hidden" imgSrcA="/build/assets/images/media/media-41.jpg" imgClassA=" horizontal-custom-card" footer="<small class='text-muted'>Last updated 3 mins ago</small>"
                            bodyText={(
                                <>
            ...
            <Row>
                <Col xl={12}>
                    <Row className="row-cols-1 row-cols-md-4 g-4">
                        <div className="col">
                            <SpkCard imgSrcA="/build/assets/images/media/media-44.jpg" imgClassA="card-img-top" bodyText={(
                                <>
                        ...
                        <div className="col">
                            <SpkCard imgSrcA="/build/assets/images/media/media-43.jpg" imgClassA="card-img-top" bodyText={(
                                <>
                        ...
                        <div className="col">
                            <SpkCard imgSrcA="/build/assets/images/media/media-45.jpg" imgClassA="card-img-top" bodyText={(
                                <>
                        ...
                        <div className="col">
                            <SpkCard imgSrcA="/build/assets/images/media/media-46.jpg" imgClassA="card-img-top" bodyText={(
                                <>
            ...
            <Row>
                <Col xxl={3} xl={12}>
                    <SpkCard imgSrcA="/build/assets/images/media/media-23.jpg" imgClassA="card-img-top" linkTag={true} titleClass="fw-medium mb-0" title="Forests are Awesome." />
                </Col>
                <Col xxl={6} xl={6}>
                    <Row>
                        <Col xxl={12} xl={12}>
                                    ...
                                    <div className="d-flex align-items-center">
                                        <div className="me-3">
                                            <span className="avatar avatar-xl">
                                                <BaseImage width={64} height={64} src="/build/assets/images/faces/8.jpg" alt="img" />
                                            </span>
                                        </div>
                                        <div>
                        ...
                        <Col xxl={7} zl={12}>
                            <Spkhorizontalcards Linktag={true} Navigate="#!" Imgposition="after" CardFooter={true} Imagesrc="/build/assets/images/media/media-39.jpg" Footertext="Last updated 3 mins ago" >
                ...
                <Col xxl={3} xl={6}>
                    <SpkCard linkTag={true} imgSrcA="/build/assets/images/media/media-47.jpg" imgClassA="card-img-top" bodyText={(
                        <>
                            <h6 className="card-title fw-medium">Most tropical areas are suitable</h6>
                            <p className="card-text"> If you are going to use a passage of Lorem Ipsum, you need to be sure there isn't anything embarrassing hidden in the middle of text.</p>
                        </>
...
// Assign layout
Cards.layout = (page) => <MainLayout>{page}</MainLayout>;
