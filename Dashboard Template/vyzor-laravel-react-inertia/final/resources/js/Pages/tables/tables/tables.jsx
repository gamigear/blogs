                                    ...
                                    <tr key={index}>
                                        ...
                                        <td>
                                            <div className="hstack gap-2 flex-wrap">
                                                <BaseLink href="#!" className="text-info fs-14 lh-1">
                                                    <i className="ri-edit-line"></i>
                                                </BaseLink>
                                                <BaseLink href="#!" className="text-danger fs-14 lh-1">
                            ...
                            <SpkTables tableClass="text-nowrap" tBodyClass="table-group-divider" header={[{ title: 'Product' }, { title: 'Seller' }, { title: 'Sale Percentage' }, { title: 'Quantity Sold' }]}>
                                {Groupdata.map((idx, index) => (
                                    <tr key={index}>
                                        ...
                                        <td>{idx.seller}</td>
                                        <td><BaseLink href="#!" className={`text-${idx.color}`}>{idx.percent}<i
                                            className={`ri-arrow-${idx.icon}-fill ms-1`}></i></BaseLink></td>
                                        <td>{idx.sold}</td>
                                    </tr>
                                ))}
                            </SpkTables>
                                    ...
                                    <tr key={index}>
                                        ...
                                        <td>
                                            <div className="hstack gap-2 fs-15">
                                                <BaseLink href="#!" className="btn btn-icon btn-sm btn-success-light rounded-pill"><i className="ri-download-2-line"></i></BaseLink>
                                                <BaseLink href="#!" className="btn btn-icon btn-sm btn-info-light rounded-pill"><i className="ri-edit-line"></i></BaseLink>
                                                <BaseLink href="#!" className="btn btn-icon btn-sm btn-danger-light rounded-pill"><i className="ri-delete-bin-line"></i></BaseLink>
                                            </div>
                                        </td>
                                    </tr>
                                ))}
            ...
            <Row>
                ...
                <Col xl={4}>
                    <ShowCode title="Table With Caption" customCardClass="custom-card" reactCode={basicTable25} dataCode={loopTable25} reusableCode={reusableTable25}>
                        <div className="table-responsive">
                            <SpkTables headerContent={<caption className='px-3 border-top'>Top 3 Countries</caption>} tableClass="text-nowrap" header={[{ title: 'S.No' }, { title: 'Country' }, { title: 'Medals Won' }, { title: 'No Of Athletes' }]}>
                            ...
                            <SpkTables tableClass="text-nowrap table-sm" header={[{ title: 'Invoice' }, { title: 'Created Date' }, { title: 'Status' }, { title: 'Action' }]}>
                                {Smalltables.map((idx, index) => (
                                    <tr key={index}>
                                        ...
                                        <td>
                                            <div className="hstack gap-2 fs-15">
                                                <BaseLink href="#!" className="btn btn-icon btn-sm btn-light"><i className="ri-download-2-line"></i></BaseLink>
                                                <BaseLink href="#!" className="btn btn-icon btn-sm btn-light"><i className="ri-edit-line"></i></BaseLink>
                                            </div>
                                        </td>
                                    </tr>
                                ))}
                            ...
                            <SpkTables tableClass="text-nowrap" showCheckbox={true} header={[{ title: 'Team Head' }, { title: 'Category' }, { title: 'Role' }, { title: 'Gmail' }, { title: 'Team' }, { title: 'Work Progress' }, { title: 'Revenue' }, { title: 'Action' }]}>
                                {Responsivedata.map((idx, index) => (
                                    <tr key={index}>
                                        ...
                                        <td>
                                            <div className="hstack gap-2 fs-15">
                                                <BaseLink href="#!" className="btn btn-icon btn-sm btn-success"><i className="ri-download-2-line"></i></BaseLink>
                                                <BaseLink href="#!" className="btn btn-icon btn-sm btn-info"><i className="ri-edit-line"></i></BaseLink>
                                            </div>
                                        </td>
                                    </tr>
                                ))}
...
// Assign layout
Tables.layout = (page) => <MainLayout>{page}</MainLayout>;
