...
const GridJsTables = () => {
    ...
    return (
        ...
        <Fragment>
            ...
            <Head title="GridJs Tables" />

            <Pageheader title="Tables" currentpage="Grid Js Tables" activepage="Grid Js Tables" />
...
// Assign layout
GridJsTables.layout = (page) => <MainLayout>{page}</MainLayout>;
