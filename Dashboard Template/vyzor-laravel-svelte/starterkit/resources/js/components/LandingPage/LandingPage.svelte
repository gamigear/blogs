<script>
    import SpkBasicpricecard from "@/shared/@spk/reusable-pages/spk-basicpricecard.svelte";
    import SpkTeamcard from "@/shared/@spk/reusable-pages/spk-teamcard.svelte";
    ...
    import {
        ...
        Swiperdata,
        WorkflowCards,
    } from "@/shared/data/pages/landingdata";
    import {
        BasicPricing1data,
        BasicPricingdata,
    } from "@/shared/data/pages/pricingdata";
    import { TeamMembersLanding } from "@/shared/data/pages/teamdata";
    import { CustomReviews } from "@/shared/data/pages/testimonialsdata";
    import {
        Accordion,
        AccordionItem,
        Card,
    ...
    onMount(() => {
        handleClickOutside = (event) => {
            if (expande && menuRef && !menuRef.contains(event.target)) {
                expande = false;
            }
        };
    ...
    const documentSelector = (selector) => document.querySelector(selector);
    let menuRef;
    ...
    const handleSubMenuToggle1 = (e) => {
        e.preventDefault();
        expande1 = !expande1;
    };
    const handleSubMenuToggle2 = (e) => {
        e.preventDefault();
        expande2 = !expande2;
    };
...
<!-- svelte-ignore a11y_consider_explicit_label -->
<a href="#!" on:click|preventDefault={screenUp}
                ...
                <ul class="list-unstyled fw-normal landing-footer-list mb-0">
                    ...
                    <li>
                        <Link
                            ...
                            class="text-fixed-white op-6">Pricing</Link
                        >
                    </li>
                </ul>
            </div>
                ...
                <ul class="list-unstyled fw-normal landing-footer-list mb-0">
                    <li>
                        <Link
                            ...
                            class="text-fixed-white op-6">Blog</Link
                        >
                    </li>
                    <li>
