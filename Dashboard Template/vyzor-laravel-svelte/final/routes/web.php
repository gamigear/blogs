...
Route::get('pages/authentication/under-maintainance', function () {
    return Inertia::render('pages/authentication/under-maintainance');
});
...
Route::get('pages/forms/quill-editor', function () {
    return Inertia::render('pages/forms/quill-editor');
});
...
Route::get('pages/forms/select2', function () {
    return Inertia::render('pages/forms/select2');
});
...
Route::get('maps/leaflet-maps', function () {
    return Inertia::render('maps/leaflet-maps');
});
Route::get('maps/google-maps', function () {
    return Inertia::render('maps/google-maps');
});
Route::get('maps/vector-maps', function () {
    return Inertia::render('maps/vector-maps');
});
...
Route::get('charts/apex-charts/range-area-chart', function () {
    return Inertia::render('charts/apex-charts/range-area-chart');
});
Route::get('charts/apex-charts/timeline-chart', function () {
    return Inertia::render('charts/apex-charts/timeline-chart');
});
...
Route::get('tables/gridjs-tables', function () {
    return Inertia::render('tables/gridjs-tables');
});
