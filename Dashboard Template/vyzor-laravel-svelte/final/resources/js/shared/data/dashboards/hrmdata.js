...
export const Hrmcards = [
        {
            ...
            percent: "3.21%",
            year: "This Year",
            svgIcon: ` <svg xmlns="http://www.w3.org/2000/svg" enable-background="new 0 0 24 24" height="24px" viewBox="0 0 24 24" width="24px" fill="#5f6368">
        ...
        },
        {
            ...
            svgColor: "success",
            cardClass:'dashboard-main-card dashboard-main-border border-0 shadow-none border-lg-end mb-0 rounded-0'
        },
        {
...
export const AttendanceData = [
    { type: 'Present', count: 1754, className: 'present' },
