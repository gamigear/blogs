export const Swiperdata = [
    { imgsrc: '/images/company-logos/13.png' },
    { imgsrc: '/images/company-logos/14.png' },
    { imgsrc: '/images/company-logos/15.png' },
    { imgsrc: '/images/company-logos/16.png' },
    { imgsrc: '/images/company-logos/17.png' },
    { imgsrc: '/images/company-logos/18.png' },
    { imgsrc: '/images/company-logos/19.png' },
    { imgsrc: '/images/company-logos/20.png' },
    { imgsrc: '/images/company-logos/12.png' },
]
...
export const LandingFaqs = [
    {
        id: 1,
        active:true,
        title:`<i class="ri-layout-4-line fw-medium avatar avatar-sm avatar-rounded bg-primary-transparent fs-5 me-2 text-primary"></i>
                How do I customize my dashboard layout?`,
        content: "You can easily customize the dashboard by dragging and dropping widgets. Go to the settings menu and select 'Customize Dashboard' to rearrange the layout.",
    },
    {
        id: 2,
        title:`<i class="ri-plug-line fw-medium avatar avatar-sm avatar-rounded bg-primary-transparent fs-5 me-2 text-primary"></i>
                Can I integrate third-party apps with the admin template?`,
        content: 'Yes! Our admin template supports seamless integrations with third-party apps. You can easily connect tools like Google Analytics, CRM software, and more',
    },
    {
        id: 3,
        title:`<i class="ri-phone-line fw-medium avatar avatar-sm avatar-rounded bg-primary-transparent fs-5 me-2 text-primary"></i>
                Is this admin template mobile responsive?`,
        content: ' Absolutely! The admin template is fully responsive and optimized for mobile, ensuring that it works perfectly on smartphones and tablets.',
    },
    {
        id: 4,
        title: `<i class="ri-user-settings-line fw-medium avatar avatar-sm avatar-rounded bg-primary-transparent fs-5 me-2 text-primary"></i>
                How do I manage user roles and permissions?`,
        content: "You can manage user roles and permissions under the 'User Management' section. Simply assign roles like Admin, Manager, or Viewer to control access.",
    },
    {
        id: 5,
        title: `<i class="ri-file-excel-line fw-medium avatar avatar-sm avatar-rounded bg-primary-transparent fs-5 me-2 text-primary"></i>
            Can I export data from the reports section?`,

        content: 'Yes, you can easily export reports as CSV, PDF, or Excel files. Just click the export button at the top of the reports page.',
    },
    {
        id: 6,
        title: `<i class="ri-notification-line fw-medium avatar avatar-sm avatar-rounded bg-primary-transparent fs-5 me-2 text-primary"></i>
            How do I enable notifications for updates?`,

        content: "Notifications can be enabled under the 'Settings' section. You can choose to receive real-time alerts via email or in-app for important updates.",
    },
];
...
export const WorkflowCards = [
    {
        ...
        icon:`<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 256 256"><rect width="256" height="256" fill="none"></rect><path d="M104,208V104H32v96a8,8,0,0,0,8,8H96" opacity="0.2"></path><line x1="32" y1="104" x2="224" y2="104" fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="16"></line><line x1="104" y1="104" x2="104" y2="208" fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="16"></line><rect x="32" y="48" width="192" height="160" rx="8" fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="16"></rect></svg>`,
        imgSrc: "/images/media/backgrounds/3.png",
    ...
    },
    {
        ...
        imgSrc: "/images/media/backgrounds/4.png",
