...
export const solidalerts = [
	...
	{ id: 7, text: "A simple solid light alert-check it out! ", class: "solid-light", color: "text-default", customBtnClass: "text-dark" },
	{ id: 8, text: "A simple solid dark alert-check it out!", class: "solid-dark", color: "text-white",  customBtnClass: "text-white" },
...
export const defaultsolidalerts = [
	{ id: 1, text: "A simple primary alert with small shadow—check it out!", class: "primary", size: "sm" },
	{ id: 2, text: "A simple primary alert with normal shadow—check it out!", class: "primary", size: "" },
	{ id: 3, text: "A simple primary alert with large shadow—check it out!", class: "primary", size: "lg" },
	{ id: 4, text: "A simple secondary alert with small shadow—check it out!", class: "secondary", size: "sm" },
	{ id: 5, text: "A simple secondary alert with normal shadow—check it out!", class: "secondary", size: "" },
	{ id: 6, text: "A simple secondary alert with large shadow—check it out!", class: "secondary", size: "lg" },
];
...
export const roundesolidalerts = [
	{ id: 1, text: "A simple solid rounded primary alert—check it out!", class: "primary" },
	{ id: 2, text: "A simple solid rounded secondary alert—check it out! ", class: "secondary" },
...
export const roundeoutlinealerts = [
	{ id: 1, text: "A simple outline rounded primary alert—check it out!", class: "primary" },
	{ id: 2, text: "A simple outline rounded secondary alert—check it out! ", class: "secondary" },
...
export const iconalerts = [
	{
		id: 1,
		class: 'primary',
		text: 'An example primary alert with an icon',
...
export const customizedalert1 = [
	{
		id: 1, class: "primary", text: 'An example primary alert with an icon',
...
export const avatarsizealert = [
	...
	{ id: 6, src: "../../images/faces/14.jpg", class: "dark", text: 'A simple light  alert with image—check it out!', size: "xl" },
];
  export let Svgalert = [
    { id: 1, icon: '<svg class="flex-shrink-0 svg-primary" xmlns="http://www.w3.org/2000/svg" height="1.5rem" viewBox="0 0 24 24" width="1.5rem" fill="#000000"><path d="M0 0h24v24H0V0z" fill="none" /><path d="M11 7h2v2h-2zm0 4h2v6h-2zm1-9C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2zm0 18c-4.41 0-8-3.59-8-8s3.59-8 8-8 8 3.59 8 8-3.59 8-8 8z" /></svg>', text1: "Information Alert", text2: "Information alert to show to information", color1: "primary", btn1: "cancel", btn2: "open", class: "secondary" },
    { id: 2, icon: '<svg class="flex-shrink-0 svg-secondary" xmlns="http://www.w3.org/2000/svg" height="1.5rem" viewBox="0 0 24 24" width="1.5rem" fill="#000000"><path d="M0 0h24v24H0V0zm0 0h24v24H0V0z" fill="none" /><path d="M16.59 7.58L10 14.17l-3.59-3.58L5 12l5 5 8-8zM12 2C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2zm0 18c-4.42 0-8-3.58-8-8s3.58-8 8-8 8 3.58 8 8-3.58 8-8 8z" /></svg>', text1: "Success Alert", text2: "Success alert to show to success message", color1: "secondary", btn1: "cancel", btn2: "open", class: "danger" },
    { id: 3, icon: '<svg class="flex-shrink-0 svg-warning" xmlns="http://www.w3.org/2000/svg" enableBackground="new 0 0 24 24" height="1.5rem" viewBox="0 0 24 24" width="1.5rem" fill="#000000"><g><rect fill="none" height="24" width="24" /></g><g><g><g><path d="M12,5.99L19.53,19H4.47L12,5.99 M12,2L1,21h22L12,2L12,2z" /><polygon points="13,16 11,16 11,18 13,18" /><polygon points="13,10 11,10 11,15 13,15" /></g></g></g></svg>', text1: "Warning Alert", text2: "Warning alert to show warning message", color1: "warning", btn1: "cancel", btn2: "open", class: "dark" },
    { id: 4, icon: '<svg class="flex-shrink-0 svg-danger" xmlns="http://www.w3.org/2000/svg" enableBackground="new 0 0 24 24" height="1.5rem" viewBox="0 0 24 24" width="1.5rem" fill="#000000"><g><rect fill="none" height="24" width="24" /></g><g><g><g><path d="M15.73,3H8.27L3,8.27v7.46L8.27,21h7.46L21,15.73V8.27L15.73,3z M19,14.9L14.9,19H9.1L5,14.9V9.1L9.1,5h5.8L19,9.1V14.9z" /><rect height="6" width="2" x="11" y="7" /><rect height="2" width="2" x="11" y="15" /></g></g></g></svg>', text1: "Danger Alert", text2: "Danger alert to show the danger message", color1: "danger", btn1: "cancel", btn2: "open", class: "info" },
  ];
