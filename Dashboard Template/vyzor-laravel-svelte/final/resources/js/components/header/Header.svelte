<script>
    ...
    import { menuData } from "@/components/sidebar/nav"; // Adjust the path as needed
    ...
    function highlightFirstMatch(text, query) {
            ...
            >
                ...
                {#if showa}
                    <div
                        ...
                        class="card search-result position-absolute z-index-9 search-fix border mt-1 w-100"
                    >
                ...
                >
                    <div class="p-3 bg-primary text-fixed-white">
                        ...
                        >
                            ...
                            <Link
                                href={`${basePath}/dashboards/ecommerce/products/`}
                ...
                >
                    ...
                    >
                        ...
                        >
                            ...
                            >
                                <Link
                                    href={`${basePath}/applications/chat`}
                        ...
                        <li>
                            <ul class="list-unstyled mb-0 sub-list">
                                ...
                                <li>
                                    <Link
                                        class="dropdown-item d-flex align-items-center"
                                        href={`${basePath}/applications/email/mail-settings`}
                                        ><i
                                            class="ti ti-settings-cog me-2 fs-18"
                                        ></i>Account Settings</Link
                                    >
                                </li>
                            </ul>
                        </li>
    ...
    <ModalBody class="modal-body">
        <div class="input-group" bind:this={container}>
            ...
            {#if showa}
                <div
                    bind:this={searchResult}
                    class="card search-result position-absolute z-index-9 w-100 search-fix mt-5 rounded"
                >
