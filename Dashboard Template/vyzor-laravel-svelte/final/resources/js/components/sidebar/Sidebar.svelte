<script>
    ...
    onMount(() => {
        ...
        Inertia.on("navigate", async () => {
            await tick();
            Baselocation = window.location.pathname;
            const updatedMenu = updateMenu(get(openMenu));
    ...
    let Baselocation = window.location.pathname;
...
<a href="#!" onclick={menuClose} aria-label="Close menu">
...
<aside class="app-sidebar sticky" id="sidebar">
    ...
    <div class="main-sidebar-header">
        <Link href={`${basePath}/dashboards/sales`} class="header-logo">
            <img
        ...
        <Svroller width="100%" height="100%">
            ...
            <nav class="main-menu-container nav nav-pills flex-column sub-open">
                        ...
                        <li class="text-center p-3 text-fixed-white">
                            ...
                            >
                                ...
                                <div class="d-grid w-100">
                                    <button class="btn btn-light border-0 custom-double-button" 
                                        >Try Now</button
                                    >
                                </div>
                            </div>
                ...
                <ul class="doublemenu_bottom-menu main-menu mb-0 border-top">
                    ...
                    <li class="slide">
                        <Link
                            href={`${basePath}/pages/authentication/sign-in/cover`}
                            class="side-menu__item"
                        >
                            <svg
                                xmlns="http://www.w3.org/2000/svg"
                    ...
                    <li class="slide">
                        <Link
                            href={`${basePath}/pages/profile-settings`}
                            class="side-menu__item"
                        >
                            <svg
                                xmlns="http://www.w3.org/2000/svg"
