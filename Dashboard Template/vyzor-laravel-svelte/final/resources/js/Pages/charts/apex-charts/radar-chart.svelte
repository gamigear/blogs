...
<script>
    ...
    import {
        ...
        Polygonoptions,
        Radaroptions,
    } from "@/shared/data/charts/apexcharts/radarchartdata";
</script>

<!-- Page Title -->
<svelte:head>
    <title>RadarChart | Vyzor - Svelte Admin & Dashboard Template</title>
</svelte:head>
<!-- Page Title Close -->

<!-- Page Header -->
<Pageheader
    homepage="Apex Radar Charts"
    activepage="Charts"
...
<Row>
    <Col xl={6}>
        <Card class="custom-card">
            ...
            <CardBody class="">
                <div id="radar-basic">
                    <Spkapexcharts options={Radaroptions} id="radar-basic" />
                </div>
            </CardBody>
        </Card>
    </Col>
        ...
        <Card class="custom-card">
            ...
            <CardBody>
                <div id="radar-multiple">
                    <Spkapexcharts options={Multioptions} id="radar-multiple" />
                </div>
            </CardBody>
        </Card>
    </Col>
    <Col xl={6}>
        <Card class="custom-card">
            <CardHeader>
                <CardTitle>Radar Chart Polygon Fill</CardTitle>
            </CardHeader>
            <CardBody class="">
