...
<!-- Page Title -->
<svelte:head>
    <title>AreaChart | Vyzor - Svelte Admin & Dashboard Template</title>
</svelte:head>
<!-- Page Title Close -->

<!-- Page Header -->
<Pageheader
    homepage="Apex Area Charts"
    page="Apex Area Charts"
    activepage="Charts"
        ...
        <Card class="custom-card">
            ...
            <CardBody>
                <div id="area-basic">
                    <Spkapexcharts
                        id="area-basic"
                        options={areachartdata.Areabasicoptions}
                    />
                </div>
            </CardBody>
        </Card>
        ...
        <Card class="custom-card">
            ...
            <CardBody>
                <div id="area-spline">
                    <Spkapexcharts
                        id="area-spline"
                        options={areachartdata.Areasplineoptions}
                    />
                </div>
            </CardBody>
        </Card>
        ...
        <Card class="custom-card">
            ...
            <CardBody>
                <div id="area-negative">
                    <Spkapexcharts
                        id="area-negative"
                        options={areachartdata.Areavalueoptions}
                    />
                </div>
            </CardBody>
        </Card>
            ...
            <CardBody>
                <div id="wrapper">
                    <div id="chart-months">
                        <Spkapexcharts
                            id="chart-months"
                            options={areachartdata.Areagithuboptions}
                        />
                    </div>
                    ...
                    <div class="github-style d-flex align-items-center">
                        ...
                        <div class="userdetails lh-1">
                            <a href="#!" class="username fw-semibold fs-14"
                                >coder</a
                            >
                    ...
                    <div id="chart-years">
                        <Spkapexcharts
                            id="chart-years"
                            options={areachartdata.optionsYears}
                        />
                    </div>
                </div>
            </CardBody>
        ...
        <Card class="custom-card">
            ...
            <CardBody>
                <div id="area-stacked">
                    <Spkapexcharts
                        id="area-stacked"
                        options={areachartdata.Areastackoptions}
                    />
                </div>
            </CardBody>
        </Card>
        ...
        <Card class="custom-card">
            ...
            <CardBody>
                <div id="area-irregular">
                    <Spkapexcharts
                        id="area-irregular"
                        options={areachartdata.Areatimeoptions}
                    />
                </div>
            </CardBody>
        </Card>
        ...
        <Card class="custom-card">
            ...
            <CardBody>
                <div id="area-null">
                    <Spkapexcharts
                        id="area-null"
                        options={areachartdata.Areanulloptions}
                    />
                </div>
            </CardBody>
        </Card>
        ...
        <Card class="custom-card">
            ...
            <CardBody>
                <div id="area-datetime">
                    <Spkapexcharts
                        id="area-datetime"
                        options={areachartdata.Dateoptions}
                    />
                </div>
            </CardBody>
        </Card>
