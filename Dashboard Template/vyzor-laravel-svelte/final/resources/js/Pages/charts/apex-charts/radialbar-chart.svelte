...
<script>
    ...
    import * as radialdata from "@/shared/data/charts/apexcharts/radialbarchartdata";
</script>

<!-- Page Title -->
<svelte:head>
    <title>RadialbarChart | Vyzor - Svelte Admin & Dashboard Template</title>
</svelte:head>
<!-- Page Title Close -->

<!-- Page Header -->
<Pageheader
    homepage="Apex Radialbar Charts"
    activepage="Charts"
        ...
        <Card class="custom-card">
            ...
            <CardBody>
                <div id="radialbar-basic">
                    <Spkapexcharts options={radialdata.Pieoptions} />
                </div>
            </CardBody>
        </Card>
    </Col>
        ...
        <Card class="custom-card">
            ...
            <CardBody>
                <div id="radialbar-multiple">
                    <Spkapexcharts
                        options={radialdata.Multiroptions}
        ...
        <Card class="custom-card">
            ...
            <CardBody>
                <div id="circle-custom">
                    <Spkapexcharts
                        options={radialdata.Customoptions}
                        id="circle-custom"
                    />
                </div>
            </CardBody>
        ...
        <Card class="custom-card">
            ...
            <CardBody>
                <div id="gradient-circle">
                    <Spkapexcharts
                        options={radialdata.Gradientoptions}
                        id="gradient-circle"
                    />
                </div>
            </CardBody>
        ...
        <Card class="custom-card">
            ...
            <CardBody>
                <div id="circular-stroked">
                    <Spkapexcharts
                        options={radialdata.Strokeoptions}
                        id="circular-stroked"
                    />
                </div>
            </CardBody>
    ...
    <Col xl={6}>
        <Card class="custom-card">
            ...
            <CardBody>
                <div id="circle-image">
                    <Spkapexcharts
                        options={radialdata.Circleoptions}
                        id="circle-image"
                    />
                </div>
            </CardBody>
        ...
        <Card class="custom-card">
            ...
            <CardBody>
                <div id="circular-semi">
                    <Spkapexcharts
                        options={radialdata.Gaugeoptions}
                        id="circular-semi"
                    />
                </div>
            </CardBody>
