...
<script>
    ...
    import SpkEcommercecard from "@/shared/@spk/dashboards-reusable/spk-ecommercecard.svelte";
    ...
    } from "@/shared/data/dashboards/ecommerce/ecommercedashboardata";
    import {
        ecommerceDropdown,
        SortByDropdown,
            ...
            <CardHeader class="justify-content-between">
                ...
                <div class="d-flex flex-wrap gap-2">
                    <SpkDropdown
                        ...
                        ToggleClass="btn-outline-light no-caret"
                    ...
                    {#each Orders as order}
                        <tr>
                            <td class={order.borderClass}
                                ><a href="#!">{order.id}</a></td
                            >
                            <td class={order.borderClass}
                                ><a href="#!">{order.customer}</a></td
                            >
                            <td class={order.borderClass}>
                                <div class="d-flex align-items-center gap-2">
                                    <div class="lh-1">
                            ...
                            <td class={`text-center ${order.borderClass}`}
                                >{order.quantity}</td
                            >
