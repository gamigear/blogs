...
<script>
    ...
    import { ecommerceDropdown1 } from "@/shared/data/uielements/dropdowndata";
    import CustomGrid from "@/view/ecommercesGrid/customGrid.svelte";
    import {
        Card,
        CardBody,
        Col,
    ...
    <Col xl={12}>
        <Card class="custom-card">
            <div class="card-header justify-content-between border-bottom-0">
                ...
                <div class="d-flex gap-2 flex-wrap w-sm-50 justify-content-start justify-content-sm-end">
                    <!-- Stock Filter -->
