...
<script>
    ...
    import {
        ...
        NftList,
        NftRatings,
    } from "@/shared/data/dashboards/nft/nftdetailsdata";
    import {
        Card,
        CardBody,
        Col,
...
<!-- Page Title -->
<svelte:head>
    <title>NftDetails | Vyzor - Svelte Admin & Dashboard Template</title>
</svelte:head>
<!-- Page Title Close -->

<!-- Page Header -->
<Pageheader
    homepage="NFT Details"
    subTitle="NFT"
...
<Row class="justify-content-center">
    <Col xl={12}>
        <Card class="custom-card overflow-hidden">
            <CardBody>
                <span class="nft-details-auction-time"
                    >48hrs : 16mins : 21sec</span
                >
                <Row class="gx-5">
                    <Col xxl={4} xl={12}>
                        <Row>
                            <Col xxl={12} sm={12} class="mb-md-5 mb-3">
                                <swiper-container
                                ...
                                >
                                    <swiper-slide id="img-container">
                                        <Image
                                            class="img-fluid"
                                            src="../../images/nft-images/14.png"
                                            alt="img"
                                        />
                                    </swiper-slide>
                                    <swiper-slide id="image-container">
                                        <Image
                                            class="img-fluid"
                                            src="../../images/nft-images/13.png"
                                            alt="img"
                                        />
                                    </swiper-slide>
                                    <swiper-slide id="image-container">
                                ...
                                <div class="d-grid mt-4">
                                    <SpkButton
                                        ...
                                        >Place a bid</SpkButton
                                    >
                                </div>
                            </Col>
                            <Col xxl={12} sm={12} class="d-md-block d-none">
                                <div
                    ...
                    <Col xxl={8} xl={12} class="">
                        <Row class="gx-5">
                            <Col xl={12} class="mt-xxl-0 mt-3">
                                <div>
                                    ...
                                    <div class="fs-13 mb-4">
                                        <span class="fw-medium text-muted"
                                            ><i
                                                class="ri-heart-3-fill text-danger align-middle me-2"
                                            ></i>(2.4k Likes)</span
                                        >
                                    </div>
                                    <Row class="mb-4">
                                        <Col xxl={3} xl={12}>
                                            <p
                                                class="mb-1 lh-1 fs-11 text-success fw-medium"
                                            >
                                                Current Bid
                                            </p>
                                        ...
                                        >
                                            ...
                                            >
                                                <span
                                                    class="avatar avatar-xs avatar-rounded lh-1 me-1"
                                                    ><Image
                                                        width={20}
                                                        height={20}
                                    ...
                                    <div class="mb-4">
                                        ...
                                        <p class="text-muted mb-0">
                                            "Digital Dreamscape" is a
                                            mesmerizing NFT artwork created by a
                                            renowned digital artist. This unique
                                            piece takes viewers on a journey
                                            through a vivid and ethereal world,
                                            where vibrant colors blend
                                            seamlessly with abstract forms. The
                                            artwork is a digital representation
                                            of the artist's imagination,
                                            combining elements of surrealism and
                                    ...
                                    <div class="mb-4">
                                        <Row>
                                            <Col xl={7}>
                                                ...
                                                <SpkTablescomponent
                                                    Responsive={true}
                                                    tableClass="table-bordered text-nowrap product-details-table"
                                                    headerClass="d-none"
                                                >
                                                    {#each NftData as item}
                                                        <tr>
                                                            <th
                                                                scope="row"
                                                                class="fw-medium"
                                    ...
                                    <div class="mb-0">
                                        ...
                                        <Row>
                                            ...
                                            >
                                                ...
                                                {#each NftRatings as rating}
                                                    <div
                                                        class="d-flex align-items-center mb-3"
                                                    >
                                                        <div
                                                            class="fs-12 me-2 fw-medium"
                                                        >
                                                            {rating.stars}
                                                            <i
                                                        ...
                                                        >
                                                            <div
                                                                class={`progress-bar bg-${rating.color}`}
                                                                role="progressbar"
                                                ...
                                                <div class="border rounded p-3">
                                                    ...
                                                    >
                                                        ...
                                                        >
                                                            ...
                                                            >
                                                                ...
                                                                >
                                                                    <i
                                                                        class="ri-star-fill text-warning align-middle fs-12"
                                                                    ></i>
                                                                    <i
                                                                        class="ri-star-fill text-warning align-middle fs-12"
                                                                    ></i>
                                                                    ...
                                                                    ></i>
                                                                    <i
                                                                        class="ri-star-line text-warning align-middle fs-12"
                                                                    ></i>
                                                                </div>
                                                                <div
                                                    ...
                                                    >
                                                        <div class="row">
                                                            ...
                                                            <Col
                                                                xl={6}
                                                                class="d-flex align-items-end justify-content-sm-end mt-sm-0 mt-2"
                                                            >
                                                                <SpkButton
                                                                    color=""
