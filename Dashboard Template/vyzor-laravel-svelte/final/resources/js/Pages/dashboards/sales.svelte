...
<script>
    ...
    let date = new Date("2025-07-07");
    const locale = localeFromDateFnsLocale(enUS);
</script>

<!-- Page Title -->
<svelte:head>
    <title>Sales | Vyzor - Svelte Admin & Dashboard Template</title>
</svelte:head>
<!-- Page Title Close -->
...
>
    ...
    <div class="d-flex align-items-center gap-2 flex-wrap">
        <div class="form-group custom-date-picker sales-picker">
            <DateInput
        ...
        <div class="btn-list">
            <SpkButton color="primary" customClass="btn btn-icon btn-wave"
                ><i class="ri-refresh-line"></i></SpkButton
            >
            <SpkButton color="primary" customClass="btn btn-icon btn-wave me-0"
                ><i class="ri-filter-3-line"></i></SpkButton
            >
        </div>
    </div>
</div>
...
<Row>
    <Col xxl={9}>
        <Row>
            <Col xl={3}>
                <Row>
                    {#each SalesCard as idx}
                        <Col xl={12} md={6}>
                            <SpkListcard
                                titleClass="fs-13 fw-medium mb-0"
                                bodyClass={`${idx.id === 3 || idx.id === 4 ? "p-4" : ""}`}
                                listCard={true}
            ...
            <Col xl={9}>
                <Card class="custom-card">
                    <CardHeader class="justify-content-between">
                        ...
                        >
                            <SpkButton
                                buttontype="button"
                                color=""
                                customClass="btn btn-primary btn-wave waves-effect waves-light"
                                >Day</SpkButton
                            >
                            <SpkButton
                                buttontype="button"
                                color=""
                                customClass="btn btn-primary-light btn-wave waves-effect waves-light"
                                >Week</SpkButton
                            >
                            <SpkButton
                                buttontype="button"
                    ...
                    <CardFooter class="bg-light p-0">
                        <Row class="g-0 w-100">
                            {#each Stats as stat, idx}
                                <div
                                    class={`col-sm-4 ${idx !== Stats.length - 1 ? "border-sm-end" : ""}`}
                                >
    ...
    <Col xxl={3}>
        <Row>
            <Col xl={12}>
                <Card
                    class="custom-card shadow-none card-bg-primary overflow-hidden dashboard-banner-card"
                >
                    <CardBody>
                        <div class="dashboard-banner-card-background">
                            <Image
                                src="../images/media/backgrounds/8.png "
                                alt=""
                            />
                        </div>
                        <div
                        ...
                        >
                            <div>
                                ...
                                <span
                                    class="d-block fs-14 mb-3 pe-5 text-fixed-white"
                                    >Check out the latest sales updates.</span
                                >
                                <a
                                    href="#!"
                                    class="btn btn-secondary btn-wave mt-1"
                                    >Upgrade To Pro <i
                            ...
                            <div
                                class="dashboard-banner-image d-sm-block d-none"
                            >
                                <svg
            ...
            <Col xl={12}>
                <Card class="custom-card">
                    <CardHeader class="justify-content-between">
                        ...
                        <a
                            href="#!"
                            class="fs-12 text-muted text-decoration-underline"
                            >View Report <i class="ti ti-arrow-narrow-right"
                            ></i></a
                        >
                    </CardHeader>
                    <CardBody class="pb-0 px-0">
...
<Row class="boxed-transform-card">
    <Col xxl={3} md={6}>
        <Card class="custom-card overflow-hidden">
            <CardHeader class="justify-content-between">
                <div class="card-title">Top Selling Products</div>
                <a href="#!" class="text-muted fs-12 text-decoration-underline"
                    ...
                    {#each Products as product}
                        <ListGroupItem class="">
                            <div class="d-flex align-items-center gap-3">
                                <div class="lh-1">
                                    <span
                                        class="avatar avatar-lg bg-light border border-dashed p-1"
                                    >
                                        <Image
                                            src={product.image}
                                            alt={product.name}
                                ...
                                <div class="flex-fill">
                                    ...
                                    >
                                        ...
                                        <div class="vr"></div>
                                        <span
                                            class={`${product.stockColor} fs-12`}
                                        >
                                            <i
                                                class="ri-circle-fill me-1 fs-7 align-middle"
                                            ></i>
                                            {product.stockStatus}
                                        </span>
                                    </div>
                    ...
                    {#each Customers as customer}
                        <li>
                            ...
                            >
                                <div class="lh-1">
                                    <span
                                        class={`avatar avatar-md bg-${customer.colorClass}-transparent`}
                                    >
                                        {customer.initials}
                                    </span>
                                </div>
                                ...
                                <div class="text-end">
                                    <div
                                        class={`fw-semibold text-${customer.colorClass} mb-0`}
                                    >
                                        {customer.amount}
                                    </div>
                        ...
                        <li>
                            ...
                            >
                                ...
                                <div class="text-end">
                                    ...
                                    >
                                        <span
                                            class={`fs-12 fw-medium text-${company.changeDirection === "up" ? "success" : "danger"}`}
                                        >
                                            <i
                                                class={`ti ti-arrow-narrow-${company.changeDirection}`}
                                            ></i>
                                    ...
                                    <div
                                        class={`progress progress-xs progress-animate bg-${company.progressColor}-transparent`}
                                        role="progressbar"
                                        aria-valuenow="75"
                                        aria-valuemin="0"
                                        aria-valuemax="100"
                                    >
                                        <div
                                            class={`progress-bar bg-${company.progressColor}`}
    ...
    <Col xl={8}>
        <Card class="custom-card overflow-hidden">
            <CardHeader class="justify-content-between">
                ...
                <div class="d-flex flex-wrap gap-2 custom-sales">
                    <SpkDropdown
                ...
                >
                    {#each Orders as order, index}
                        <tr>
                            ...
                            <td class={order.borderBottom}>{order.id}</td>
                            <td class={order.borderBottom}>
                                <div class="d-flex align-items-center gap-2">
                                    <div class="lh-1">
                                        <span
                                            class={`avatar avatar-sm avatar-rounded bg-${order.avatarBg}`}
                                        >
                                            {order.initials}
                                        </span>
                                    </div>
                            ...
                            <td class={order.borderBottom}>
                                <div>{order.date}</div>
                                <div class="text-muted fs-12">{order.time}</div>
                            </td>
                            <td class={order.borderBottom}>
                                <div class="avatar-list-stacked">
                                    {#each order.products as product}
                                        ...
                                        >
                                            <Image
                                                src={`../images/ecommerce/jpg/${product}`}
                                                alt="img"
                                            />
                                        </span>
                                    {/each}
                            ...
                            <td class={order.borderBottom}>{order.amount}</td>
                            <td class={order.borderBottom}>
                                <SpkBadge
                                    Color=""
                                    CustomClass={`badge bg-${order.statusBg}`}
                                    >{order.status}</SpkBadge
                                >
                            </td>
                            <td class={order.borderBottom}>
                                <SpkDropdown
                                    option={salesDropodown1}
            ...
            <div class="card-footer">
                <div class="d-flex align-items-center flex-wrap">
                    <div>
                        Showing 5 Entries <i
                            class="bi bi-arrow-right ms-2 fw-semibold custom-arrow"
                        ></i>
                    </div>
                    <div class="ms-auto">
                        <nav
    ...
    <Col xl={4}>
        <Card class="custom-card overflow-hidden">
            <CardHeader class="justify-content-between">
                ...
                <SpkDropdown
                    option={salesDropodown}
                    ToggleClass="btn btn-icon btn-light no-caret"
                    Caret={false}
                    parent={`<i class="fe fe-more-vertical"></i>`}
                />
            </CardHeader>
            <CardBody class="p-0">
                <SpkTablescomponent
                    ...
                    header={[
                        { title: "Order" },
                        { title: "Price" },
                        { title: "Products", headerClassname: "text-end" },
                    ]}
                >
                    {#each Transactionsdata as order}
                        <tr>
                            <td class={order.borderClass}>
                                <div class="flex-fill">
                                    ...
                                    >
                                        ...
                                        <div class="vr"></div>
                                        <SpkBadge
                                            CustomClass={`badge bg-${order.statusColor}-transparent`}
                                        >
                                            <i
                                                class={`${order.icon} me-1 align-middle`}
                                            ></i>
                                            {order.status}
                                        </SpkBadge>
                                    </div>
                            ...
                            <td class={order.borderClass}>
                                <div class="avatar-list-stacked text-end">
                                    ...
                                    {/each}
                                    {#if order.extraAvatars}
                                        <a
                                            class="avatar bg-primary avatar-rounded avatar-sm"
                                            href="#!"
                                        >
                                            +{order.extraAvatars}
                                        </a>
