...
<script>
    ...
    import {
        ...
        Options,
        PeopleList,
    } from "@/shared/data/applications/filemanagerdata";
    import {
        Card,
        CardBody,
        CardHeader,
        ...
        <Row>
                ...
                <Card class="custom-card">
                    <CardBody>
                        <Svroller width="100%" height="100%">
                            <ul
                                class="list-unstyled files-main-nav"
                                id="files-main-nav"
                            >
                                {#each FileMenuItems as item}
                                    <li
                                        class={`files-type ${item.active ? "active" : ""}`}
                                    >
                                        <a href="#!">
                                            <div
            ...
            <Col xxl={12} xl={6} class="">
                <Card class="custom-card">
                    <CardBody>
                        <div
                            class="filemanager-upgrade-storage w-100 text-center"
                        >
                            <span
                                class="d-block mb-3 p-4 bg-light rounded file-manager-upgrade-img"
                            >
                                <Image
                                    src="../images/media/file-manager/2.png"
                                    alt=""
                                    class="img-fluid"
                                />
                            </span>
                            <span class="fs-15 fw-semibold text-default"
                                >Upgrade To PRO</span
                            >
                            <span
                                class="fs-13 fw-medium d-block text-muted mt-2"
                                >Unlock Pro for faster transfers, stronger
                                security, and unlimited storage.</span
                            >
                            <div class="mt-3 d-grid">
                                <SpkButton
                                    color="primary"
                                    customClass="btn btn-lg"
                                    >Upgrade Now</SpkButton
                                >
                            </div>
                        </div>
                    </CardBody>
            ...
            <CardBody class="p-0">
                <div class="file-manager-folders">
                    ...
                    >
                        ...
                        <div
                            class="d-flex gap-2 flex-wrap justify-content-sm-end"
                        >
                            <SpkButton
                                color="primary"
                                onclickfunc={() => handleShow("modal")}
                                customClass="btn btn-w-md d-flex align-items-center justify-content-center btn-wave waves-light"
                            >
                                <i class="ri-add-circle-line align-middle me-1"
                                ></i>Create Folder
                            </SpkButton>
                            <Modal
                                centered
                            ...
                            >
                                ...
                                <ModalFooter>
                                    <SpkButton
                                        ...
                                        buttontype="button"
                                        customClass="btn btn-sm btn-icon btn-light"
                                    ...
                                    <SpkButton
                                        color=""
                                        buttontype="button"
                                        customClass="btn btn-sm btn-success"
                                        >Create</SpkButton
                                    >
                                </ModalFooter>
                            </Modal>
                        ...
                        <div class="row">
                            {#each FileCategories as category}
                                <Col xxl={4} xl={4} lg={6} md={6} class="">
                                    <Card
                                        class={`custom-card shadow-none file-category-card ${category.colorClass}`}
                                    >
                                        <CardBody class="text-center">
                                            ...
                                            <div
                                                class={`mb-2 text-${category.colorClass} svg-${category.colorClass} file-img`}
                                            >
                                                {@html category.icon}
                                            </div>
                                ...
                                <Col xxl={4} xl={4} lg={6} md={6} class="">
                                    <Card class="custom-card">
                                        <CardBody>
                                            ...
                                            >
                                                <div
                                                    class="svg-warning text-warning"
                                                >
                                                    <svg
                                                        xmlns="http://www.w3.org/2000/svg"
                                                        viewBox="0 0 256 256"
                                                ...
                                                <div
                                                    class="d-flex align-items-center gap-2 lh-1 file-icons"
                                                >
                                                    {#if folder.important}
                                                        <div
                                                            class="file-important true"
                                                        >
                                                            <svg
                                                                xmlns="http://www.w3.org/2000/svg"
                                                                viewBox="0 0 256 256"
                                            ...
                                            <div
                                                class="fs-14 fw-medium mb-1 lh-1"
                                            >
                                                {folder.name}
                                            </div>
                                            <div
                        ...
                        <Row>
                            <Col xl={12}>
                                <SpkTablescomponent
                                    Responsive={true}
                                    Hover={true}
                                    tableClass="text-nowrap border"
                                    tBodyClass="files-list"
                                    header={[
                                        { title: "File Name" },
                                        { title: "Category" },
                                        { title: "Size" },
                                        ...
                                        <tr>
                                            <th scope="row">
                                                ...
                                                >
                                                    <div class="me-0">
                                                        <span
                                                            class={`avatar avatar-sm ${file.avatarClass}`}
                                                        >
                                                            {@html file.icon}
                                                        </span>
                                                    </div>
                    ...
                    {#each FileCategorie as item}
                        <li>
                            <div class="d-flex align-items-center gap-2">
                                <div class="lh-1">
                                    <span
                                        class={`avatar avatar-md avatar-rounded svg-${item.color} bg-${item.color}-transparent`}
                                    >
                                        {@html item.icon}
                                    </span>
                                </div>
                    ...
                    {#each ActivityLog as activity}
                        <li>
                            <div class="d-flex align-items-center gap-2">
                                <div class="lh-1">
                                    <span
                                        class="avatar avatar-md avatar-rounded bg-light text-muted"
                                    >
                                        <i class={`ti ${activity.icon} fs-18`}
                                        ></i>
                                    </span>
                                </div>
                                <div class="flex-fill w-75">
                                    ...
                                    <span
                                        class="d-block text-muted fs-13 w-100 text-truncate"
                                    >
...
>
    ...
    <div class="selected-file-details">
        <div
            class="d-flex p-3 align-items-center justify-content-between border-bottom"
        >
            <div>
            ...
            <div class="d-flex align-items-center">
                ...
                <SpkButton
                    ...
                    buttontype="button"
                    customClass="btn btn-sm btn-icon btn-outline-light border"
                ...
                {#each PeopleList as person}
                    <a href="#!">
                        <div class="d-flex align-items-center p-2 mb-1">
                            ...
                            <span class="fw-medium flex-fill"
                                >{person.name}</span
                            >
                            <SpkBadge
                                Color=""
                                CustomClass="bg-success-transparent fw-normal"
                                >{person.date}</SpkBadge
                            >
                        </div>
                    </a>
                {/each}
