...
<!-- Page Title -->
<svelte:head>
    <title>Signin-Cover | Vyzor - Svelte Admin & Dashboard Template</title>
</svelte:head>
<!-- Page Title Close -->
                                ...
                                <Col xl={12} class="mb-2">
                                    ...
                                    <div class="mt-2">
                                        <div class="form-check">
                                            ...
                                            <Link
                                                href={`${basePath}/pages/authentication/reset-password/basic`}
    ...
    <Col xxl={3} xl={3} lg={12} class="d-xl-block d-none px-0">
        <div class="authentication-cover overflow-hidden">
            ...
            <div class="authentication-cover-content">
                ...
                <div>
                    <Image
                        src={`${basePath}/images/media/media-72.png`}
                        alt=""
                        class="img-fluid"
                    />
                </div>
