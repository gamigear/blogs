...
<script>
    ...
    import SpkProductscard from "@/shared/@spk/reusable-widgets/spk-productscard.svelte";
    import SpkSalescard from "@/shared/@spk/reusable-widgets/spk-salescard.svelte";
    ...
    import {
        ...
        Transactionsdata,
        Visitorsoptions,
    } from "@/shared/data/widgetsdata";
    import WidgetMap from "@/view/maps/WidgetMap.svelte";
    import {
        Card,
        CardBody,
        CardFooter,
                    ...
                    {#each Ordersdata as txn}
                        <tr>
                            <td class={txn.borderClass}
                                ><span class="fw-semibold">{txn.id}</span></td
                            >
                            <td class={txn.borderClass}>
                                <div>
