...
<script>
    ...
    import {
        ...
        typography30,
        typography31,
    } from "@/shared/data/prism-code/uielementsprim.js";
    import { Col, Row } from "@sveltestrap/sveltestrap";
</script>

<!-- Page Title -->
<svelte:head>
    <title>Typography | Vyzor - Svelte Admin & Dashboard Template</title>
</svelte:head>
<!-- Page Title Close -->
...
<Row>
    <Col xl={12}>
        <ShowCode
            title="Headings H tags"
            customCardClass=""
            customCardBodyClass=""
            svelteCode={typography1}
        >
        ...
        <ShowCode
            title="Heading Class Names"
            customCardClass=""
            customCardBodyClass=""
            svelteCode={typography2}
        >
...
<Row>
    <Col xl={6}>
        <ShowCode
            title="Primary Blockquote"
            customCardClass=""
            customCardBodyClass=""
            svelteCode={typography12}
        >
            <blockquote
                class="blockquote custom-blockquote primary mb-0 text-center"
            >
                <h6>
                ...
                <footer
                    class="blockquote-footer mt-3 fs-14 text-muted op-7 mb-0"
                >
    ...
    <Col xl={6}>
        <ShowCode
            title="Secondary Blockquote"
            customCardClass=""
            customCardBodyClass=""
            svelteCode={typography13}
        >
            <blockquote
                class="blockquote custom-blockquote secondary mb-0 text-center"
            >
                <h6>
                    The future belongs to those who believe in the beauty of
                    their dreams..
    ...
    <Col xl={6}>
        <ShowCode
            title="Warning Blockquote"
            customCardClass=""
            customCardBodyClass=""
            svelteCode={typography14}
        >
            <blockquote
                class="blockquote custom-blockquote warning mb-0 text-center"
            >
                <h6>
                    The future belongs to those who believe in the beauty of
                    their dreams..
    ...
    <Col xl={6}>
        <ShowCode
            title="Success Blockquote"
            customCardClass=""
            customCardBodyClass=""
            svelteCode={typography15}
        >
            <blockquote
                class="blockquote custom-blockquote success mb-0 text-center"
            >
                <h6>
                    The future belongs to those who believe in the beauty of
                    their dreams..
    ...
    <Col xl={6}>
        <ShowCode
            title="Info Blockquote"
            customCardClass=""
            customCardBodyClass=""
            svelteCode={typography16}
        >
            <blockquote
                class="blockquote custom-blockquote info mb-0 text-center"
            >
                <h6>
                    The future belongs to those who believe in the beauty of
                    their dreams..
    ...
    <Col xl={6}>
        <ShowCode
            title="Danger Blockquote"
            customCardClass=""
            customCardBodyClass=""
            svelteCode={typography17}
        >
            <blockquote
                class="blockquote custom-blockquote danger mb-0 text-center"
            >
                <h6>
                    The future belongs to those who believe in the beauty of
                    their dreams..
...
<Row>
    ...
    <Col xl={6}>
        <ShowCode
            ...
            customCardClass=""
            customCardBodyClass=""
            svelteCode={typography22}
        >
            <p class="text-muted mb-0">
                Muted text with a <a
                    href="#!"
                    class="text-reset text-decoration-underline text-dark"
                    >reset link</a
                >.
            </p>
        </ShowCode>
...
<Row>
    ...
    <Col xl={12}>
        ...
        >
            ...
            <div class="text-nowrap bg-light border custom-text-responsive" style="width:8rem;">
