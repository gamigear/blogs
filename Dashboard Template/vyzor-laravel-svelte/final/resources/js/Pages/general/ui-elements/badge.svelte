...
<script>
    ...
    import {
        ...
        badgesdata,
        Outlinebadgesdata,
    } from "@/shared/data/uielements/badgedata";
...
<!-- Page Title -->
<svelte:head>
    <title>Badge | Vyzor - Svelte Admin & Dashboard Template</title>
</svelte:head>
<!-- Page Title Close -->
<Pageheader homepage="Badge" activepage="UI Elements" page="Badge" />
<!-- Start::row-1 -->
<Row>
    <Col xl={12}>
        <ShowCode
    ...
    <Col xl={12}>
        ...
        >
            {#each badges1 as badge (badge.id)}
                <SpkBadge
                    CustomClass={`${badge.color} bg-${badge.color}-gradient me-1`}
                    text={badge.heading}
                />
            {/each}
        </ShowCode>
    ...
    <Col xl={12}>
        ...
        >
            <SpkButton
                ...
                text="Notifications"
            >
                <SpkBadge Color="" CustomClass=" ms-2 " text="4" />
            </SpkButton>
            <SpkButton
                outline={true}
                color="secondary"
                ...
                text="Notifications"
            >
                <SpkBadge Color="" CustomClass=" ms-2" text="7" />
            </SpkButton>
            <SpkButton
                outline={true}
                color="success"
                ...
                text="Notifications"
            >
                <SpkBadge Color="" CustomClass=" ms-2 " text="12" />
            </SpkButton>
            <SpkButton
                outline={true}
                color="info"
                ...
                text="Notifications"
            >
                <SpkBadge Color="" CustomClass=" ms-2 " text="32" />
            </SpkButton>
        </ShowCode>
    </Col>
</Row>
                    ...
                    <div class="d-flex align-items-center gap-5 flex-wrap">
                        <div>
                            <SpkBadge
                                ...
                                text="Hot"
                                ><i class="ti ti-flame me-1"></i></SpkBadge
                            >
                        </div>
                        <div>
                        ...
                        <div>
                            <SpkBadge
                                Color="bg-light"
                                Border="border"
                                CustomClass="text-default custom-badge"
                                text="13.2k"
                                ><i class="fe fe-eye me-1 d-inline-block"
                                ></i></SpkBadge
                            >
                        </div>
                        <div>
