...
<script>
    ...
    import { SocialIconButtons } from "@/shared/data/uielements/buttonsdata";
</script>

<!-- Page Title -->
<svelte:head>
    <title>ButtonGroup | Vyzor - Svelte Admin & Dashboard Template</title>
</svelte:head>
<!-- Page Title Close -->
...
<Row>
    <Col xl={6}>
        <ShowCode title="Basic example" svelteCode={btngroup1}>
    ...
    <Col xl={6}>
        <ShowCode title="Navigation" svelteCode={btngroup2}>
            <ButtonGroup>
                <SpkButton
                    color="primary"
                    active
                    ...
                    text="Active link"
                />
                <SpkButton color="primary" href="#!" text="Link" />
                <SpkButton color="primary" href="#!" text="Link" />
            </ButtonGroup>
        </ShowCode>
    </Col>
    <Col xl={6}>
        <ShowCode title="Mixed Style" svelteCode={btngroup3}>
    ...
    <Col xl={6}>
        <ShowCode title="Outline styled" svelteCode={btngroup4}>
            <ButtonGroup
                class="btn-group1"
                role="group"
    ...
    <Col xl={6}>
        <ShowCode
            ...
            customCardBodyClass=" checkbox-button-group"
            svelteCode={btngroup5}
        >
            <ButtonGroup
                class="btn-group2"
                role="group"
    ...
    <Col xl={6}>
        <ShowCode
            ...
            customCardBodyClass="radio-button-group"
            svelteCode={btngroup6}
        >
            <ButtonGroup
                class="btn-group2"
                role="group"
    ...
    <Col xl={12}>
        <ShowCode title="Sizing" svelteCode={btngroup7}>
            <ButtonGroup
    ...
    <Col xl={12}>
        <ShowCode title="Button toolbar" svelteCode={btngroup8}>
            <ButtonToolbar
            ...
            >
                ...
                >
                    <SpkButton
                        color="info"
                        buttontype="button"
                        class="btn btn-info">8</SpkButton
                    >
                </ButtonGroup>
            </ButtonToolbar>
            <ButtonToolbar
    ...
    <Col xl={12}>
        <ShowCode title="Nesting" svelteCode={btngroup9}>
            <ButtonGroup
                role="group"
            ...
            >
                ...
                >
                    ...
                    <DropdownMenu>
                        <DropdownItem
                            ><a href="#!">Dropdown link</a></DropdownItem
                        >
                        <DropdownItem
                            ><a href="#!">Dropdown link</a></DropdownItem
                        >
    ...
    <Col xl={12}>
        <ShowCode title="Vertical variation" svelteCode={btngroup10}>
            <div class="row gap-2">
                <Col sm={3}>
                    <ButtonGroup
                        vertical
                    ...
                    >
                        <SpkButton color="primary" buttontype="button"
                            >Button</SpkButton
                        >
                        <SpkButton color="primary" buttontype="button"
                            >Button</SpkButton
    ...
    <Col xl={12}>
        <ShowCode
            title="Social Group Buttons"
            svelteCode={btngroup11}
