...
<!-- Page Title -->
<svelte:head>
    <title>AdditionalContent | Vyzor - Svelte Admin & Dashboard Template</title>
</svelte:head>
<!-- Page Title Close -->
<!-- Page Header -->
<Pageheader
            ...
            <Col xl={12}>
                <Card class="custom-card">
                    ...
                    <div class="card-body d-sm-flex">
                        <div
                            class="opacity-100 p-3 m-2 bg-primary text-fixed-white fw-bold rounded"
                        >
                            100%
                        </div>
                        <div
                            class="opacity-75 p-3 m-2 bg-primary text-fixed-white fw-bold rounded"
                        >
                            75%
                        </div>
                        <div
                            class="opacity-50 p-3 m-2 bg-primary text-fixed-white fw-bold rounded"
                        >
                            50%
                        </div>
                        <div
                            class="opacity-25 p-3 m-2 bg-primary text-fixed-white fw-bold rounded"
                        >
                            25%
                        </div>
                    </div>
...
<Row>
    <Col xl={6}>
        <Card class="custom-card">
            ...
            <CardBody class="overflow-x-auto">
                <div class="mb-5">
                ...
                >
                    <div
                        ...
                        style="width: 120px; background-color: rgba(0,0,255,.1);padding-inline:10px;"
                    >
                        Height 25%
                    </div>
                    <div
                        class="h-50 d-inline-block"
                        style="width: 120px; background-color: rgba(0,0,255,.1);padding:10px;"
                    >
                        Height 50%
                    </div>
                    <div
                    ...
                    <div
                        class="h-auto d-inline-block d-none d-sm-block"
                        style="width: 120px; background-color: rgba(0,0,255,.1);padding:10px;"
                    >
                        Height auto
                    </div>
    ...
    <Col xl={6}>
        <Card class="custom-card">
            <CardHeader>
                <div class="card-title">
                    You can also use <span class="text-danger">
                        max-width: 100%;</span
                    >
                    and <span class="text-danger">max-height: 100%;</span> utilities
                    as needed.
                </div>
            </CardHeader>
            <CardBody>
                <Image
                    class="bd-placeholder-img mw-100 card-img"
                    src="../../images/media/media-7.jpg"
                    alt="..."
                />
                <div
                    style="height: 100px; background-color: rgba(255,0,0,.1);"
                    class="mt-3"
                >
                    <div
                        class="mh-100"
    ...
    <Col xl={4}>
        <Col xl={12}>
            <Card class="custom-card">
                ...
                <CardBody>
                    <div
                        class="d-inline p-2 bg-primary text-fixed-white rounded m-1"
                    >
                        d-inline
                    </div>
                    <div
                        class="d-inline p-2 bg-primary-transparent text-primary rounded m-1"
                    >
                        d-inline
                    </div>
                </CardBody>
        ...
        <Col xl={12}>
            <Card class="custom-card">
                ...
                <CardBody>
                    <span
                        class="d-block p-2 bg-secondary-transparent mb-1 rounded"
                        >d-block</span
                    >
                    <span
                        class="d-block p-2 bg-primary-transparent mb-1 rounded"
                        >d-block</span
                    >
                    <span
                        class="d-block p-2 bg-success-transparent mb-1 rounded"
                        >d-block</span
                    >
                </CardBody>
            </Card>
        ...
        <Row>
            <Col xl={12}>
                <Card class="custom-card">
                    ...
                    <CardBody>
                        <div
                            class="float-start p-2 bg-primary rounded text-fixed-white mb-2"
                        >
                            Float start
                        </div>
                        <br />
                        <div
                            class="float-end p-2 bg-primary rounded text-fixed-white"
                        >
                            Float end
                        </div>
                        <br />
                        <div
                            class="float-none p-2 bg-primary rounded text-fixed-white mt-4"
                        >
                            Don't float
                        </div>
                    </CardBody>
                    ...
                    <CardBody>
                        <p>
                            <a
                                ...
                                tabIndex={-1}
                                aria-disabled="false"
                                ><code class="text-primary fw-medium"
                                    >This link</code
                                >
                            </a>
                            can not be clicked.
                        ...
                        <p class="pe-none mb-0">
                            <a href="#!" tabIndex={-1} aria-disabled="false"
                                ><code>This link</code>
                            </a>
    ...
    <Col xl={12}>
        <Card class="custom-card">
            ...
            <div class="card-body d-md-flex">
                <div
                    class="overflow-auto p-3 mb-3 mb-md-0 me-md-3 bg-light"
                ...
                <div
                    class="overflow-hidden p-3 mb-3 mb-md-0 me-md-3 bg-light"
                    style="max-width: 260px; max-height: 100px;"
                >
                ...
                <div
                    class="overflow-visible p-3 mb-3 mb-md-0 me-md-3 bg-light"
                    style="max-width: 260px; max-height: 100px;"
                >
