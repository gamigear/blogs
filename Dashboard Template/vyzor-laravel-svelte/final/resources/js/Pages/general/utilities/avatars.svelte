...
<script>
    ...
    import {
        ...
        avatardata7,
        avatardata8,
    } from "@/shared/data/prism-code/utilitiesprism";
    import {
        Avatardata,
        Avataricon,
        Avatarinitial,
        ...
        Avatarsize,
        Avatarstack,
    } from "@/shared/data/utilities/avatars";
    import { Badge, Image } from "@sveltestrap/sveltestrap";
</script>

<!-- Page Title -->
<svelte:head>
    <title>Avatars | Vyzor - Svelte Admin & Dashboard Template</title>
</svelte:head>
<!-- Page Title Close -->
<!-- Page Header -->
...
<div class="row">
    <div class="col-xl-6 col-lg-6 col-md-12 col-sm-12">
        <ShowCode
            title=" Avatars"
            svelteCode={avatar1}
            dataCode={avatardata1}
            customCardBodyClass="py-4"
        >
    ...
    <div class="col-xl-6 col-lg-6 col-md-12 col-sm-12">
        <ShowCode
            title=" Avatars With Number Badges<p class='subtitle text-muted fs-12 fw-normal'>   Avatar numbers indicates the no. of unread notifactions/messages. </p>"
            customCardClass="custom-card"
            customCardBodyClass=""
            svelteCode={avatar6}
            dataCode={avatardata6}
        >
    ...
    <div class="col-xl-12 col-lg-6 col-md-12 col-sm-12">
        ...
        >
            <div class="avatar-list-stacked">
                ...
                {/each}
                <a class="avatar bg-primary avatar-rounded" href="#!"> +8 </a>
            </div>
        </ShowCode>
    </div>
</div>
