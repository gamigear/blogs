...
<!-- Page Title -->
<svelte:head>
    <title>Columns | Vyzor - Svelte Admin & Dashboard Template</title>
</svelte:head>
<!-- Page Title Close -->

<!-- Page Header -->
<Pageheader homepage="Columns" activepage="Utilities" page="Columns" />
<!-- Page Header Close -->
...
<Row>
        ...
        <Row>
            <Col xl={12}>
                <Card class="custom-card">
                    ...
                    <CardBody class="bd-example-row bd-example-row-flex-cols">
                        <div class="container">
    ...
    <Col xl={12}>
        <Card class="custom-card">
            ...
            <CardBody class="bd-example-row">
                <div class="container">
                    <Row>
                        <div class="col-9">.col-9</div>
                        <div class="col-4">
                            .col-4<br />Since 9 + 4 = 13 &gt; 12, this
                            4-column-wide div gets wrapped onto a new line as
                            one contiguous unit.
                        </div>
                        <div class="col-6">
                            .col-6<br />Subsequent columns continue along the
                            new line.
                        </div>
                    </Row>
                </div>
        ...
        <Card class="custom-card">
            ...
            <CardBody class="bd-example-row">
                <p class="mb-4">
                    ...
                    like
                    <span class="text-danger me-1">.me-auto</span>to force
        ...
        <Row>
            ...
            <Col xl={12}>
                <Card class="custom-card">
                    ...
                    <CardBody class="bd-example-row">
                        ...
                        <p>
                            You may also apply this break at specific
                            breakpoints with our <span class="text-danger"
                                >responsive display utilities.</span
                            >
                        </p>
                        <div class="container">
                            <Row>
            ...
            <Col xl={12}>
                <Card class="custom-card">
                    ...
                    <CardBody class="bd-example-row">
                        ...
                        <p>
                            There are also responsive <span class="text-danger"
                                >.order-first</span
                            >
                            and
                            <span class="text-danger">.order-last</span> classes
                            that change the order of an element by applying
                            <span class="text-danger">order: -1 </span>
                            and
                            <span class="text-danger"> order: 6</span>,
                            respectively. These classes can also be intermixed
                            with the numbered .order-* classes as needed.
                        </p>
                        <div class="container">
                            <Row>
            ...
            <Col xl={12}>
                <Card class="custom-card">
                    ...
                    <CardBody class="">
                        <p>
                            The <span class="text-danger">.col-*</span> classes
                            can also be used outside a
                            <span class="text-danger">.row</span> to give an element
                            a specific width. Whenever column classes are used as
                            non direct children of a row, the paddings are omitted.
                        </p>
            ...
            <CardBody class="bd-example-row">
                ...
                <div class="container">
                    ...
                    <Row>
                        ...
                        >
                            .col-sm-6 .col-md-5 .offset-md-2 .col-lg-6
                            .offset-lg-0
                        </div>
                    </Row>
                </div>
        ...
        <Card class="custom-card">
            <CardBody class="">
                <p>
                    ...
                    responsive floated images. Make sure to wrap the content in
                    a <span class="text-danger">.clearfix </span>
                ...
                <div class="clearfix">
                    ...
                    <p>
                        ...
                        show the use of the clearfix class. We're adding quite a
                        few meaningless phrases here to demonstrate how the
                    ...
                    <p>
                        ...
                        placeholder text that goes on and on, but actually
                        conveys no tangible information at. It simply takes up
