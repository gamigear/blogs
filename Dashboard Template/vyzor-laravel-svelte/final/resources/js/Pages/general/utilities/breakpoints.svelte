...
<!-- Page Title -->
<svelte:head>
    <title>Breakpoints | Vyzor - Svelte Admin & Dashboard Template</title>
</svelte:head>
<!-- Page Title Close -->

<!-- Page Header -->
<Pageheader homepage="Breakpoints" activepage="Utilities" page="Breakpoints" />
<!-- Page Header Close -->
...
<Row>
    ...
    <Col xl={12}>
        <Card class="custom-card">
            ...
            <CardBody>
                <Table responsive bordered hover class="table-nowrap mb-0">
                    <thead>
                        <tr>
                            <th>Breakpoint</th>
                            <th>class infix</th>
