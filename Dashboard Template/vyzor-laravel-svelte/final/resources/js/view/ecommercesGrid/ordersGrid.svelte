<script>
    ...
    import { initialOrders } from "@/shared/data/dashboards/ecommerce/ordersdata";
...
{:else}
    <Grid
        columns={[
            ...
            {
                name: "Payment Method",
                formatter: (cell, row) => html(`${row.cells[6].data}`),
            },
            {
                name: "Payment Status",
                formatter: (cell, row) =>
            ...
            "Ordered Date",
            {
                ...
                formatter: (cell, row, rowIndex) => {
                    ...
                    return html(`
                          <span>
                                <a href="${url}" class="btn btn-sm btn-primary-transparent">
