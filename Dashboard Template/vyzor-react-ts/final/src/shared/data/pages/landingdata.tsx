...
import BG3 from '../../../assets/images/media/backgrounds/3.png';
import BG4 from '../../../assets/images/media/backgrounds/4.png';
import comppanyLogo12 from '../../../assets/images/company-logos/12.png';
import comppanyLogo13 from '../../../assets/images/company-logos/13.png';
import comppanyLogo14 from '../../../assets/images/company-logos/14.png';
import comppanyLogo15 from '../../../assets/images/company-logos/15.png';
import comppanyLogo16 from '../../../assets/images/company-logos/16.png';
import comppanyLogo17 from '../../../assets/images/company-logos/17.png';
import comppanyLogo18 from '../../../assets/images/company-logos/18.png';
import comppanyLogo19 from '../../../assets/images/company-logos/19.png';
import comppanyLogo20 from '../../../assets/images/company-logos/20.png';
...
const Swiperdata = [
    { imgsrc: comppanyLogo13 },
    { imgsrc: comppanyLogo14 },
    { imgsrc: comppanyLogo15 },
    { imgsrc: comppanyLogo16 },
    { imgsrc: comppanyLogo17 },
    { imgsrc: comppanyLogo18 },
    { imgsrc: comppanyLogo19 },
    { imgsrc: comppanyLogo20 },
    { imgsrc: comppanyLogo12 },
]
export const laningSwiper = Swiperdata.map((idx, index) => (
    <Card key={index} className="custom-card trusted-clients-container mb-0 border border-dashed">
        <Card.Body>
            <Image  src={idx.imgsrc} alt="" className="img-fluid" />
        </Card.Body>
    </Card>
));
