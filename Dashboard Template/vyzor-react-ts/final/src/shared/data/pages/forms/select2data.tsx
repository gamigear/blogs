...
import Select2_face1 from '../../../../assets/images/faces/select2/p-1.jpg';
import Select2_face2 from '../../../../assets/images/faces/select2/p-2.jpg';
import Select2_face3 from '../../../../assets/images/faces/select2/p-3.jpg';
import Select2_face4 from '../../../../assets/images/faces/select2/p-4.jpg';
import Select2_face5 from '../../../../assets/images/faces/select2/p-5.jpg';
...
export const Selectoption5 = [
	{
		value: "Andrew", label: (
			<div>
				<Image  src={Select2_face1} alt="Option 1" className="me-2 me-2" />
				Andrew
			</div>
		)
	},
	{
		value: "Maya", label: (
			<div>
				<Image  src={Select2_face2} alt="Option 1" className="me-2" />
				Maya
			</div>
		)
	},
	{
		value: "Brodus Axel", label: (
			<div>
				<Image  src={Select2_face3} alt="Option 1" className="me-2" />
				Brodus Axel
			</div>
		)
	},
	{
		value: "Goldhens", label: (
			<div>
				<Image  src={Select2_face4} alt="Option 1" className="me-2" />
				Goldhens
			</div>
		)
	},
	{
		value: "Angelina", label: (
			<div>
				<Image  src={Select2_face5} alt="Option 1" className="me-2" />
				Angelina
			</div>
		)
	}
