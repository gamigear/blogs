...
export const Audiencedata: CountryData[] = [
    ...
    { id: 5, country: 'France', flag: french_flag, likes: 4000, change: -31.54, count:'11,000'},
];
...
export const Insightsdata: MediaData[] = [
    ...
    { id: 5, title: 'Fashion Forward', image: media27, date: '11, Feb', platform: 'Pinterest', followers: '1.6M+', platformColor:'primary'},
];
