...
export const ProductDetailsSwiper = [
    <div className="" id="img-container">
      <Image className="img-fluid" src={ecommerce4} alt="img" />
    </div>,
    <div className=" image-container">
      <Image className="img-fluid" src={ecommerce2} alt="img" />
    </div>,
    <div className="image-container">
      <Image className="img-fluid" src={ecommerce3} alt="img" />
    </div>,
    <div className="image-container">
      <Image className="img-fluid" src={ecommerce1} alt="img" />
    </div>,
    <div className="image-container">
      <Image className="img-fluid" src={ecommerce5} alt="img" />
    </div>,
    <div className="image-container">
      <Image className="img-fluid" src={ecommerce6} alt="img" />
    </div>
  ]
