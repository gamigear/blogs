      ...
      const grid = new Grid({
        columns: [
          ...
          },
          {
            name: 'Customer',
            formatter: (_, row) => html(`
              <a href="${import.meta.env.BASE_URL}dashboards/ecommerce/order-details">
        ...
        },
        {
          ...
          'Ordered Date',
          {
            ...
            formatter: (_, rowIndex) =>
                        html(`
                          <span>
                                <a  href="${import.meta.env.BASE_URL}dashboards/ecommerce/order-details" class="btn btn-sm btn-primary-transparent me-1">
