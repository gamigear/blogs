...
export const TransactionsTable: Transaction[] = [
    {
        ...
        direction: 'up',
        crypto: { name: 'Bitcoin', icon: bitcoin_btc_logo },
    ...
    },
    {
        ...
        direction: 'down',
        crypto: { name: 'Ethereum', icon: ethereum_eth_logo },
    ...
    },
    {
        ...
        direction: 'up',
        crypto: { name: 'Solana', icon: solana_sol_logo },
    ...
    },
    {
        ...
        direction: 'up',
        crypto: { name: 'Dogecoin', icon: dogecoin_doge_logo },
    ...
    },
    {
        ...
        direction: 'up',
        crypto: { name: 'Tether', icon: tether_usdt_logo },
