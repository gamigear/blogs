...
export const JobsSwiper =  jobs.map((job,jobIndex) => (
      <div className="row" key={jobIndex} >
        {job.badges.map((badge:any,index:any) => (
        <div className="col-md-6" key={index}>
          <div className="card custom-card featured-jobs">
            <div className="card-body">
              <div className="btn-list float-end">
                <SpkTooltips placement="top" title="Add to wishlist">
                <Link to="#!" className="avatar avatar-sm avatar-rounded bg-light text-default"><span><i className="bi bi-heart"></i></span></Link>
                </SpkTooltips>
                <SpkTooltips placement="top" title="Featured Jobs">
                <Link to="#!" className="avatar avatar-sm avatar-rounded bg-warning-transparent me-0"><span><i className="bi bi-star-fill"></i></span></Link>
                </SpkTooltips>
              </div>
              ...
              <div className="popular-tags mb-3">
                <Link to="#!" className="badge rounded-pill bg-light text-default me-1">
