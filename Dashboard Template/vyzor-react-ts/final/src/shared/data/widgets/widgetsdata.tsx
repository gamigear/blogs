...
export const Employeesdata: WidgetData[] = [
    {
...
export const Salesdata: Salesdatas[] = [
    {
        id: "chart-2",
        title: "Total Sales",
        value: "12,432",
    ...
    },
    {
        ...
        color: "info",
        svgIcon: (
            <svg xmlns="http://www.w3.org/2000/svg" className="svg-info" width="32" height="32" fill="#000000" viewBox="0 0 256 256"><path d="M128,24A104,104,0,1,0,232,128,104.11,104.11,0,0,0,128,24Zm12,152h-4v8a8,8,0,0,1-16,0v-8H104a8,8,0,0,1,0-16h36a12,12,0,0,0,0-24H116a28,28,0,0,1,0-56h4V72a8,8,0,0,1,16,0v8h16a8,8,0,0,1,0,16H116a12,12,0,0,0,0,24h24a28,28,0,0,1,0,56Z"></path></svg>
        ),
...
export const CategoryItemsData: CategoryItems[] = [
...
export const Ordersdata: Transaction[] = [
    {
        id: '#ORD789ABC',
...
export const StatusData: StatusBlock[] = [
    {
        label: 'Delivered',
        count: "1,754",
...
export const Transactionsdata: PurchaseItem[] = [
    {
