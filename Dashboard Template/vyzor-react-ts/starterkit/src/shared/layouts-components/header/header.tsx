                            ...
                            <DropdownMenu className="main-header-dropdown dropdown-menu-end" data-popper-placement="none">
                                <div className="p-3 bg-primary text-fixed-white">
                                    <div className="d-flex align-items-center justify-content-between">
                                        ...
                                        <Link to="#!" className="text-fixed-white text-decoration-underline fs-12">Continue Shopping <i className="ti ti-arrow-narrow-right"></i></Link>
                                    </div>
                                </div>
                                ...
                                <ul className="list-unstyled mb-0">
                                    <li>
                                        <ul className="list-unstyled mb-0 sub-list">
                                            <li>
                                                <Link className="dropdown-item d-flex align-items-center" to="#!"><i className="ti ti-user-circle me-2 fs-18"></i>View Profile</Link>
                                            </li>
                                            <li>
                                                <Link className="dropdown-item d-flex align-items-center" to="#!"><i className="ti ti-settings-cog me-2 fs-18"></i>Account Settings</Link>
                                            </li>
                                        </ul>
                                    </li>
                                    <li>
