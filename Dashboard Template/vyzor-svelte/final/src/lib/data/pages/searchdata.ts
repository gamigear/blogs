...
export const images: GalleryItem[] = [
    ...
    },
    {
        ...
        logo: '../images/company-logos/9.png',
...
export const Books: Book[] = [
    {
        id:1,
        imgSrc: "../images/media/books/6.jpg",
    ...
    {
        id:2,
        imgSrc: "../images/media/books/1.jpg",
    ...
    {
        id:3,
        imgSrc: "../images/media/books/2.jpg",
    ...
    {
        id:4,
        imgSrc: "../images/media/books/3.jpg",
        title: "The Hobbit",
    ...
    {
        id:5,
        imgSrc: "../images/media/books/4.jpg",
    ...
    {
        id:6,
        imgSrc: "../images/media/books/5.jpg",
