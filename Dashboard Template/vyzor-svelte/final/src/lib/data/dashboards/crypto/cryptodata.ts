...
const Chartoptions1 = ({color, colors}:any) => ({
    series: [{
...
const Chartoptions2 = ({color, colors}:any) => ({
   series:[{
...
const Chartoptions3 = ({color, colors}:any) => ({
  series:[{
...
const Chartoptions4 = ({color, colors}:any) => ({
  series:[{
...
export const CryptoCards: CryptoCardItem[] = [
    {
        ...
        id: "btc-chart",
        chartoptions: Chartoptions1({color:'var(--primary-color)', colors:'var(--primary01)'}),
        type:'area'
    },
    {
        ...
        id: "eth-chart",
        chartoptions: Chartoptions2({color:'rgb(255, 73, 205)', colors:'rgba(255, 73, 205, 0.1)'}),
        type:'area'
    },
    {
        ...
        icon: "ti ti-trending-up",
        id: "tether-chart",
        chartoptions: Chartoptions3({color:'rgb(50, 212, 132)', colors:'rgba(50, 212, 132, 0.1)'}),
        type:'area'
    },
    {
        ...
        icon: "ti ti-trending-down",
        id: "bnb-chart",
        chartoptions: Chartoptions4({color:'rgb(253, 175, 34)', colors:'rgba(253, 175, 34, 0.1)'}),
        type:'area'
    },
];
...
export const Transactions: Transaction[] = [
  ...
  {
    icon: "../../images/crypto-currencies/crypto-icons/xrp-xrp-logo.svg",
    title: "Transfer",
    date: "2025-02-12 16:45",
    amount: "2,000 XRP",
    status: "Completed",
    imgClass: "custom-Transactions-img"
  },
  {
    icon: "../../images/crypto-currencies/crypto-icons/bitcoin-btc-logo.svg",
    title: "Deposit",
...
export const TransactionActivities: TransactionActivity[] = [
  {
...
export const CryptoTableRows: CryptoTableData[] = [
  {
    name: "Bitcoin (BTC)",
