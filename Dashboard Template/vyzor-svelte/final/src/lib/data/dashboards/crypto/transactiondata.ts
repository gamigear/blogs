...
export const TransactionCard: CardInfo[] = [
    {
        title: "New",
        count: 43,
        price: "12,345",
...
export const TransactionsTable: Transaction[] = [
    {
        toolId:1,
        id: '#1234567890',
        user: { name: 'John Doe', avatar: '../../images/faces/10.jpg' },
        direction: 'up',
        crypto: { name: 'Bitcoin', icon: '../../images/crypto-currencies/crypto-icons/bitcoin-btc-logo.svg' },
    ...
    },
    {
        toolId:2,
        id: '#1234567891',
        user: { name: 'Jane Smith', avatar: '../../images/faces/5.jpg' },
        direction: 'down',
        crypto: { name: 'Ethereum', icon: '../../images/crypto-currencies/crypto-icons/ethereum-eth-logo.svg' },
    ...
    },
    {
        toolId:3,
        id: '#1234567892',
        user: { name: 'Mark Lee', avatar: '../../images/faces/12.jpg' },
        direction: 'up',
        crypto: { name: 'Solana', icon: '../../images/crypto-currencies/crypto-icons/solana-sol-logo.svg' },
    ...
    },
    {
        toolId:4,
        id: '#1234567893',
        user: { name: 'Alex Green', avatar: '../../images/faces/15.jpg' },
        direction: 'up',
        crypto: { name: 'Bitcoin', icon: '../../images/crypto-currencies/crypto-icons/bitcoin-btc-logo.svg' },
    ...
    },
    {
        toolId:5,
        id: '#1234567894',
        user: { name: 'Emma White', avatar: '../../images/faces/4.jpg' },
        direction: 'up',
        crypto: { name: 'Dogecoin', icon: '../../images/crypto-currencies/crypto-icons/dogecoin-doge-logo.svg' },
    ...
    },
    {
        toolId:6,
        id: '#1234567895',
        user: { name: 'Luke Brown', avatar: '../../images/faces/7.jpg' },
        direction: 'down',
        crypto: { name: 'Bitcoin', icon: '../../images/crypto-currencies/crypto-icons/bitcoin-btc-logo.svg' },
    ...
    },
    {
        toolId:7,
        id: '#1234567896',
        user: { name: 'Sophia Black', avatar: '../../images/faces/6.jpg' },
        direction: 'up',
        crypto: { name: 'Ethereum', icon: '../../images/crypto-currencies/crypto-icons/ethereum-eth-logo.svg' },
    ...
    },
    {
        toolId:8,
        id: '#1234567897',
        user: { name: 'Rachel Green', avatar: '../../images/faces/7.jpg' },
        direction: 'up',
        crypto: { name: 'Tether', icon: '../../images/crypto-currencies/crypto-icons/tether-usdt-logo.svg' },
    ...
    },
    {
        toolId:9,
        id: '#1234567898',
        user: { name: 'David Kim', avatar: '../../images/faces/15.jpg' },
        direction: 'down',
        crypto: { name: 'Bitcoin', icon: '../../images/crypto-currencies/crypto-icons/bitcoin-btc-logo.svg' },
    ...
    },
    {
        toolId:10,
        id: '#1234567899',
        user: { name: 'Oliver Stone', avatar: '../../images/faces/16.jpg' },
        direction: 'up',
        crypto: { name: 'Ethereum', icon: '../../images/crypto-currencies/crypto-icons/ethereum-eth-logo.svg' },
