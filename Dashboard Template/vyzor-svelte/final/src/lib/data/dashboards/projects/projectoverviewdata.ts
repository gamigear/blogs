...
export const Filedocument: FileItem[] = [
    { id: 1, name: 'Project_Proposal.pdf', size: '1.2MB', img: '../../images/media/file-manager/1.png', avatarClass:'p-2'},
    { id: 2, name: 'Design_Mockups.zip', size: '1.5MB', img: '../../images/media/file-manager/3.png', avatarClass:''},
    { id: 3, name: 'Project_Timeline.xlsx', size: '256KB', img: '../../images/media/file-manager/1.png', avatarClass:'p-2'},
    { id: 4, name: 'Contract_Agreement.pdf', size: '1.8MB', img: '../../images/media/file-manager/1.png', avatarClass:'p-2'},
];
