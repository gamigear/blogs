...
export const Drag: dataType[] = [
    { id: 1, name: "Draft 300-word blog post" },
    { id: 2, name: "Create project plan with milestones" },
    { id: 3, name: "Develop sample interview questions" },
    { id: 4, name: "Generate customer feedback for product." },
    { id: 5, name: "Write email template for newsletter." },
    { id: 6, name: "Design logo for fictional company" },
];

export const Drag1: dataType[] = [
    { id: 1, name: "Sketch a website homepage" },
    { id: 2, name: "Summarize meeting minutes." },
    { id: 3, name: "Code a simple webpage." },
    { id: 4, name: "Create survey questions." },
    { id: 5, name: "Schedule team meeting." },
    { id: 6, name: "Plan team-building activity." },
];

export const Drag2: dataType[] = [
    { id: 1, name: "Brainstorm marketing ideas." },
    { id: 2, name: "Write slogan for brand." },
    { id: 3, name: "Update contact information." },
    { id: 4, name: "Proofread blog post." },
    { id: 5, name: "Analyze sales data." },
    { id: 6, name: "Edit product description" },
];
...
export let Drag12: dataType[] = [
    { id: 1, name: "Analyze market trends." },
    { id: 2, name: "Edit video content." },
    { id: 3, name: "Plan social media calendar." },
    { id: 4, name: "Update company policies." },
    { id: 5, name: "Compile sales reports." },
    { id: 6, name: "Schedule client calls." },
]
