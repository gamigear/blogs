<script lang="ts">
    import SpkBasicpricecard from "$lib/@spk/reusable-pages/spk-basicpricecard.svelte";
    import SpkTeamcard from "$lib/@spk/reusable-pages/spk-teamcard.svelte";
    import SpkTeststylecard from "$lib/@spk/reusable-pages/spk-teststylecard.svelte";
    import {
        LandingFaqs,
        LandingFeatures,
        ServiceCards,
        Swiperdata,
        WorkflowCards,
    } from "$lib/data/pages/landingdata";
    import {
        BasicPricing1data,
        BasicPricingdata,
    } from "$lib/data/pages/pricingdata";
    import { TeamMembersLanding } from "$lib/data/pages/teamdata";
    import { CustomReviews } from "$lib/data/pages/testimonialsdata";
    import {
        Accordion,
        AccordionItem,
        Card,
    ...
    // handling the Landing switcher through props
    export let toggle;
    const basePath = base;
    ...
    onMount(() => {
        // Use requestAnimationFrame to ensure the update happens after the page is painted
        requestAnimationFrame(() => {
            updateWidth(); // Immediately set the width after the component mounts
        });
    ...
    onMount(() => {
        const handleScroll = () => {
            const color: any =
                document.getElementsByClassName("scrollToTop")[0];
            const dynamicClass = document.querySelector("#sidebar");
            if (color) {
                window.scrollY > 100
            ...
            if (dynamicClass) {
                if (window.scrollY > 100) {
                    dynamicClass.classList.add("sticky-pin");
                } else {
                    dynamicClass.classList.remove("sticky-pin");
                }
            }
        };
    ...
    onMount(() => {
        handleClickOutside = (event: MouseEvent) => {
            if (expande && menuRef && !menuRef.contains(event.target as Node)) {
                expande = false;
            }
        };
    ...
    const documentSelector = (selector: any) =>
        document.querySelector(selector);
    let menuRef: any;

    onMount(() => {
        const pageLinks = menuRef.querySelectorAll(".side-menu__item");
    ...
    const handleSubMenuToggle1 = (e: any) => {
        e.preventDefault();
        expande1 = !expande1;
    };
    const handleSubMenuToggle2 = (e: any) => {
        e.preventDefault();
        expande2 = !expande2;
    };
    ...
    let swiperEl2: SwiperContainer | undefined;
    onMount(() => {
        ...
        <div class="header-content-left">
            ...
            <div class="header-element">
                <div class="horizontal-logo">
                    <a
                        href={`${basePath}/dashboards/sales`}
                        class="header-logo"
                    >
                        <Image
        ...
        <div class="main-sidebar">
            ...
            <nav class="main-menu-container nav nav-pills sub-open">
                ...
                <ul class="main-menu flex-fill justify-content-center">
                    ...
                    <li class="slide">
                        <a
                            class={`side-menu__item ${activeLink === "home" ? "active" : ""} `}
                            href="#home"
                            bind:this={menuRef}
                            on:click={() => {
                                activeLink = "home";
                    ...
                    <li class="slide">
                        <a
                            href="#feature"
                            class={`side-menu__item ${activeLink === "feature" ? "active" : ""} `}
                            bind:this={menuRef}
                            on:click={() => (activeLink = "feature")}
                        >
                    ...
                    <li class="slide">
                        <a
                            href="#service"
                            class={`side-menu__item ${activeLink === "service" ? "active" : ""} `}
                            bind:this={menuRef}
                            on:click={() => (activeLink = "service")}
                        >
                    ...
                    <!-- Start::slide -->
                    <li
                        class={`slide has-sub ${expande ? "open" : ""} `}
                        bind:this={menuRef}
                    >
                        <a
                            href="#!"
                        ...
                        <ul
                            class={`slide-menu child1 ${expande ? "active" : ""}`}
                        ...
                        >
                            <li class="slide">
                                <a
                                    ...
                                    bind:this={menuRef}
                                    on:click={handlePrevent}>Abous Us</a
                                >
                            </li>
                            <li class="slide">
                                <a
                            ...
                            <li class="slide">
                                <a
                                    ...
                                    class="side-menu__item"
                                    bind:this={menuRef}
                                    on:click={handlePrevent}>Privacy Policy</a
                                >
                            </li>
                            <li
                                class={`slide has-sub ${expande1 ? "open" : ""}`}
                            >
                                <a
                                    href="#!"
                                    class="side-menu__item"
                                    bind:this={menuRef}
                                    on:click={handleSubMenuToggle1}
                                    >Level-2
                                    <i
                                ...
                                >
                                <ul
                                    class={`slide-menu child2 ${expande1 ? "active" : ""}`}
                                ...
                                >
                                    ...
                                    <li
                                        class={`slide has-sub ${expande2 ? "open" : ""}`}
                                    >
                                        <a
                                            href="#!"
                                            class="side-menu__item"
                                            bind:this={menuRef}
                                            on:click={handleSubMenuToggle2}
                                            >Level-2-2
                                            <i
                                                class="fe fe-chevron-right side-menu__angle"
                                            ></i></a
                                        >
                                        <ul
                                            class={`slide-menu child3 ${expande2 ? "active" : ""}`}
                ...
                <div class="d-lg-flex d-none align-items-center">
                    <div class="btn-list d-xl-flex d-none">
                        <a
                            href={`${basePath}/authentication/sign-up/basic`}
                            class="btn btn-wave btn-primary border"
                        >
                            Login / Register
                        </a>
                    </div>
                    ...
                    <a
                        href="#!"
                        class="btn btn-icon btn-primary-light switcher-icon"
                        on:click={toggle}
                        data-bs-toggle="offcanvas"
                        data-bs-target="#switcher-canvas"
                    >
...
<div class="main-content landing-main px-0" on:click={handleClick1}>
    <!-- Start:: Landing Banner -->
    <div class="landing-banner" id="home">
        <div class="banner-image-container">
            <img src={`${basePath}/images/media/backgrounds/5.png`} alt="" />
        </div>
        <div class="container">
            <div class="row">
                <div class="col-xl-6 my-auto">
                    ...
                    >
                        <span class="avatar avatar-xs avatar-rounded bg-warning"
                            ><i class="ri-flashlight-fill fs-14"></i></span
                        >Seamless Integration
                    </div>
                    <h1 class="fw-semibold mt-3 landing-banner-heading">
                        Track key metrics <br /> and
                        <span class="text-primary">optimize</span> your business
                    </h1>
                    <span class="d-block fs-18"
                        >Keep track of important business metrics and optimize
                        processes to drive growth and improve efficiency.</span
                    >
                    <div class="btn-list banner-buttons">
                        ...
                        >
                        <a
                            class="btn btn-lg btn-light border rounded-pill btn-w-lg"
                            href="#!">View Demo</a
                        >
                    </div>
                </div>
                <div class="col-xl-6">
                    <div class="banner-main-img text-end d-xl-block d-none">
                        <img
                            src={`${basePath}/images/media/backgrounds/7.png`}
                            alt=""
                            class="img-fluid"
                        />
                    </div>
        ...
        <div class="container">
            <div class="heading-section">
                ...
                <div class="heading-description">
                    Thousands of businesses trust our solutions <br /> to optimize
            ...
            <swiper-container
                init="false"
                bind:this={swiperEl}
                class="trusted-clients swiper swiper-backface-hidden"
            >
                {#each Swiperdata as idx}
                    <swiper-slide>
                        <div
                            class="card custom-card trusted-clients-container mb-0 border border-dashed"
                        >
                            <div class="card-body">
                                <img
                                    src={`${basePath}${idx.imgsrc}`}
                                    alt=""
                                    class="img-fluid"
                                />
                            </div>
    ...
    <section class="section" id="feature">
        <div class="container">
            <div class="heading-section">
                ...
                <div class="heading-description">
                    Boost productivity and simplify management with our
                    ...
                    <Col xl={4} md={6}>
                        <Card class="custom-card">
                            <CardBody>
                                <div class="lh-1 mb-3">
                                    <span
                                        class={`avatar avatar-lg avatar-rounded ${feature.bgClass} ${feature.svgClass}`}
                                    >
                                        {@html feature.svgIcon}
                                    </span>
                                </div>
    ...
    <section class="section" id="service">
        <div class="container">
            <div class="heading-section">
                ...
                <div class="heading-description">
                    Discover our services to streamline operations, boost
                    productivity, <br /> and drive growth, from analytics to automation.
                </div>
            </div>
            <Row>
                <Col xl={7}>
                    <Row>
                        {#each ServiceCards as card}
                            <Col lg={6}>
                                <Card
                                    class={`custom-card landing-services-card ${card.cardClass}`}
                                >
                                    <CardBody>
                                        <div
                                        ...
                                        >
                                            <div class="lh-1">
                                                <span
                                                    class={`avatar avatar-lg avatar-rounded ${card.iconBgClass} ${card.iconColorClass}`}
                                                >
                                                    {@html card.icon}
                                                </span>
                                            </div>
                                            <div>
                                                <h6 class="d-block fw-semibold">
                                                    {card.title}
                                                </h6>
                ...
                <Col xl={5} class="my-auto">
                    <div
                        class="services-image-container text-end d-xl-block d-none"
                    >
                        <Image
                            src={`${basePath}/images/media/media-67.png`}
                            alt=""
                            class="img-fluid"
                        />
                    </div>
    ...
    <section
        class="section section-md section-primary text-fixed-white py-5 buy-now-section"
    >
        <div class="testimonials-background-container grid-cards">
            <Image src={`${basePath}/images/media/backgrounds/1.png`} alt="" />
        </div>
        <div class="container">
            <div
            ...
            >
                <div>
                    ...
                    <span class="d-block fs-16 op-8"
                        >Unlock all the powerful features of our admin template. <br
                        /> Purchase now or try the demo to see it in action!</span
                    >
                </div>
                <div class="btn-list">
                    <a
                        ...
                        >View Demo<i class="ti ti-arrow-narrow-right ms-2"
                        ></i></a
                    >
                    <button
                        class="btn btn-success btn-lg btn-w-md d-inline-flex align-items-center"
                        >Buy Now<i class="ti ti-shopping-cart ms-2"></i></button
                    >
                </div>
            </div>
        </div>
        ...
        <div class="container">
            <div class="heading-section">
                ...
                <div class="heading-description mb-3">
                    Select the right fit and enjoy seamless access to all
                    features.
                </div>
                <div
                    class="tab-style-1 border bg-white rounded-0 d-inline-block"
                >
                    <Nav class="nav nav-pills" role="tablist">
                        <NavItem class="nav-item" role="presentation">
                            <NavLink
                                on:click={() => (activeTab2 = 1)}
                                active={activeTab2 == 1}
                                class="nav-link rounded-0 fw-medium"
                                data-bs-toggle="pill"
                                data-bs-target="#pricing1-monthly"
                                aria-selected="true"
                                role="tab">Monthly</NavLink
                            >
                        </NavItem>
                        <NavItem class="nav-item" role="presentation">
                            <NavLink
                                on:click={() => (activeTab2 = 2)}
                                active={activeTab2 == 2}
                                class="nav-link rounded-0 fw-medium"
                                data-bs-toggle="pill"
                                data-bs-target="#pricing1-yearly"
                                aria-selected="false"
                                role="tab"
                                tabindex={-1}>Yearly</NavLink
                            >
                        </NavItem>
                    </Nav>
                </div>
            </div>
            <TabContent id="landingPageTab">
                <TabPane
                    class={`${activeTab2 == 1 ? "active" : ""} p-0 border-0`}
                    id="pricing1-monthly"
                    role="tabpanel"
                >
                    <Row>
                        {#each BasicPricingdata as card}
                            <Col xxl={4}>
                                <SpkBasicpricecard
                ...
                <TabPane
                    class={`${activeTab2 == 2 ? "active" : ""} p-0 border-0`}
                    id="pricing1-yearly"
                    role="tabpanel"
                >
                    <Row>
                        {#each BasicPricing1data as card}
                            <Col xxl={4}>
                                <SpkBasicpricecard
                                    cardClass={card.cardClass}
                                    price={card}
    ...
    <section class="section">
        <div class="container">
            <div class="heading-section">
                ...
                <div class="heading-description">
                    Browse through common questions to get quick solutions.
                    We're here to help!
                </div>
            </div>
            <div class="row">
                <div class="col-xl-12">
                    <Accordion
                        ...
                        id="accordionFAQ3"
                    >
                        {#each LandingFaqs as idx}
                            <AccordionItem active={idx.active} class="">
                                <h6
    ...
    <section class="section section-primary testimonials-section">
        <div class="testimonials-background-container">
            <img src={`${basePath}/images/media/backgrounds/2.png`} alt="" />
        </div>
        <div class="container">
            <div class="heading-section">
                ...
                <div class="heading-description">
                    Read real testimonials from customers who’ve <br /> improved
            ...
            <swiper-container
                init="false"
                bind:this={swiperEl2}
                class="testimonialSwiperService testimonials-swiper-2 swiper swiper-backface-hidden"
            >
                {#each CustomReviews as review}
                    <swiper-slide>
                        <div>
                            <SpkTeststylecard
                                cardClass={review.color}
                                style={review}
                            />
                        </div>
                    </swiper-slide>
    ...
    <section class="section">
        <div class="container">
            <div class="heading-section">
                ...
                <div class="heading-description">
                    Discover how our structured workflow drives productivity, <br
            ...
            <Row class="justify-content-between">
                {#each WorkflowCards as card}
                    <Col lg={3}>
                        <Card class="custom-card border-0 shadow-none">
                            <CardBody class="p-4 text-center">
                                {#if card.imgSrc}
                                    <div
                                        class="step-arrow-container d-lg-block d-none"
                                    >
                                        <Image
                                            src={`${basePath}${card.imgSrc}`}
                                            alt={card.title}
                                            class="img-fluid"
                                        />
                                    </div>
                                ...
                                <div class="lh-1 mb-3">
                                    <span
                                        class={`avatar avatar-lg ${card.iconClass} workflow-icon-container`}
                                    >
                                        {@html card.icon}
                                    </span>
                                </div>
    ...
    <section class="section our-team-section">
        <div class="container">
            <div class="heading-section">
                ...
                <div class="heading-description">
                    Get to know the talented individuals behind our success, <br
                    /> working together to deliver exceptional results.
                </div>
            </div>
            <Row>
                {#each TeamMembersLanding.slice(0, 4) as idx}
                    <Col lg={3} md={6}>
        ...
        <div class="container">
            <div class="heading-section">
                ...
                <div class="heading-description">
                    ...
                    /> Reach out to us anytime for support or inquiries.
                </div>
            </div>
            <div class="row gy-4 justify-content-between">
                <div class="col-xl-6">
                    ...
                    <div class="row gy-3">
                        ...
                        <div class="col-xl-12">
                            <label for="contact-mail-message" class="form-label"
                                >Message</label
                            >
                            <textarea
                                class="form-control"
                    ...
                    <div class="d-grid mt-3">
                        <button class="btn btn-primary"
                            >Submit<i
                                class="ti ti-arrow-narrow-right ms-1 align-middle"
                            ></i></button
                        >
                    </div>
                </div>
                    ...
                    <div class="row gy-5">
                        <div class="col-xl-12">
                            <div class="d-flex align-items-start gap-3">
                                <div>
                                    <span
                                        class="avatar avatar-lg bg-primary-transparent svg-primary"
                                    >
                                        <svg
                                            xmlns="http://www.w3.org/2000/svg"
                                            height="24px"
                                ...
                                <div>
                                    ...
                                    <span class="d-block fs-12 text-muted mb-2"
                                        >Visit us in person From Mon-Fri 9:00am
                                        - 6:00pm</span
                                    >
                        ...
                        <div class="col-xl-12">
                            <div class="d-flex align-items-start gap-3">
                                ...
                                <div>
                                    ...
                                    <span class="d-block fs-12 text-muted mb-2"
                                        >Call our team Mon-Fri 9:00am - 6:00pm</span
                                    >
                                    <div class="fw-semibold">
                                        +1 (555) 123-4567
                                    </div>
                        ...
                        <div class="col-xl-12">
                            <div class="d-flex align-items-start gap-3">
                                ...
                                <div>
                                    ...
                                    <div
                                        class="fw-semibold lh-1 chat-platforms"
                                    >
                                        <a
    ...
    >
        <div class="testimonials-background-container">
            <img src={`${basePath}/images/media/backgrounds/1.png`} alt="" />
        </div>
        <div class="container">
            <div
            ...
            >
                <div>
                    ...
                    <span class="d-block fs-16 op-8"
                        >Create, manage, and optimize effortlessly with our
                        admin template.</span
                    >
                </div>
                <button
                    class="btn btn-secondary btn-lg btn-w-md d-inline-flex align-items-center"
                    >Buy Now<i class="ti ti-shopping-cart ms-2"></i></button
                >
            </div>
        </div>
...
<section class="section landing-footer text-fixed-white">
    <div class="container">
        <div
            class="row my-auto justify-content-between align-items-center mb-5 pb-5 newsletter-area gap-3"
        >
            <div class="col-lg-6">
                <h3 class="mb-2 text-fixed-white">
                    Subscribe to our News Letter
                </h3>
                <div class="op-6">
                    Stay up-to-date with the latest news and updates on our
            ...
            <div class="col-lg-4">
                <div class="form mb-0">
                    <div class="form-group custom-form-group mx-auto">
                        ...
                        />
                        <button
                            class="custom-form-btn btn btn-primary bg-primary border-0 right-0 shadow-none"
        ...
        <div class="row justify-content-center gy-3">
            ...
            <div class="col-sm-3 col-xl-2 col-6">
                ...
                <ul class="list-unstyled fw-normal landing-footer-list mb-0">
                    <li>
                        <a href="#!" class="text-fixed-white op-6">Services</a>
                    </li>
                    <li>
                        <a href="#!" class="text-fixed-white op-6"
                            >Product Tour</a
                        >
                    </li>
                    <li>
                    ...
                    <li>
                        <a
                            href={`${basePath}/pages/pricing`}
                            class="text-fixed-white op-6">Pricing</a
                        >
                    </li>
                </ul>
            </div>
            <div class="col-sm-3 col-xl-2 col-6">
                ...
                <ul class="list-unstyled fw-normal landing-footer-list mb-0">
                    <li>
                        <a href="#!" class="text-fixed-white op-6">Contact Us</a
                        >
                    </li>
                    <li>
                        <a href="#!" class="text-fixed-white op-6"
                    ...
                    <li>
                        <a href="#!" class="text-fixed-white op-6">Support</a>
                    </li>
                </ul>
            </div>
            <div class="col-sm-3 col-xl-2 col-6">
            ...
            <div class="col-sm-3 col-xl-2 col-6">
                ...
                <ul class="list-unstyled fw-normal landing-footer-list mb-0">
                    <li>
                        <a
                            href={`${basePath}/pages/blog/blog`}
                            class="text-fixed-white op-6">Blog</a
                        >
                    </li>
                    <li>
                        <a href="#!" class="text-fixed-white op-6">About Us</a>
                    </li>
                    <li>
                        <a href="#!" class="text-fixed-white op-6">Customers</a>
                    </li>
                    <li>
                        <a href="#!" class="text-fixed-white op-6">Jobs</a>
                    </li>
                </ul>
            </div>
        </div>
    ...
    <div class="container">
        <div class="row align-items-center justify-content-center">
            <div class="col-xl-7 col-lg-9">
                ...
                >
                    <p class="mb-0 me-3 text-fixed-white op-6 fw-normal">
                        Payments We Accept :
                    </p>
                    <div
        ...
        <div class="row">
            <div class="col-lg-4 text-lg-start text-center">
                <span class="text-fixed-white op-7 fs-14">
                    ...
                    <a href="#!" class="text-primary fs-15 fw-semibold"
                        >Spruko
            ...
            <div class="col-lg-8 text-lg-end text-center mt-lg-0 mt-1">
                <ul class="list-unstyled fw-normal landing-footer-list mb-0">
                    <li>
                        <a href="#!" class="text-fixed-white op-8"
                            >Terms Of Service</a
                        >
                    </li>
                    <li>
                    ...
                    <li>
                        <a href="#!" class="text-fixed-white op-8">Legal</a>
                    </li>
                    <li>
                        <a href="#!" class="text-fixed-white op-8">Contact</a>
                    </li>
                    <li>
                        <a href="#!" class="text-fixed-white op-8">Blog</a>
                    </li>
                    <li>
                        <a href="#!" class="text-fixed-white op-8">Licenses</a>
                    </li>
                </ul>
            </div>
        </div>
