...
export const progress9 = `//<!-- Prism Code: This code is only used for showcode purpose -->//
 ...
 <Progress Bar color='primary' class="progress mb-3 progress-animate" value={10} />
 <Progress Bar color='secondary' class="progress mb-3 progress-animate" value={20} />
 <Progress Bar color='success' class="progress mb-3 progress-animate" value={40} />
 <Progress Bar color='info' class="progress mb-3 progress-animate" value={60} />
 <Progress Bar color='warning' class="progress  progress-animate" value={80} />`
