<script lang="ts">
    ...
    export let CustomCardClass:string=""
    ...
    export let collapseToggle: boolean = false;
    export let normalToggle: boolean = false;
    export let hideToggle: boolean = false;
...
{#if Basicshow}
    <Card class={`custom-card ${CustomCardClass} ${isFullscreen ? "card-fullscreen" : ""} `}>
        <CardHeader
