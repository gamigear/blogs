<script lang="ts">
    ...
    import {
        ...
        Testimonials3,
        Testimonialsdata,
    } from "$lib/data/pages/testimonialsdata";
    import SpkTestimonialcard from "$lib/@spk/reusable-pages/spk-testimonialcard.svelte";
    ...
    let swiperEl3: SwiperContainer | undefined;
    let swiperEl4: SwiperContainer | undefined;
    onMount(() => {
