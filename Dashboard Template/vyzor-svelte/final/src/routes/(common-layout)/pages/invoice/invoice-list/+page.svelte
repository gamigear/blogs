<script lang="ts">
    ...
    import SpkInvoicelistcard from "$lib/@spk/reusable-pages/invoice/spk-invoicelistcard.svelte";
    ...
    import {
        ...
        Invoicedata,
        Invoices,
    } from "$lib/data/pages/invoice/invoicelistdata";
    import {
        Card,
        CardBody,
        CardFooter,
