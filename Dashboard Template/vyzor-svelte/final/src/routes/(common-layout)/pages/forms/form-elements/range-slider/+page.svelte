<script lang="ts">
    ...
    } from "$lib/data/forms/rangesliderdata";
    import { onMount } from "svelte"; // Import the function from slider

    let sliderStart: HTMLElement;
    let FitHandles: HTMLElement;
    let Rounded: HTMLElement;
    let Square: HTMLElement;
    let sliderPrimary: HTMLElement;
    let sliderSecondary: HTMLElement;
    let sliderWarning: HTMLElement;
    let sliderInfo: HTMLElement;
    let sliderSuccess: HTMLElement;
    let sliderDanger: HTMLElement;
    let verticalSlider: HTMLElement;
    let colorSlider: HTMLElement;
    let tooltipSlider: HTMLElement;
    let marginSlider: HTMLElement;
    //
    let nonlinearSlider: HTMLElement;
    ...
    //
    let pipsSlider: HTMLElement;
    let softSlider: HTMLElement;
    //
    let slider1: HTMLElement;
    let slider2: HTMLElement;
    let lockButton: HTMLElement;
    let slider1Value: number = 60;
    let slider2Value: number = 80;
    onMount(() => {
