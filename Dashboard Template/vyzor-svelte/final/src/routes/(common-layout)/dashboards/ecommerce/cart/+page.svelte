<script lang="ts">
    ...
    import {
        CartData,
        PricingSummary,
    } from "$lib/data/dashboards/ecommerce/cartdata";
    import {
        Card,
        CardBody,
        CardFooter,
    ...
    <Col xl={3}>
        <Card class="custom-card">
                    ...
                    {#each PricingSummary as item}
                        <li >
                            ...
                            >
                                <div>{item.label}</div>
                                <div
                                    class={`fw-medium ${item.isDiscount ? "text-danger" : item.isFree ? "text-success" : ""}`}
                                >
                                    {item.value}
                                </div>
                            </div>
            ...
            <CardFooter class="d-grid">
                   <a href={`${basePath}/dashboards/ecommerce/checkout`}
