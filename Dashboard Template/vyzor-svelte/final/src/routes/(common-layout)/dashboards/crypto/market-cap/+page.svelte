<script lang="ts">
    ...
    import SpkMarketcard from "$lib/@spk/dashboards-reusable/crypto-reusable/spk-marketcard.svelte";
    ...
    import {
        ...
        MartketTable,
        PortfolioData,
    } from "$lib/data/dashboards/crypto/marketdata";
    import { MarketcapDropdown } from "$lib/data/uielements/dropdowndata";
    import {
        Card,
        CardBody,
        CardFooter,
...
<Row>
    ...
    <Col xxl={3} xl={6} lg={12}>
        <Card class="custom-card overflow-hidden">
            ...
            <CardBody class="p-0">
                <ListGroup class="list-group list-group-flush custom-market-cap">
