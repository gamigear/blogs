<script lang="ts">
    ...
    import {
        TransactionCard,
        TransactionsTable,
    } from "$lib/data/dashboards/crypto/transactiondata";
                ...
                >
                    {#each Transactions as txn}
                        <tr>
                            ...
                            <td class={txn.borderClass}><span>{txn.id}</span></td>
                            <td class={txn.borderClass}>
                                <div class="d-flex align-items-center gap-2">
                                    <span
                                        class="avatar avatar-xs avatar-rounded"
                            ...
                            <td class={txn.borderClass}><span>{txn.date}</span></td>
                            <td class={txn.borderClass}><span>{txn.amount}</span></td>
                            <td class={txn.borderClass}><span>{txn.recipient}</span></td>
                            <td class={txn.borderClass}>
                                <SpkBadge
                                    Color=""
