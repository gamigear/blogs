<script lang="ts">
    ...
    import SpkMedicalcard from "$lib/@spk/dashboards-reusable/spk-medicalcard.svelte";
    ...
    import {
        ...
        PatientsOptions,
        TestRecords,
    } from "$lib/data/dashboards/medicaldata";
    import { medicalDropdown, SortByDropdown } from "$lib/data/uielements/dropdowndata";
    import {
        Card,
        CardBody,
        CardFooter,
            ...
            <Col xl={5}>
                <Card class="custom-card">
                    ...
                    <CardBody>
                        ...
                        <ul
                            class="list-unstyled availabe-doctors-list"
