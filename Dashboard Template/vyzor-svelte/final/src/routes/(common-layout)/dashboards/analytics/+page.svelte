<script lang="ts">
    ...
    import SpkAnalyticscard from "$lib/@spk/dashboards-reusable/spk-analyticscard.svelte";
    ...
    import {
        ...
        Sessionoptions,
        Timeoptions,
    } from "$lib/data/dashboards/analyticsdata";
    import {
        dayDropdown,
        DropdownDownload,
        SortByDropdown,
            ...
            <Col xxl={4}>
                <Card class="custom-card">
                    <CardHeader class="justify-content-between">
                        ...
                        <SpkDropdown
                            option={dayDropdown} CustomClass="ms-auto"
