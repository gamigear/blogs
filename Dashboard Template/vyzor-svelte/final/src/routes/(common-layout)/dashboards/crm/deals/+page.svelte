<script lang="ts">
    import SpkDealscard from "$lib/@spk/dashboards-reusable/crm/spk-dealscard.svelte";
    ...
    import {
        ...
        SuccessDeal,
        WarningDeal,
    } from "$lib/data/dashboards/crm/dealsdata";
    ...
    let firstContainerRef: HTMLElement;
    let secondContainerRef: HTMLElement;
    let thirdContainerRef: HTMLElement;
    let fourthContainerRef: HTMLElement;
    let fifthContainerRef: HTMLElement;
    let sixthContainerRef: HTMLElement;
