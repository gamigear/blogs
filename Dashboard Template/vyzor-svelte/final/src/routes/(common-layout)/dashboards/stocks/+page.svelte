<script lang="ts">
    ...
    import SpkStockcard from "$lib/@spk/dashboards-reusable/spk-stockcard.svelte";
    ...
    import {
        ...
        Trendingdata,
        Watchlistdata,
    } from "$lib/data/dashboards/stocksdata";
                        ...
                        <Col xxl={2} xl={4} lg={6} md={6} sm={12} class="">
                            <Card class="p-3 custom-card border bg-white rounded">
                                    ...
                                    <div class="d-flex flex-fill align-items-center">
                                        <div class="me-2">
                                            <span class="avatar avatar-rounded bg-light p-2">
                                                <i class={`bi ${asset.icon} ${asset.iconColor} fs-18`}></i>
                                            </span>
                                        </div>
                                        <div class="lh-1">
                                            <span class="fw-semibold d-block mb-2 text-default">{asset.name}</span>
                                            <span class="d-block text-muted fs-12">{asset.value}</span>
                                        </div>
                                    </div>
                                ...
                                <div class="d-flex gap-2">
                                    <SpkButton color="" buttontype="button" customClass="btn btn-sm btn-light flex-fill">Short</SpkButton>
                                    <SpkButton color="" buttontype="button" customClass="btn btn-sm btn-primary-light flex-fill">Buy</SpkButton>
                                </div>
                            </Card>
                        </Col>
                        {/each}
            ...
            <Row>
                <Col xxl={3}>
                    <Card class="custom-card overflow-hidden">
                        <CardHeader class="justify-content-between">
                            ...
                            <a href="#!" class="fs-12 text-muted py-1 tag-a"> View All<i
                                ...
                                <li >
                                    <div class="d-flex gap-2 flex-wrap align-items-start justify-content-between mb-2">
                                        <div class="d-flex flex-fill align-items-center">
                                            <div class="me-2">
                                                <span class="avatar avatar-md p-1">
                                                    <Image width={40} height={40} src={stock.logo} alt={stock.name} class="invert-1" />
                                                </span>
                                            </div>
                                            <div class="lh-1">
                                                <span class="fw-semibold d-block mb-2 text-default">
                                                    {stock.name}
                                                </span>
                                        ...
                                        <div class="fw-medium fs-14 text-end">
                                            <span class="d-block">{stock.valueChange}</span>
                                        </div>
                                    </div>
                                    <div>
                                        <Progress color={stock.progressColor} class="progress-xs" animated striped value={stock.progressBarWidth} />
                                    </div>
                                </li>
                                {/each}
                            </ul>
                ...
                <Col xxl={9}>
                    <Card class="custom-card overflow-hidden">
                        ...
                        <CardBody class="p-0">
                            <SpkTablescomponent Responsive={true} tableClass="text-nowrap" header={[{ title: 'S.No' }, { title: 'Name' }, { title: 'Price' }, { title: 'Date Invested' }, { title: 'Market Cap' }, { title: 'Price Change' }, { title: 'Volume' }, { title: 'Actions' }]}>
                                    ...
                                    <tr>
                                            ...
                                            <div class="d-flex align-items-start gap-3">
                                                <div class="lh-1">
                                                    <span class="avatar avatar-sm">
                                                        <Image width={28} height={28} src={stock.logo} alt={stock.name} class="invert-1" />
                                                    </span>
                                                </div>
                                                <div class="flex-fill lh-1">
                                                    <a href="#!" class="d-block mb-1 fs-14 fw-medium">
                                                        {stock.name}
                                                    </a>
                                        ...
                                        <td>
                                            <SpkBadge Color="" CustomClass={`badge ${stock.change.includes("-") ? "bg-danger-transparent text-danger" : "bg-success-transparent text-success"}`}>
                                                {stock.change}
                                            </SpkBadge>
                                        </td>
                                        <td>{stock.volume}</td>
                                        <td>
                                            ...
                                            <div class="btn-list">
                                                <a href="#!" id={`stocks-${stock.id}`} class="btn btn-icon btn-primary-light btn-sm">
                                                    <i class="bi bi-pencil-square"></i>
                                                </a>
                                                <SpkTooltips placement="top" content="Edit" targetId={`stocks-${stock.id}`}>
                                                </SpkTooltips>
                                                <a href="#!" id={`stocks1-${stock.id}`} class="btn btn-icon btn-danger-light btn-sm">
                                                    <i class="bi bi-trash"></i>
                                                </a>
                                                <SpkTooltips placement="top" content="Delete" targetId={`stocks1-${stock.id}`}>
                                                </SpkTooltips>
                                            </div>
                                        </td>
                                    </tr>
                                    ...
                                    <nav aria-label="Page navigation" class="pagination-style-4">
                                        <Pagination class="mb-0 customPaginationPageBottom" >
                                            <PaginationItem disabled>
                                                <PaginationLink on:click={e=>e.preventDefault()}>Prev</PaginationLink>
                                            </PaginationItem>
