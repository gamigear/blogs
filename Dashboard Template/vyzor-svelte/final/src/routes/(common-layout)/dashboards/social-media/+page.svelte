<script lang="ts">
    ...
    import SpkSocialcard from "$lib/@spk/dashboards-reusable/spk-socialcard.svelte";
    ...
    import {
        ...
        SocialMediaOptions,
        Suggestion,
    } from "$lib/data/dashboards/socialmediadata";
    import { socialmediaDropdown1, socialmediaDropdown2, SortByDropdown } from "$lib/data/uielements/dropdowndata";
    import {
        Card,
        CardBody,
        CardFooter,
                        ...
                        >
                            {#each Insightsdata as row}
                                <tr>
                                    ...
                                    <td class={row.borderClass}>{row.followers}</td>
    ...
    <Col xxl={3}>
        <Row>
            <Col xl={12}>
                <Card class="custom-card">
                    <CardHeader>
                        <div class="card-title">Recent Acivity</div>
                    </CardHeader>
                    <CardBody>
