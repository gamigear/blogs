...
<script lang="ts">
    ...
    import SpkHrmcard from "$lib/@spk/dashboards-reusable/spk-hrmcard.svelte";
    ...
    import { Applicants, AttendanceData, AttendanceOptions, AttendancesToday, CandidateOptions, EmployeeOptions, Employees, Hrmcards } from "$lib/data/dashboards/hrmdata";
    import { hrmDropdown1, SortByDropdown } from "$lib/data/uielements/dropdowndata";
    import { Card, CardBody, CardFooter, CardHeader, Col, Image, Input, Pagination, PaginationItem, PaginationLink, Row } from "@sveltestrap/sveltestrap";
</script>
                    ...
                    <Card class="custom-card">
                        ...
                        <CardBody class="p-0">
                            ...
                            <div id="candidate-statistics" class="p-3">
                                <Spkapexcharts id="candidate-statistics"  options={CandidateOptions} />
                            </div>
                        </CardBody>
                    </Card>
                </Col>
                    ...
                    <Card class="custom-card">
                        ...
                        <CardBody>
                            <div id="attendance-overview">
                                <Spkapexcharts id="attendance-overview" options={AttendanceOptions} />
                            </div>
                            ...
                            <div class="d-grid">
                                <SpkButton color="" customClass="btn btn-light btn-lg">View Complete Statistics <i class="ti ti-arrow-narrow-right ms-1"></i></SpkButton>
                            </div>
                        </CardBody>
                    </Card>
                </Col>
                    ...
                    <Card class="custom-card">
                        ...
                        <CardBody>
                            <div id="employee-department">
                                <Spkapexcharts id="employee-department" options={EmployeeOptions}  />
                            </div>
                        </CardBody>
                    </Card>
                </Col>
                <Col xxl={4}>
                    <Card class="custom-card">
                        <CardHeader class="justify-content-between">
                            ...
                            <a  href="#!" class="text-muted fs-13">View All<i class="ti ti-arrow-narrow-right ms-1"></i></a>
                        </CardHeader>
                        <CardBody>
                                    ...
                                    <div class="d-flex align-items-center gap-2 flex-wrap">
                                        ...
                                        <div class="flex-fill">
                                            <span class="d-block fw-semibold">
                                                {employee.name}
                                                <SpkBadge Color="" CustomClass={`bg-${employee.badgeColor}-transparent ms-2`}>
                                                    {employee.department}
                                                </SpkBadge>
                                            </span>
                                            <span class="text-muted fs-13">{employee.role}</span>
                                        </div>
                                        <div class="text-end">
                                            <span class="fw-medium">{employee.joinDate}</span>
                                            <span class="d-block fs-12 mt-1 text-muted">Joined</span>
                                        </div>
                                    </div>
                                </li>
                                {/each}
                ...
                <Col xxl={4}>
                    <Card class="custom-card overflow-hidden">
                        <CardHeader class="justify-content-between">
                            ...
                            <SpkDropdown
                            option={hrmDropdown1}
                            ToggleClass=" fs-12 text-muted no-caret border-0 px-0"
                            Caret={false}
                            parent={`Sort By <i class="ri-arrow-down-s-line align-middle ms-1 d-inline-block"></i>`}
                            />
                        </CardHeader>
                        <CardBody class="p-0">
                           <SpkTablescomponent Responsive={true} Hover={true} tableClass="text-nowrap table-hover" header={[{ title: 'Name' }, { title: 'Time In' }, { title: 'Status' }]}>
                                    ...
                                    <tr >
                                        ...
                                        <td class={attendance.borderClass}>{attendance.time}</td>
                                        <td class={attendance.borderClass}>
                                            <SpkBadge Color="" CustomClass={`bg-${attendance.badgeColor}-transparent rounded-pill min-w-badge`}>
                                                {attendance.status}
                                            </SpkBadge>
                                        </td>
                                    </tr>
                    ...
                    <Card class="custom-card">
                        <CardHeader class="justify-content-between">
                            ...
                            <div class="d-flex flex-wrap gap-2">
                                <div>
                                    <Input class="form-control-sm" type="text" placeholder="Search Here" aria-label=".form-control-sm example" />
                                </div>
                                <SpkDropdown 
                        ...
                        <CardBody class="p-0">
                             <SpkTablescomponent Responsive={true} tableClass="text-nowrap" showCheckbox={true} header={[{ title: 'Application ID' }, { title: 'Applicant Name' }, { title: 'Position Applied' }, { title: 'Date Of Application' }, { title: 'Email' }, { title: 'Work Experience' }, { title: 'Status' }, { title: 'Action' }]}>
                                    {#each Applicants as applicant, index}
                                    <tr >
                                        <th scope="row">
                                            <input class="form-check-input" type="checkbox" id={`checkboxNoLabel${index}`} defaultValue="" defaultChecked={applicant.id == 2 || applicant.id == 4 || applicant.id == 5} aria-label="..." />
                                        </th>
                                        ...
                                        <td>
                                            <SpkBadge Color="" CustomClass={`bg-${applicant.status === 'New' ? 'primary' : applicant.status === 'Interviewed' ? 'success' : applicant.status === 'Hired' ? 'info' : applicant.status === 'Under Review' ? 'secondary' : 'danger'}-transparent`}>
                                                {applicant.status}
                                            </SpkBadge>
                                        </td>
                                        <td>
                                            <div class="hstack gap-2 fs-15">
                                                <a aria-label="anchor" href="#!" class="btn btn-icon waves-effect waves-light btn-sm btn-success-light rounded-circle">
                                                    <i class="ri-phone-line"></i>
                                                </a>
                                                <a aria-label="anchor" href="#!" class="btn btn-icon waves-effect waves-light btn-sm btn-primary-light rounded-circle">
                                                    <i class="ri-edit-line"></i>
                                                </a>
                                                <a aria-label="anchor" href="#!" class="btn btn-icon btn-wave waves-effect waves-light btn-sm btn-danger-light rounded-circle">
