<script lang="ts">
    ...
    import SpkDashboardcard from "$lib/@spk/dashboards-reusable/projects/spk-dashboardcard.svelte";
    ...
    import {
        ...
        Transactions,
        UrgentTasks,
    } from "$lib/data/dashboards/projects/projectdashboardata";
    import {
        SortByDropdown,
        WeekDropdown,
                    ...
                    >
                        {#each ProjectsSummary as project}
                            <tr>
                                ...
                                <td class={project.borderBottom}>{project.startDate}</td>
                                <td class={project.borderBottom}>{project.endDate}</td>
                                <td class={project.borderBottom}>
                                    <SpkBadge
                                        Color=""
                                ...
                                <td class={project.borderBottom}>{project.amount}</td>
                                <td class={project.borderBottom}>
                                    <div class="btn-list">
                                        <SpkButton
                                            color=""
