<script lang="ts">
    ...
    import {
        ...
        Piemonooptions,
        Updatedoptions,
    } from "$lib/data/charts/apexcharts/piechartdata";
        ...
        <Card class="custom-card">
            ...
            <CardBody>
                <div id="donut-gradient">
                    <Spkapexcharts
                        options={Piegardientoptions} id="donut-gradient"
                    />
                </div>
            </CardBody>
        </Card>
        ...
        <Card class="custom-card">
            ...
            <div class="card-body">
                <div id="donut-pattern">
                    <Spkapexcharts
                        options={Piechartoptions} id="donut-pattern"
                    />
                </div>
            </div>
        </Card>
    ...
    <Col xl={6}>
        <Card class="custom-card">
            ...
            <CardBody>
                <div id="pie-image">
                    <Spkapexcharts
                        options={Pieimgoptions}  id="pie-image"
                    />
                </div>
            </CardBody>
        </Card>
