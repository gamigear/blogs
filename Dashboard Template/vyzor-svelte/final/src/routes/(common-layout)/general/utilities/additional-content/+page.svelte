<script lang="ts">
    ...
    import { Card, CardBody, CardHeader, Col, Image, Row } from "@sveltestrap/sveltestrap";
</script>
            ...
            Height auto
                ...
                <Col xl={6}>
                    <Card class="custom-card">
                        ...
                        <CardBody>
                            <Image class="bd-placeholder-img mw-100 card-img" src="../../images/media/media-7.jpg" alt="..." />
                    ...
                    <Row>
                        ...
                        <Col xl={12}>
                            <Card class="custom-card">
                                ...
                                <CardBody>
                                    <p><a href="#!" class="pe-none" tabIndex={-1} aria-disabled="false"><code class="text-primary fw-medium">This link</code> </a>
                                        can
                                        not be clicked.
                                    </p>
                                    <p><a href="#!" class="pe-auto"><code class="text-primary fw-medium">This link</code></a> can be clicked (this is default
                                        behavior).
                                    </p>
                                    <p class="pe-none mb-0"><a href="#!" tabIndex={-1} aria-disabled="false"><code>This link</code> </a>
                                        can
                                        not be clicked because the <code class="text-primary fw-medium">pointer-events</code> property is inherited
                                        from its parent. However, <a href="#!" class="pe-auto">this link</a> has a
