<script lang="ts">
  ...
  import {
    ...
    progressDataSm,
    progressDataXl,
  } from "$lib/data/uielements/progressbardata";
</script>

<!-- Page Title -->
<svelte:head>
  <title>Progress | Vyzor - Svelte Admin & Dashboard Template</title>
</svelte:head>
<!-- Page Title Close -->
...
<Row>
  ...
  <Col xl={12}>
    <ShowCode
      title="Different Colored Progress"
      customCardClass=""
      customCardBodyClass=""
      svelteCode={progress2}
    >
...
<Row>
  <Col xl={12}>
    <ShowCode
      ...
      customCardClass=""
      customCardBodyClass=""
      svelteCode={progress7}
    >
      <Progress color="primary" value={10} class="progress mb-3">10%</Progress>
      <Progress color="secondary" value={20} class="progress mb-3"
        >20%
      </Progress>
      <Progress color="success" value={40} class="progress mb-3">40%</Progress>
      <Progress color="info" value={60} class="progress mb-3">60%</Progress>
      <Progress color="warning" value={80} class="progress mb-0">80%</Progress>
    </ShowCode>
  </Col>
  <Col xl={12}>
    <ShowCode
      title="Multiple bars With Sizes"
      customCardClass=""
      customCardBodyClass="progress-body"
      svelteCode={progress8}
      dataCode={dataprogress8}
    >
      ...
      <div class="progress-stacked mb-3">
        {#each progressDataMd as { width, color }}
          <div
            class="progress-bar {color}"
            role="progressbar"
            style="width: {width}"
...
<Row>
  <Col xl={12}>
    <ShowCode
      title="Animated Stripped Progress"
      customCardClass=""
      customCardBodyClass=""
      svelteCode={progress5}
    >
  ...
  <Col xl={12}>
    <ShowCode
      ...
      customCardClass=""
      customCardBodyClass=""
      svelteCode={progress6}
    >
      <Progress bar class="progress mb-3 primary-gradient" value={10} />
      <Progress bar color="secondary" class="progress mb-3" value={20} />
      <Progress bar color="success" class="progress mb-3" value={40} />
      <Progress bar color="info" class="progress mb-3" value={60} />
      <Progress bar color="warning" class="progress" value={80} />
    </ShowCode>
  </Col>
</Row>
<!-- End:: row-4 -->
...
<Row>
  <Col xl={12}>
    <ShowCode
      title="Custom Animated Progress"
      customCardClass=""
      customCardBodyClass=""
      svelteCode={progress9}
    >
      <Progress
        color="primary"
      ...
      <Progress
        ...
        value={60}
      />
      <Progress color="warning" class="progress  progress-animate" value={80} />
    </ShowCode>
  </Col>
  <Col xl={12}>
    <ShowCode
      title="Custom Progress-1"
      customCardClass=""
      customCardBodyClass=""
      svelteCode={progress10}
    >
      <div
      ...
      <div
        class="progress progress-sm progress-custom mb-4 progress-animate"
        role="progressbar"
        aria-valuemin={0}
        aria-valuemax={100}
      >
...
<Row>
  <Col xl={12}>
    <ShowCode
      title="Custom Progress-2"
      customCardClass=""
      customCardBodyClass=""
      svelteCode={progress11}
      dataCode={dataprogress11}
    >
      {#each progressData2 as { now, class1 }}
        ...
        <div
          ...
          aria-valuemax="100"
        >
          <div class={`progress-item-1 ${now >= 50 ? class1 : ""}`}></div>
          <div class={`progress-item-2 ${now >= 60 ? class1 : ""}`}></div>
          <div class={`progress-item-3 ${now >= 76 ? class1 : ""}`}></div>
  ...
  <Col xl={12}>
    <ShowCode
      title="Custom Progress-3"
      customCardClass=""
      customCardBodyClass=""
      svelteCode={progress12}
    >
      <div
...
<Row>
  <Col xl={12}>
    <ShowCode
      title="Custom Progress-4"
      customCardClass=""
      customCardBodyClass="progress-body"
      svelteCode={progress13}
    >
      <div
      ...
      >
        <div
          class="progress-bar bg-secondary-gradient"
          style="width: 20%;"
        ></div>
      ...
      <div
        class="progress progress-xl mb-3 progress-animate custom-progress-4 danger"
        role="progressbar"
        aria-valuenow={100}
        aria-valuemin={0}
        aria-valuemax={100}
  ...
  <Col xl={12}>
    <ShowCode
      title="Custom Progress-5"
      customCardClass=""
      customCardBodyClass=""
      svelteCode={progress14}
    >
