<script lang="ts">
    ...
    import {
        Buttonspinner,
        Colorspinner,
    } from "$lib/data/uielements/spinnersdata";
    import SpkButton from "$lib/@spk/uielements/Button/SpkButton.svelte";
</script>

<!-- Page Title -->
<svelte:head>
    <title>Spinners | Vyzor - Svelte Admin & Dashboard Template</title>
</svelte:head>
<!-- Page Title Close -->
...
<Row>
    <Col xl={6}>
        ...
        <ShowCode
            title="Spinner Sizes"
            customCardClass=""
            customCardBodyClass="d-flex align-items-center"
            svelteCode={spinner8}
        >
            ...
            <SpkSpinners
                type="border"
                customClass="me-4 flex-shrink-0"
                width="3rem"
                height="3rem"
            />
            <SpkSpinners
...
<Row>
    <Col xl={12}>
        <ShowCode
            ...
            customCardClass=""
            customCardBodyClass=""
            svelteCode={spinner10}
            dataCode={dataspinner10}
        >
            <div class="btn-list">
                <SpkButton
                    color="primary-light"
