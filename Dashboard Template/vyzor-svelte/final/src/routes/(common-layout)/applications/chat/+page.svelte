<script lang="ts">
    ...
    import {
        ...
        GroupedContacts,
        images
    } from "$lib/data/applications/chatdata";
    ...
    import ChatGallery from "$lib/view/chatGallery.svelte";
            ...
            >
                ...
                <ul class="list-unstyled mb-0 mt-2">
                    ...
                    {#each GroupChatPreviews as chat}
                        ...
                        <!-- svelte-ignore a11y_no_noninteractive_element_interactions -->
                        <li
                            class={`checkforactive ${!chat.online ? "chat-inactive" : ""} ${chat.unread ? "chat-msg-unread" : ""} ${activeUser.name === chat.name ? "active" : ""}`} on:click={() => handleChatClick(chat)}
                        >
                            <a href="#!">
                                <!-- svelte-ignore a11y_click_events_have_key_events -->
                                <!-- svelte-ignore a11y_no_static_element_interactions -->
    ...
    <div class="main-chat-area border">
        ...
        >
            ...
            <div class="d-flex align-items-center flex-wrap rightIcons">
                <SpkButton color="light"  buttontype="button" customClass="btn btn-icon ms-2 btn-sm">
                                <i class="ti ti-phone"></i>
                            </SpkButton>
                            <SpkButton color="light" buttontype="button" customClass="btn btn-icon ms-2 btn-sm">
                                <i class="ti ti-video"></i>
                            </SpkButton>
                            <SpkButton color="light"  buttontype="button" customClass="btn btn-icon ms-2 responsive-userinfo-open btn-sm">
                            ...
                            parent={`<i class="ti ti-dots-vertical"></i>`}
                            />
                <SpkButton color="light"  onclickfunc={toggleChat1} buttontype="button" customClass="btn btn-icon ms-2 responsive-chat-close btn-sm">
                                    ...
                                    <div class="chat-list-inner">
                                        <div class="chat-user-profile">
                                            <span class={`avatar avatar-md ${activeUser.status} avatar-rounded chatstatusperson`}>
                                                <Image class="chatimageperson" src={activeUser.image} alt="img" />
                                            </span>
                                        </div>
                                        <div class="ms-3">
                                    ...
                                    <div class="chat-list-inner">
                                        ...
                                        <div class="chat-user-profile">
                                            <span class={`avatar avatar-md online avatar-rounded`}>
                                                <Image class="chatimageperson" src="../images/faces/15.jpg" alt="img" />
                                            </span>
                                        </div>
                                    </div>
                                </li>
...
<Offcanvas placement="end" class="offcanvas-end" {isOpen} {toggle} tabindex={-1} id="offcanvasRight">
    <div class="">
                        ...
                        <div class="d-flex align-items-center">
                            <div class="lh-1">
                                <span class="avatar avatar-lg">
                                    <Image src={file.fileIcon} alt={file.fileName} />
                                </span>
                            </div>
                            <div class="flex-fill">
                                <p class="fs-13 fw-medium mb-0">{file.fileName}</p>
                                <p class="mb-0 text-muted fs-11">{file.fileDate}</p>
                            </div>
                            <div class="fs-13 text-muted">{file.fileSize}</div>
                        </div>
                    </li>
                    {/each}
                </ul>
