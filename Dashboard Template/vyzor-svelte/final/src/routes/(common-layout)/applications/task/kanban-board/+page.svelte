<script lang="ts">
    import SpkKanbancard from "$lib/@spk/application-reusable/spk-kanbancard.svelte";
    ...
    import {
        ...
        Option1,
        simpleItems1,
    } from "$lib/data/applications/task/kanbandata";
    import {
        Card,
        CardBody,
        Col,
    ...
    let leftContainerRef1: HTMLElement;
    let rightContainerRef1: HTMLElement;
    let topContainerRef1: HTMLElement;
    let bottomContainerRef1: HTMLElement;
    let lastContainerRef1: HTMLElement;
    let childCount: number = 0;
    let childCount1: number = 0;
    let childCount2: number = 0;
    let childCount3: number = 0;
    let childCount4: number = 0;
...
<div class="VYZOR-kanban-board">
    <div class="kanban-tasks-type new">
        ...
        <div class="kanban-tasks overflow-y-scroll" id="new-tasks">
        ...
        <div
            class={`d-grid view-more-button mt-3 ${childCount === 0 ? "d-none" : ""}`}
        >
    ...
    <div class="kanban-tasks-type todo">
        ...
        <div class="kanban-tasks overflow-y-scroll" id="todo-tasks">
            <div
        ...
        <div
            class={`d-grid view-more-button mt-3 ${childCount1 === 0 ? "d-none" : ""}`}
        >
    ...
    <div class="kanban-tasks-type in-progress">
        ...
        <div class="kanban-tasks overflow-y-scroll" id="inprogress-tasks">
            <div
        ...
        <div
            class={`d-grid view-more-button mt-3 ${childCount2 === 0 ? "d-none" : ""}`}
        >
    ...
    <div class="kanban-tasks-type inreview">
        ...
        <div class="kanban-tasks overflow-y-scroll" id="inreview-tasks">
            <div
        ...
        <div
            class={`d-grid view-more-button mt-3 ${childCount3 === 0 ? "d-none" : ""}`}
        >
    ...
    <div class="kanban-tasks-type completed">
        ...
        <div class="kanban-tasks overflow-y-scroll" id="completed-tasks">
            <div
        ...
        <div
            class={`d-grid view-more-button mt-3 ${childCount4 === 0 ? "d-none" : ""}`}
        >
...
>
    <ModalHeader toggle={() => handleModalClose("addmodal")}>
        ...
        <!-- <SpkButton color="" Buttontype="button" onClickfunc={() => handleClose("addmodal")} Customclass="btn-close" Buttondismiss="modal" Buttonlabel="Close"></SpkButton> -->
    </ModalHeader>
    <ModalBody>
        <Row>
            <Col xl={12}>
    ...
    <div class="">
        <div class="">
            <ModalHeader toggle={() => handleModalClose("taskmodal")}>
                <h6>Add Task</h6>
                <!-- <SpkButton Buttontype="button" color="" Customclass="btn-close" data-bs-dismiss="modal"
