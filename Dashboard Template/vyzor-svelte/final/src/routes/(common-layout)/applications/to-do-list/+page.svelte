<script lang="ts">
    ...
    import {
        ...
        TodoDropdown,
        Todotables,
    } from "$lib/data/applications/todolistdata";
    ...
    let HandleDrag: HTMLTableSectionElement;
                ...
                >
                    <div class="d-grid">
                        <SpkButton
                            ...
                            customClass="btn btn-outline-light rounded-pill d-flex align-items-center justify-content-center"
                        >
                            <i
