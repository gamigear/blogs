...
<!-- Page Title -->
<svelte:head>
    <title>Lockscreen-Basic | Vyzor - Svelte Admin & Dashboard Template</title>
</svelte:head>
<!-- Page Title Close -->
                ...
                <CardBody class="p-5">
                    ...
                    <div class="d-flex gap-2 align-items-center mb-3">
                        <div class="lh-1">
                            <span class="avatar avatar-sm avatar-rounded">
                                <Image src="../../images/faces/12.jpg" alt="" />
                            </span>
                        </div>
                        <div>
                    ...
                    <div class="text-center">
                        <p class="fw-medium mt-3 mb-0">
                            Try unlock with <a class="text-success" href="#!"
                                ><u>Finger print</u></a
                            >
                            /
                            <a class="text-success" href="#!"><u>Face Id</u></a>
                        </p>
                    </div>
                </CardBody>
            </Card>
