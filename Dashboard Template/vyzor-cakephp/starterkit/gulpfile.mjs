...
// Watch Task
function watchTask() {
  gulp.watch(['./webroot/scss/**/*', '!./webroot/switcher/*.scss'], gulp.series(scssTask));
}

// SCSS Task
function scssTask() {
  const scssFiles = './webroot/scss/**/*.scss';
  const cssDest = './webroot/css';
