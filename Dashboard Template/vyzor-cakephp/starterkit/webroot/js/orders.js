(function () {
    ...
    // Sample Data
    const ordersData = [
        ['#SPK001', 'John Doe', '../img/faces/9.jpg', '$699.99', 'Pending', 'Pending', 'Visa Card', 'Jan 15, 2025, 09:45 AM', 'john.doe@example.com'],
        ['#SPK002', 'Jane Smith', '../img/faces/1.jpg', '$89.99', 'Shipped', 'Completed', 'MasterCard', 'Feb 3, 2025, 02:30 PM', 'jane.smith@example.com'],
        ['#SPK003', 'Michael Brown', '../img/faces/10.jpg', '$399.99', 'Delivered', 'Failed', 'PayPal', 'Mar 10, 2025, 11:15 AM', 'michael.brown@example.com'],
        ['#SPK004', 'Emily White', '../img/faces/2.jpg', '$129.99', 'Cancelled', 'Refunded', 'Apple Pay', 'Apr 5, 2025, 04:00 PM', 'emily.white@example.com'],
        ['#SPK005', 'Chris Johnson', '../img/faces/11.jpg', '$199.99', 'Shipped', 'Cancelled', 'COD', 'May 1, 2025, 10:30 AM', 'chris.johnson@example.com'],
        ['#SPK006', 'Sarah Lee', '../img/faces/3.jpg', '$149.99', 'Delivered', 'Refunded', 'MasterCard', 'Jun 10, 2025, 03:45 PM', 'sarah.lee@example.com'],
        ['#SPK007', 'David Green', '../img/faces/13.jpg', '$79.99', 'Delivered', 'Completed', 'PayPal', 'Jul 18, 2025, 01:00 PM', 'david.green@example.com'],
        ['#SPK008', 'Olivia Davis', '../img/faces/4.jpg', '$59.99', 'Pending', 'Pending', 'American Express', 'Aug 25, 2025, 12:30 PM', 'olivia.davis@example.com'],
        ['#SPK009', 'James Wilson', '../img/faces/14.jpg', '$59.99', 'Cancelled', 'Completed', 'Visa Card', 'Sep 5, 2025, 06:00 PM', 'james.wilson@example.com'],
        ['#SPK010', 'Sophia Martinez', '../img/faces/5.jpg', '$39.99', 'Shipped', 'Failed', 'COD', 'Oct 12, 2025, 08:15 AM', 'sophia.martinez@example.com']
    ];
                ...
                formatter: (_, row) => gridjs.html(`
                    <div class="dropdown text-center">
                        ...
                        <ul class="dropdown-menu">
                            <li><a class="dropdown-item" href="orders_details"><i class="ri-eye-line me-2"></i>View</a></li>
