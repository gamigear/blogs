...
<?php
    ...
    $this->set('BodyClass', 'coming-soon-main');
?> 
                                ...
                                <div>
                                    <div class="mb-3"> 
                                        <a href="<?= $this->Url->build('/home') ?>"> 
                                            <img src="<?php echo $this->Url->image('brand-logos/desktop-logo.png'); ?>" alt="" class="authentication-brand"> 
                                            <img src="<?php echo $this->Url->image('brand-logos/desktop-dark.png'); ?>" alt="" class="authentication-brand dark"> 
                                        </a> 
                                    </div>
