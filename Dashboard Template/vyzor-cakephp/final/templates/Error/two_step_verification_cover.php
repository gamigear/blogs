                                    ...
                                    <div class="col-xl-12 mb-2">
                                        ...
                                        <div class="form-check mt-3">
                                            ...
                                            <label class="form-check-label" for="defaultCheck1">
                                                Did not recieve a code ?<a href="<?= $this->Url->build('/mail') ?>" class="text-primary ms-2 d-inline-block fw-medium">Resend</a>
                                            </label>
                                        </div>
                                    </div>
                                    <div class="col-xl-12 d-grid mt-3">
                                        <a href="<?= $this->Url->build('/home') ?>" class="btn btn-lg btn-primary">Verify</a>
                                    </div>
                                </div>
...
<?php $this->start('scripts'); ?>
        ...
        <?= $this->Html->script(['two-step-verification']) ?>
