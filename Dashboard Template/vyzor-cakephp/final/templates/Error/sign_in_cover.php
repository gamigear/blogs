                                    ...
                                    <div class="col-xl-12 mb-2">
                                        ...
                                        <div class="mt-2">
                                            <div class="form-check">
                                                ...
                                                <label class="form-check-label me-1" for="defaultCheck1">
                                                    Remember me
                                                </label>
                                                <a href="<?= $this->Url->build('/reset_password_basic') ?>" class="float-end link-danger fw-medium fs-12">Forget password ?</a>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                <div class="d-grid mt-3">
                                    <a href="<?= $this->Url->build('/home') ?>" class="btn btn-primary">Sign In</a>
                                </div>
                                ...
                                <div class="d-grid mb-3">
                                    ...
                                    <button class="btn btn-white btn-w-lg border d-flex align-items-center justify-content-center flex-fill">
                                        <span class="avatar avatar-xs flex-shrink-0">
                                            <img src="<?php echo $this->Url->image('media/apps/facebook.png'); ?>" alt="">
                                        </span>
                                        <span class="lh-1 ms-2 fs-13 text-default fw-medium">Signup with Facebook</span>
                                    </button>
                                </div>
                                <div class="text-center mt-3 fw-medium">
                                    Dont have an account? <a href="<?= $this->Url->build('/sign_up_basic') ?>" class="text-primary">Register Here</a>
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <div class="col-xxl-3 col-xl-3 col-lg-12 d-xl-block d-none px-0">
                <div class="authentication-cover overflow-hidden">
                    <div class="authentication-cover-logo">
                        ...
                        <img src="<?php echo $this->Url->image('brand-logos/toggle-logo.png'); ?>" alt="logo" class="desktop-dark"> 
                        </a>
                    </div>
                    <div class="authentication-cover-background">
                        <img src="<?php echo $this->Url->image('media/backgrounds/9.png'); ?>" alt="">
                    </div>
                    <div class="authentication-cover-content">
                        ...
                        <div>
                            <img src="<?php echo $this->Url->image('media/media-72.png'); ?>" alt="" class="img-fluid">
                        </div>
                    </div>
                </div>
            </div>
...
<?php $this->start('scripts'); ?>
        ...
        <!-- Show Password JS -->
        <?= $this->Html->script(['show-password']) ?>
