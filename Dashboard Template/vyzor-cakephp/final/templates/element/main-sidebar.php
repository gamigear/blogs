			...
			<aside class="app-sidebar sticky" id="sidebar">
				...
				<div class="main-sidebar-header">
					<a href="<?= $this->Url->build('/home') ?>" class="header-logo">
						<img src="<?php echo $this->Url->image('brand-logos/desktop-logo.png'); ?>" alt="logo" class="desktop-logo">
						<img src="<?php echo $this->Url->image('brand-logos/toggle-dark.png'); ?>" alt="logo" class="toggle-dark">
						<img src="<?php echo $this->Url->image('brand-logos/desktop-dark.png'); ?>" alt="logo" class="desktop-dark">
						<img src="<?php echo $this->Url->image('brand-logos/toggle-logo.png'); ?>" alt="logo" class="toggle-logo">
					</a>
				</div>
				...
				<div class="main-sidebar" id="sidebar-scroll">
					...
					<nav class="main-menu-container nav nav-pills flex-column sub-open">
						...
						<ul class="main-menu">
							...
							<li class="slide has-sub">
								...
								<ul class="slide-menu child1">
									...
									<li class="slide <?= ($this->request->getAttribute('here') === $this->Url->build('/home')) ? 'active' : '' ?>">
										<a href="<?= $this->Url->build('/home') ?>" class="side-menu__item">
									...
									<li class="slide">
										<a href="<?= $this->Url->build('/index1') ?>" class="side-menu__item">
									...
									<li class="slide has-sub">
										...
										<ul class="slide-menu child2">
											<li class="slide">
												<a href="<?= $this->Url->build('/index2') ?>" class="side-menu__item">Dashboard</a>
											</li>
											<li class="slide">
												<a href="<?= $this->Url->build('/products') ?>" class="side-menu__item">Products</a>
											</li>
											<li class="slide">
												<a href="<?= $this->Url->build('/product_details') ?>" class="side-menu__item">Product Details</a>
											</li>
											<li class="slide">
												<a href="<?= $this->Url->build('/cart') ?>" class="side-menu__item">Cart</a>
											</li>
											<li class="slide">
												<a href="<?= $this->Url->build('/checkout') ?>" class="side-menu__item">Checkout</a>
											</li>
											<li class="slide">
												<a href="<?= $this->Url->build('/customers_list') ?>" class="side-menu__item">Customers</a>
											</li>
											<li class="slide">
												<a href="<?= $this->Url->build('/orders') ?>" class="side-menu__item">Orders</a>
											</li>
											<li class="slide">
												<a href="<?= $this->Url->build('/orders_details') ?>" class="side-menu__item">Order Details</a>
											</li>
											<li class="slide">
												<a href="<?= $this->Url->build('/add_product') ?>" class="side-menu__item">Add Product</a>
											</li>
										</ul>    
									</li>
									<li class="slide has-sub">
										...
										<ul class="slide-menu child2">
											<li class="slide">
												<a href="<?= $this->Url->build('/index4') ?>" class="side-menu__item">Dashboard</a>
											</li>
											<li class="slide">
												<a href="<?= $this->Url->build('/crypto_transactions') ?>" class="side-menu__item">Transactions</a>
											</li>
											<li class="slide">
												<a href="<?= $this->Url->build('/crypto_currency_exchange') ?>" class="side-menu__item">Exchange</a>
											</li>
											<li class="slide">
												<a href="<?= $this->Url->build('/crypto_buy_sell') ?>" class="side-menu__item">Buy & Sell</a>
											</li>
											<li class="slide">
												<a href="<?= $this->Url->build('/crypto_marketcap') ?>" class="side-menu__item">Marketcap</a>
											</li>
											<li class="slide">
												<a href="<?= $this->Url->build('/crypto_wallet') ?>" class="side-menu__item">Wallet</a>
											</li>
										</ul>    
									</li>
									<li class="slide has-sub">
										...
										<ul class="slide-menu child2">
											<li class="slide">
												<a href="<?= $this->Url->build('/index3') ?>" class="side-menu__item">Dashboard</a>
											</li>
											<li class="slide">
												<a href="<?= $this->Url->build('/crm_contacts') ?>" class="side-menu__item">Contacts</a>
											</li>
											<li class="slide">
												<a href="<?= $this->Url->build('/crm_companies') ?>" class="side-menu__item">Companies</a>
											</li>
											<li class="slide">
												<a href="<?= $this->Url->build('/crm_deals') ?>" class="side-menu__item">Deals</a>
											</li>
											<li class="slide">
												<a href="<?= $this->Url->build('/crm_leads') ?>" class="side-menu__item">Leads</a>
											</li>
										</ul>    
									</li>
									<li class="slide has-sub">
										...
										<ul class="slide-menu child2">
											<li class="slide">
												<a href="<?= $this->Url->build('/index6') ?>" class="side-menu__item">Dashboard</a>
											</li>
											<li class="slide">
												<a href="<?= $this->Url->build('/projects_list') ?>" class="side-menu__item">Projects List</a>
											</li>
											<li class="slide">
												<a href="<?= $this->Url->build('/projects_overview') ?>" class="side-menu__item">Project Overview</a>
											</li>
											<li class="slide">
												<a href="<?= $this->Url->build('/projects_create') ?>" class="side-menu__item">Create Project</a>
											</li>
										</ul>    
									</li>
									<li class="slide">
										<a href="<?= $this->Url->build('/index8') ?>" class="side-menu__item">
									...
									<li class="slide">
										<a href="<?= $this->Url->build('/index9') ?>" class="side-menu__item">
									...
									<li class="slide">
										<a href="<?= $this->Url->build('/index10') ?>" class="side-menu__item">
									...
									<li class="slide has-sub">
										...
										<ul class="slide-menu child2">
											<li class="slide">
												<a href="<?= $this->Url->build('/index5') ?>" class="side-menu__item">Dashboard</a>
											</li>
											<li class="slide">
												<a href="<?= $this->Url->build('/nft_marketplace') ?>" class="side-menu__item">Market Place</a>
											</li>
											<li class="slide">
												<a href="<?= $this->Url->build('/nft_details') ?>" class="side-menu__item">NFT Details</a>
											</li>
											<li class="slide">
												<a href="<?= $this->Url->build('/nft_create') ?>" class="side-menu__item">Create NFT</a>
											</li>
											<li class="slide">
												<a href="<?= $this->Url->build('/nft_wallet_integration') ?>" class="side-menu__item">Wallet Integration</a>
											</li>
											<li class="slide">
												<a href="<?= $this->Url->build('/nft_live_auction') ?>" class="side-menu__item">Live Auction</a>
											</li>
										</ul>    
									</li>
									<li class="slide has-sub">
										...
										<ul class="slide-menu child2">
											<li class="slide">
												<a href="<?= $this->Url->build('/index7') ?>" class="side-menu__item">Dashboard</a>
											</li>
											<li class="slide">
												<a href="<?= $this->Url->build('/job_details') ?>" class="side-menu__item">Job Details</a>
											</li>
											<li class="slide">
												<a href="<?= $this->Url->build('/job_company_search') ?>" class="side-menu__item">Search Company</a>
											</li>
											<li class="slide">
												<a href="<?= $this->Url->build('/job_search') ?>" class="side-menu__item">Search Jobs</a>
											</li>
											<li class="slide">
												<a href="<?= $this->Url->build('/job_post') ?>" class="side-menu__item">Job Post</a>
											</li>
											<li class="slide">
												<a href="<?= $this->Url->build('/jobs_list') ?>" class="side-menu__item">Jobs List</a>
											</li>
											<li class="slide">
												<a href="<?= $this->Url->build('/job_candidate_search') ?>" class="side-menu__item">Search Candidate</a>
											</li>
											<li class="slide">
												<a href="<?= $this->Url->build('/job_candidate_details') ?>" class="side-menu__item">Candidate Details</a>
											</li>
										</ul>    
									</li>
									<li class="slide">
										<a href="<?= $this->Url->build('/index13') ?>" class="side-menu__item">
									...
									<li class="slide">
										<a href="<?= $this->Url->build('/index15') ?>" class="side-menu__item">
									...
									<li class="slide">
										<a href="<?= $this->Url->build('/index14') ?>" class="side-menu__item">
									...
									<li class="slide">
										<a href="<?= $this->Url->build('/index11') ?>" class="side-menu__item">
									...
									<li class="slide">
										<a href="<?= $this->Url->build('/index12') ?>" class="side-menu__item">
							...
							<li class="slide has-sub">
								...
								<ul class="slide-menu child1">
									...
									<li class="slide">
										<a href="<?= $this->Url->build('/chat') ?>" class="side-menu__item">
									...
									<li class="slide has-sub">
										...
										<ul class="slide-menu child2">
											<li class="slide">
												<a href="<?= $this->Url->build('/mail') ?>" class="side-menu__item">Mail App</a>
											</li>
											<li class="slide">
												<a href="<?= $this->Url->build('/mail_settings') ?>" class="side-menu__item">Mail Settings</a>
											</li>
										</ul>
									</li>
									<li class="slide">
										<a href="<?= $this->Url->build('/file_manager') ?>" class="side-menu__item">
									...
									<li class="slide">
										<a href="<?= $this->Url->build('/full_calendar') ?>" class="side-menu__item">
									...
									<li class="slide">
										<a href="<?= $this->Url->build('/gallery') ?>" class="side-menu__item">
									...
									<li class="slide">
										<a href="<?= $this->Url->build('/sweet_alerts') ?>" class="side-menu__item">
									...
									<li class="slide has-sub">
										...
										<ul class="slide-menu child2">
											<li class="slide">
												<a href="<?= $this->Url->build('/task_kanban_board') ?>" class="side-menu__item">Kanban Board</a>
											</li>
											<li class="slide">
												<a href="<?= $this->Url->build('/task_list_view') ?>" class="side-menu__item">List View</a>
											</li>
										</ul>
									</li>
									<li class="slide">
										<a href="<?= $this->Url->build('/to_do_list') ?>" class="side-menu__item">
							...
							<li class="slide has-sub">
								...
								<ul class="slide-menu child1 pages-ul">
									...
									<li class="slide has-sub">
										...
										<ul class="slide-menu child2">
											<li class="slide">
												<a href="<?= $this->Url->build('/coming_soon') ?>" class="side-menu__item">Coming Soon</a>
											</li>
											<li class="slide has-sub">
												...
												<ul class="slide-menu child3">
													<li class="slide">
														<a href="<?= $this->Url->build('/create_password_basic') ?>" class="side-menu__item">Basic</a>
													</li>
													<li class="slide">
														<a href="<?= $this->Url->build('/create_password_cover') ?>" class="side-menu__item">Cover</a>
													</li>
												</ul>
											</li>      
											<li class="slide has-sub">
												...
												<ul class="slide-menu child3">
													<li class="slide">
														<a href="<?= $this->Url->build('/lockscreen_basic') ?>" class="side-menu__item">Basic</a>
													</li>
													<li class="slide">
														<a href="<?= $this->Url->build('/lockscreen_cover') ?>" class="side-menu__item">Cover</a>
													</li>
												</ul>
											</li>     
											<li class="slide has-sub">
												...
												<ul class="slide-menu child3">
													<li class="slide">
														<a href="<?= $this->Url->build('/reset_password_basic') ?>" class="side-menu__item">Basic</a>
													</li>
													<li class="slide">
														<a href="<?= $this->Url->build('/reset_password_cover') ?>" class="side-menu__item">Cover</a>
													</li>
												</ul>
											</li>     
											<li class="slide has-sub">
												...
												<ul class="slide-menu child3">
													<li class="slide">
														<a href="<?= $this->Url->build('/sign_up_basic') ?>" class="side-menu__item">Basic</a>
													</li>
													<li class="slide">
														<a href="<?= $this->Url->build('/sign_up_cover') ?>" class="side-menu__item">Cover</a>
													</li>
												</ul>
											</li>  
											<li class="slide has-sub">
												...
												<ul class="slide-menu child3">
													<li class="slide">
														<a href="<?= $this->Url->build('/sign_in_basic') ?>" class="side-menu__item">Basic</a>
													</li>
													<li class="slide">
														<a href="<?= $this->Url->build('/sign_in_cover') ?>" class="side-menu__item">Cover</a>
													</li>
												</ul>
											</li> 
											<li class="slide has-sub">
												...
												<ul class="slide-menu child3">
													<li class="slide">
														<a href="<?= $this->Url->build('/two_step_verification_basic') ?>" class="side-menu__item">Basic</a>
													</li>
													<li class="slide">
														<a href="<?= $this->Url->build('/two_step_verification_cover') ?>" class="side-menu__item">Cover</a>
													</li>
												</ul>
											</li> 
											<li class="slide">
												<a href="<?= $this->Url->build('/under_maintenance') ?>" class="side-menu__item">Under Maintenance</a>
											</li>
										</ul>
									</li>
									<li class="slide has-sub">
										...
										<ul class="slide-menu child2">
											<li class="slide">
												<a href="<?= $this->Url->build('/error401') ?>" class="side-menu__item">401 - Error</a>
											</li>
											<li class="slide">
												<a href="<?= $this->Url->build('/error404') ?>" class="side-menu__item">404 - Error</a>
											</li>
											<li class="slide">
												<a href="<?= $this->Url->build('/error500') ?>" class="side-menu__item">500 - Error</a>
											</li>
										</ul>
									</li>
									<li class="slide has-sub">
										...
										<ul class="slide-menu child2">
											<li class="slide">
												<a href="<?= $this->Url->build('/blog') ?>" class="side-menu__item">Blog</a>
											</li>
											<li class="slide">
												<a href="<?= $this->Url->build('/blog_details') ?>" class="side-menu__item">Blog Details</a>
											</li>
											<li class="slide">
												<a href="<?= $this->Url->build('/blog_create') ?>" class="side-menu__item">Create Blog</a>
											</li>
										</ul>
									</li>
									<li class="slide">
										<a href="<?= $this->Url->build('/emptypage') ?>" class="side-menu__item">
									...
									<li class="slide has-sub">
										...
										<ul class="slide-menu child2">
											<li class="slide">
												<a href="<?= $this->Url->build('/form_advanced') ?>" class="side-menu__item">Form Advanced</a>
											</li>
											<li class="slide has-sub">
												...
												<ul class="slide-menu child3">
													<li class="slide">
														<a href="<?= $this->Url->build('/form_inputs') ?>" class="side-menu__item">Inputs</a>
													</li>
													<li class="slide">
														<a href="<?= $this->Url->build('/form_check_radios') ?>" class="side-menu__item">Checks & Radios</a>
													</li>
													<li class="slide">
														<a href="<?= $this->Url->build('/form_input_group') ?>" class="side-menu__item">Input Group</a>
													</li>
													<li class="slide">
														<a href="<?= $this->Url->build('/form_select') ?>" class="side-menu__item">Form Select</a>
													</li>
													<li class="slide">
														<a href="<?= $this->Url->build('/form_range') ?>" class="side-menu__item">Range Slider</a>
													</li>
													<li class="slide">
														<a href="<?= $this->Url->build('/form_input_masks') ?>" class="side-menu__item">Input Masks</a>
													</li>
													<li class="slide">
														<a href="<?= $this->Url->build('/form_file_uploads') ?>" class="side-menu__item">File Uploads</a>
													</li>
													<li class="slide">
														<a href="<?= $this->Url->build('/form_datetime_pickers') ?>" class="side-menu__item">Date,Time Picker</a>
													</li>
													<li class="slide">
														<a href="<?= $this->Url->build('/form_color_pickers') ?>" class="side-menu__item">Color Pickers</a>
													</li>
												</ul>
											</li>
											<li class="slide">
												<a href="<?= $this->Url->build('/floating_labels') ?>" class="side-menu__item">Floating Labels</a>
											</li>
											<li class="slide">
												<a href="<?= $this->Url->build('/form_layout') ?>" class="side-menu__item">Form Layouts</a>
											</li>
											<li class="slide">
												<a href="<?= $this->Url->build('/form_wizards') ?>" class="side-menu__item">Form Wizards</a>
											</li>
											<li class="slide">
												<a href="<?= $this->Url->build('/quill_editor') ?>" class="side-menu__item">Quill Editor</a>
											</li>
											<li class="slide">
												<a href="<?= $this->Url->build('/form_validation') ?>" class="side-menu__item">Validation</a>
											</li>
											<li class="slide">
												<a href="<?= $this->Url->build('/form_select2') ?>" class="side-menu__item">Select2</a>
											</li>
										</ul>
									</li>
									<li class="slide">
										<a href="<?= $this->Url->build('/faqs') ?>" class="side-menu__item">
									...
									<li class="slide has-sub">
										...
										<ul class="slide-menu child2">
											<li class="slide">
												<a href="<?= $this->Url->build('/invoice_create') ?>" class="side-menu__item">Create Invoice</a>
											</li>
											<li class="slide">
												<a href="<?= $this->Url->build('/invoice_details') ?>" class="side-menu__item">Invoice Details</a>
											</li>
											<li class="slide">
												<a href="<?= $this->Url->build('/invoice_list') ?>" class="side-menu__item">Invoice List</a>
											</li>
										</ul>
									</li>
									<li class="slide">
										<a href="<?= $this->Url->build('/landing') ?>" class="side-menu__item">
									...
									<li class="slide">
										<a href="<?= $this->Url->build('/pricing') ?>" class="side-menu__item">
									...
									<li class="slide">
										<a href="<?= $this->Url->build('/profile') ?>" class="side-menu__item">
											<svg xmlns="http://www.w3.org/2000/svg" class="side-menu-doublemenu__icon" viewBox="0 0 256 256"><rect width="256" height="256" fill="none"/><path d="M128,32A96,96,0,0,0,63.8,199.38h0A72,72,0,0,1,128,160a40,40,0,1,1,40-40,40,40,0,0,1-40,40,72,72,0,0,1,64.2,39.37A96,96,0,0,0,128,32Z" opacity="0.2"/><path d="M63.8,199.37a72,72,0,0,1,128.4,0" fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="16"/><circle cx="128" cy="128" r="96" fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="16"/><circle cx="128" cy="120" r="40" fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="16"/></svg>
											Profile</a>
									</li>
									<li class="slide">
										<a href="<?= $this->Url->build('/profile_settings') ?>" class="side-menu__item">
									...
									<li class="slide">
										<a href="<?= $this->Url->build('/testimonials') ?>" class="side-menu__item">
									...
									<li class="slide">
										<a href="<?= $this->Url->build('/search_results') ?>" class="side-menu__item">
									...
									<li class="slide">
										<a href="<?= $this->Url->build('/team') ?>" class="side-menu__item">
									...
									<li class="slide">
										<a href="<?= $this->Url->build('/terms_conditions') ?>" class="side-menu__item">
											<svg xmlns="http://www.w3.org/2000/svg" class="side-menu-doublemenu__icon" viewBox="0 0 256 256"><rect width="256" height="256" fill="none"/><polygon points="152 32 152 88 208 88 152 32" opacity="0.2"/><path d="M200,224H56a8,8,0,0,1-8-8V40a8,8,0,0,1,8-8h96l56,56V216A8,8,0,0,1,200,224Z" fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="16"/><polyline points="152 32 152 88 208 88" fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="16"/><line x1="96" y1="136" x2="160" y2="136" fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="16"/><line x1="96" y1="168" x2="160" y2="168" fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="16"/></svg>
											Terms & Conditions</a>
									</li>
									<li class="slide">
										<a href="<?= $this->Url->build('/timeline') ?>" class="side-menu__item">
							...
							<li class="slide has-sub">
								...
								<ul class="slide-menu child1">
									...
									<li class="slide has-sub">
										...
										<ul class="slide-menu child2">
											<li class="slide">
												<a href="<?= $this->Url->build('/alerts') ?>" class="side-menu__item">Alerts</a>
											</li>
											<li class="slide">
												<a href="<?= $this->Url->build('/badge') ?>" class="side-menu__item">Badge</a>
											</li>
											<li class="slide">
												<a href="<?= $this->Url->build('/breadcrumb') ?>" class="side-menu__item">Breadcrumb</a>
											</li>
											<li class="slide">
												<a href="<?= $this->Url->build('/buttons') ?>" class="side-menu__item">Buttons</a>
											</li>
											<li class="slide">
												<a href="<?= $this->Url->build('/buttongroup') ?>" class="side-menu__item">Button Group</a>
											</li>
											<li class="slide">
												<a href="<?= $this->Url->build('/cards') ?>" class="side-menu__item">Cards</a>
											</li>
											<li class="slide">
												<a href="<?= $this->Url->build('/dropdowns') ?>" class="side-menu__item">Dropdowns</a>
											</li>
											<li class="slide">
												<a href="<?= $this->Url->build('/images_figures') ?>" class="side-menu__item">Images & Figures</a>
											</li>
											<li class="slide">
												<a href="<?= $this->Url->build('/links_interactions') ?>" class="side-menu__item">Links & Interactions</a>
											</li>
											<li class="slide">
												<a href="<?= $this->Url->build('/listgroup') ?>" class="side-menu__item">List Group</a>
											</li>
											<li class="slide">
												<a href="<?= $this->Url->build('/navs_tabs') ?>" class="side-menu__item">Navs & Tabs</a>
											</li>
											<li class="slide">
												<a href="<?= $this->Url->build('/object_fit') ?>" class="side-menu__item">Object Fit</a>
											</li>
											<li class="slide">
												<a href="<?= $this->Url->build('/pagination') ?>" class="side-menu__item">Pagination</a>
											</li>
											<li class="slide">
												<a href="<?= $this->Url->build('/popovers') ?>" class="side-menu__item">Popovers</a>
											</li>
											<li class="slide">
												<a href="<?= $this->Url->build('/progress') ?>" class="side-menu__item">Progress</a>
											</li>
											<li class="slide">
												<a href="<?= $this->Url->build('/spinners') ?>" class="side-menu__item">Spinners</a>
											</li>
											<li class="slide">
												<a href="<?= $this->Url->build('/toasts') ?>" class="side-menu__item">Toasts</a>
											</li>
											<li class="slide">
												<a href="<?= $this->Url->build('/tooltips') ?>" class="side-menu__item">Tooltips</a>
											</li>
											<li class="slide">
												<a href="<?= $this->Url->build('/typography') ?>" class="side-menu__item">Typography</a>
											</li>
										</ul>
									</li>
									<li class="slide has-sub">
										...
										<ul class="slide-menu child2">
											<li class="slide">
												<a href="<?= $this->Url->build('/avatars') ?>" class="side-menu__item">Avatars</a>
											</li>
											<li class="slide">
												<a href="<?= $this->Url->build('/borders') ?>" class="side-menu__item">Borders</a>
											</li>
											<li class="slide">
												<a href="<?= $this->Url->build('/breakpoints') ?>" class="side-menu__item">Breakpoints</a>
											</li>
											<li class="slide">
												<a href="<?= $this->Url->build('/colors') ?>" class="side-menu__item">Colors</a>
											</li>
											<li class="slide">
												<a href="<?= $this->Url->build('/columns') ?>" class="side-menu__item">Columns</a>
											</li>
											<li class="slide">
												<a href="<?= $this->Url->build('/css_grid') ?>" class="side-menu__item">Css Grid</a>
											</li>
											<li class="slide">
												<a href="<?= $this->Url->build('/flex') ?>" class="side-menu__item">Flex</a>
											</li>
											<li class="slide">
												<a href="<?= $this->Url->build('/gutters') ?>" class="side-menu__item">Gutters</a>
											</li>
											<li class="slide">
												<a href="<?= $this->Url->build('/helpers') ?>" class="side-menu__item">Helpers</a>
											</li>
											<li class="slide">
												<a href="<?= $this->Url->build('/position') ?>" class="side-menu__item">Position</a>
											</li>
											<li class="slide">
												<a href="<?= $this->Url->build('/more') ?>" class="side-menu__item">Additional Content</a>
											</li>
										</ul>
									</li>
									<li class="slide has-sub">
										...
										<ul class="slide-menu child2">
											<li class="slide">
												<a href="<?= $this->Url->build('/accordions_collpase') ?>" class="side-menu__item">Accordions & Collapse</a>
											</li>
											<li class="slide">
												<a href="<?= $this->Url->build('/carousel') ?>" class="side-menu__item">Carousel</a>
											</li>
											<li class="slide">
												<a href="<?= $this->Url->build('/draggable_cards') ?>" class="side-menu__item">Draggable Cards</a>
											</li>
											<li class="slide">
												<a href="<?= $this->Url->build('/media_player') ?>" class="side-menu__item">Media Player</a>
											</li>
											<li class="slide">
												<a href="<?= $this->Url->build('/modals_closes') ?>" class="side-menu__item">Modals & Closes</a>
											</li>
											<li class="slide">
												<a href="<?= $this->Url->build('/navbar') ?>" class="side-menu__item">Navbar</a>
											</li>
											<li class="slide">
												<a href="<?= $this->Url->build('/offcanvas') ?>" class="side-menu__item">Offcanvas</a>
											</li>
											<li class="slide">
												<a href="<?= $this->Url->build('/placeholders') ?>" class="side-menu__item">Placeholders</a>
											</li>
											<li class="slide">
												<a href="<?= $this->Url->build('/ratings') ?>" class="side-menu__item">Ratings</a>
											</li>
											<li class="slide">
												<a href="<?= $this->Url->build('/ribbons') ?>" class="side-menu__item">Ribbons</a>
											</li>
											<li class="slide">
												<a href="<?= $this->Url->build('/scrollspy') ?>" class="side-menu__item">Scrollspy</a>
											</li>
											<li class="slide">
												<a href="<?= $this->Url->build('/sortable_list') ?>" class="side-menu__item">Sortable JS</a>
											</li>
											<li class="slide">
												<a href="<?= $this->Url->build('/swiperjs') ?>" class="side-menu__item">Swiper JS</a>
											</li>
											<li class="slide">
												<a href="<?= $this->Url->build('/tour') ?>" class="side-menu__item">Tour</a>
											</li>
										</ul>
									</li>
								</ul>
							...
							<!-- Start::slide -->
							<li class="slide">
								<a href="<?= $this->Url->build('/widgets') ?>" class="side-menu__item">
							...
							<li class="slide has-sub">
								...
								<ul class="slide-menu child1">
									...
									<li class="slide">
										<a href="<?= $this->Url->build('/vector_maps') ?>" class="side-menu__item">
									...
									<li class="slide">
										<a href="<?= $this->Url->build('/leaflet_maps') ?>" class="side-menu__item">
									...
									<li class="slide">
										<a href="<?= $this->Url->build('/google_maps') ?>" class="side-menu__item">
							...
							<!-- Start::slide -->
							<li class="slide">
								<a href="<?= $this->Url->build('/icons') ?>" class="side-menu__item">
							...
							<li class="slide has-sub">
								...
								<ul class="slide-menu child1">
									...
									<li class="slide has-sub">
										...
										<ul class="slide-menu child2">
											<li class="slide">
												<a href="<?= $this->Url->build('/apex_line_charts') ?>" class="side-menu__item">Line Charts</a>
											</li>
											<li class="slide">
												<a href="<?= $this->Url->build('/apex_area_charts') ?>" class="side-menu__item">Area Charts</a>
											</li>
											<li class="slide">
												<a href="<?= $this->Url->build('/apex_column_charts') ?>" class="side-menu__item">Column Charts</a>
											</li>
											<li class="slide">
												<a href="<?= $this->Url->build('/apex_bar_charts') ?>" class="side-menu__item">Bar Charts</a>
											</li>
											<li class="slide">
												<a href="<?= $this->Url->build('/apex_mixed_charts') ?>" class="side-menu__item">Mixed Charts</a>
											</li>
											<li class="slide">
												<a href="<?= $this->Url->build('/apex_rangearea_charts') ?>" class="side-menu__item">Range Area Charts</a>
											</li>
											<li class="slide">
												<a href="<?= $this->Url->build('/apex_timeline_charts') ?>" class="side-menu__item">Timeline Charts</a>
											</li>
											<li class="slide">
												<a href="<?= $this->Url->build('/apex_funnel_charts') ?>" class="side-menu__item">Funnel Charts</a>
											</li>
											<li class="slide">
												<a href="<?= $this->Url->build('/apex_candlestick_charts') ?>" class="side-menu__item">CandleStick Charts</a>
											</li>
											<li class="slide">
												<a href="<?= $this->Url->build('/apex_boxplot_charts') ?>" class="side-menu__item">Boxplot Charts</a>
											</li>
											<li class="slide">
												<a href="<?= $this->Url->build('/apex_bubble_charts') ?>" class="side-menu__item">Bubble Charts</a>
											</li>
											<li class="slide">
												<a href="<?= $this->Url->build('/apex_scatter_charts') ?>" class="side-menu__item">Scatter Charts</a>
											</li>
											<li class="slide">
												<a href="<?= $this->Url->build('/apex_heatmap_charts') ?>" class="side-menu__item">Heatmap Charts</a>
											</li>
											<li class="slide">
												<a href="<?= $this->Url->build('/apex_treemap_charts') ?>" class="side-menu__item">Treemap Charts</a>
											</li>
											<li class="slide">
												<a href="<?= $this->Url->build('/apex_pie_charts') ?>" class="side-menu__item">Pie Charts</a>
											</li>
											<li class="slide">
												<a href="<?= $this->Url->build('/apex_radialbar_charts') ?>" class="side-menu__item">Radialbar Charts</a>
											</li>
											<li class="slide">
												<a href="<?= $this->Url->build('/apex_radar_charts') ?>" class="side-menu__item">Radar Charts</a>
											</li>
											<li class="slide">
												<a href="<?= $this->Url->build('/apex_polararea_charts') ?>" class="side-menu__item">Polararea Charts</a>
											</li>
										</ul>
									</li>
									<li class="slide">
										<a href="<?= $this->Url->build('/chartjs_charts') ?>" class="side-menu__item">
									...
									<li class="slide">
										<a href="<?= $this->Url->build('/echarts') ?>" class="side-menu__item">
							...
							<li class="slide has-sub">
								...
								<ul class="slide-menu child1"> 
									...
									<li class="slide">
										<a href="<?= $this->Url->build('/tables') ?>" class="side-menu__item">
									...
									<li class="slide">
										<a href="<?= $this->Url->build('/grid_tables') ?>" class="side-menu__item">
									...
									<li class="slide">
										<a href="<?= $this->Url->build('/data_tables') ?>" class="side-menu__item">
								...
								<ul class="slide-menu child1 doublemenu_slide-menu">
									<li class="text-center p-3 text-fixed-white">
										<div class="doublemenu_slide-menu-background">
											<img src="<?php echo $this->Url->image('media/backgrounds/13.png'); ?>" alt="">
										</div>
										<div class="d-flex flex-column align-items-center justify-content-between h-100">
											<div class="fs-15 fw-medium">Dashboard AI Helper</div>
											<div>
												<span class="avatar avatar-lg p-1">
													<img src="<?php echo $this->Url->image('media/media-80.png'); ?>" alt="">
						...
						<ul class="doublemenu_bottom-menu main-menu mb-0 border-top">
							...
							<!-- Start::slide -->
							<li class="slide">
								<a href="<?= $this->Url->build('/sign_in_cover') ?>" class="side-menu__item">
							...
							<!-- Start::slide -->
							<li class="slide">
								<a href="<?= $this->Url->build('/profile') ?>" class="side-menu__item p-1 rounded-circle mb-0">
									<span class="avatar avatar-md avatar-rounded">
										<img src="<?php echo $this->Url->image('faces/10.jpg'); ?>" alt="">
									</span>
								</a>
							</li>
							<!-- End::slide -->
