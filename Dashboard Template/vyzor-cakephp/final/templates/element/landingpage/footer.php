        ...
        <section class="section landing-footer text-fixed-white">
            <div class="container">
                ...
                <div class="row justify-content-center gy-3">
                    <div class="col-xl-4">
                        <p class="fw-semibold mb-3 brand-image"><a href="<?= $this->Url->build('/home') ?>"><img src="<?php echo $this->Url->image('brand-logos/desktop-dark.png'); ?>" alt=""></a></p>
                    ...
                    <div class="col-sm-3 col-xl-2 col-6">
                        ...
                        <ul class="list-unstyled fw-normal landing-footer-list mb-0">
                            ...
                            <li>
                                <a href="<?= $this->Url->build('/pricing') ?>" class="text-fixed-white op-6">Pricing</a>
                            </li>
                        </ul>
                    </div>
                    <div class="col-sm-3 col-xl-2 col-6">
                    ...
                    <div class="col-sm-3 col-xl-2 col-6">
                        ...
                        <ul class="list-unstyled fw-normal landing-footer-list mb-0">
                            <li>
                                <a href="<?= $this->Url->build('/blog') ?>" class="text-fixed-white op-6">Blog</a>
                            </li>
                            <li>
