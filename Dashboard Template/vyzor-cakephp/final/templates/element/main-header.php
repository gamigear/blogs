					...
					<ul class="header-content-right">
						...
						<li class="header-element country-selector dropdown d-sm-block d-none">
							...
							<ul class="main-header-dropdown dropdown-menu dropdown-menu-end" data-popper-placement="none">
								<li>
									<a class="dropdown-item d-flex align-items-center" href="javascript:void(0);">
										<span class="avatar avatar-rounded avatar-xs lh-1 me-2">
											<img src="<?php echo $this->Url->image('flags/us_flag.jpg'); ?>" alt="img">
										</span>
										English
									</a>
								</li>
								<li>
									<a class="dropdown-item d-flex align-items-center" href="javascript:void(0);">
										<span class="avatar avatar-rounded avatar-xs lh-1 me-2">
											<img src="<?php echo $this->Url->image('flags/spain_flag.jpg'); ?>" alt="img" >
										</span>
										español
									</a>
								</li>
								<li>
									<a class="dropdown-item d-flex align-items-center" href="javascript:void(0);">
										<span class="avatar avatar-rounded avatar-xs lh-1 me-2">
											<img src="<?php echo $this->Url->image('flags/french_flag.jpg'); ?>" alt="img" >
										</span>
										français
									</a>
								</li>
								<li>
									<a class="dropdown-item d-flex align-items-center" href="javascript:void(0);">
										<span class="avatar avatar-rounded avatar-xs lh-1 me-2">
											<img src="<?php echo $this->Url->image('flags/uae_flag.jpg'); ?>" alt="img" >
										</span>
										عربي
									</a>
								</li>
								<li>
									<a class="dropdown-item d-flex align-items-center" href="javascript:void(0);">
										<span class="avatar avatar-rounded avatar-xs lh-1 me-2">
											<img src="<?php echo $this->Url->image('flags/germany_flag.jpg'); ?>" alt="img" >
										</span>
										Deutsch
									</a>
								</li>
								<li>
									<a class="dropdown-item d-flex align-items-center" href="javascript:void(0);">
										<span class="avatar avatar-rounded avatar-xs lh-1 me-2">
											<img src="<?php echo $this->Url->image('flags/china_flag.jpg'); ?>" alt="img" >
										</span>
										中国人
									</a>
								</li>
								<li>
									<a class="dropdown-item d-flex align-items-center" href="javascript:void(0);">
										<span class="avatar avatar-rounded avatar-xs lh-1 me-2">
											<img src="<?php echo $this->Url->image('flags/italy_flag.jpg'); ?>" alt="img" >
										</span>
										Italiano
									</a>
								</li>
								<li>
									<a class="dropdown-item d-flex align-items-center" href="javascript:void(0);">
										<span class="avatar avatar-rounded avatar-xs lh-1 me-2">
											<img src="<?php echo $this->Url->image('flags/russia_flag.jpg'); ?>" alt="img" >
										</span>
										Русский
									</a>
								</li>
							...
							<div class="main-header-dropdown dropdown-menu dropdown-menu-end" data-popper-placement="none">
								<div class="p-3 bg-primary text-fixed-white">
									<div class="d-flex align-items-center justify-content-between">
										...
										<a href="<?= $this->Url->build('/products') ?>" class="text-fixed-white text-decoration-underline fs-12">Continue Shopping <i class="ti ti-arrow-narrow-right"></i></a>
									</div>
								</div>
								...
								<ul class="list-unstyled mb-0" id="header-cart-items-scroll">
										...
										<div class="d-flex align-items-start cart-dropdown-item gap-3">
											<div class="lh-1">
												<span class="avatar avatar-xl bg-gray-300">
													<img src="<?php echo $this->Url->image('ecommerce/png/13.png'); ?>" alt="img">
												</span>
											</div>
												...
												<div class="d-flex align-items-start justify-content-between mb-3">
													<div class="fs-14 fw-medium w-75">
														<div class="text-truncate">
															<a href="<?= $this->Url->build('/cart') ?>">Urban Chic Satchel</a>
														</div>
									...
									<li class="dropdown-item">
										<div class="d-flex align-items-start cart-dropdown-item gap-3">
											<div class="lh-1">
												<span class="avatar avatar-xl bg-gray-300">
													<img src="<?php echo $this->Url->image('ecommerce/png/15.png'); ?>" alt="img">
												</span>
											</div>
											<div class="flex-fill w-75">
												<div class="d-flex align-items-start justify-content-between mb-3">
													<div class="fs-14 fw-medium w-75">
														<div class="text-truncate">
															<a href="<?= $this->Url->build('/cart') ?>">TrailBlaze Runners</a>
														</div>
														<div class="fs-11 text-muted text-truncate">
									...
									<li class="dropdown-item">
										<div class="d-flex align-items-start cart-dropdown-item gap-3">
											<div class="lh-1">
												<span class="avatar avatar-xl bg-gray-300">
													<img src="<?php echo $this->Url->image('ecommerce/png/19.png'); ?>" alt="img">
												</span>
											</div>
											<div class="flex-fill w-75">
												<div class="d-flex align-items-start justify-content-between mb-3">
													<div class="fs-14 fw-medium w-75">
														<div class="text-truncate">
															<a href="<?= $this->Url->build('/cart') ?>">VisionTech SLR</a>
														</div>
														<div class="fs-11 text-muted text-truncate">
									...
									<li class="dropdown-item">
										<div class="d-flex align-items-start cart-dropdown-item gap-3">
											<div class="lh-1">
												<span class="avatar avatar-xl bg-gray-300">
													<img src="<?php echo $this->Url->image('ecommerce/png/6.png'); ?>" alt="img">
												</span>
											</div>
											<div class="flex-fill w-75">
												<div class="d-flex align-items-start justify-content-between mb-3">
													<div class="fs-14 fw-medium w-75">
														<div class="text-truncate">
															<a href="<?= $this->Url->build('/cart') ?>">FlexiSeat Office Chair</a>
														</div>
														<div class="fs-11 text-muted text-truncate">
									...
									<li class="dropdown-item">
										<div class="d-flex align-items-start cart-dropdown-item gap-3">
											<div class="lh-1">
												<span class="avatar avatar-xl bg-gray-300">
													<img src="<?php echo $this->Url->image('ecommerce/png/11.png'); ?>" alt="img">
												</span>
											</div>
											<div class="flex-fill w-75">
												<div class="d-flex align-items-start justify-content-between mb-3">
													<div class="fs-14 fw-medium w-75">
														<div class="text-truncate">
															<a href="<?= $this->Url->build('/cart') ?>">DecoDial Classic</a>
														</div>
														<div class="fs-11 text-muted text-truncate">
								...
								<div class="p-3 empty-header-item border-top">
									<div class="text-center d-grid">
										<a href="<?= $this->Url->build('/checkout') ?>" class="btn btn-primary btn-wave">Proceed to checkout</a>
									</div>
								</div>
							...
							<div class="main-header-dropdown dropdown-menu dropdown-menu-end" data-popper-placement="none">
								...
								<ul class="list-unstyled mb-0" id="header-notification-scroll">
									<li class="dropdown-item position-relative">
										<a href="<?= $this->Url->build('/chat') ?>" class="stretched-link"></a>
						...
						<li class="header-element dropdown">
							...
							<a href="javascript:void(0);" class="header-link dropdown-toggle" id="mainHeaderProfile" data-bs-toggle="dropdown" data-bs-auto-close="outside" aria-expanded="false">
								<div>
									<img src="<?php echo $this->Url->image('faces/12.jpg'); ?>" alt="img" class="header-link-icon">
								</div>
							</a>
							<!-- End::header-link|dropdown-toggle -->
								...
								<ul class="list-unstyled mb-0">
									<li>
										<ul class="list-unstyled mb-0 sub-list">
											<li>
												<a class="dropdown-item d-flex align-items-center" href="<?= $this->Url->build('/profile') ?>"><i class="ti ti-user-circle me-2 fs-18"></i>View Profile</a>
											</li>
											<li>
												<a class="dropdown-item d-flex align-items-center" href="<?= $this->Url->build('/mail_settings') ?>"><i class="ti ti-settings-cog me-2 fs-18"></i>Account Settings</a>
											</li>
										</ul>        
									</li>
									<li>
									...
									<li><a class="dropdown-item d-flex align-items-center" href="<?= $this->Url->build('/sign_in_cover') ?>"><i class="ti ti-logout me-2 fs-18"></i>Log Out</a></li>
								</ul>
							</div>
						</li>  
						<!-- End::header-element -->
