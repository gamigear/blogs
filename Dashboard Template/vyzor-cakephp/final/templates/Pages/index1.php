                                                                ...
                                                                <div class="d-flex align-items-center gap-2">
                                                                    <div class="lh-1">
                                                                        <span class="avatar avatar-xs">
                                                                            <img src="<?php echo $this->Url->image('flags/us_flag.jpg'); ?>" alt="">
                                                                        </span>
                                                                    </div>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td class="border-bottom-0">
                                                                <div class="d-flex align-items-center gap-2">
                                                                    <div class="lh-1">
                                                                        <span class="avatar avatar-xs">
                                                                            <img src="<?php echo $this->Url->image('flags/italy_flag.jpg'); ?>" alt="">
                                                                        </span>
                                                                    </div>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td class="border-bottom-0">
                                                                <div class="d-flex align-items-center gap-2">
                                                                    <div class="lh-1">
                                                                        <span class="avatar avatar-xs">
                                                                            <img src="<?php echo $this->Url->image('flags/russia_flag.jpg'); ?>" alt="">
                                                                        </span>
                                                                    </div>
                                                    ...
                                                    <tbody>
                                                        <tr>
                                                            <td>
                                                                <div class="d-flex align-items-center lh-1">
                                                                        ...
                                                                        <img src="<?php echo $this->Url->image('faces/1.jpg'); ?>">
                                                                        </span>
                                                        ...
                                                        <tr>
                                                            <td>
                                                                <div class="d-flex align-items-center lh-1">
                                                                    <span class="avatar avatar-sm p-1 bg-light me-2">
                                                                    <img src="<?php echo $this->Url->image('faces/2.jpg'); ?>">
                                                                    </span>
                                                        ...
                                                        <tr>
                                                            <td>
                                                                <div class="d-flex align-items-center lh-1">
                                                                    <span class="avatar avatar-sm p-1 bg-light me-2">
                                                                    <img src="<?php echo $this->Url->image('faces/3.jpg'); ?>">
                                                                    </span>
                                                        ...
                                                        <tr>
                                                            <td>
                                                                <div class="d-flex align-items-center lh-1">
                                                                    <span class="avatar avatar-sm p-1 bg-light me-2">
                                                                    <img src="<?php echo $this->Url->image('faces/4.jpg'); ?>">
                                                                    </span>
                                                        ...
                                                        <tr>
                                                            <td class="border-bottom-0">
                                                                <div class="d-flex align-items-center lh-1">
                                                                    <span class="avatar avatar-sm p-1 bg-light me-2">
                                                                    <img src="<?php echo $this->Url->image('faces/5.jpg'); ?>">
                                                                    </span>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <div class="d-flex align-items-center gap-2">
                                                                    <div class="lh-1">
                                                                        <span class="avatar avatar-xs avatar-rounded">
                                                                            <img src="<?php echo $this->Url->image('flags/canada_flag.jpg'); ?>" alt="">
                                                                        </span>
                                                                    </div>
                                                                    <div>
                                                                        Canada
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <div class="d-flex align-items-center gap-2">
                                                                    <div class="lh-1">
                                                                        <span class="avatar avatar-xs avatar-rounded">
                                                                            <img src="<?php echo $this->Url->image('flags/india_flag.jpg'); ?>" alt="">
                                                                        </span>
                                                                    </div>
                                                                    <div>
                                                                        India
                                            ...
                                            <ul class="list-unstyled browser-insights-list">
                                                    ...
                                                    <div class="d-flex align-items-start gap-3">
                                                        <div class="lh-1">
                                                            <span class="avatar avatar-rounded avatar-sm">
                                                                <img src="<?php echo $this->Url->image('browsers/chrome.png'); ?>" alt="">
                                                            </span>
                                                        </div>
                                                        <div class="flex-fill">
                                                ...
                                                <li>
                                                    <div class="d-flex align-items-start gap-3">
                                                        <div class="lh-1">
                                                            <span class="avatar avatar-rounded avatar-sm">
                                                                <img src="<?php echo $this->Url->image('browsers/edge.png'); ?>" alt="">
                                                            </span>
                                                        </div>
                                                        <div class="flex-fill">
                                                ...
                                                <li>
                                                    <div class="d-flex align-items-start gap-3">
                                                        <div class="lh-1">
                                                            <span class="avatar avatar-rounded avatar-sm">
                                                                <img src="<?php echo $this->Url->image('browsers/firefox.png'); ?>" alt="">
                                                            </span>
                                                        </div>
                                                        <div class="flex-fill">
                                                ...
                                                <li>
                                                    <div class="d-flex align-items-start gap-3">
                                                        <div class="lh-1">
                                                            <span class="avatar avatar-rounded avatar-sm">
                                                                <img src="<?php echo $this->Url->image('browsers/opera.png'); ?>" alt="">
                                                            </span>
                                                        </div>
                                                        <div class="flex-fill">
                                                ...
                                                <li>
                                                    <div class="d-flex align-items-start gap-3">
                                                        <div class="lh-1">
                                                            <span class="avatar avatar-rounded avatar-sm">
                                                                <img src="<?php echo $this->Url->image('browsers/safari.png'); ?>" alt="">
                                                            </span>
                                                        </div>
                                                        <div class="flex-fill">
                                                ...
                                                <li>
                                                    <div class="d-flex align-items-start gap-3">
                                                        <div class="lh-1">
                                                            <span class="avatar avatar-rounded avatar-sm">
                                                                <img src="<?php echo $this->Url->image('browsers/uc.png'); ?>" alt="">
                                                            </span>
                                                        </div>
                                                        <div class="flex-fill">
...
<?php $this->start('scripts'); ?>
        ...
        <!-- Analytics Dashboard --> 
        <?= $this->Html->script(['analytics-dashboard']) ?>
