...
<?php $this->end(); ?>
                    ...
                    <div class="page-header-breadcrumb mb-3">
                        <div class="d-flex align-center justify-content-between flex-wrap">
                            <h1 class="page-title fw-medium fs-18 mb-0 me-1">Blog Details</h1>
                    ...
                    <div class="row">
                        <div class="col-xxl-9">
                            ...
                            <div class="card custom-card">
                                <img src="<?php echo $this->Url->image('media/blog/27.jpg'); ?>" class="card-img-top" alt="...">
                                <div class="card-body">
                                                ...
                                                <div class="media mb-0 overflow-visible d-flex align-items-start flex-wrap">
                                                    ...
                                                    <div class="media-body overflow-visible flex-fill">
                                                        <div>
                                                            ...
                                                            <h6 class="mt-0">FutureCoder<span class="text-muted fs-12 ms-1 d-inline-flex">27 Mar 2025 - 10:45AM</span></h6>
