                            ...
                            <div class="card custom-card">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="github-style d-flex align-items-center">
                                        <div class="me-2">
                                            <img class="userimg rounded" src="<?php echo $this->Url->image('faces/1.jpg'); ?>"
...
<?php $this->start('scripts'); ?>
        ...
        <?= $this->Html->script(['apex-github-data']) ?>

        <!-- Used For Irregular Time Series Chart -->
        <?= $this->Html->script(['apexcharts-irregulardata']) ?>
        <script src="libs/moment/moment.js"></script>

        <!-- Internal Apex Area Charts JS -->
        <?= $this->Html->script(['apexcharts-area']) ?>
