                                                    ...
                                                    <div class="swiper swiper-preview-details bg-light product-details-page">
                                                        <div class="swiper-wrapper">
                                                            <div class="swiper-slide" id="img-container">
                                                                <img class="img-fluid" src="<?php echo $this->Url->image('nft-images/14.png'); ?>" alt="img">
                                                            </div>
                                                            <div class="swiper-slide image-container">
                                                                <img class="img-fluid" src="<?php echo $this->Url->image('nft-images/13.png'); ?>" alt="img">
                                                            </div>
                                                            <div class="swiper-slide image-container">
                                                                <img class="img-fluid" src="<?php echo $this->Url->image('nft-images/12.png'); ?>" alt="img">
                                                            </div>
                                                            <div class="swiper-slide image-container">
                                                                <img class="img-fluid" src="<?php echo $this->Url->image('nft-images/10.png'); ?>" alt="img">
                                                            </div>
                                                        </div>
                                                    ...
                                                    <ul class="list-group">
                                                            ...
                                                            <div class="d-flex align-items-center gap-2">
                                                                <div class="lh-1">
                                                                    <span class="avatar avatar-lg">
                                                                        <img src="<?php echo $this->Url->image('nft-images/5.png'); ?>" alt="">
                                                                    </span>
                                                                </div>
                                                                <div class="flex-fill">
                                                        ...
                                                        <li class="list-group-item">
                                                            <div class="d-flex align-items-center gap-2">
                                                                <div class="lh-1">
                                                                    <span class="avatar avatar-lg">
                                                                        <img src="<?php echo $this->Url->image('nft-images/7.png'); ?>" alt="">
                                                                    </span>
                                                                </div>
                                                                <div class="flex-fill">
                                                                    <span class="d-block fw-semibold">
                                                        ...
                                                        <li class="list-group-item">
                                                            <div class="d-flex align-items-center gap-2">
                                                                <div class="lh-1">
                                                                    <span class="avatar avatar-lg">
                                                                        <img src="<?php echo $this->Url->image('nft-images/10.png'); ?>" alt="">
                                                                    </span>
                                                                </div>
                                                                <div class="flex-fill">
                                                                    <span class="d-block fw-semibold">
                                                        ...
                                                        <li class="list-group-item">
                                                            <div class="d-flex align-items-center gap-2">
                                                                <div class="lh-1">
                                                                    <span class="avatar avatar-lg">
                                                                        <img src="<?php echo $this->Url->image('nft-images/12.png'); ?>" alt="">
                                                                    </span>
                                                                </div>
                                                                <div class="flex-fill">
                                                                    <span class="d-block fw-semibold">
                                                        ...
                                                        <li class="list-group-item">
                                                            <div class="d-flex align-items-center gap-2">
                                                                <div class="lh-1">
                                                                    <span class="avatar avatar-lg">
                                                                        <img src="<?php echo $this->Url->image('nft-images/13.png'); ?>" alt="">
                                                                    </span>
                                                                </div>
                                                                <div class="flex-fill">
                                                                    <span class="d-block fw-semibold">
                                                        ...
                                                        <li class="list-group-item">
                                                            <div class="d-flex align-items-center gap-2">
                                                                <div class="lh-1">
                                                                    <span class="avatar avatar-lg">
                                                                        <img src="<?php echo $this->Url->image('nft-images/14.png'); ?>" alt="">
                                                                    </span>
                                                                </div>
                                                                <div class="flex-fill">
                                                                    <span class="d-block fw-semibold">
                                                        ...
                                                        <div class="row mb-4">
                                                            ...
                                                            <div class="col-xxl-4 col-xl-6 col-lg-6 col-md-6 col-sm-12 mt-xxl-0 mt-3">
                                                                ...
                                                                <div class="d-flex align-items-center">
                                                                    <span class="avatar avatar-xs avatar-rounded lh-1 me-1"><img src="<?php echo $this->Url->image('faces/9.jpg'); ?>" alt=""></span>
                                                                    PixelWarrior
                                                                </div>
                                                            </div>
                                                                                ...
                                                                                <div class="col-xl-6">
                                                                                    <div class="products-review-images">
                                                                                        <a href="javascript:void(0);">
                                                                                            <img src="<?php echo $this->Url->image('nft-images/44.png'); ?>" alt="">
                                                                                        </a>
                                                                                        <a href="javascript:void(0);">
                                                                                            <img src="<?php echo $this->Url->image('nft-images/18.png'); ?>" alt="">
                                                                                        </a>
                                                                                    </div>
                                                                                </div>
