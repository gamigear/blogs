                                                                ...
                                                                <div class="d-flex align-items-center gap-2 mb-2 position-relative">
                                                                    <div class="lh-1">
                                                                        <span class="avatar avatar-md avatar-rounded bg-light border">
                                                                            <img src="<?php echo $this->Url->image('company-logos/1.png'); ?>" alt="">
                                                                        </span>
                                                                    </div>
                                                                    <div>
                                                        ...
                                                        <div>
                                                            <div class="position-relative">
                                                                ...
                                                                <div class="d-flex align-items-center gap-2 mb-2 position-relative">
                                                                    <div class="lh-1">
                                                                        <span class="avatar avatar-md avatar-rounded bg-light border">
                                                                            <img src="<?php echo $this->Url->image('company-logos/5.png'); ?>" alt="">
                                                                        </span>
                                                                    </div>
                                                                    <div>
                                                        ...
                                                        <div>
                                                            ...
                                                            <div class="d-flex align-items-start gap-3 flex-wrap">
                                                                <div>
                                                                    <figure class="figure mb-0">
                                                                        <a class="avatar avatar-search" href="javascript:void(0);">
                                                                            <img class="img-fluid rounded card-img" src="<?php echo $this->Url->image('media/media-59.jpg'); ?>" alt="...">
                                                                        </a>
                                                                ...
                                                                <div>
                                                                    <figure class="figure mb-0">
                                                                        <a class="avatar avatar-search" href="javascript:void(0);">
                                                                            <img class="img-fluid rounded card-img" src="<?php echo $this->Url->image('media/media-60.jpg'); ?>" alt="...">
                                                                        </a>
                                                                        <a href="javascript:void(0)" class="d-block">
                                                                            Active Living
                                                                        </a>
                                                                ...
                                                                <div>
                                                                    <figure class="figure mb-0">
                                                                        <a class="avatar avatar-search" href="javascript:void(0);">
                                                                            <img class="img-fluid rounded card-img" src="<?php echo $this->Url->image('media/media-61.jpg'); ?>" alt="...">
                                                                        </a>
                                                                        <a href="javascript:void(0)" class="d-block">
                                                                            Creative Elegance
                                                                        </a>
                                                        ...
                                                        <div>
                                                            <div class="position-relative">
                                                                ...
                                                                <div class="d-flex align-items-center gap-2 mb-2 position-relative">
                                                                    <div class="lh-1">
                                                                        <span class="avatar avatar-md avatar-rounded bg-light border">
                                                                            <img src="<?php echo $this->Url->image('company-logos/6.png'); ?>" alt="">
                                                                        </span>
                                                                    </div>
                                                                    <div>
                                                        ...
                                                        <div>
                                                            <div class="position-relative">
                                                                ...
                                                                <div class="d-flex align-items-center gap-2 mb-2 position-relative">
                                                                    <div class="lh-1">
                                                                        <span class="avatar avatar-md avatar-rounded bg-light border">
                                                                            <img src="<?php echo $this->Url->image('company-logos/2.png'); ?>" alt="">
                                                                        </span>
                                                                    </div>
                                                                    <div>
                                                        ...
                                                        <div>
                                                            <div class="position-relative">
                                                                ...
                                                                <div class="d-flex align-items-center gap-2 mb-2 position-relative">
                                                                    <div class="lh-1">
                                                                        <span class="avatar avatar-md avatar-rounded bg-light border">
                                                                            <img src="<?php echo $this->Url->image('company-logos/4.png'); ?>" alt="">
                                                                        </span>
                                                                    </div>
                                                                    <div>
                                                        ...
                                                        <div>
                                                            <div class="position-relative">
                                                                ...
                                                                <div class="d-flex align-items-center gap-2 mb-2 position-relative">
                                                                    <div class="lh-1">
                                                                        <span class="avatar avatar-md avatar-rounded bg-light border">
                                                                            <img src="<?php echo $this->Url->image('company-logos/3.png'); ?>" alt="">
                                                                        </span>
                                                                    </div>
                                                                    <div>
                                ...
                                <div class="tab-pane border-0 p-0" id="search-images" role="tabpanel">
                                    <div class="row">
                                        <div class="col-lg-3 col-md-3 col-sm-6 col-12">
                                            <a href="<?php echo $this->Url->image('media/media-40.jpg'); ?>" class="glightbox card search-images-card" data-gallery="gallery1">
                                        ...
                                        <div class="col-lg-3 col-md-3 col-sm-6 col-12">
                                            <a href="<?php echo $this->Url->image('media/media-41.jpg'); ?>" class="glightbox card search-images-card" data-gallery="gallery1">
                                        ...
                                        <div class="col-lg-3 col-md-3 col-sm-6 col-12">
                                            <a href="<?php echo $this->Url->image('media/media-42.jpg'); ?>" class="glightbox card search-images-card" data-gallery="gallery1">
                                        ...
                                        <div class="col-lg-3 col-md-3 col-sm-6 col-12">
                                            <a href="<?php echo $this->Url->image('media/media-43.jpg'); ?>" class="glightbox card search-images-card" data-gallery="gallery1">
                                        ...
                                        <div class="col-lg-3 col-md-3 col-sm-6 col-12">
                                            <a href="<?php echo $this->Url->image('media/media-44.jpg'); ?>" class="glightbox card search-images-card" data-gallery="gallery1">
                                        ...
                                        <div class="col-lg-3 col-md-3 col-sm-6 col-12">
                                            <a href="<?php echo $this->Url->image('media/media-45.jpg'); ?>" class="glightbox card search-images-card" data-gallery="gallery1">
                                                <img src="<?php echo $this->Url->image('media/media-45.jpg'); ?>" alt="image" >
                                                <div class="p-2">
                                                    <div class="d-flex align-items-center gap-1">
                                                        <div class="avatar avatar-xs">
                                                            <img src="<?php echo $this->Url->image('company-logos/7.png'); ?>" alt="">
                                                        </div>
                                        ...
                                        <div class="col-lg-3 col-md-3 col-sm-6 col-12">
                                            <a href="<?php echo $this->Url->image('media/media-46.jpg'); ?>" class="glightbox card search-images-card" data-gallery="gallery1">
                                                <img src="<?php echo $this->Url->image('media/media-46.jpg'); ?>" alt="image" >
                                                <div class="p-2">
                                                    <div class="d-flex align-items-center gap-1">
                                                        <div class="avatar avatar-xs">
                                                            <img src="<?php echo $this->Url->image('company-logos/8.png'); ?>" alt="">
                                                        </div>
                                        ...
                                        <div class="col-lg-3 col-md-3 col-sm-6 col-12">
                                            <a href="<?php echo $this->Url->image('media/media-60.jpg'); ?>" class="glightbox card search-images-card" data-gallery="gallery1">
                                                <img src="<?php echo $this->Url->image('media/media-60.jpg'); ?>" alt="image" >
                                                <div class="p-2">
                                                    <div class="d-flex align-items-center gap-1">
                                                        <div class="avatar avatar-xs">
                                                            <img src="<?php echo $this->Url->image('company-logos/9.png'); ?>" alt="">
                                                        </div>
                                                        ...
                                                        <div class="d-flex align-items-center">
                                                            <div>
                                                                <span class="avatar avatar-lg avatar-rounded bg-primary bg-opacity-10 border">
                                                                    <img src="<?php echo $this->Url->image('media/books/6.jpg'); ?>" alt="">
                                                                </span>
                                                            </div>
                                                            <div class="ms-2">
                                                ...
                                                <div class="card-body">
                                                    <div class="d-flex align-items-start flex-wrap gap-3 justify-content-between">
                                                        <div class="d-flex align-items-center">
                                                            <div>
                                                                <span class="avatar avatar-lg avatar-rounded bg-primary bg-opacity-10 border">
                                                                    <img src="<?php echo $this->Url->image('media/books/1.jpg'); ?>" alt="">
                                                                </span>
                                                            </div>
                                                            <div class="ms-2">
                                                ...
                                                <div class="card-body">
                                                    <div class="d-flex align-items-start flex-wrap gap-3 justify-content-between">
                                                        <div class="d-flex align-items-center">
                                                            <div>
                                                                <span class="avatar avatar-lg avatar-rounded bg-primary bg-opacity-10 border">
                                                                    <img src="<?php echo $this->Url->image('media/books/2.jpg'); ?>" alt="">
                                                                </span>
                                                            </div>
                                                            <div class="ms-2">
                                                ...
                                                <div class="card-body">
                                                    <div class="d-flex align-items-start flex-wrap gap-3 justify-content-between">
                                                        <div class="d-flex align-items-center">
                                                            <div>
                                                                <span class="avatar avatar-lg avatar-rounded bg-primary bg-opacity-10 border">
                                                                    <img src="<?php echo $this->Url->image('media/books/3.jpg'); ?>" alt="">
                                                                </span>
                                                            </div>
                                                            <div class="ms-2">
                                                ...
                                                <div class="card-body">
                                                    <div class="d-flex align-items-start flex-wrap gap-3 justify-content-between">
                                                        <div class="d-flex align-items-center">
                                                            <div>
                                                                <span class="avatar avatar-lg avatar-rounded bg-primary bg-opacity-10 border">
                                                                    <img src="<?php echo $this->Url->image('media/books/4.jpg'); ?>" alt="">
                                                                </span>
                                                            </div>
                                                            <div class="ms-2">
                                                ...
                                                <div class="card-body">
                                                    <div class="d-flex align-items-start flex-wrap gap-3 justify-content-between">
                                                        <div class="d-flex align-items-center">
                                                            <div>
                                                                <span class="avatar avatar-lg avatar-rounded bg-primary bg-opacity-10 border">
                                                                    <img src="<?php echo $this->Url->image('media/books/5.jpg'); ?>" alt="">
                                                                </span>
                                                            </div>
                                                            <div class="ms-2">
...
<?php $this->start('scripts'); ?>
        ...
        <?= $this->Html->script(['search-results']) ?>
