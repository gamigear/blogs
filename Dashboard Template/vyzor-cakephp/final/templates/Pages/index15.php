                                                    ...
                                                    <tbody>
                                                        <tr>
                                                            ...
                                                            <div class="d-flex align-items-center gap-2">
                                                                    <div class="lh-1">
                                                                        <span class="avatar avatar-sm">
                                                                            <img src="<?php echo $this->Url->image('media/media-23.jpg'); ?>">
                                                                        </span>
                                                                    </div>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <div class="d-flex align-items-center gap-2">
                                                                    <div class="lh-1">
                                                                        <span class="avatar avatar-sm">
                                                                            <img src="<?php echo $this->Url->image('media/media-24.jpg'); ?>">
                                                                        </span>
                                                                    </div>    
                                                        ...
                                                        <tr>
                                                            ...
                                                            <div class="d-flex align-items-center gap-2">
                                                                    <div class="lh-1">
                                                                        <span class="avatar avatar-sm">
                                                                            <img src="<?php echo $this->Url->image('media/media-25.jpg'); ?>">
                                                                        </span>
                                                                    </div>    
                                                        ...
                                                        <tr>
                                                            ...
                                                            <div class="d-flex align-items-center gap-2">
                                                                    <div class="lh-1">
                                                                        <span class="avatar avatar-sm">
                                                                            <img src="<?php echo $this->Url->image('media/media-26.jpg'); ?>">
                                                                        </span>
                                                                    </div>    
                                                        ...
                                                        <tr>
                                                            ...
                                                            <div class="d-flex align-items-center gap-2">
                                                                    <div class="lh-1">
                                                                        <span class="avatar avatar-sm">
                                                                            <img src="<?php echo $this->Url->image('media/media-27.jpg'); ?>">
                                                                        </span>
                                                                    </div>    
...
<?php $this->start('scripts'); ?>
        ...
        <?= $this->Html->script(['social-media-dashboard']) ?>
