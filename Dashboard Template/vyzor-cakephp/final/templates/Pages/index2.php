                                                                ...
                                                                <div class="d-flex align-items-center gap-2">
                                                                    <div class="lh-1">
                                                                        <span class="avatar avatar-sm avatar-rounded bg-light">
                                                                            <img src="<?php echo $this->Url->image('ecommerce/png/11.png'); ?>" alt="">
                                                                        </span>
                                                                    </div>
                                                                    <div>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <div class="d-flex align-items-center gap-2">
                                                                    <div class="lh-1">
                                                                        <span class="avatar avatar-sm avatar-rounded bg-light">
                                                                            <img src="<?php echo $this->Url->image('ecommerce/png/12.png'); ?>" alt="">
                                                                        </span>
                                                                    </div>
                                                                    <div>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <div class="d-flex align-items-center gap-2">
                                                                    <div class="lh-1">
                                                                        <span class="avatar avatar-sm avatar-rounded bg-light">
                                                                            <img src="<?php echo $this->Url->image('ecommerce/png/14.png'); ?>" alt="">
                                                                        </span>
                                                                    </div>
                                                                    <div>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <div class="d-flex align-items-center gap-2">
                                                                    <div class="lh-1">
                                                                        <span class="avatar avatar-sm avatar-rounded bg-light">
                                                                            <img src="<?php echo $this->Url->image('ecommerce/png/16.png'); ?>" alt="">
                                                                        </span>
                                                                    </div>
                                                                    <div>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td class="border-bottom-0">
                                                                <div class="d-flex align-items-center gap-2">
                                                                    <div class="lh-1">
                                                                        <span class="avatar avatar-sm avatar-rounded bg-light">
                                                                            <img src="<?php echo $this->Url->image('ecommerce/png/13.png'); ?>" alt="">
                                                                        </span>
                                                                    </div>
                                                                    <div>
                                            ...
                                            <ul class="list-unstyled ecommerce-recent-orders-list">
                                                ...
                                                <li>
                                                    <div class="d-flex align-items-center gap-3">
                                                        <div class="lh-1">
                                                            <span class="avatar avatar-md">
                                                                <img src="<?php echo $this->Url->image('ecommerce/png/15.png'); ?>" alt="">
                                                            </span>
                                                        </div>
                                                        <div class="flex-fill">
                                                ...
                                                <li>
                                                    <div class="d-flex align-items-center gap-3">
                                                        <div class="lh-1">
                                                            <span class="avatar avatar-md">
                                                                <img src="<?php echo $this->Url->image('ecommerce/png/19.png'); ?>" alt="">
                                                            </span>
                                                        </div>
                                                        <div class="flex-fill">
                                                ...
                                                <li>
                                                    <div class="d-flex align-items-center gap-3">
                                                        <div class="lh-1">
                                                            <span class="avatar avatar-md">
                                                                <img src="<?php echo $this->Url->image('ecommerce/png/6.png'); ?>" alt="">
                                                            </span>
                                                        </div>
                                                        <div class="flex-fill">
                                            ...
                                            <ul class="pt-2 list-unstyled top-country-sales-list">
                                                    ...
                                                    <div class="d-flex justify-content-between align-items-center">
                                                        <div class="d-flex align-items-center lh-1 gap-2">
                                                            <span class="avatar avatar-xs avatar-rounded">
                                                                <img src="<?php echo $this->Url->image('flags/french_flag.jpg'); ?>" alt="">
                                                            </span>
                                                ...
                                                <li>
                                                    <div class="d-flex justify-content-between align-items-center">
                                                        <div class="d-flex align-items-center lh-1 gap-2">
                                                            <span class="avatar avatar-xs avatar-rounded">
                                                                <img src="<?php echo $this->Url->image('flags/spain_flag.jpg'); ?>" alt="">
                                                            </span>
                                                ...
                                                <li>
                                                    <div class="d-flex justify-content-between align-items-center">
                                                        <div class="d-flex align-items-center lh-1 gap-2">
                                                            <span class="avatar avatar-xs avatar-rounded">
                                                                <img src="<?php echo $this->Url->image('flags/argentina_flag.jpg'); ?>" alt="">
                                                            </span>
                                                ...
                                                <li>
                                                    <div class="d-flex justify-content-between align-items-center">
                                                        <div class="d-flex align-items-center lh-1 gap-2">
                                                            <span class="avatar avatar-xs avatar-rounded">
                                                                <img src="<?php echo $this->Url->image('flags/uae_flag.jpg'); ?>" alt="">
                                                            </span>
                                                ...
                                                <li class="mb-0">
                                                    <div class="d-flex justify-content-between align-items-center">
                                                        <div class="d-flex align-items-center lh-1 gap-2">
                                                            <span class="avatar avatar-xs avatar-rounded">
                                                                <img src="<?php echo $this->Url->image('flags/germany_flag.jpg'); ?>" alt="">
                                                            </span>
                                    ...
                                    <div class="card custom-card atm-card border-0 overflow-hidden">
                                        <div class="card-body">
                                            <div class="atm-card-background-container">
                                                <img src="<?php echo $this->Url->image('ecommerce/png/21.png'); ?>" alt="">
                                            </div>
                                            <div class="d-flex align-items-center gap-2">
                                                <div>
                                            ...
                                            <ul class="list-group list-group-flush">
                                                    ...
                                                    <div class="d-flex align-items-center gap-2 mb-1">
                                                        ...
                                                        <div>
                                                            <span class="avatar avatar-xs">
                                                                <img src="<?php echo $this->Url->image('faces/emojis/1'); ?>.png" alt="">
                                                            </span>
                                                        </div>
                                                    </div>
                                                ...
                                                <li class="list-group-item">
                                                    <div class="d-flex align-items-center gap-2 mb-1">
                                                        ...
                                                        <div>
                                                            <span class="avatar avatar-xs">
                                                                <img src="<?php echo $this->Url->image('faces/emojis/2'); ?>.png" alt="">
                                                            </span>
                                                        </div>
                                                    </div>
                                                ...
                                                <li class="list-group-item">
                                                    <div class="d-flex align-items-center gap-2 mb-1">
                                                        ...
                                                        <div>
                                                            <span class="avatar avatar-xs">
                                                                <img src="<?php echo $this->Url->image('faces/emojis/3'); ?>.png" alt="">
                                                            </span>
                                                        </div>
                                                    </div>
                                                ...
                                                <li class="list-group-item">
                                                    <div class="d-flex align-items-center gap-2 mb-1">
                                                        ...
                                                        <div>
                                                            <span class="avatar avatar-xs">
                                                                <img src="<?php echo $this->Url->image('faces/emojis/4'); ?>.png" alt="">
                                                            </span>
                                                        </div>
                                                    </div>
                                                ...
                                                <li class="list-group-item">
                                                    <div class="d-flex align-items-center gap-2 mb-1">
                                                        ...
                                                        <div>
                                                            <span class="avatar avatar-xs">
                                                                <img src="<?php echo $this->Url->image('faces/emojis/5'); ?>.png" alt="">
                                                            </span>
                                                        </div>
                                                    </div>
                                                ...
                                                <li class="list-group-item">
                                                    <div class="d-flex align-items-center gap-2 mb-1">
                                                        ...
                                                        <div>
                                                            <span class="avatar avatar-xs">
                                                                <img src="<?php echo $this->Url->image('faces/emojis/6'); ?>.png" alt="">
                                                            </span>
                                                        </div>
                                                    </div>
...
<?php $this->start('scripts'); ?>
        ...
        <!-- Ecommerce Dashboard --> 
        <?= $this->Html->script(['ecommerce-dashboard']) ?>
