...
<?php $this->start('styles'); ?>
        ...
        <!-- Tagify CSS -->
        <link rel="stylesheet" href="libs/@yaireo/tagify/tagify.css">

        <!-- Dragsort CSS -->
        <link rel="stylesheet" href="libs/@yaireo/dragsort/dragsort.css">

        <!-- Dual ListBox CSS -->
        <link rel="stylesheet" href="libs/dual-listbox/dual-listbox.css">
...
<?php $this->start('scripts'); ?>
        ...
        <!-- Tagify JS -->
        <script src="libs/@yaireo/tagify/tagify.js"></script>

        <!-- Dragsort JS -->
        <script src="libs/@yaireo/dragsort/dragsort.js"></script>

        <!-- Dual ListBox JS -->
        <script src="libs/dual-listbox/dual-listbox.js"></script>

        <!-- Internal Advanced Forms JS -->
        <?= $this->Html->script(['form-advanced']) ?>
