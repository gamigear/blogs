                                        ...
                                        <table class="table text-nowrap">
                                            ...
                                            <tbody>
                                                <tr>
                                                    ...
                                                    <td>
                                                        <div class="avatar-list-stacked"> 
                                                            <span class="avatar avatar-xs avatar-rounded"> <img src="<?php echo $this->Url->image('faces/2.jpg'); ?>" alt="img"> </span> 
                                                            <span class="avatar avatar-xs avatar-rounded"> <img src="<?php echo $this->Url->image('faces/8.jpg'); ?>" alt="img"> </span> 
                                                            <span class="avatar avatar-xs avatar-rounded"> <img src="<?php echo $this->Url->image('faces/2.jpg'); ?>" alt="img"> </span> 
                                                        </div>
                                                    </td>
                                                    <td>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <div class="avatar-list-stacked mb-0"> 
                                                            <span class="avatar avatar-xs avatar-rounded"> <img src="<?php echo $this->Url->image('faces/6.jpg'); ?>" alt="img"> </span> 
                                                            <span class="avatar avatar-xs avatar-rounded"> <img src="<?php echo $this->Url->image('faces/9.jpg'); ?>" alt="img"> </span> 
                                                        </div>
                                                    </td>
                                                    <td>
                                                        High
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <div class="avatar-list-stacked"> 
                                                            <span class="avatar avatar-xs avatar-rounded"> <img src="<?php echo $this->Url->image('faces/3.jpg'); ?>" alt="img"> </span> 
                                                            <span class="avatar avatar-xs avatar-rounded"> <img src="<?php echo $this->Url->image('faces/5.jpg'); ?>" alt="img"> </span> 
                                                            <span class="avatar avatar-xs avatar-rounded"> <img src="<?php echo $this->Url->image('faces/10.jpg'); ?>" alt="img"> </span> 
                                                            <span class="avatar avatar-xs avatar-rounded"> <img src="<?php echo $this->Url->image('faces/15.jpg'); ?>" alt="img"> </span> 
                                                        </div>
                                                    </td>
                                                    <td>
                                                        Medium
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <div class="avatar-list-stacked"> 
                                                            <span class="avatar avatar-xs avatar-rounded"> <img src="<?php echo $this->Url->image('faces/11.jpg'); ?>" alt="img"> </span> 
                                                        </div>
                                                    </td>
                                                    <td>
                                                        High
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <div class="avatar-list-stacked mb-0"> 
                                                            <span class="avatar avatar-xs avatar-rounded"> <img src="<?php echo $this->Url->image('faces/13.jpg'); ?>" alt="img"> </span> 
                                                            <span class="avatar avatar-xs avatar-rounded"> <img src="<?php echo $this->Url->image('faces/16.jpg'); ?>" alt="img"> </span> 
                                                            <span class="avatar avatar-xs avatar-rounded"> <img src="<?php echo $this->Url->image('faces/8.jpg'); ?>" alt="img"> </span> 
                                                        </div>
                                                    </td>
                                                    <td>
...
<?php $this->start('scripts'); ?>
        ...
        <!-- Projects Dashboard --> 
        <?= $this->Html->script(['projects-dashboard']) ?>
