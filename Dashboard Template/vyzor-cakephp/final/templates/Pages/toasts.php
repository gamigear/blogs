...
<?php $this->start('styles'); ?>
        ...
        <!-- Toastify CSS -->
        <link rel="stylesheet" href="libs/toastify-js/src/toastify.css">
                                    ...
                                    <div class="toast-container position-fixed top-0 end-0 p-3">
                                        <div id="liveToast" class="toast" role="alert" aria-live="assertive"
                                            ...
                                            <div class="toast-header text-default">
                                                <img class="bd-placeholder-img rounded me-2" src="<?php echo $this->Url->image('brand-logos/favicon.ico'); ?>" alt="...">
                                    ...
                                    <div class="toast-container position-fixed top-0 end-0 p-3">
                                        <div id="primaryToast" class="toast colored-toast bg-primary-transparent" role="alert" aria-live="assertive"
                                            ...
                                            <div class="toast-header bg-primary">
                                                <img class="bd-placeholder-img rounded me-2" src="<?php echo $this->Url->image('brand-logos/toggle-dark.png'); ?>" alt="...">
...
<?php $this->start('scripts'); ?>
        ...
        <!-- Toastify JS -->
        <script src="libs/toastify-js/src/toastify.js"></script>
