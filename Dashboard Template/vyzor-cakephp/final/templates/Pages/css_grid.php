                                    ...
                                    <div class="card custom-card">
                                        ...
                                        <div class="card-body bd-example-cssgrid text-center">
                                           <div class="overflow-x-auto">
                                            <div class="grid mb-3 gap-2 gap-sm-4" style="--bs-columns: 4; --bs-gap: 5rem;">
                                                <div class="g-col-2">.g-col-2</div>
                                                <div class="g-col-2">.g-col-2</div>
                                            </div>
                                            <div class="grid gap-2 gap-sm-4" style="--bs-columns: 10; --bs-gap: 1rem;">
                                                <div class="g-col-6">.g-col-6</div>
                                ...
                                <div class="col-xl-12">
                                    <div class="card custom-card">
                                        ...
                                        <div class="card-body bd-example-cssgrid text-center overflow-x-auto">
                                            ...
                                            <div class="grid mb-3 gap-2 gap-sm-4" style="row-gap: 0;">
                                                <div class="g-col-6">.g-col-6</div>
                                                <div class="g-col-6">.g-col-6</div>
                                            ...
                                            <p>Because of that, you can have different vertical and horizontal gaps, which
                                                ...
                                                variable.</p>
                                            <div class="grid gap-2 gap-sm-4" style="--bs-gap: .25rem 1rem;">
                                                <div class="g-col-6">.g-col-6</div>
                                                <div class="g-col-6">.g-col-6</div>
