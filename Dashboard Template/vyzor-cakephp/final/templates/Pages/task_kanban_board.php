...
<?php $this->start('styles'); ?>
        ...
        <link rel="stylesheet" href="libs/filepond-plugin-image-edit/filepond-plugin-image-edit.min.css">
                            ...
                            <div class="kanban-tasks" id="new-tasks">
                                <div id="new-tasks-draggable" data-view-btn="new-tasks">
                                    <div class="task-null-background" draggable="false">
                                        <img src="<?php echo $this->Url->image('media/media-81.svg'); ?>" alt="">
                                    </div>
                                    <div class="card custom-card">
                                            ...
                                            <div class="p-3 kanban-board-head">
                                                ...
                                                <div class="kanban-content mt-2">
                                                    <div class="task-image mt-2">
                                                        <img src="<?php echo $this->Url->image('media/media-36.jpg'); ?>" class="img-fluid rounded kanban-image" alt="">
                                                    </div>
                                    ...
                                    <div class="card custom-card">
                                        <div class="card-body p-0">
                                            <div class="p-3 kanban-board-head">
                                                ...
                                                <div class="kanban-content mt-2">
                                                    <div class="task-image mt-2">
                                                        <img src="<?php echo $this->Url->image('media/media-41.jpg'); ?>" class="img-fluid rounded kanban-image" alt="">
                                                    </div>
                                    ...
                                    <div class="card custom-card">
                                        <div class="card-body p-0">
                                            <div class="p-3 kanban-board-head">
                                                ...
                                                <div class="kanban-content mt-2">
                                                    <div class="task-image mt-2">
                                                        <img src="<?php echo $this->Url->image('media/media-43.jpg'); ?>" class="img-fluid rounded kanban-image" alt="">
                                                    </div>
                                    ...
                                    <div class="card custom-card">
                                        <div class="card-body p-0">
                                            <div class="p-3 kanban-board-head">
                                                ...
                                                <div class="kanban-content mt-2">
                                                    <div class="task-image mt-2">
                                                        <img src="<?php echo $this->Url->image('media/media-69.jpg'); ?>" class="img-fluid rounded kanban-image bg-light" alt="">
                                                    </div>
...
<?php $this->start('scripts'); ?>
        ...
        <script src="libs/filepond-plugin-image-edit/filepond-plugin-image-edit.min.js"></script>
        <script src="libs/filepond-plugin-file-validate-type/filepond-plugin-file-validate-type.min.js"></script>
        <script src="libs/filepond-plugin-file-validate-type/filepond-plugin-file-validate-type.min.js"></script>
        <script src="libs/filepond-plugin-image-crop/filepond-plugin-image-crop.min.js"></script>
        <script src="libs/filepond-plugin-image-resize/filepond-plugin-image-resize.min.js"></script>
        <script src="libs/filepond-plugin-image-transform/filepond-plugin-image-transform.min.js"></script>
        ...
        <!-- Internal Task  JS -->
        <?= $this->Html->script(['task-kanban-board']) ?>
