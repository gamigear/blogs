                                        ...
                                        <table class="table text-nowrap">
                                            ...
                                            <tbody>
                                                ...
                                                <tr class="crm-contact">
                                                    ...
                                                    <td>
                                                        <div>
                                                            <span class="d-block"><i class="ri-phone-line me-2 align-middle fs-14 text-muted d-inline-block"></i>(444) 666-8888</span>
                                                        </div>
                                                    </td>
                                                    <td>
                                                        <div class="d-flex align-items-center flex-wrap gap-1">
                                        ...
                                        <div class="col-xl-12">
                                            <div class="mb-0 text-center">
                                                <span class="avatar avatar-xxl avatar-rounded p-2 bg-light">
                                                    <img src="<?php echo $this->Url->image('company-logos/11.png'); ?>" alt="" id="profile-img">
...
<?php $this->start('scripts'); ?>
        ...
        <!-- CRM Contacts JS -->
        <?= $this->Html->script(['crm-companies']) ?>
