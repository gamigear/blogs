                                        ...
                                        <div class="d-flex align-items-center">
                                            <div class="me-2">
                                                <span class="avatar avatar-md avatar-rounded bg-light p-2">
                                                    <img src="<?php echo $this->Url->image('crypto-currencies/regular/Bitcoin.svg'); ?>" alt="">
                                                </span>
                                            </div>
                                ...
                                <div class="card-body">
                                    <div class="d-flex align-items-center mb-4 flex-wrap">
                                        <div class="d-flex align-items-center">
                                            <div class="me-2">
                                                <span class="avatar avatar-md avatar-rounded bg-light p-2">
                                                    <img src="<?php echo $this->Url->image('crypto-currencies/regular/Ethereum.svg'); ?>" alt="">
                                                </span>
                                            </div>
                                            <div class="mb-0 fw-medium">
                                                Etherium - ETH
                                ...
                                <div class="card-body">
                                    <div class="d-flex align-items-center mb-4 flex-wrap">
                                        <div class="d-flex align-items-center">
                                            <div class="me-2">
                                                <span class="avatar avatar-md avatar-rounded bg-light p-2">
                                                    <img src="<?php echo $this->Url->image('crypto-currencies/regular/Dash.svg'); ?>" alt="">
                                                </span>
                                            </div>
                                            <div class="mb-0 fw-medium">
                                                Dash - DASH
                                        ...
                                        <li class="list-group-item">
                                            <div class="d-flex align-items-center justify-content-between flex-wrap gap-3">
                                                <div class="d-flex align-items-center gap-2">
                                                    <div>
                                                        <span class="avatar avatar-sm p-1 bg-light">
                                                            <img src="<?php echo $this->Url->image('crypto-currencies/regular/litecoin.svg'); ?>" alt="">
                                                        </span>
                                                    </div>
                                                    <div>
                                                        ...
                                                        <div class="d-flex align-items-center gap-2">
                                                            <div class="lh-1">
                                                                <span class="avatar avatar-xs avatar-rounded">
                                                                    <img src="<?php echo $this->Url->image('crypto-currencies/square-color/Bitcoin.svg'); ?>" alt="">
                                                                </span>
                                                            </div>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <div class="d-flex align-items-center gap-2">
                                                            <div class="lh-1">
                                                                <span class="avatar avatar-xs avatar-rounded">
                                                                    <img src="<?php echo $this->Url->image('crypto-currencies/square-color/Ethereum.svg'); ?>" alt="">
                                                                </span>
                                                            </div>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <div class="d-flex align-items-center gap-2">
                                                            <div class="lh-1">
                                                                <span class="avatar avatar-xs avatar-rounded">
                                                                    <img src="<?php echo $this->Url->image('crypto-currencies/square-color/Golem.svg'); ?>" alt="">
                                                                </span>
                                                            </div>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <div class="d-flex align-items-center gap-2">
                                                            <div class="lh-1">
                                                                <span class="avatar avatar-xs avatar-rounded">
                                                                    <img src="<?php echo $this->Url->image('crypto-currencies/square-color/Dash.svg'); ?>" alt="">
                                                                </span>
                                                            </div>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <div class="d-flex align-items-center gap-2">
                                                            <div class="lh-1">
                                                                <span class="avatar avatar-xs avatar-rounded">
                                                                    <img src="<?php echo $this->Url->image('crypto-currencies/square-color/Litecoin.svg'); ?>" alt="">
                                                                </span>
                                                            </div>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <div class="d-flex align-items-center gap-2">
                                                            <div class="lh-1">
                                                                <span class="avatar avatar-xs avatar-rounded">
                                                                    <img src="<?php echo $this->Url->image('crypto-currencies/square-color/Ripple.svg'); ?>" alt="">
                                                                </span>
                                                            </div>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <div class="d-flex align-items-center gap-2">
                                                            <div class="lh-1">
                                                                <span class="avatar avatar-xs avatar-rounded">
                                                                    <img src="<?php echo $this->Url->image('crypto-currencies/square-color/EOS.svg'); ?>" alt="">
                                                                </span>
                                                            </div>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <div class="d-flex align-items-center gap-2">
                                                            <div class="lh-1">
                                                                <span class="avatar avatar-xs avatar-rounded">
                                                                    <img src="<?php echo $this->Url->image('crypto-currencies/square-color/Bytecoin.svg'); ?>" alt="">
                                                                </span>
                                                            </div>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <div class="d-flex align-items-center gap-2">
                                                            <div class="lh-1">
                                                                <span class="avatar avatar-xs avatar-rounded">
                                                                    <img src="<?php echo $this->Url->image('crypto-currencies/square-color/IOTA.svg'); ?>" alt="">
                                                                </span>
                                                            </div>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <div class="d-flex align-items-center gap-2">
                                                            <div class="lh-1">
                                                                <span class="avatar avatar-xs avatar-rounded">
                                                                    <img src="<?php echo $this->Url->image('crypto-currencies/square-color/Monero.svg'); ?>" alt="">
                                                                </span>
                                                            </div>
...
<?php $this->start('scripts'); ?>
        ...
        <!-- Crypto MarketCap JS -->
        <?= $this->Html->script(['crypto-marketcap']) ?>
