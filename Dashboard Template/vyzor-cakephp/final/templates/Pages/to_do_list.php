                            ...
                            <div class="card custom-card">
                                <div class="card-body p-0">
                                    <div class="p-3 task-navigation border-bottom border-block-end-dashed"> 
                                        <div class="d-grid">
                                            <button class="btn btn-primary rounded-pill d-flex align-items-center justify-content-center" data-bs-toggle="modal" data-bs-target="#addtask">
                                    ...
                                    <div class="p-3 text-center">
                                        <img src="<?php echo $this->Url->image('media/media-66.png'); ?>" alt="">
                                    </div>
                                </div>
                            </div>
                        </div>
