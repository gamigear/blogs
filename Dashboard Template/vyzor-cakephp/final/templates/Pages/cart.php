                                                ...
                                                <tr>
                                                    <td>
                                                        <div class="d-flex align-items-center gap-3">
                                                            <div class="lh-1">
                                                                <span class="avatar avatar-xxl">
                                                                    <img src="<?php echo $this->Url->image('ecommerce/jpg/3.jpg'); ?>" alt="">
                                                                </span>
                                                            </div>
                                                            <div>
                                                ...
                                                <tr>
                                                    <td>
                                                        <div class="d-flex align-items-center gap-3">
                                                            <div class="lh-1">
                                                                <span class="avatar avatar-xxl">
                                                                    <img src="<?php echo $this->Url->image('ecommerce/jpg/4.jpg'); ?>" alt="">
                                                                </span>
                                                            </div>
                                                            <div>
                                                ...
                                                <tr>
                                                    <td class="border-bottom-0">
                                                        <div class="d-flex align-items-center gap-3">
                                                            <div class="lh-1">
                                                                <span class="avatar avatar-xxl">
                                                                    <img src="<?php echo $this->Url->image('ecommerce/jpg/5.jpg'); ?>" alt="">
                                                                </span>
                                                            </div>
                                                            <div>
                        ...
                        <div class="col-xl-3">
                            <div class="card custom-card">
                                ...
                                <div class="card-footer d-grid">
                                    <a href="<?= $this->Url->build('/checkout') ?>" class="btn btn-primary d-inline-flex align-items-center justify-content-center">Proceed to checkout<i class="ti ti-arrow-narrow-right ms-1"></i></a>
                                </div>
                            </div>
                        </div>
                    </div>
