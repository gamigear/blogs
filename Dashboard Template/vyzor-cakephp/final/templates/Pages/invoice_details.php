                        ...
                        <div class="col-xl-12">
                            <div class="card custom-card invoice-card">
                                <div class="card-body">
                                    <div class="row gy-3">
                                        <div class="col-xl-12">
                                            <img src="<?php echo $this->Url->image('brand-logos/desktop-logo.png'); ?>" alt="" class="img-fluid desktop-logo">
                                            <img src="<?php echo $this->Url->image('brand-logos/desktop-dark.png'); ?>" alt="" class="img-fluid desktop-dark">
                                        </div>
                                        <div class="col-xl-12">
                                            <div class="row">
