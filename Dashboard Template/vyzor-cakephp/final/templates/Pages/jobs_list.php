                            ...
                            <div class="card custom-card overflow-hidden">
                                <div class="card-header justify-content-between">
                                    ...
                                    <div class="d-flex flex-wrap gap-2">
                                        <a href="<?= $this->Url->build('/job_post') ?>" class="btn btn-primary btn-wave">
                                                ...
                                                <tr class="joblist-list">
                                                    ...
                                                    <td>
                                                        <div class="d-flex align-items-center">
                                                            ...
                                                            <div class="ms-2">
                                                                <p class="fw-medium mb-0 d-flex align-items-center"><a href="<?= $this->Url->build('/job_details') ?>">Software Engineer</a></p>
                                                    ...
                                                    <td>
                                                        <a href="<?= $this->Url->build('/job_details') ?>" class="btn btn-icon btn-sm btn-primary-light btn-wave waves-effect waves-light">
                                                ...
                                                <tr class="joblist-list">
                                                    ...
                                                    <td>
                                                        <div class="d-flex align-items-center">
                                                            ...
                                                            <div class="ms-2">
                                                                <p class="fw-medium mb-0 d-flex align-items-center"><a href="<?= $this->Url->build('/job_details') ?>">Data Analyst</a></p>
                                                ...
                                                <tr class="joblist-list">
                                                    ...
                                                    <td>
                                                        <div class="d-flex align-items-center">
                                                            ...
                                                            <div class="ms-2">
                                                                <p class="fw-medium mb-0 d-flex align-items-center"><a href="<?= $this->Url->build('/job_details') ?>">Product Manager</a></p>
                                                ...
                                                <tr class="joblist-list">
                                                    ...
                                                    <td>
                                                        <div class="d-flex align-items-center">
                                                            ...
                                                            <div class="ms-2">
                                                                <p class="fw-medium mb-0 d-flex align-items-center"><a href="<?= $this->Url->build('/job_details') ?>">UI/UX Designer</a></p>
                                                ...
                                                <tr class="joblist-list">
                                                    ...
                                                    <td>
                                                        <div class="d-flex align-items-center">
                                                            ...
                                                            <div class="ms-2">
                                                                <p class="fw-medium mb-0 d-flex align-items-center"><a href="<?= $this->Url->build('/job_details') ?>">Marketing Specialist</a></p>
                                                ...
                                                <tr class="joblist-list">
                                                    ...
                                                    <td>
                                                        <div class="d-flex align-items-center">
                                                            ...
                                                            <div class="ms-2">
                                                                <p class="fw-medium mb-0 d-flex align-items-center"><a href="<?= $this->Url->build('/job_details') ?>">HR Manager</a></p>
                                                ...
                                                <tr class="joblist-list">
                                                    ...
                                                    <td>
                                                        <div class="d-flex align-items-center">
                                                            ...
                                                            <div class="ms-2">
                                                                <p class="fw-medium mb-0 d-flex align-items-center"><a href="<?= $this->Url->build('/job_details') ?>">Full Stack Developer</a></p>
                                                ...
                                                <tr class="joblist-list">
                                                    ...
                                                    <td>
                                                        <div class="d-flex align-items-center">
                                                            ...
                                                            <div class="ms-2">
                                                                <p class="fw-medium mb-0 d-flex align-items-center"><a href="<?= $this->Url->build('/job_details') ?>">Network Administrator</a></p>
                                                ...
                                                <tr class="joblist-list">
                                                    ...
                                                    <td>
                                                        <div class="d-flex align-items-center">
                                                            ...
                                                            <div class="ms-2">
                                                                <p class="fw-medium mb-0 d-flex align-items-center"><a href="<?= $this->Url->build('/job_details') ?>">Customer Support Lead</a></p>
                                                ...
                                                <tr class="joblist-list">
                                                    ...
                                                    <td>
                                                        <div class="d-flex align-items-center">
                                                            ...
                                                            <div class="ms-2">
                                                                <p class="fw-medium mb-0 d-flex align-items-center"><a href="<?= $this->Url->build('/job_details') ?>">Sales Manager</a></p>
                                                    ...
                                                    <td>
                                                        <div class="d-flex align-items-center">
                                                            <span class="avatar avatar-md me-1 avatar-rounded">
                                                                <img src="<?php echo $this->Url->image('company-logos/10.png'); ?>" alt="">
                                                            </span>
