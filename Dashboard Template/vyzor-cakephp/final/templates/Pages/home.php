                                    ...
                                    <div class="card custom-card shadow-none card-bg-primary overflow-hidden dashboard-banner-card">
                                        <div class="card-body">
                                            <div class="dashboard-banner-card-background">
                                                <img src="<?php echo $this->Url->image('media/backgrounds/8.png'); ?>" alt="">
                                            </div>
                                            ...
                                            <tbody>
                                                    ...
                                                    <td>
                                                        <div class="avatar-list-stacked">
                                                            <span class="avatar avatar-rounded avatar-sm bg-light">
                                                                <img src="<?php echo $this->Url->image('ecommerce/jpg/3.jpg'); ?>" alt="img">
                                                            </span>
                                                            <span class="avatar avatar-rounded avatar-sm bg-light">
                                                                <img src="<?php echo $this->Url->image('ecommerce/jpg/4.jpg'); ?>" alt="img">
                                                            </span>
                                                            <span class="avatar avatar-rounded avatar-sm bg-light">
                                                                <img src="<?php echo $this->Url->image('ecommerce/jpg/5.jpg'); ?>" alt="img">
                                                            </span>
                                                        </div>
                                                    </td>
                                                    <td>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <div class="avatar-list-stacked">
                                                            <span class="avatar avatar-rounded avatar-sm bg-light">
                                                                <img src="<?php echo $this->Url->image('ecommerce/jpg/1.jpg'); ?>" alt="img">
                                                            </span>
                                                            <span class="avatar avatar-rounded avatar-sm bg-light">
                                                                <img src="<?php echo $this->Url->image('ecommerce/jpg/2.jpg'); ?>" alt="img">
                                                            </span>
                                                        </div>
                                                    </td>
                                                    <td>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <div class="avatar-list-stacked">
                                                            ...
                                                            <span class="avatar avatar-rounded avatar-sm bg-light">
                                                                <img src="<?php echo $this->Url->image('ecommerce/jpg/6.jpg'); ?>" alt="img">
                                                            </span>
                                                        </div>
                                                    </td>
                                                    <td>
...
<?php $this->start('scripts'); ?>
        ...
        <!-- Sales Dashboard --> 
        <?= $this->Html->script(['sales-dashboard']) ?>
