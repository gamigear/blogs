                                ...
                                <div class="col-xl-12">
                                    <div class="card custom-card profile-card">
                                        <div class="profile-banner-image">
                                            <img src="<?php echo $this->Url->image('media/media-3.jpg'); ?>" class="card-img-top" alt="...">
                                        </div>
                                        <div class="card-body p-4 pb-0 position-relative">
                                            <div class="d-flex align-items-end justify-content-between flex-wrap">
                                                <div>
                                                    <span class="avatar avatar-xxl avatar-rounded bg-info online">
                                                        <img src="<?php echo $this->Url->image('faces/12.jpg'); ?>" alt="">
                                                    </span>
                                                    <div class="mt-4 mb-3 d-flex align-items-center flex-wrap gap-3 justify-content-between">
                                                        <div>
                                                            ...
                                                            <p class="fs-12 mb-0 fw-medium text-muted"> <span class="me-3"><i class="ri-building-line me-1 align-middle"></i>New York, USA</span> <span class="d-inline-flex"><i class="ri-phone-line me-1 align-middle"></i>+1 (123) 456-7890</span> </p>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div>
                                                ...
                                                <div class="col-xxl-8">
                                                    ...
                                                    <div class="card custom-card">
                                                        <div class="card-body">
                                                            ...
                                                            <div>
                                                                <img src="<?php echo $this->Url->image('media/media-23.jpg'); ?>" class="card-img" alt="...">
                                                            </div>
                                                        </div>
                                                            ...
                                                            <div class="d-flex align-items-center gap-2 flex-wrap">
                                                                <div class="avatar-list-stacked">
                                                                    <span class="avatar avatar-rounded">
                                                                        <img src="<?php echo $this->Url->image('faces/2.jpg'); ?>" alt="img">
                                                                    </span>
                                                                    <span class="avatar avatar-rounded">
                                                                        <img src="<?php echo $this->Url->image('faces/8.jpg'); ?>" alt="img">
                                                                    </span>
                                                                    <span class="avatar avatar-rounded">
                                                                        <img src="<?php echo $this->Url->image('faces/2.jpg'); ?>" alt="img">
                                                                    </span>
                                                                    <span class="avatar avatar-rounded">
                                                                        <img src="<?php echo $this->Url->image('faces/10.jpg'); ?>" alt="img">
                                                                    </span>
                                                                </div>
                                                                <div class="flex-fill">
                                                            ...
                                                            <ul class="list-unstyled post-comments-list">
                                                                    ...
                                                                    <div class="d-flex align-items-start gap-3">
                                                                        <div class="lh-1">
                                                                            <span class="avatar avatar-md avatar-rounded">
                                                                                <img src="<?php echo $this->Url->image('faces/4.jpg'); ?>" alt="">
                                                                            </span>
                                                                        </div>
                                                                ...
                                                                <li>
                                                                    <div class="d-flex align-items-start gap-3">
                                                                        <div class="lh-1">
                                                                            <span class="avatar avatar-md avatar-rounded">
                                                                                <img src="<?php echo $this->Url->image('faces/14.jpg'); ?>" alt="">
                                                                            </span>
                                                                        </div>
                                                                        <div class="flex-fill p-3 rounded bg-light">
                                                                            <div class="d-flex align-items-center justify-content-between flex-wrap">
                                                    ...
                                                    <div class="card custom-card">
                                                        ...
                                                        <div class="card-footer">
                                                            <div class="d-flex align-items-center gap-2 flex-wrap">
                                                                <div class="avatar-list-stacked">
                                                                    <span class="avatar avatar-rounded">
                                                                        <img src="<?php echo $this->Url->image('faces/12.jpg'); ?>" alt="img">
                                                                    </span>
                                                                    <span class="avatar avatar-rounded">
                                                                        <img src="<?php echo $this->Url->image('faces/3.jpg'); ?>" alt="img">
                                                                    </span>
                                                                    <span class="avatar avatar-rounded">
                                                                        <img src="<?php echo $this->Url->image('faces/15.jpg'); ?>" alt="img">
                                                                    </span>
                                                                </div>
                                                                <div class="flex-fill">
                                                    ...
                                                    <div class="card custom-card">
                                                        <div class="card-body">
                                                            ...
                                                            <div>
                                                                <img src="<?php echo $this->Url->image('media/media-10.jpg'); ?>" class="card-img" alt="...">
                                                            </div>
                                                        </div>
                                                        <div class="card-footer">
                                                            <div class="d-flex align-items-center gap-2 flex-wrap">
                                                                <div class="avatar-list-stacked">
                                                                    <span class="avatar avatar-rounded">
                                                                        <img src="<?php echo $this->Url->image('faces/13.jpg'); ?>" alt="img">
                                                                    </span>
                                                                    <span class="avatar avatar-rounded">
                                                                        <img src="<?php echo $this->Url->image('faces/3.jpg'); ?>" alt="img">
                                                                    </span>
                                                                    <span class="avatar avatar-rounded">
                                                                        <img src="<?php echo $this->Url->image('faces/4.jpg'); ?>" alt="img">
                                                                    </span>
                                                                    <span class="avatar avatar-rounded">
                                                                        <img src="<?php echo $this->Url->image('faces/14.jpg'); ?>" alt="img">
                                                                    </span>
                                                                    <span class="avatar avatar-rounded">
                                                                        <img src="<?php echo $this->Url->image('faces/5.jpg'); ?>" alt="img">
                                                                    </span>
                                                                </div>
                                                                <div class="flex-fill">
                                                            ...
                                                            <ul class="list-unstyled post-comments-list">
                                                                <li>
                                                                    <div class="d-flex align-items-start gap-3">
                                                                        <div class="lh-1">
                                                                            <span class="avatar avatar-md avatar-rounded">
                                                                                <img src="<?php echo $this->Url->image('faces/6.jpg'); ?>" alt="">
                                                                            </span>
                                                                        </div>
                                                                        <div class="flex-fill p-3 rounded bg-light">
                                                                            <div class="d-flex align-items-center justify-content-between flex-wrap">
                                                        ...
                                                        <div class="card-body">
                                                            <div class="row gy-4">
                                                                <div class="col-xxl-3 col-xl-3 col-lg-3 col-md-6 col-sm-12">
                                                                    <a href="<?php echo $this->Url->image('media/media-40.jpg'); ?>" class="glightbox" data-gallery="gallery1">
                                                                        <img src="<?php echo $this->Url->image('media/media-40.jpg'); ?>" alt="image" class="img-fluid rounded">
                                                                    </a>
                                                                </div>
                                                                <div class="col-xxl-3 col-xl-3 col-lg-3 col-md-6 col-sm-12">
                                                                    <a href="<?php echo $this->Url->image('media/media-41.jpg'); ?>" class="glightbox" data-gallery="gallery1">
                                                                        <img src="<?php echo $this->Url->image('media/media-41.jpg'); ?>" alt="image" class="img-fluid rounded">
                                                                    </a>
                                                                </div>
                                                                <div class="col-xxl-3 col-xl-3 col-lg-3 col-md-6 col-sm-12">
                                                                    <a href="<?php echo $this->Url->image('media/media-42.jpg'); ?>" class="glightbox" data-gallery="gallery1">
                                                                        <img src="<?php echo $this->Url->image('media/media-42.jpg'); ?>" alt="image" class="img-fluid rounded">
                                                                    </a>
                                                                </div>
                                                                <div class="col-xxl-3 col-xl-3 col-lg-3 col-md-6 col-sm-12">
                                                                    <a href="<?php echo $this->Url->image('media/media-43.jpg'); ?>" class="glightbox" data-gallery="gallery1">
                                                                        <img src="<?php echo $this->Url->image('media/media-43.jpg'); ?>" alt="image" class="img-fluid rounded">
                                                                    </a>
                                                                </div>
                                                                <div class="col-xxl-3 col-xl-3 col-lg-3 col-md-6 col-sm-12">
                                                                    <a href="<?php echo $this->Url->image('media/media-44.jpg'); ?>" class="glightbox" data-gallery="gallery1">
                                                                        <img src="<?php echo $this->Url->image('media/media-44.jpg'); ?>" alt="image" class="img-fluid rounded">
                                                                    </a>
                                                                </div>
                                                                <div class="col-xxl-3 col-xl-3 col-lg-3 col-md-6 col-sm-12">
                                                                    <a href="<?php echo $this->Url->image('media/media-45.jpg'); ?>" class="glightbox" data-gallery="gallery1">
                                                                        <img src="<?php echo $this->Url->image('media/media-45.jpg'); ?>" alt="image" class="img-fluid rounded">
                                                                    </a>
                                                                </div>
                                                                <div class="col-xxl-3 col-xl-3 col-lg-3 col-md-6 col-sm-12">
                                                                    <a href="<?php echo $this->Url->image('media/media-46.jpg'); ?>" class="glightbox" data-gallery="gallery1">
                                                                        <img src="<?php echo $this->Url->image('media/media-46.jpg'); ?>" alt="image" class="img-fluid rounded">
                                                                    </a>
                                                                </div>
                                                                <div class="col-xxl-3 col-xl-3 col-lg-3 col-md-6 col-sm-12">
                                                                    <a href="<?php echo $this->Url->image('media/media-60.jpg'); ?>" class="glightbox" data-gallery="gallery1">
                                                                        <img src="<?php echo $this->Url->image('media/media-60.jpg'); ?>" alt="image" class="img-fluid rounded">
                                                                    </a>
                                                                </div>
                                                                <div class="col-xxl-3 col-xl-3 col-lg-3 col-md-6 col-sm-12">
                                                                    <a href="<?php echo $this->Url->image('media/media-26.jpg'); ?>" class="glightbox" data-gallery="gallery1">
                                                                        <img src="<?php echo $this->Url->image('media/media-26.jpg'); ?>" alt="image" class="img-fluid rounded">
                                                                    </a>
                                                                </div>
                                                                <div class="col-xxl-3 col-xl-3 col-lg-3 col-md-6 col-sm-12">
                                                                    <a href="<?php echo $this->Url->image('media/media-32.jpg'); ?>" class="glightbox" data-gallery="gallery1">
                                                                        <img src="<?php echo $this->Url->image('media/media-32.jpg'); ?>" alt="image" class="img-fluid rounded">
                                                                    </a>
                                                                </div>
                                                                <div class="col-xxl-3 col-xl-3 col-lg-3 col-md-6 col-sm-12">
                                                                    <a href="<?php echo $this->Url->image('media/media-30.jpg'); ?>" class="glightbox" data-gallery="gallery1">
                                                                        <img src="<?php echo $this->Url->image('media/media-30.jpg'); ?>" alt="image" class="img-fluid rounded">
                                                                    </a>
                                                                </div>
                                                                <div class="col-xxl-3 col-xl-3 col-lg-3 col-md-6 col-sm-12">
                                                                    <a href="<?php echo $this->Url->image('media/media-31.jpg'); ?>" class="glightbox" data-gallery="gallery1">
                                                                        <img src="<?php echo $this->Url->image('media/media-31.jpg'); ?>" alt="image" class="img-fluid rounded">
                                                                    </a>
                                                                </div>
                                                                <div class="col-xxl-3 col-xl-3 col-lg-3 col-md-6 col-sm-12">
                                                                    <a href="<?php echo $this->Url->image('media/media-46.jpg'); ?>" class="glightbox" data-gallery="gallery1">
                                                                ...
                                                                <div class="col-xxl-3 col-xl-3 col-lg-3 col-md-6 col-sm-12">
                                                                    <a href="<?php echo $this->Url->image('media/media-59.jpg'); ?>" class="glightbox" data-gallery="gallery1">
                                                                        <img src="<?php echo $this->Url->image('media/media-59.jpg'); ?>" alt="image" class="img-fluid rounded">
                                                                    </a>
                                                                </div>
                                                                <div class="col-xxl-3 col-xl-3 col-lg-3 col-md-6 col-sm-12">
                                                                    <a href="<?php echo $this->Url->image('media/media-61.jpg'); ?>" class="glightbox" data-gallery="gallery1">
                                                                        <img src="<?php echo $this->Url->image('media/media-61.jpg'); ?>" alt="image" class="img-fluid rounded">
                                                                    </a>
                                                                </div>
                                                                <div class="col-xxl-3 col-xl-3 col-lg-3 col-md-6 col-sm-12">
                                                                    <a href="<?php echo $this->Url->image('media/media-42.jpg'); ?>" class="glightbox" data-gallery="gallery1">
                                                            ...
                                                            <div class="d-flex align-items-center gap-2 flex-wrap">
                                                                <div class="lh-1">
                                                                    <span class="avatar avatar-lg avatar-rounded">
                                                                        <img src="<?php echo $this->Url->image('faces/9.jpg'); ?>" alt="">
                                                                    </span>
                                                                </div>
                                                                <div class="flex-fill">
                                                    ...
                                                    <div class="card custom-card">
                                                        <div class="card-body">
                                                            <div class="d-flex align-items-center gap-2 flex-wrap">
                                                                <div class="lh-1">
                                                                    <span class="avatar avatar-lg avatar-rounded">
                                                                        <img src="<?php echo $this->Url->image('faces/1.jpg'); ?>" alt="">
                                                                    </span>
                                                                </div>
                                                                <div class="flex-fill">
                                                    ...
                                                    <div class="card custom-card">
                                                        <div class="card-body">
                                                            <div class="d-flex align-items-center gap-2 flex-wrap">
                                                                <div class="lh-1">
                                                                    <span class="avatar avatar-lg avatar-rounded">
                                                                        <img src="<?php echo $this->Url->image('faces/2.jpg'); ?>" alt="">
                                                                    </span>
                                                                </div>
                                                                <div class="flex-fill">
                                                    ...
                                                    <div class="card custom-card">
                                                        <div class="card-body">
                                                            <div class="d-flex align-items-center gap-2 flex-wrap">
                                                                <div class="lh-1">
                                                                    <span class="avatar avatar-lg avatar-rounded">
                                                                        <img src="<?php echo $this->Url->image('faces/11.jpg'); ?>" alt="">
                                                                    </span>
                                                                </div>
                                                                <div class="flex-fill">
                                                    ...
                                                    <div class="card custom-card">
                                                        <div class="card-body">
                                                            <div class="d-flex align-items-center gap-2 flex-wrap">
                                                                <div class="lh-1">
                                                                    <span class="avatar avatar-lg avatar-rounded">
                                                                        <img src="<?php echo $this->Url->image('faces/3.jpg'); ?>" alt="">
                                                                    </span>
                                                                </div>
                                                                <div class="flex-fill">
                                                    ...
                                                    <div class="card custom-card">
                                                        <div class="card-body">
                                                            <div class="d-flex align-items-center gap-2 flex-wrap">
                                                                <div class="lh-1">
                                                                    <span class="avatar avatar-lg avatar-rounded">
                                                                        <img src="<?php echo $this->Url->image('faces/13.jpg'); ?>" alt="">
                                                                    </span>
                                                                </div>
                                                                <div class="flex-fill">
                                                    ...
                                                    <div class="card custom-card">
                                                        <div class="card-body">
                                                            <div class="d-flex align-items-center gap-2 flex-wrap">
                                                                <div class="lh-1">
                                                                    <span class="avatar avatar-lg avatar-rounded">
                                                                        <img src="<?php echo $this->Url->image('faces/5.jpg'); ?>" alt="">
                                                                    </span>
                                                                </div>
                                                                <div class="flex-fill">
                                                    ...
                                                    <div class="card custom-card">
                                                        <div class="card-body">
                                                            <div class="d-flex align-items-center gap-2 flex-wrap">
                                                                <div class="lh-1">
                                                                    <span class="avatar avatar-lg avatar-rounded">
                                                                        <img src="<?php echo $this->Url->image('faces/15.jpg'); ?>" alt="">
                                                                    </span>
                                                                </div>
                                                                <div class="flex-fill">
                                                    ...
                                                    <div class="card custom-card">
                                                        <div class="card-body">
                                                            <div class="d-flex align-items-center gap-2 flex-wrap">
                                                                <div class="lh-1">
                                                                    <span class="avatar avatar-lg avatar-rounded">
                                                                        <img src="<?php echo $this->Url->image('faces/16.jpg'); ?>" alt="">
                                                                    </span>
                                                                </div>
                                                                <div class="flex-fill">
                                                    ...
                                                    <div class="card custom-card">
                                                        <div class="card-body">
                                                            <div class="d-flex align-items-center gap-2 flex-wrap">
                                                                <div class="lh-1">
                                                                    <span class="avatar avatar-lg avatar-rounded">
                                                                        <img src="<?php echo $this->Url->image('faces/7.jpg'); ?>" alt="">
                                                                    </span>
                                                                </div>
                                                                <div class="flex-fill">
                                                    ...
                                                    <div class="card custom-card">
                                                        <div class="card-body">
                                                            <div class="d-flex align-items-center gap-2 flex-wrap">
                                                                <div class="lh-1">
                                                                    <span class="avatar avatar-lg avatar-rounded">
                                                                        <img src="<?php echo $this->Url->image('faces/8.jpg'); ?>" alt="">
                                                                    </span>
                                                                </div>
                                                                <div class="flex-fill">
