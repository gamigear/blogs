                                        ...
                                        <div class="d-flex flex-wrap gap-2 w-75">
                                            <div>
                                                <span class="avatar avatar-xxl">
                                                    <img src="<?php echo $this->Url->image('faces/13.jpg'); ?>" class="img-fluid" alt="">
                                                </span>
                                            </div>    
                                            <div class="ms-3 w-75">
                                                    ...
                                                    <div class="card custom-card">
                                                        <div class="card-body">
                                                            <div class="d-flex align-items-start gap-3 mb-4 flex-wrap">
                                                                ...
                                                                <a href="javascript:void(0);" class="btn btn-primary-light"><i class="ti ti-eye me-1 align-middle d-inline-flex"></i>View</a>
                                                            </div>
...
<?php $this->start('scripts'); ?>
        ...
        <?= $this->Html->script(['job-candidate-details']) ?>
