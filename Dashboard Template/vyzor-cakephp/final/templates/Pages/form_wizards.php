                                                                                        ...
                                                                                        <div class="d-sm-flex d-block align-items-center justify-content-between">
                                                                                            <div class="me-2 lh-1">
                                                                                                <span class="avatar avatar-md">
                                                                                                    <img src="<?php echo $this->Url->image('ecommerce/png/18.png'); ?>" alt="">
                                                                                                </span>
                                                                                            </div>
                                                                                ...
                                                                                <div class="col-xl-6">
                                                                                    <div class="form-check payment-card-container mb-0 lh-1">
                                                                                        ...
                                                                                        <div class="d-sm-flex d-block align-items-center justify-content-between">
                                                                                            <div class="me-2 lh-1">
                                                                                                <span class="avatar avatar-md">
                                                                                                    <img src="<?php echo $this->Url->image('ecommerce/png/20.png'); ?>" alt="">
                                                                                                </span>
                                                                                            </div>
                                                                                            <div class="saved-card-details pe-5">
                                                ...
                                                <div class="row">
                                                    <div class="col-xl-12">
                                                        <div class="checkout-payment-success text-center">
                                                            ...
                                                            <div class="mb-4">
                                                                <img src="<?php echo $this->Url->image('ecommerce/png/17.png'); ?>" alt="" class="img-fluid">
                                                            </div>
                                                            <div class="mb-4">
                                                        ...
                                                        <div class="text-center p-4">
                                                            ...
                                                            <div class="mb-0">
                                                                <div class="form-check d-inline-block">
                                                                    <input class="form-check-input" id="customCheck1" required="" type="checkbox"> <label class="form-check-label" for="customCheck1">I agree with the <a class="fw-medium text-decoration-underline" href="<?= $this->Url->build('/terms_conditions') ?>">Terms and Conditions.</a></label>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div><!-- end col -->
                                                ...
                                                <div class="row d-flex justify-content-center">
                                                    <div class="col-lg-10">
                                                        <div class="text-center p-4">
                                                            ...
                                                            <div class="mb-0">
                                                                <div class="form-check d-inline-block">
                                                                    <input class="form-check-input" id="customCheck2" required="" type="checkbox"> <label class="form-check-label" for="customCheck2">I agree with the <a class="fw-medium text-decoration-underline" href="<?= $this->Url->build('/terms_conditions') ?>">Terms and Conditions.</a></label>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div><!-- end col -->
...
<?php $this->start('scripts'); ?>
        ...
        <!-- Vanilla-Wizard JS -->
        <script src="libs/vanilla-wizard/js/wizard.min.js"></script>

        <!-- Internal Form Wizard JS -->
        <?= $this->Html->script(['form-wizard']) ?>
        <?= $this->Html->script(['form-wizard-init']) ?>
