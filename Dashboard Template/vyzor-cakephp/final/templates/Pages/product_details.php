                                        ...
                                        <div class="row g-5">
                                                ...
                                                <div class="swiper swiper-preview-details bg-light product-details-page">
                                                    <div class="swiper-wrapper">
                                                        <div class="swiper-slide" id="img-container">
                                                            <img class="img-fluid" src="<?php echo $this->Url->image('ecommerce/jpg/4.jpg'); ?>" alt="img">
                                                        </div>
                                                        <div class="swiper-slide image-container">
                                                            <img class="img-fluid" src="<?php echo $this->Url->image('ecommerce/jpg/2.jpg'); ?>" alt="img">
                                                        </div>
                                                        <div class="swiper-slide image-container">
                                                            <img class="img-fluid" src="<?php echo $this->Url->image('ecommerce/jpg/3.jpg'); ?>" alt="img">
                                                        </div>
                                                        <div class="swiper-slide image-container">
                                                            <img class="img-fluid" src="<?php echo $this->Url->image('ecommerce/jpg/1.jpg'); ?>" alt="img">
                                                        </div>
                                                        <div class="swiper-slide image-container">
                                                            <img class="img-fluid" src="<?php echo $this->Url->image('ecommerce/jpg/5.jpg'); ?>" alt="img">
                                                        </div>
                                                        <div class="swiper-slide image-container">
                                                            <img class="img-fluid" src="<?php echo $this->Url->image('ecommerce/jpg/6.jpg'); ?>" alt="img">
                                                        </div>
                                                    </div>
                                            ...
                                            <div class="col-xl-6">
                                                ...
                                                <div class="d-flex align-items-center justify-content-center gap-2 mt-5 flex-wrap">
                                                    <a href="<?= $this->Url->build('/cart') ?>" class="btn btn-primary btn-lg btn-w-lg border"><i class="ti ti-shopping-cart me-1 d-inline-flex"></i>Add To Cart</a>
                                                    <a href="<?= $this->Url->build('/checkout') ?>" class="btn btn-primary btn-lg btn-w-lg border">Buy Now</a>
                                                </div>
                                            </div>
                                                                        ...
                                                                        <div class="col-xl-6">
                                                                            <div class="products-review-images">
                                                                                <a href="javascript:void(0);">
                                                                                    <img src="<?php echo $this->Url->image('ecommerce/jpg/1.jpg'); ?>" alt="">
                                                                                </a>
                                                                                <a href="javascript:void(0);">
                                                                                    <img src="<?php echo $this->Url->image('ecommerce/jpg/2.jpg'); ?>" alt="">
                                                                                </a>
                                                                            </div>
                                                                        </div>
...
<?php $this->start('scripts'); ?>
        ...
        <?= $this->Html->script(['product-details']) ?>
