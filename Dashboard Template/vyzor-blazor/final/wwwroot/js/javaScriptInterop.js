window.interop = {
  ...
  applyPageStyleClass: function () {
        const pageStyle = document.documentElement.getAttribute("data-page-style");
        const mainContainer = document.getElementById("MainLayoutContainer");

        if (mainContainer) {
            if (pageStyle === "flat") {
                // Add all required classes for 'flat' style
                mainContainer.classList.add("main-body-container");
            } else {
                // For 'classic', 'regular', 'modern', or any other style,
                // ensure 'main-body-container' is removed and 'container-fluid' and 'page-container' are present.
                mainContainer.classList.remove("main-body-container");
            }
        }
  }
