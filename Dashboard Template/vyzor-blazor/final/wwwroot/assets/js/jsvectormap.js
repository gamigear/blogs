(function () {
    ...
    function loadMapScript(mapName, callback) {
        const script = document.createElement("script");
        script.src = `assets/js/${mapName}.js`;
    ...
    function initLineMap() {
        ...
        new jsVectorMap({
            ...
            labels: {
                markers: {
                    render: marker => marker.name,
                    offsets: (index) => markers[index].offsets || [0, 0]
                },
            },
            markers,
            lines,
    ...
    function loadCanadaMapAndInit() {
        loadMapScript("canada", function () {
            new jsVectorMap({
                selector: "#canada-map",
                map: "canada",
                regionStyle: {
    ...
    function loadUSMapAndInit() {
        loadMapScript("us-merc-en", function () {
            new jsVectorMap({
                selector: "#us-map",
                map: "us_merc_en",
                regionStyle: {
    ...
    function loadRussiaMapAndInit() {
        loadMapScript("russia", function () {
            new jsVectorMap({
                selector: "#russia-map",
                map: "russia",
                regionStyle: {
    ...
    function loadSpainMapAndInit() {
        loadMapScript("spain", function () {
            new jsVectorMap({
                selector: "#spain-map",
                map: "spain",
                regionStyle: {
    ...
    initImageMarkerMap();
    initLineMap();
    loadCanadaMapAndInit();
    loadUSMapAndInit();
    loadRussiaMapAndInit();
    loadSpainMapAndInit();
