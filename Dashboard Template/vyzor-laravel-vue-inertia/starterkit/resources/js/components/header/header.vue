            ...
            <ul class="header-content-right">
                ...
                <li class="header-element cart-dropdown dropdown">
                    ...
                    <a href="javascript:void(0);" class="header-link dropdown-toggle" data-bs-auto-close="outside"
                        ...
                        <span class="badge bg-primary rounded-pill header-icon-badge" id="cart-icon-badge">{{ notificationNotes.length }}</span>
                    </a>
                    <!-- End::header-link|dropdown-toggle -->
                    ...
                    <div class="main-header-dropdown dropdown-menu dropdown-menu-end" data-popper-placement="none">
                            ...
                            <div class="d-flex align-items-center justify-content-between">
                                ...
                                <Link href="`#!`"
                                    class="text-fixed-white text-decoration-underline fs-12">Continue Shopping <i
                                        class="ti ti-arrow-narrow-right"></i></Link>
                            </div>
                        </div>
                                            ...
                                            <div class="d-flex align-items-center justify-content-between">
                                                ...
                                                <div
                                                    ...
                                                    <input type="text"
                                                        ...
                                                        aria-label="quantity" id="product-qty-1" :value="item.quantity">
                        ...
                        <div class="p-3 empty-header-item border-top position-relative z-2" v-if="notificationNotes.length">
                            <div class="text-center d-grid">
                                <Link href="#!" class="btn btn-primary btn-wave">
                                    Proceed to
                                    checkout</Link>
                            </div>
                        </div>
            ...
            <div class="modal-content">
                <div class="modal-body">
                    <div class="input-group">
                        ...
                        <template v-if="showSuggestions">
                            <div className="custom-card card w-100 search-result position-absolute z-index-9 search-fix border mt-15 rounded-1">
...
import { Languages, Notifications, notificationNotes as initialNotificationNotes } from '@/shared/data/header.js';
