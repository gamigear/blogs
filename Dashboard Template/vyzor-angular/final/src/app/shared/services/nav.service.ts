...
export class NavService implements OnDestroy {
  ...
  constructor(private router: Router) {
      ...
      { headTitle:'MAIN'},
      {
        ...
        children: [
          ...
          },
          {
            title: 'Ecommerce',
            dirchange: false,
            subIcon: `<svg xmlns="http://www.w3.org/2000/svg" class="side-menu-doublemenu__icon" width="32" height="32" viewBox="0 0 256 256"><path d="M224,56V200a8,8,0,0,1-8,8H40a8,8,0,0,1-8-8V56a8,8,0,0,1,8-8H216A8,8,0,0,1,224,56Z" opacity="0.2"></path><path d="M216,40H40A16,16,0,0,0,24,56V200a16,16,0,0,0,16,16H216a16,16,0,0,0,16-16V56A16,16,0,0,0,216,40Zm0,160H40V56H216V200ZM176,88a48,48,0,0,1-96,0,8,8,0,0,1,16,0,32,32,0,0,0,64,0,8,8,0,0,1,16,0Z"></path></svg>`,
            type: 'sub',
            ...
            children: [
              ...
              },
              {
                ...
                active: false,
                selected: false,
                path: '/dashboards/ecommerce/productdetails',
              },
              {
                title: 'Cart',
                dirchange: false,
              ...
              },
              {
                ...
                active: false,
                selected: false,
                path: '/dashboards/ecommerce/addproduct',
              },
            ],
          },
          {
            ...
            children: [
              ...
              },
              {
                ...
                active: false,
                selected: false,
                path: '/dashboards/crypto/marketcap',
              },
              {
                title: 'Wallet',
                dirchange: false,
          ...
          },
          {
            title: 'Courses',
            dirchange: false,
            subIcon: `<svg xmlns="http://www.w3.org/2000/svg" class="side-menu-doublemenu__icon" viewBox="0 0 256 256"><rect width="256" height="256" fill="none"></rect><path d="M48,216a24,24,0,0,1,24-24H208V32H72A24,24,0,0,0,48,56Z" opacity="0.2"></path><path d="M48,216a24,24,0,0,1,24-24H208V32H72A24,24,0,0,0,48,56Z" fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="16"></path><polyline points="48 216 48 224 192 224" fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="16"></polyline></svg>`,
            type: 'link',
            active: false,
            selected: false,
          ...
          },
          {
            title: 'Stocks',
            dirchange: false,
            subIcon: `<svg xmlns="http://www.w3.org/2000/svg" class="side-menu-doublemenu__icon" viewBox="0 0 256 256"><rect width="256" height="256" fill="none"></rect><path d="M32,48H208a16,16,0,0,1,16,16V208a0,0,0,0,1,0,0H32a0,0,0,0,1,0,0V48A0,0,0,0,1,32,48Z" opacity="0.2"></path><polyline points="224 208 32 208 32 48" fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="16"></polyline><polyline points="224 96 160 152 96 104 32 160" fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="16"></polyline></svg>`,
            type: 'link',
            active: false,
            selected: false,
          ...
          },
          {
            title: 'Podcast',
            dirchange: false,
            subIcon: `<svg xmlns="http://www.w3.org/2000/svg" class="side-menu-doublemenu__icon" viewBox="0 0 256 256"><rect width="256" height="256" fill="none"></rect><rect x="88" y="24" width="80" height="144" rx="40" opacity="0.2"></rect><rect x="88" y="24" width="80" height="144" rx="40" fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="16"></rect><line x1="128" y1="200" x2="128" y2="240" fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="16"></line><path d="M200,128a72,72,0,0,1-144,0" fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="16"></path></svg>`,
            type: 'link',
            active: false,
            selected: false,
          ...
          },
          {
            title: 'Social Media',
            dirchange: false,
            subIcon: `<svg xmlns="http://www.w3.org/2000/svg" class="side-menu-doublemenu__icon" viewBox="0 0 256 256"><rect width="256" height="256" fill="none"></rect><path d="M163.94,80.11h0A71.83,71.83,0,0,1,168,104h0a72,72,0,0,1-72,72H92.1A72,72,0,0,0,160,224h64a8,8,0,0,0,8-8V152A72,72,0,0,0,163.94,80.11Z" opacity="0.2"></path><path d="M96,176H32a8,8,0,0,1-8-8V104A72,72,0,0,1,96,32h0a72,72,0,0,1,72,72h0A72,72,0,0,1,96,176Z" fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="16"></path><path d="M92.1,176A72,72,0,0,0,160,224h64a8,8,0,0,0,8-8V152a72,72,0,0,0-68.06-71.89" fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="16"></path></svg>`,
            type: 'link',
            active: false,
            selected: false,
          ...
          },
          {
            title: 'Medical',
            dirchange: false,
            subIcon: `<svg xmlns="http://www.w3.org/2000/svg" class="side-menu-doublemenu__icon" viewBox="0 0 256 256"><rect width="256" height="256" fill="none"></rect><polygon points="56 128 96 40 160 208 200 128 56 128" opacity="0.2"></polygon><polyline points="24 128 56 128 96 40 160 208 200 128 232 128" fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="16"></polyline></svg>`,
            type: 'link',
            active: false,
            selected: false,
      ...
      { headTitle:'Web Apps'},
      {
         ...
         children:[
          ...
          { path: '/applications/gallery',
            subIcon: `<svg xmlns="http://www.w3.org/2000/svg" class="side-menu-doublemenu__icon" viewBox="0 0 256 256"><rect width="256" height="256" fill="none"></rect><path d="M64,128.69l38.34-38.35a8,8,0,0,1,11.32,0L163.31,140,189,114.34a8,8,0,0,1,11.31,0L224,138.06V56a8,8,0,0,0-8-8H72a8,8,0,0,0-8,8Z" opacity="0.2"></path><rect x="64" y="48" width="160" height="128" rx="8" fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="16"></rect><circle cx="172" cy="84" r="12"></circle><path d="M64,128.69l38.34-38.35a8,8,0,0,1,11.32,0L163.31,140,189,114.34a8,8,0,0,1,11.31,0L224,138.06" fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="16"></path><path d="M192,176v24a8,8,0,0,1-8,8H40a8,8,0,0,1-8-8V88a8,8,0,0,1,8-8H64" fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="16"></path></svg>`,
            dirchange: false,  selected: false, title: 'Gallery', type: 'link' },
          { path: '/applications/sweet-alerts',
            subIcon: `<svg xmlns="http://www.w3.org/2000/svg" class="side-menu-doublemenu__icon" viewBox="0 0 256 256"><rect width="256" height="256" fill="none"></rect><rect x="52.13" y="52.13" width="151.73" height="151.73" rx="7.95" transform="translate(-53.02 128) rotate(-45)" opacity="0.2"></rect><line x1="128" y1="136" x2="128" y2="80" fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="16"></line><circle cx="128" cy="172" r="12"></circle><rect x="52.13" y="52.13" width="151.73" height="151.73" rx="7.95" transform="translate(-53.02 128) rotate(-45)" fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="16"></rect></svg>`,
            dirchange: false,  selected: false, title: 'Sweet Alerts', type: 'link' },
          {
            title: 'Task',
            dirchange: false,
       ...
       children: [
        {
          ...
          subIcon: `<svg xmlns="http://www.w3.org/2000/svg" class="side-menu-doublemenu__icon" viewBox="0 0 256 256"><rect width="256" height="256" fill="none"></rect><path d="M128,128V48H48a8,8,0,0,0-8,8v56a146.29,146.29,0,0,0,.87,16Z" opacity="0.2"></path><path d="M128,128V232s78.06-21.3,87.13-104Z" opacity="0.2"></path><path d="M216,112V56a8,8,0,0,0-8-8H48a8,8,0,0,0-8,8v56c0,96,88,120,88,120S216,208,216,112Z" fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="16"></path><line x1="128" y1="232" x2="128" y2="48" fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="16"></line><line x1="40.86" y1="128" x2="215.14" y2="128" fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="16"></line></svg>`,
          dirchange: false,
          type: 'sub',
          active: false,
          selected: false,
          children: [
            {
              ...
              active: false,
              selected: false,
              path: '/pages/authentication/coming-soon',
            },
            {
              ...
              children: [
                {
                  ...
                  active: false,
                  selected: false,
                  path: '/pages/authentication/create-password/basic',
                },
                {
                  title: 'Cover',
                  dirchange: false,
                  ...
                  active: false,
                  selected: false,
                  path: '/pages/authentication/create-password/cover',
                },
              ],
            },
            {
              ...
              children: [
                {
                  ...
                  active: false,
                  selected: false,
                  path: '/pages/authentication/lock-screen/basic',
                },
                {
                  title: 'Cover',
                  dirchange: false,
                  ...
                  active: false,
                  selected: false,
                  path: '/pages/authentication/lock-screen/cover',
                },
              ],
            },
            {
              ...
              children: [
                {
                  ...
                  active: false,
                  selected: false,
                  path: '/pages/authentication/reset-password/basic',
                },
                {
                  title: 'Cover',
                  dirchange: false,
                  ...
                  active: false,
                  selected: false,
                  path: '/pages/authentication/reset-password/cover',
                },
              ],
            },
              ...
              children: [
                {
                  ...
                  active: false,
                  selected: false,
                  path: '/pages/authentication/sign-up/basic',
                },
                {
                  title: 'Cover',
                  dirchange: false,
                  ...
                  active: false,
                  selected: false,
                  path: '/pages/authentication/sign-up/cover',
                },
              ],
            },
            {
              ...
              children: [
                {
                  ...
                  active: false,
                  selected: false,
                  path: '/pages/authentication/sign-in/basic',
                },
                {
                  title: 'Cover',
                  dirchange: false,
                  ...
                  active: false,
                  selected: false,
                  path: '/pages/authentication/sign-in/cover',
                },
              ],
            },
            {
              ...
              children: [
                {
                  ...
                  active: false,
                  selected: false,
                  path: '/pages/authentication/two-step-verification/basic',
                },
                {
                  title: 'Cover',
                  dirchange: false,
                  ...
                  active: false,
                  selected: false,
                  path: '/pages/authentication/two-step-verification/cover',
                },
              ],
            },
            {
              ...
              active: false,
              selected: false,
              path: '/pages/authentication/under-maintanace',
            },
          ],
        },
        {
          ...
          {	 dirchange: false, title: 'Blog',
            subIcon:`<svg xmlns="http://www.w3.org/2000/svg" class="side-menu-doublemenu__icon" viewBox="0 0 256 256"><rect width="256" height="256" fill="none"></rect><path d="M32,96H224V56a8,8,0,0,0-8-8H40a8,8,0,0,0-8,8Z" opacity="0.2"></path><rect x="32" y="48" width="192" height="160" rx="8" fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="16"></rect><line x1="32" y1="96" x2="224" y2="96" fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="16"></line></svg>`,
             type: 'sub', Menusub: true,
            active: false, children: [
           { path: '/pages/blog/blog',  dirchange: false,  selected: false, title: 'Blog', type: 'link' },
           { path: '/pages/blog/blogdetails',  dirchange: false,  selected: false, title: 'Blog Details', type: 'link' },
           { path: '/pages/blog/create-blog',  dirchange: false,  selected: false, title: 'Create Blog', type: 'link' },
         ]},
         { path: '/pages/empty-page',
          ...
          dirchange: false,  selected: false, title: 'Empty', type: 'link' },
         {
          title: 'Forms',
          subIcon: `<svg xmlns="http://www.w3.org/2000/svg" class="side-menu-doublemenu__icon" viewBox="0 0 256 256"><rect width="256" height="256" fill="none"></rect><polygon points="152 32 152 88 208 88 152 32" opacity="0.2"></polygon><path d="M200,224H56a8,8,0,0,1-8-8V40a8,8,0,0,1,8-8h96l56,56V216A8,8,0,0,1,200,224Z" fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="16"></path><polyline points="152 32 152 88 208 88" fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="16"></polyline><line x1="96" y1="136" x2="160" y2="136" fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="16"></line><line x1="96" y1="168" x2="160" y2="168" fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="16"></line></svg>`,
          type: 'sub',
          dirchange: false,
          active: false,
          children: [
            {
              path: '/pages/form/form-advanced',
              title: 'Form Advanced',
              type: 'link',
              dirchange: false,  selected: false,
              active: false,
            },
            {
              title: 'Form Elements',
              ...
              children: [
                {
                  path: '/pages/form/form-elements/inputs',
                  title: 'Inputs',
                  type: 'link',
                  dirchange: false,  selected: false,
                  active: false,
                ...
                {
                  path: '/pages/form/form-elements/checks-radios',
                  title: 'Checks & Radios',
                  type: 'link',
                  dirchange: false,  selected: false,
                  active: false,
                ...
                {
                  path: '/pages/form/form-elements/input-group',
                  title: 'Input Group',
                  type: 'link',
                  dirchange: false,  selected: false,
                  active: false,
                ...
                {
                  path: '/pages/form/form-elements/form-select',
                  title: 'Form Select',
                  type: 'link',
                  dirchange: false,  selected: false,
                  active: false,
                ...
                {
                  path: '/pages/form/form-elements/range-slider',
                  title: 'Range Slider',
                  type: 'link',
                  dirchange: false,  selected: false,
                  active: false,
                ...
                {
                  path: '/pages/form/form-elements/input-masks',
                  title: 'Input Masks',
                  type: 'link',
                  dirchange: false,  selected: false,
                  active: false,
                ...
                {
                  path: '/pages/form/form-elements/file-uploads',
                  title: 'File Uploads',
                  type: 'link',
                  dirchange: false,  selected: false,
                  active: false,
                ...
                {
                  path: '/pages/form/form-elements/datetimepicker',
                ...
                {
                  path: '/pages/form/form-elements/colorpicker',
                  title: 'Color Pickers',
                  type: 'link',
                  dirchange: false,  selected: false,
                  active: false,
            ...
            {
              path: '/pages/form/floating-labels',
            ...
            {
              path: '/pages/form/form-validation',
        ...
        { path: '/pages/faqs',
          subIcon:`<svg xmlns="http://www.w3.org/2000/svg" class="side-menu-doublemenu__icon" viewBox="0 0 256 256"><rect width="256" height="256" fill="none"></rect><circle cx="128" cy="128" r="96" opacity="0.2"></circle><circle cx="128" cy="180" r="12"></circle><path d="M128,144v-8c17.67,0,32-12.54,32-28s-14.33-28-32-28S96,92.54,96,108v4" fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="16"></path><circle cx="128" cy="128" r="96" fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="16"></circle></svg>`,
          dirchange: false,  selected: false, title: "FAQ's", type: 'link' },
        {
          title: 'Invoice',
          dirchange: false,
          subIcon:`<svg xmlns="http://www.w3.org/2000/svg" class="side-menu-doublemenu__icon" viewBox="0 0 256 256"><rect width="256" height="256" fill="none"></rect><path d="M168,200V104h56v88a8,8,0,0,1-8,8Z" opacity="0.2"></path><path d="M64,56H40A16,16,0,0,0,24,72h0A16,16,0,0,0,40,88H56a16,16,0,0,1,16,16h0a16,16,0,0,1-16,16H28" fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="16"></path><line x1="48" y1="48" x2="48" y2="56" fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="16"></line><line x1="48" y1="120" x2="48" y2="128" fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="16"></line><path d="M96,56H224V192a8,8,0,0,1-8,8H40a8,8,0,0,1-8-8V152" fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="16"></path><line x1="104" y1="104" x2="224" y2="104" fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="16"></line><line x1="80" y1="152" x2="224" y2="152" fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="16"></line><line x1="168" y1="104" x2="168" y2="200" fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="16"></line></svg>`,
          type: 'sub',
          active: false,
          selected: false,
          children: [
    ...
    {
      title: 'Utilities',
      subIcon:`<svg xmlns="http://www.w3.org/2000/svg" class="side-menu-doublemenu__icon" viewBox="0 0 256 256"><rect width="256" height="256" fill="none"></rect><path d="M128,192a24,24,0,0,1,24-24h46.21a24,24,0,0,0,23.4-18.65A96.48,96.48,0,0,0,224,127.17c-.45-52.82-44.16-95.7-97-95.17a96,96,0,0,0-95,96c0,41.81,26.73,73.44,64,86.61A24,24,0,0,0,128,192Z" opacity="0.2"></path><path d="M128,192a24,24,0,0,1,24-24h46.21a24,24,0,0,0,23.4-18.65A96.48,96.48,0,0,0,224,127.17c-.45-52.82-44.16-95.7-97-95.17a96,96,0,0,0-95,96c0,41.81,26.73,73.44,64,86.61A24,24,0,0,0,128,192Z" fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="16"></path><circle cx="128" cy="76" r="12"></circle><circle cx="84" cy="100" r="12"></circle><circle cx="84" cy="156" r="12"></circle><circle cx="172" cy="100" r="12"></circle></svg>`,
      type: 'sub',
      dirchange: false,
      active: false,
      children: [
    ...
    {
       dirchange: false,title: 'Advanced UI',
       subIcon:`<svg xmlns="http://www.w3.org/2000/svg" class="side-menu-doublemenu__icon" viewBox="0 0 256 256"><rect width="256" height="256" fill="none"></rect><rect x="40" y="144" width="176" height="64" rx="8" opacity="0.2"></rect><rect x="40" y="48" width="176" height="64" rx="8" opacity="0.2"></rect><rect x="40" y="144" width="176" height="64" rx="8" fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="16"></rect><rect x="40" y="48" width="176" height="64" rx="8" fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="16"></rect><circle cx="180" cy="80" r="12"></circle><circle cx="180" cy="176" r="12"></circle></svg>`,
       type: 'sub',
       active: false,
      children: [
        { path: '/advancedui/accordions_collpase',  dirchange: false,  selected: false, title: 'Accordions & Collapse', type: 'link' },
        { path: '/advancedui/carousel',  dirchange: false,  selected: false, title: 'Carousel', type: 'link' },
        { path: '/advancedui/draggable-cards',  dirchange: false,  selected: false, title: 'Draggable Cards', type: 'link' },
        { path: '/advancedui/media-player',  dirchange: false,  selected: false, title: 'Media Player', type: 'link' },
        { path: '/advancedui/modals',  dirchange: false,  selected: false, title: 'Modals & Closes', type: 'link' },
        { path: '/advancedui/navbars',  dirchange: false,  selected: false, title: 'Navbar', type: 'link' },
        { path: '/advancedui/offcanvas',  dirchange: false,  selected: false, title: 'Offcanvas', type: 'link' },
        { path: '/advancedui/placeholders',  dirchange: false,  selected: false, title: 'Placeholders', type: 'link' },
        { path: '/advancedui/ratings',  dirchange: false,  selected: false, title: 'Ratings', type: 'link' },
        { path: '/advancedui/ribbons',  dirchange: false,  selected: false, title: 'Ribbons', type: 'link' },
        { path: '/advancedui/scrollspy',  dirchange: false,  selected: false, title: 'Scrollspy', type: 'link' },
        { path: '/advancedui/sortablejs',  dirchange: false,  selected: false, title: 'Sortable Js', type: 'link' },
        { path: '/advancedui/swiperjs',  dirchange: false,  selected: false, title: 'Swiperjs', type: 'link' },
        { path: '/advancedui/tour',  dirchange: false,  selected: false, title: 'Tour', type: 'link' },
      ]
    },
    ...
    {
      title: 'Charts',
      icon: `<svg xmlns="http://www.w3.org/2000/svg" class="side-menu__icon" viewBox="0 0 256 256"><rect width="256" height="256" fill="none"></rect><path d="M32,48H208a16,16,0,0,1,16,16V208a0,0,0,0,1,0,0H32a0,0,0,0,1,0,0V48A0,0,0,0,1,32,48Z" opacity="0.2"></path><polyline points="224 208 32 208 32 48" fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="16"></polyline><polyline points="200 72 128 144 96 112 32 176" fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="16"></polyline><polyline points="200 112 200 72 160 72" fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="16"></polyline></svg>`,
      type: 'sub',
      dirchange: false,
      active: false,
      children: [
      ...
      children: [
        {
          ...
          title: 'Basic Tables',
          subIcon:`<svg xmlns="http://www.w3.org/2000/svg" class="side-menu-doublemenu__icon" viewBox="0 0 256 256"><rect width="256" height="256" fill="none"></rect><rect x="48" y="48" width="160" height="160" rx="8" opacity="0.2"></rect><rect x="48" y="48" width="160" height="160" rx="8" fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="16"></rect><line x1="128" y1="48" x2="128" y2="208" fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="16"></line><line x1="48" y1="128" x2="208" y2="128" fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="16"></line></svg>`,
          type: 'link',
         dirchange: false,  selected: false,
          active: false,
        },
