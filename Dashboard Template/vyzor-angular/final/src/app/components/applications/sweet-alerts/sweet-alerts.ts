...
export class SweetAlerts {
  ...
  successNotification(){
   ...
   errorNotification(){
    Swal.fire('Danger Message', 'Great Job!!', 'error')
  }
  alertConfirmation(){
    Swal.fire('Warning Message', 'Great Job!!', 'warning')
  }
  infoNotification(){
    Swal.fire('Info Message', 'Great Job!!', 'info')
  }
  questionNotification(){
    Swal.fire('Question Message', 'Great Job!!', 'question')
  }
}
