...
import { SpkCryptoCard } from '../../../../@spk/reusable-dashboards/crypto/spk-crypto-card/spk-crypto-card';
...
@Component({
  ...
  imports: [SharedModule,SpkApexChart,SpkDropdowns,SpkReusableTables,SpkNgSelect,SpkCryptoCard,CommonModule,NgbModule],
...
//Assets Overview
 ...
 Chartoptions = ({color, colors,Series}:any) => ({
  series : [Series],
  chart: {
    height: 20,
    width: 100,
...
CryptoCards: CryptoCardItem[] = [
  {
      imgSrc: "./assets/images/crypto-currencies/crypto-icons/bitcoin-btc-logo.svg",
      value: "21.235-BTC",
      percent: "4.21%",
      iconColor: "success",
      icon: "me-1 align-middle ti ti-trending-up ms-1",
      id: "btc-chart",
      chartoptions: this.Chartoptions({color:'var(--primary-color)', colors:'var(--primary01)',Series:{
  ...
  },
  {
      ...
      percent: "2.21%",
      iconColor: "danger",
      icon: "ti ti-trending-down me-1 align-middle ms-1",
      id: "eth-chart",
      chartoptions: this.Chartoptions({color:'rgb(255, 73, 205)', colors:'rgba(255, 73, 205, 0.1)',Series:{
  ...
  },
  {
      ...
      percent: "12.43%",
      iconColor: "success",
      icon: "ti ti-trending-up me-1 align-middle ms-1",
      id: "tether-chart",
      chartoptions: this.Chartoptions({color:'rgb(50, 212, 132)', colors:'rgba(50, 212, 132, 0.1)',Series:{
  ...
  },
  {
      ...
      icon: "ti ti-trending-down me-1 align-middle ms-1",
      id: "bnb-chart",
      chartoptions: this.Chartoptions({color:'rgb(253, 175, 34)', colors:'rgba(253, 175, 34, 0.1)',Series:{
...
CryptoColumn=[
  { header: 'Asset Type' },
  { header: 'Current Balance (Crypto)' },
  { header: 'Current Price (USD)' },
  { header: 'Total Value (USD)' },
  { header: '24h Change' },
  { header: 'Total Gain/Loss (USD)' },
  { header: '24h Volume (USD)' },
  { header: 'Market Rank', tableHeadColumn: 'text-center' }
];
//Portfolio Overview
 CryptoTableRows: CryptoTableData[] = [
  {
    name: "Bitcoin (BTC)",
  ...
  {
    name: "Ripple (XRP)",
    image: "./assets/images/crypto-currencies/crypto-icons/xrp-xrp-logo.svg",
    quantity: "5,000",
    price: "$0.75",
    totalValue: "$3,750.00",
    change: "+2.5%",
