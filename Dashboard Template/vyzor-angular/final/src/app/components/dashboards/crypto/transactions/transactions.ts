...
interface CardInfo {
  ...
  percent: string;
  isPositive: boolean;
  priceColor: 'primary' | 'secondary' | 'success' | 'warning';
  svgIcon: string;
  iconColor: string;
  cardClass?: string;
  bodyClass?:string;
...
interface Transaction {
  ...
  direction: 'up' | 'down';
  crypto: { name: string; icon: string };
  date: string;
  amount: string;
  recipient: string;
...
@Component({
  ...
  imports: [SharedModule,SpkListCard,SpkDropdowns,SpkReusableTables,CommonModule,NgbModule],
  templateUrl: './transactions.html',
  styleUrl: './transactions.scss'
})
export class Transactions {
  TransactionCard: CardInfo[] = [
    {
        title: "New",
        count: 43,
        price: "12,345",
...
click(id:string){
  const data = this.TransactionsTable.filter((x: { id: string }) => {
    return x.id != id;
...
TransactionsTable: Transaction[] = [
  {
      id: '#1234567890',
      user: { name: 'John Doe', avatar: './assets/images/faces/10.jpg' },
      direction: 'up',
      crypto: { name: 'Bitcoin', icon: './assets/images/crypto-currencies/crypto-icons/bitcoin-btc-logo.svg' },
  ...
  {
      id: '#1234567891',
      user: { name: 'Jane Smith', avatar: './assets/images/faces/5.jpg' },
      direction: 'down',
      crypto: { name: 'Ethereum', icon: './assets/images/crypto-currencies/crypto-icons/ethereum-eth-logo.svg' },
  ...
  {
      id: '#1234567892',
      user: { name: 'Mark Lee', avatar: './assets/images/faces/12.jpg' },
      direction: 'up',
      crypto: { name: 'Solana', icon: './assets/images/crypto-currencies/crypto-icons/solana-sol-logo.svg' },
  ...
  {
      id: '#1234567893',
      user: { name: 'Alex Green', avatar: './assets/images/faces/15.jpg' },
      direction: 'up',
      crypto: { name: 'Bitcoin', icon: './assets/images/crypto-currencies/crypto-icons/bitcoin-btc-logo.svg' },
  ...
  {
      id: '#1234567894',
      user: { name: 'Emma White', avatar: './assets/images/faces/4.jpg' },
      direction: 'up',
      crypto: { name: 'Dogecoin', icon: './assets/images/crypto-currencies/crypto-icons/dogecoin-doge-logo.svg' },
  ...
  {
      id: '#1234567895',
      user: { name: 'Luke Brown', avatar: './assets/images/faces/7.jpg' },
      direction: 'down',
      crypto: { name: 'Bitcoin', icon: './assets/images/crypto-currencies/crypto-icons/bitcoin-btc-logo.svg' },
  ...
  {
      id: '#1234567896',
      user: { name: 'Sophia Black', avatar: './assets/images/faces/6.jpg' },
      direction: 'up',
      crypto: { name: 'Ethereum', icon: './assets/images/crypto-currencies/crypto-icons/ethereum-eth-logo.svg' },
  ...
  {
      id: '#1234567897',
      user: { name: 'Rachel Green', avatar: './assets/images/faces/7.jpg' },
      direction: 'up',
      crypto: { name: 'Tether', icon: './assets/images/crypto-currencies/crypto-icons/tether-usdt-logo.svg' },
  ...
  {
      id: '#1234567898',
      user: { name: 'David Kim', avatar: './assets/images/faces/15.jpg' },
      direction: 'down',
      crypto: { name: 'Bitcoin', icon: './assets/images/crypto-currencies/crypto-icons/bitcoin-btc-logo.svg' },
  ...
  {
      id: '#1234567899',
      user: { name: 'Oliver Stone', avatar: './assets/images/faces/16.jpg' },
      direction: 'up',
      crypto: { name: 'Ethereum', icon: './assets/images/crypto-currencies/crypto-icons/ethereum-eth-logo.svg' },
