...
import { SpkStockCard1 } from "../../../@spk/reusable-dashboards/spk-stock-card1/spk-stock-card1";
...
@Component({
  selector: 'app-stocks',
  standalone: true,
  imports: [NgbModule, SharedModule, CommonModule, SpkStockCard1, SpkApexChart, SpkDropdowns, SpkReusableTables],
...
export class Stocks {
  ...
  StockData: StockData[] = [
    {
      id: "apple",
      imgSrc: "./assets/images/media/apps/apple.png",
      title: "Apple",
      subtitle: "AAPL",
      percent: "+1.50",
      ...
      chartOptions:this.StockOptions,
    },
    {
      id: "google",
      imgSrc: "./assets/images/media/apps/google.png",
      title: "Alphabet",
      subtitle: "GOOGL",
      percent: "-5.25",
      percentColor: "danger",
    ...
    {
      id: "microsoft",
      imgSrc: "./assets/images/media/apps/microsoft.png",
    ...
    {
      id: "amazon",
      imgSrc: "./assets/images/media/apps/amazon.png",
    ...
    {
      id: "tesla",
      imgSrc: "./assets/images/media/apps/tesla.png",
      title: "Tesla Inc",
      subtitle: "TSLA",
      percent: "+8.00%",
      percentColor: "success",
    ...
    {
      id: "meta",
      imgSrc: "./assets/images/media/apps/meta.png",
    ...
    {
      id: "nvidia",
      imgSrc: "./assets/images/media/apps/nvidia.png",
...
Watchlistdata: SimpleStock[] = [
  ...
  },
  {
    ...
    change: "+1.45%",
    changeType: "success",
    image: "./assets/images/media/apps/tesla.png"
  },
  {
    id: "microsoft",
    name: "Microsoft Corp",
  ...
  },
  {
    ...
    change: "-1.35%",
    changeType: "danger",
    image: "./assets/images/media/apps/meta.png"
  },
  {
    id: "google",
    name: "Alphabet Inc",
  ...
  },
  {
    ...
    change: "-0.47%",
    changeType: "danger",
    image: "./assets/images/media/apps/alibaba.png"
  }
];
Trendingdata: AssetCard[] = [
  {
    id: "apple",
    name: "Apple",
    icon: "bi-apple",
...
Recentstocks: Stock[] = [
  {
    ...
    name: "Apple Inc",
    symbol: "AAPL",
    logo: "./assets/images/media/apps/apple.png",
    valueChange: "+$5,000",
    progressBarWidth: "85",
  ...
  },
  {
    ...
    name: "Microsoft Corp",
    symbol: "MSFT",
    logo: "./assets/images/media/apps/microsoft.png",
    valueChange: "+$11,246",
    progressBarWidth: "80",
  ...
  },
  {
    ...
    name: "NVIDIA Corp",
    symbol: "NVDA",
    logo: "./assets/images/media/apps/nvidia.png",
    valueChange: "+$1,566",
    progressBarWidth: "50",
  ...
  },
  {
    ...
    name: "Amazon.com Inc",
    symbol: "AMZN",
    logo: "./assets/images/media/apps/amazon.png",
    valueChange: "$23,855",
    progressBarWidth: "60",
  ...
  },
  {
    ...
    name: "Alphabet Inc",
    symbol: "GOOGL",
    logo: "./assets/images/media/apps/google.png",
    valueChange: "+$6,274",
    progressBarWidth: "70",
  ...
  },
  {
    ...
    name: "Tesla Inc",
    symbol: "TSLA",
    logo: "./assets/images/media/apps/tesla.png",
    valueChange: "+$8,643",
    progressBarWidth: "50",
