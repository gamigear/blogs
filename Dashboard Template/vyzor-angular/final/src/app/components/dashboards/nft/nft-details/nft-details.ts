...
@Component({
  ...
  imports: [SharedModule,CommonModule, SpkReusableTables],
  schemas: [CUSTOM_ELEMENTS_SCHEMA],
  templateUrl: './nft-details.html',
  styleUrl: './nft-details.scss'
})
export class NftDetails {
 ...
 NftRatings: Rating[] = [
    { stars: 5, percentage: 55, count: 10 ,color:"bg-success"},
    { stars: 4, percentage: 22, count: 6 ,color:"bg-success"},
    { stars: 3, percentage: 8, count: 4 ,color:"bg-success"},
    { stars: 2, percentage: 9, count: 1 ,color:"bg-warning"},
    { stars: 1, percentage: 6, count: 1 ,color:"bg-danger"},
  ];
}
