...
@Component({
    ...
    imports: [SharedModule, NgbModule, FormsModule, NouisliderModule, NgxSliderModule, ReactiveFormsModule,ShowcodeCard]
})
export class RangeSlider {
 ...
 Slider1: SimpleSliderModel = {
  ...
  minValuesecondary = 15;
  optionssecondary: Options = {
    ceil: 50,
    showSelectionBar: true,
    selectionBarGradient: {
      from: '#ff8e6f',
