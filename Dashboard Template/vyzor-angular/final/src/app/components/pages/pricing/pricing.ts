...
import { SpkPricingCard } from '../../../@spk/reusable-pages/spk-pricing-card/spk-pricing-card';
...
@Component({
    ...
    standalone: true,
    imports:[SharedModule,NgbModule,SpkPricingCard,SpkBasicpricecard]
})
