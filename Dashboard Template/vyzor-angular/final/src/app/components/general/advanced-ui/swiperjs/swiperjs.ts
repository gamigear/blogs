...
import { SwiperComponent } from '../../../../@spk/spk-reusable-plugins/swiper/swiper';
...
@Component({
    ...
    templateUrl: './swiperjs.html',
    styleUrls: ['./swiperjs.scss'],
    imports: [SharedModule, SwiperComponent]
})
