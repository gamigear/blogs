...
import * as reuseCode from '../../../../shared/prismData/advancedUi/accordion';
import * as tsCode from '../../../../shared/prismData/advancedUi/accordion';
...
import { NgbCollapse } from '../../../../@spk/spk-reusable-plugins/ngb-collapse/ngb-collapse';
...
@Component({
    ...
    standalone: true,
    animations: [
      trigger('horizontalCollapse', [
          state('true', style({ width: '0' })),
          state('false', style({ width: '230px' })),
          transition('true <=> false', animate('300ms ease-in-out')),
      ]),
  ],
    imports:[SharedModule,NgbModule,ShowcodeCard,NgbCollapse,NgbAccordion]
})
