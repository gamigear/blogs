...
import { SpkImageCard } from '../../../../@spk/reusable-ui-elements/spk-cards/spk-image-card/spk-image-card';
import { SpkLinkCard } from '../../../../@spk/reusable-ui-elements/spk-cards/spk-link-card/spk-link-card';
import { SpkHorizontalCard } from '../../../../@spk/reusable-ui-elements/spk-cards/spk-horizontal-card/spk-horizontal-card';
import { SpkBgcolorCard } from '../../../../@spk/reusable-ui-elements/spk-cards/spk-bgcolor-card/spk-bgcolor-card';
import { SpkFeaturedCard } from '../../../../@spk/reusable-ui-elements/spk-cards/spk-featured-card/spk-featured-card';
import { SpkBlockquoteCard } from '../../../../@spk/reusable-ui-elements/spk-cards/spk-blockquote-card/spk-blockquote-card';
import { SpkAlignmentCard } from '../../../../@spk/reusable-ui-elements/spk-cards/spk-alignment-card/spk-alignment-card';
import { SpkMountainsCard } from '../../../../@spk/reusable-ui-elements/spk-cards/spk-mountains-card/spk-mountains-card';
import { SpkGridmarkupCard } from '../../../../@spk/reusable-ui-elements/spk-cards/spk-gridmarkup-card/spk-gridmarkup-card';
import { SpkTitleCard } from '../../../../@spk/reusable-ui-elements/spk-cards/spk-title-card/spk-title-card';
import { SpkNewsCard } from '../../../../@spk/reusable-ui-elements/spk-cards/spk-news-card/spk-news-card';
import { SpkMediaCard } from '../../../../@spk/reusable-ui-elements/spk-cards/spk-media-card/spk-media-card';
import { SpkCustomCard } from '../../../../@spk/reusable-ui-elements/spk-cards/spk-custom-card/spk-custom-card';
import { SpkReviewCard } from '../../../../@spk/reusable-ui-elements/spk-cards/spk-review-card/spk-review-card';
import { SpkBorderCard } from '../../../../@spk/reusable-ui-elements/spk-cards/spk-border-card/spk-border-card';
import { SpkCardgroupsCard } from '../../../../@spk/reusable-ui-elements/spk-cards/spk-cardgroups-card/spk-cardgroups-card';
import { SpkGridcard } from '../../../../@spk/reusable-ui-elements/spk-cards/spk-gridcard/spk-gridcard';
import { SpkUtilitiesCard } from '../../../../@spk/reusable-ui-elements/spk-cards/spk-utilities-card/spk-utilities-card';
import { SpkOverlayCard } from '../../../../@spk/reusable-ui-elements/spk-cards/spk-overlay-card/spk-overlay-card';
import { SpkNavigationCard } from '../../../../@spk/reusable-ui-elements/spk-cards/spk-navigation-card/spk-navigation-card';
import { SpkCollapseCard } from '../../../../@spk/reusable-ui-elements/spk-cards/spk-collapse-card/spk-collapse-card';
import { SpkListgroupCard } from '../../../../@spk/reusable-ui-elements/spk-cards/spk-listgroup-card/spk-listgroup-card';
import { SpkHeaderFooterCard } from '../../../../@spk/reusable-ui-elements/spk-cards/spk-header-footer-card/spk-header-footer-card';


@Component({
  selector: 'app-cards',
  standalone: true,
  imports: [SharedModule, NgbModule, SpkImageCard, SpkLinkCard, SpkHorizontalCard, SpkBgcolorCard, SpkFeaturedCard, SpkBlockquoteCard, SpkAlignmentCard, SpkMountainsCard, SpkGridmarkupCard, SpkOverlayCard, SpkTitleCard, SpkNewsCard, SpkMediaCard, SpkHeaderFooterCard, SpkCustomCard, SpkReviewCard, SpkBorderCard, SpkCardgroupsCard, SpkGridcard, SpkUtilitiesCard, SpkNavigationCard, SpkCollapseCard, SpkListgroupCard],
...
getSanitizedSVG(svgContent: string): SafeHtml {
  ...
  blockquotes = [
    ...
    },
    {
      ...
      textColor1:'text-fixed-white op-7'
    },
  ];
  blockquotes1 = [
    {
  ...
  titleCard = [
    {
      ...
      links: [
        ...
        { text: 'Another link', href: 'javascript:void(0);', class: 'text-secondary d-inline-block' }
      ]
    },
    {
      imageUrl: './assets/images/media/media-22.jpg',
      title: 'Card title',
      text: 'As the wind whistled through the dense foliage, scattering leaves like whispered secrets, a lone sapling stood resilient, its roots anchored deep in the earth.',
      buttonText: 'Read More',
  ...
  horizontalCards = [
    ...
    },
    {
      ...
      discription1: 'Last updated 3 mins ago',
