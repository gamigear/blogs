...
@Component({
  ...
  standalone: true,
  imports: [SharedModule, NgbDropdownModule, ShowcodeCard, SpkDropdowns],
  templateUrl: './dropdowns.html',
  styleUrls: ['./dropdowns.scss']
})
export class Dropdowns {
  ...
  dropdownsizing = [
    ...
    { style: 'btn-primary btn-sm dropdown-toggle  ', splitbuttonClass: 'btn btn-info', splitbutton: false, label: 'Small button' },
  ...
  alignmentOptions = [
    ...
    { Customclass: "btn-group", style: 'btn-info    dropdown-toggle ', label: 'Left, right-aligned lg', menuClass: 'dropdown-menu dropdown-menu-lg-end' },
    { Customclass: "btn-group", style: 'btn-warning dropdown-toggle ', label: 'Right, left-aligned lg', menuClass: 'dropdown-menu-end dropdown-menu-lg-start' },
    { Customclass: "btn-group dropend", style: 'btn-danger dropdown-toggle ', label: 'Dropend', menuClass: 'dropdown-menu' },
    { Customclass: "btn-group dropup custom-dropup  my-1 me-2", style: 'btn-teal dropdown-toggle ', label: 'Dropup', menuClass: 'dropdown-menu', placement: "top-start" },
  ]
  customDropdowns = [
    {
      label: 'Primary',
