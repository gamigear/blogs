...
import * as reuseCode from '../../../../shared/prismData/popovers'
import { DomSanitizer, SafeHtml } from '@angular/platform-browser';
import { SharedModule } from '../../../../shared/shared.module';
import { ShowcodeCard } from '../../../../shared/components/showcode-card/showcode-card';
import { SpkPopovers } from '../../../../@spk/reusable-ui-elements/spk-popovers/spk-popovers';
@Component({
  selector: 'app-popovers',
  standalone: true,
  imports: [SharedModule, NgbPopoverModule, ShowcodeCard, SpkPopovers],
  templateUrl: './popovers.html',
  styleUrls: ['./popovers.scss']
})
export class Popovers {
  ...
  coloredPopovers = [
    ...
    { id: 2, header: "header-secondary", class: "secondary", title: 'colored header', title1: "Header Secondary", content: "Popover with Secondary header.", textcolor: '' },
    { id: 3, header: "header-info",      class: "info", title: 'colored header', title1: "Header Info", content: "Popover with Info header.", textcolor: '' },
    { id: 4, header: "header-warning",  class: "warning", title: 'colored header', title1: "Header Warning", content: "Popover with Warning header.", textcolor: '' },
    { id: 5, header: "header-success",  class: "success", title: 'colored header', title1: "Header Success", content: "Popover with success header.", textcolor: '' },
    { id: 6, header: "header-danger",  class: "danger", title: 'colored header', title1: "Header Danger", content: "Popover with Danger header.", textcolor: '' },
  ];
  coloredBackground = [
