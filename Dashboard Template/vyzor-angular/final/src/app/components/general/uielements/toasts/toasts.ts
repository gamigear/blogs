...
import * as reuseCode from '../../../../shared/prismData/toasts'
...
@Component({
  selector: 'app-toasts',
  standalone: true,
  imports: [SharedModule,ShowcodeCard,SpkToast],
...
export class Toasts {
  ...
  // hideToastsecondary(toast18: { autohide: boolean }) {
  ...
  // hideSolidToastsecondary(toastJ: { autohide: boolean }) {
