...
import { AngularMaterialReusableTable } from '../../../@spk/spk-reusable-plugins/angular-material-reusable-table/angular-material-reusable-table';
...
@Component({
  ...
  imports: [SharedModule,AngularMaterialReusableTable,MaterialModuleModule],
  templateUrl: './angular-material-table.html',
  styleUrl: './angular-material-table.scss'
})
export class AngularMaterialTable {
// table sample
