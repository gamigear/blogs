import { Component, Directive, Input, ViewChild, input } from '@angular/core';
import { MatPaginator } from '@angular/material/paginator';
import { MatSort } from '@angular/material/sort';
import { DataSource } from '@angular/cdk/collections';
import { MatTable, MatTableDataSource } from '@angular/material/table';
import { ELEMENT_DATA1, ELEMENT_DATA2, ELEMENT_DATA3, ELEMENT_DATA4, ELEMENT_DATA5, ELEMENT_DATA6, PeriodicElement, PeriodicElement2, PeriodicElement3, PeriodicElement4, PeriodicElement5, PeriodicElement6, PeriodicElements } from '../../../shared/data/data';
...
@Component({
  selector: 'angular-material-reusable-table',
  standalone: true,
  imports: [MaterialModuleModule],
  templateUrl: './angular-material-reusable-table.html',
  styleUrl: './angular-material-reusable-table.scss'
})
export class AngularMaterialReusableTable {
   displayedColumns = input<string[]>([]);
  @Input() dataSource!: MatTableDataSource<any>;
   showPaginator = input<boolean>(false);
   showFilter = input<boolean>(false);
   basicTable = input<boolean>(false);
   wideTable = input<boolean>(false);
   addremovebuttons = input<boolean>(false);
   matsatheader = input<any>(false);
