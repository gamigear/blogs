...
export class AppStateService {
  private readonly localStorageKey = 'vyzor-ng'; // Customize this key
  private initialState: StateType = {
    ...
    layoutStyles: 'doublemenu',        // double-menu, detached, icon-overlay, icontext-menu, closed-menu, default-menu
    pageStyles: 'flat',          // regular, classic, modern,flat
    widthStyles: 'fullwidth',       // fullwidth, boxed /default
