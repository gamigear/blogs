...
function ltrFn() {
    ...
    if (!document.querySelector("#style").href.includes('bootstrap.min.css')) {
        document.querySelector("#style")?.setAttribute("href", "../build/libs/bootstrap/css/bootstrap.min.css");
    }
...
function rtlFn() {
    ...
    document.querySelector("#style")?.setAttribute("href", "../build/libs/bootstrap/css/bootstrap.rtl.min.css");
    checkOptions();
}
