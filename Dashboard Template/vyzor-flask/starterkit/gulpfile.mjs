...
// Watch Task
function watchTask() {
  gulp.watch(['static/assets/scss/**/*', '!static/assets/switcher/*.scss'], gulp.series(scssTask));
}

// SCSS Task
function scssTask() {
  const scssFiles = 'static/assets/scss/**/*.scss';
  const cssDest = 'static/assets/css';
...
function copyLibsTask() {
  const destPath = 'static/assets/libs';
