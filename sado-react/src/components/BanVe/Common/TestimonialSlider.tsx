...
const testimonialSliderData = [
  {
    ...
    designation: "Khách Hàng Hài Lòng",
    feedbackText:
      "Dịch vụ tuyệt vời! Tôi đã có một chuyến đi đáng nhớ cùng gia đình. Hướng dẫn viên rất nhiệt tình và chuyên nghiệp. Chắc chắn sẽ quay lại sử dụng dịch vụ của VéXanh.",
    feedbackTitle: "Gói Tour Hấp Dẫn Nhất!",
    rating: [
  ...
  },
  {
    ...
    designation: "Khách Hàng Hài Lòng",
    feedbackText:
      "Giá cả hợp lý, dịch vụ chu đáo. Đặc biệt ấn tượng với cách tổ chức tour rất chuyên nghiệp. Cảm ơn VéXanh đã mang đến cho tôi những trải nghiệm tuyệt vời.",
    feedbackTitle: "Gói Tour Hấp Dẫn Nhất!",
    rating: [
      { iconName: "ri-star-fill" },
      { iconName: "ri-star-fill" },
          ...
          <div className="row align-items-center">
            ...
            <div className="col-lg-6">
              <div className="testimonial-content">
                <span className="top-title">ĐÁNH GIÁ</span>
