          ...
          <div className="row align-items-center">
            <div className="col-lg-6">
              <div className="choose-content">
                <span className="top-title">TẠI SAO CHỌN VÉXANH</span>
                <h2>Chúng Tôi Giới Thiệu Điểm Đến Tuyệt Đẹp Mỗi Tháng</h2>
                <p>
                  Với đội ngũ chuyên nghiệp và kinh nghiệm lâu năm trong ngành du lịch, chúng tôi cam kết mang đến cho bạn những trải nghiệm tuyệt vời nhất với dịch vụ chất lượng cao.
                </p>
                  ...
                  <li>
                    <div className="d-flex">
                      ...
                      <div className="flex-grow-1 ms-40">
                        ...
                        <p>
                          Cam kết mang đến dịch vụ chất lượng cao với đội ngũ hướng dẫn viên chuyên nghiệp và tận tâm
                        </p>
                      </div>
                    </div>
                  </li>
                  ...
                  <li>
                    <div className="d-flex">
                      ...
                      <div className="flex-grow-1 ms-40">
                        ...
                        <p>
                          Đội ngũ hỗ trợ 24/7 luôn sẵn sàng giải đáp mọi thắc mắc và hỗ trợ bạn trong suốt chuyến đi
                        </p>
                      </div>
                    </div>
                  </li>
            ...
            <div className="col-lg-6">
              <div className="choose-img position-relative text-lg-end">
