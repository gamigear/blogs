            ...
            <div className="col-lg-6">
              <div className="banner-content">
                <h1
                  ...
                  data-aos-once="true"
                >
                  Khám Phá Cuộc Sống <span className="text-shape">Du Lịch</span> Đến Nơi Bạn Muốn
                </h1>
                <p
                  data-aos="fade-up"
                  data-aos-delay="200"
                  ...
                  data-aos-once="true"
                >
                  Có rất nhiều lựa chọn vé du lịch hấp dẫn đang chờ đón bạn. Hãy để chúng tôi đồng hành cùng bạn trong mọi chuyến đi.
                </p>
                  ...
                  <div className="col-sm-6 h-100">
                    <div className="banner-img-two position-relative z-1">
                      ...
                      <h3 className="packages">
                        <Link href="/subscription">Gói Vé Tốt Nhất</Link>
                      </h3>
                    </div>
                  </div>
                </div>
